...
<!-- Mirrored from <?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:24 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="What is a Carbon Neutral Building? - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Carbon neutral building has become a buzzword in the construction industry, and for two major reasons. Governments and the public at large are pressuring to address climate change, which means reducing carbon emissions—and carbon neutral building does exactly that. Homeowners also enjoy green buildings, and carbon neutral buildings in particular use far less energy, which…" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-03-18T00:11:30+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:35+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2020/03/carbon-neutral-1024x687.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"What is a Carbon Neutral Building?","datePublished":"2020-03-18T00:11:30+00:00","dateModified":"2023-09-11T13:46:35+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/"},"wordCount":854,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral.png","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Builder","<?php echo $row['country']; ?> Building Guidelines","building in <?php echo $row['country']; ?>"],"articleSection":["Building in <?php echo $row['country']; ?>"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/","url":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/","name":"What is a Carbon Neutral Building? - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral.png","datePublished":"2020-03-18T00:11:30+00:00","dateModified":"2023-09-11T13:46:35+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"What is a Carbon Neutral Building?"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>What is a Carbon Neutral Building? - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2666.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index9ad9.php?p=2666' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed0015.json?url=<?php echo $row['url']; ?>%2Fwhat-is-a-carbon-neutral-building%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed1a34?url=<?php echo $row['url']; ?>%2Fwhat-is-a-carbon-neutral-building%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2666 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2020-03-17T20:11:30-04:00">03.17.2020</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">What is a Carbon Neutral Building?</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">Carbon neutral building has become a buzzword in the construction industry, and for two major reasons. Governments and the public at large are pressuring to address climate change, which means reducing carbon emissions—and carbon neutral building does exactly that. Homeowners also enjoy green buildings, and carbon neutral buildings in particular use far less energy, which means lowered utility bills, even if the initial investment cost is higher.</span></p>
<p><span style="font-weight: 400;">What exactly does </span><a href="https://www.fastcompany.com/90251807/4-steps-to-prepare-your-business-for-a-carbon-neutral-future"><span style="font-weight: 400;">carbon neutral building</span></a><span style="font-weight: 400;"> entail? It means creating buildings with reduced energy consumption along with the use of low carbon emission energy sources. But what are some of the specifics that go into a carbon neutral building? Let’s take a look!</span></p>
<p><b>Passive Design</b></p>
<p><span style="font-weight: 400;">Passive design is a method that takes the area’s climate into account. With this </span><a href="../passive-building-design-for-multi-family-sector/index.php"><span style="font-weight: 400;">design method</span></a><span style="font-weight: 400;">, a building utilizes natural energy, such as sunlight or breezes to help with heating and cooling. In <?php echo $row['country']; ?>, for instance, a building using passive design might rely on shading—trees, window awnings, shutters and so forth—to keep direct sunlight from raising the home’s temperature in the summer. Another example of passive design is a sun tube, or tubular skylight, which acts just like a light fixture during the day by reflecting sunlight into the home—without requiring energy to do so.</span></p>
<p><b>High Performance Building Envelopes</b></p>
<p><span style="font-weight: 400;">The </span><a href="../6-strategies-for-air-sealing-in-new-construction-and-retrofits/index.php"><span style="font-weight: 400;">building envelope</span></a><span style="font-weight: 400;"> is key to a carbon neutral building. One of the primary ways these buildings reduce energy usage is by preventing heat gain and loss during hot and cold seasons. These types of building envelopes require extreme insulation—walls, floors and ceilings, plus thorough sealing of any air leaks. With that, carbon neutral buildings require an effective ventilation system to keep air circulating without gaining or losing heat. This also means taking windows, doors and roofing into account, choosing products that reduce heat intake or reflect sunlight away instead of allowing the thermal energy to warm the building’s interior.</span></p>
<p><b>Energy Efficient Systems</b></p>
<p><span style="font-weight: 400;">Energy efficiency is another foundational principle in carbon neutral building. Homes and businesses still need HVAC, lighting and appliances—but to incorporate these things within a carbon neutral framework, extra care has to be taken to choose energy efficient options. Heat pumps are becoming much more popular as an efficient alternative to furnaces and air conditioning units, and as technology advances, they’re becoming a very feasible option in areas that experience extreme hot and cold like <?php echo $row['country']; ?>. Energy Star appliances also help reduce energy usage, as do LED lighting systems, and the use of natural lighting whenever available.</span></p>
<p><b>On-Site Renewable Energy</b></p>
<p><span style="font-weight: 400;">Renewable energy is a big part of the carbon neutral formula. In order to create a building that produces little to no carbon, engineers must first design the building that uses as little energy as possible, and then add in renewable systems to provide as much energy as possible to meet the building’s requirements. In practice, this often means solar power for cities like <?php echo $row['country']; ?>, though hydroelectricity and wind power are also options in areas where water currents or steady winds are reliably available.</span></p>
<p><b>Offsetting</b></p>
<p><span style="font-weight: 400;">One of the key things to understand about carbon neutral building is that it’s not the same as net zero building. Net zero building means building structures that use zero net energy, thus they have no carbon emissions. In carbon neutral building, the buildings will still produce some carbon, even if their carbon footprints are drastically reduced.</span></p>
<p><span style="font-weight: 400;">So what about that remaining, if small, carbon footprint? That’s where offsetting comes in. Offsets are investments in projects that avoid and reduce carbon consumption. They often come in the form of carbon credits, with one carbon credit purchased equaling either the removal of one metric ton of carbon dioxide from the atmosphere, or the avoidance of producing that carbon dioxide.</span></p>
<p><b><?php echo $row['country']; ?> Taking the Lead on Carbon Neutrality</b></p>
<p><span style="font-weight: 400;">Right now, there are lots of interesting things happening within <?php echo $row['country']; ?> to help combat the effects of climate change. For starters, at the end of 2019,</span><a href="https://www.<?php echo $row['country']; ?>.gov/news/executive-order-requires-new-municipal-buildings-target-carbon-neutrality"> <span style="font-weight: 400;">Mayor Walsh signed an executive order</span></a><span style="font-weight: 400;"> that requires all new municipal buildings to reach a net zero carbon standard, which means that from here on, all new municipal projects must be low energy, without the use of fossil fuels.</span></p>
<p><span style="font-weight: 400;"><?php echo $row['country']; ?> is one of the world’s foremost cities when it comes to combatting climate change, and officials are accomplishing this by reducing emissions and making other preparations for extreme temperatures, storms and sea level rise. It’s already the most energy efficient city in the country, but even so, buildings within the city still account for 70% of <?php echo $row['country']; ?>’s emissions. That’s why BERDO, the Building Energy Reporting and Disclosure Ordinance, requires that building owners account for their energy usage and start planning to increase energy efficiency. Right now, the goal to reach citywide carbon neutrality is to see all buildings, both new construction and existing, reach a zero-carbon target by 2050.</span></p>
<p><span style="font-weight: 400;">Carbon neutrality is the way of the future worldwide. Nowhere is that more prominent than in <?php echo $row['country']; ?>, a city that leads the world in its efforts to combat climate change and reduce carbon emissions.</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="../wp-content/uploads/2020/04/boston-construction-moratorium-impact-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../boston-construction-moratorium-impact-response-and-future-comeback/index.php"><?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/what-is-a-carbon-neutral-building/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:27 GMT -->
</html>
