...
<!-- Mirrored from <?php echo $row['url']; ?>/3920-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:47 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Toys for Tots 2023 - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="<?php echo $row['name']; ?> is an official drop site for Toys for Tots We all want to make the holidays brighter for children in need. The primary mission of the Toys for Tots program is to collect new unwrapped toys and distribute those toys to less fortunate children at Christmas. <?php echo $row['name']; ?> is proud to be an official drop…" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2023-11-15T18:26:06+00:00" />
	<meta property="article:modified_time" content="2023-11-22T16:27:09+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png" />
	<meta property="og:image:width" content="1530" />
	<meta property="og:image:height" content="807" />
	<meta property="og:image:type" content="image/png" />
	<meta name="author" content="moneaortiz" />
	...
	<meta name="twitter:data1" content="moneaortiz" />
	<meta name="twitter:label2" content="Est. reading time" />
	<meta name="twitter:data2" content="1 minute" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/3920-2/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/3920-2/"},"author":{"name":"moneaortiz","@id":"<?php echo $row['url']; ?>/#/schema/person/eda89ced9a6f4a22aa747831f307eb53"},"headline":"Toys for Tots 2023","datePublished":"2023-11-15T18:26:06+00:00","dateModified":"2023-11-22T16:27:09+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/3920-2/"},"wordCount":105,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/3920-2/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png","inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/3920-2/","url":"<?php echo $row['url']; ?>/3920-2/","name":"Toys for Tots 2023 - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/3920-2/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/3920-2/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png","datePublished":"2023-11-15T18:26:06+00:00","dateModified":"2023-11-22T16:27:09+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/3920-2/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/3920-2/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/3920-2/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png","width":1530,"height":807},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/3920-2/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Toys for Tots 2023"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/eda89ced9a6f4a22aa747831f307eb53","name":"moneaortiz","url":"<?php echo $row['url']; ?>/author/moneaortiz/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Toys for Tots 2023 - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/3920.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index13c7.php?p=3920' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed4cc4.json?url=<?php echo $row['url']; ?>%2F3920-2%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed2548?url=<?php echo $row['url']; ?>%2F3920-2%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-3920 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/3920-2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/3920-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:48 GMT -->
</html>
