...
<!-- Mirrored from <?php echo $row['url']; ?>/sustainable-building-trex/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:06 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Trex decking is the perfect solution for sustainable building. Contact a <?php echo $row['name']; ?> decking expert to learn more about Trex composite decking." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Go Green with Trex Decking: A Sustainable Building Solution → <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Trex decking is the perfect solution for sustainable building. Contact a <?php echo $row['name']; ?> decking expert to learn more about Trex composite decking." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2021-04-28T21:22:15+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:12+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/sustainable-building-trex/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Go Green with Trex Decking: A Sustainable Building Solution","datePublished":"2021-04-28T21:22:15+00:00","dateModified":"2023-09-11T13:46:12+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/sustainable-building-trex/"},"wordCount":479,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg","articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Decks","Developer","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/sustainable-building-trex/","url":"<?php echo $row['url']; ?>/sustainable-building-trex/","name":"Go Green with Trex Decking: A Sustainable Building Solution → <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg","datePublished":"2021-04-28T21:22:15+00:00","dateModified":"2023-09-11T13:46:12+00:00","description":"Trex decking is the perfect solution for sustainable building. Contact a <?php echo $row['name']; ?> decking expert to learn more about Trex composite decking.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/sustainable-building-trex/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg","width":2048,"height":1071,"caption":"sustainable building"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/sustainable-building-trex/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Go Green with Trex Decking: A Sustainable Building Solution"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Go Green with Trex Decking: A Sustainable Building Solution → <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2790.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexec68.php?p=2790' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedc0a8.json?url=<?php echo $row['url']; ?>%2Fsustainable-building-trex%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed5703?url=<?php echo $row['url']; ?>%2Fsustainable-building-trex%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2790 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Go Green with Trex Decking: A Sustainable Building Solution</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span data-mce-type="bookmark" style="width: 0px;overflow: hidden;line-height: 0" class="mce_SELRES_start"><span data-mce-type="bookmark" style="display: inline-block; width: 0px; overflow: hidden; line-height: 0;" class="mce_SELRES_start">﻿</span><span data-mce-type="bookmark" style="width: 0px;overflow: hidden;line-height: 0" class="mce_SELRES_start">﻿</span>﻿</span>As we’ve seen over the decades, what’s “in” or what’s popular is constantly changing. For the building and construction industry, it could be interior design, architecture trends, or which city is the new hot spot for building—regardless of the trend’s current popularity, we know that will likely change in the coming years. </p>
<p>
However, there is one trend that will always be in style no matter what the day is: sustainable building. Lucky for you, <a href="../trex-decking-benefits/index.php">Trex decking</a> is the perfect solution for building green when it comes to your outdoor living project.</p>
<h3>What Makes Trex Decking Sustainable? </h3>
<p>Trex composite decking is made from <a href="https://www.trex.com/why-trex/eco-friendly-decking/" traget="_blank" rel="noopener">95% reclaimed wood and plastic film</a>—recycling at its finest. The following reasons are why Trex decking is the perfect choice for your sustainable building project:</p>
<ul>
•	<strong>Reclaimed wood</strong>. Trex sources local reclaimed wood for composite decking, minimizing landfill waste and tree use.<br />
•	<strong>Recycled plastic film</strong>. Trex combines reclaimed wood with recycled plastic film from paper towel overwrap, sandwich bags, newspaper sleeves, and grocery bags.</ul>
</ul>
<p>Composite decking the best choice when it comes to sustainable building. The average 500-square foot composite deck contains 140,000 recycled plastic bags, making Trex one of the largest plastic bag recyclers in the country. If you’re looking to minimize your carbon footprint and build green, using Trex decking for your outdoor living project is a no-brainer. </p>
<h3>How is Trex Decking Made? </h3>
<p>If you’re not already convinced that it’s important to find sustainable building products, let’s take a look at the production process of Trex decking:</p>
<ul>
<p>1.	Buy reclaimed wood/sawdust and recycled plastic film;<br />
2.	Clean and ground film into granules;<br />
3.	Combine and heat sawdust and film;<br />
4.	Mix mixture and form into boards;<br />
5.	Cool and cut boards;<br />
6.	Inspect boards for color accuracy, strength, and defects; and<br />
7.	Wrap and ship boards.</ul>
</ul>
<p>Not only is Trex decking an eco-friendly product, but the manufacturing process is just as green when it comes to eliminating environmental waste. Almost 100% of Trex’s factory runoff from production is recycled and reused for the next project!</p>
<h3>Build Green with <?php echo $row['name']; ?> and Trex Decking </h3>
<p>Now that you know just how green composite decking is, it’s time to use it for your outdoor living project. At <?php echo $row['name']; ?> , we believe that the future of the construction industry is sustainable building—that’s why we carry a variety of <a href="../discover-trex/index.php">Trex decking products</a> for all your decking needs. </p>
<p>
<a href="https://goo.gl/maps/x6wT35D1AFqYZEf4A" target="_blank" rel="noopener">Stop by our downtown <?php echo $row['country']; ?> showroom</a> or <a href="../contact-us/index.php">give us a call today</a> to speak with one of our decking experts about the Trex products we carry. We can supply you with composite decking, railing, outdoor lighting, and decking and railing duos to ensure that you’re building a beautiful and relaxing outdoor living space while saving the environment. Sustainable building is the future—it’s time to go green!</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="683" src="../wp-content/uploads/2021/05/shutterstock_487364875-scaled-1-1024x683.jpg" class="attachment-large size-large wp-post-image" alt="energy efficiency" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/05/shutterstock_487364875-scaled-1-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/05/shutterstock_487364875-scaled-1-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/05/shutterstock_487364875-scaled-1-1536x1025.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2021/05/shutterstock_487364875-scaled-1-2048x1366.jpg 2048w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../maximizing-energy-efficiency-windows/index.php">Maximizing Energy Efficiency: What New Windows Can Do For You</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/sustainable-building-trex/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/sustainable-building-trex/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:08 GMT -->
</html>
