<HTML>
    ...
    <HEAD>
        ...
        <META HTTP-EQUIV="Refresh"
            CONTENT="0; URL=../../index.php#/character-millennials-desire-in-surban-neighborhood/">
        <TITLE>Page has moved</TITLE>
    </HEAD>

    <BODY>
        <A HREF="<?php echo $row['url']; ?>/character-millennials-desire-in-surban-neighborhood/">
            <h3>Click here...</h3>
        </A>
    </BODY>
    <!-- Created by HTTrack Website Copier/3.49-2 [XR&CO'2014] -->
