...
<html lang="en-US">
    ...
    <head>
        ...
        <meta property="og:description"
            content="Careers Our employees are the heart of <?php echo $row['name']; ?>, and service is our business. Join Our Team When you join our team, you become a part of representing the <?php echo $row['name']; ?> culture to the <?php echo $row['country']; ?> community. We take great pride in helping our customers grow their businesses and supporting our employees to achieve their highest potential as…" />
        ...
        <meta name="twitter:site" content="@heart of <?php echo $row['name']; ?>_<?php echo $row['country']; ?>" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>/about/careers/",
                "url": "<?php echo $row['url']; ?>/about/careers/",
                "name": "Careers - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/about/careers/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/about/careers/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/09/Picture-4-1-1.jpg",
                "datePublished": "2023-03-15T20:52:09+00:00",
                "dateModified": "2024-10-03T20:33:49+00:00",
                "breadcrumb": {
                    "@id": "<?php echo $row['url']; ?>/about/careers/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>/about/careers/"]
                }]
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/about/careers/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/09/Picture-4-1-1.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/09/Picture-4-1-1.jpg",
                "width": 2560,
                "height": 752
            }, {
                "@type": "BreadcrumbList",
                ...
                "sameAs": ["https://www.facebook.com",
                    "https://twitter.com/heart of <?php echo $row['name']; ?>_<?php echo $row['country']; ?>",
        ...
        <link rel="alternate" type="application/json+oembed"
            href="../../wp-json/oembed/1.0/embed96fe.json?url=<?php echo $row['url']; ?>%2Fabout%2Fcareers%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="../../wp-json/oembed/1.0/embed31ca?url=<?php echo $row['url']; ?>%2Fabout%2Fcareers%2F&amp;format=xml" />
    ...
    <body
        class="page-template-default page page-id-45 page-child parent-pageid-33 wp-custom-logo wp-embed-responsive without-announcement">
            ...
            <main class="wp-block-group alignfull is-layout-constrained wp-block-group-is-layout-constrained">
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-cover alignfull" style="min-height:47vh"><span aria-hidden="true"
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size"><strong>Our employees are the
                                    heart of <?php echo $row['name']; ?>, and service is our business.</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="wp-block-columns alignwide are-vertically-aligned-center justify-space-between pattern-2-col-text-img is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex"
                        ...
                        <div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:37%">
                            <figure class="wp-block-image size-medium"><img decoding="async" width="768" height="514"
                                    src="../../wp-content/uploads/2023/03/Yard-18-768x514.jpg" alt=""
                                    class="wp-image-102"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/03/Yard-18-768x514.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Yard-18-1024x685.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Yard-18-1536x1027.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Yard-18-2048x1370.jpg 2048w"
                        ...
                        <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:48%">
                            <h2 class="wp-block-heading has-primary-color has-text-color has-h-4-font-size">Join Our
                                Team</h2>



                            <p class="has-medium-font-size">When you join our team, you become a part of representing
                                the <?php echo $row['name']; ?> culture to the <?php echo $row['country']; ?> community.
                                We take great pride in helping our customers grow their businesses and supporting our
                                employees to achieve their highest potential as a part of our family. Click the link
                                below to view our open positions. </p>
                            ...
                            <div class="wp-block-buttons is-layout-flex wp-block-buttons-is-layout-flex">
                                <div class="wp-block-button is-style-bg-primary"><a
                                        class="wp-block-button__link wp-element-button"
                                        href="../../wp-content/uploads/2023/04/Updated-NEBS-Job-Application-1.pdf"
                                        target="_blank" rel="noreferrer noopener">Download Application</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignfull pattern-bg-highlight has-light-blue-background-color has-background is-layout-constrained wp-container-core-group-layout-7 wp-block-group-is-layout-constrained">
                    ...
                    <div
                        class="wp-block-query alignwide query-loop-careers is-layout-flow wp-block-query-is-layout-flow">
                        <ul class="wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow">
                            <li
                                class="wp-block-post post-4172 bs_career type-bs_career status-publish has-post-thumbnail hentry">
                                <h3 class="wp-block-post-title has-h-5-font-size"><a
                                        href="../../career/lumber-yard-associate-2/index.php" target="_self">Lumber Yard
                                        Associate</a></h3>

                                <div class="wp-block-post-excerpt">
                                    <p class="wp-block-post-excerpt__excerpt">Load customer orders, unload incoming
                                        inventory, assist in inventory control and perform general housekeeping. Must
                                        have forklift experience. </p>
                                </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/about/careers/" /><input type="hidden" name="item_meta[25]"
