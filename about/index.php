...
<html lang="en-US">
    ...
    <head>
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                ...
                "name": "About - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/about/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/about/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-banner-scaled.jpg",
                "datePublished": "2023-03-15T20:50:00+00:00",
                "dateModified": "2024-09-13T18:39:01+00:00",
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                ...
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/about/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-banner-scaled.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-banner-scaled.jpg",
                "width": 2560,
                "height": 757
            }, {
                "@type": "WebSite",
                ...
                "sameAs": ["https://www.facebook.com",
                    "https://twitter.com/NEBS_<?php echo $row['country']; ?>", "https://www.instagram.com",
                    "https://www.linkedin.com", "https://www.pinterest.com/newenglandbuildingsupply",
        ...
        <link rel="alternate" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embed5b72.json?url=<?php echo $row['url']; ?>%2Fabout%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embedf86b?url=<?php echo $row['url']; ?>%2Fabout%2F&amp;format=xml" />
    ...
    <body
        class="page-template-default page page-id-33 page-parent wp-custom-logo wp-embed-responsive without-announcement">
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size"><strong>As the premier
                                    supplier of building materials in the metro <?php echo $row['country']; ?>
                                    community, exceptional customer service is our highest priority.</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="wp-block-columns alignwide are-vertically-aligned-center justify-space-between pattern-2-col-text-img is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex"
                        ...
                        <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:40%">
                            <p class="has-primary-color has-text-color has-h-5-font-size"><strong>Established in 2009,
                                    <?php echo $row['name']; ?> was founded with a vision to deliver high-quality
                                    products and exceptional service to the construction industry in the
                                    <?php echo $row['country']; ?> construction industry.&nbsp;</strong></p>



                            <p>We quickly positioned ourselves as a leading provider of lumber, building materials,
                                windows, doors, cabinetry, and other related products for professional builders,
                                remodelers, and general contractors throughout the greater
                                <?php echo $row['country']; ?> community. Our strategic location in Roxbury, near
                                downtown <?php echo $row['country']; ?>, allows us to efficiently serve residential and
                                commercial contractors and tradesmen in the area with quicker deliveries. For all your
                                building needs, including new windows, patio doors, kitchen cabinets, framing, and even
                                general contracting, <?php echo $row['name']; ?> is your ideal partner.</p>



                            <p>Our primary focus is on providing exceptional service. We understand the importance of
                                accuracy and efficiency in the <?php echo $row['country']; ?> construction industry.
                                Whether it&#8217;s accurate material estimates using our advanced estimating software or
                                on-time deliveries facilitated by our fleet (including 90-foot boom trucks),
                                <?php echo $row['name']; ?> ensures that our customers receive the support they need to
                                improve their productivity and financial gain. We take pride in being more than just a
                                supplier; we strive to be a valuable resource that helps our customers through every
                                step of their construction project.</p>



                            <p>With a location in the heart of <?php echo $row['country']; ?>, our construction team can
                                get your products to you quickly anywhere in the <?php echo $row['country']; ?>
                                community. <?php echo $row['name']; ?> has you covered with our smooth scheduling
                                process, experienced fleet drivers, delivery notifications, and fast in-store pick-up.
                            </p>
                        ...
                        <div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:48%">
                            <figure class="wp-block-image size-full"><img decoding="async" width="640" height="908"
                                    src="../wp-content/uploads/2023/08/nebs-history.jpg" alt="" class="wp-image-3784"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-history.jpg 640w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-history-541x768.jpg 541w"
                    ...
                    <figure class="wp-block-pullquote alignwide">
                        <blockquote>
                            <p>With a location in the heart of <?php echo $row['country']; ?>, our fleet and team can
                                get your products to you quickly anywhere in the <?php echo $row['country']; ?>
                                community. <?php echo $row['name']; ?> has you covered with our smooth scheduling
                                process, experienced fleet drivers, delivery notifications, and fast in-store pick-up.
                            </p>
                    ...
                    <figure class="wp-block-image alignwide size-full"><img decoding="async" width="1800" height="802"
                            src="../wp-content/uploads/2023/04/about-nebs.jpg" alt="" class="wp-image-3250"
                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-nebs.jpg 1800w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-nebs-768x342.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-nebs-1024x456.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/about-nebs-1536x684.jpg 1536w"
                    ...
                    <div
                        class="wp-block-group alignfull pattern-offset-img-cta has-background-color has-primary-background-color has-text-color has-background is-layout-constrained wp-block-group-is-layout-constrained">
                        <div
                            class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-2 wp-block-columns-is-layout-flex">
                            <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:40%">
                                <h2 class="wp-block-heading has-light-blue-color has-text-color has-h-3-font-size">What
                                    Makes <?php echo $row['name']; ?> Different?</h2>



                                <p class="has-background-color has-text-color has-large-font-size">What sets
                                    <?php echo $row['name']; ?> apart from other <?php echo $row['country']; ?>
                                    construction companies is our people. The <?php echo $row['name']; ?> family is
                                    comprised of industry enthusiasts and veterans who take pride in providing the
                                    highest level of service to our customers while also being a resource to help
                                    <?php echo $row['name']; ?> customers grow their businesses.</p>
                            </div>
                    ...
                    <div class="wp-block-columns alignwide are-vertically-aligned-center justify-space-between pattern-2-col-text-img is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex"
                        ...
                        <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                            ...
                            <p>We quickly positioned ourselves as a leading provider of lumber, building materials,
                                ...
                                <?php echo $row['country']; ?> community. Our strategic location in Roxbury, near
                                downtown <?php echo $row['country']; ?>, allows us to efficiently serve residential and
                                commercial contractors and tradesmen in the area with quicker deliveries. </p>
                            <p>What sets <?php echo $row['name']; ?> apart from other <?php echo $row['country']; ?>
                                construction companies is our people. The <?php echo $row['name']; ?> family is
                                comprised of industry enthusiasts and veterans who take pride in providing the highest
                                level of service to our customers while also being a resource to help
                                <?php echo $row['name']; ?> customers grow their businesses. </p>
                        ...
                        <div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:48%">
                            <style>
                            /* Ensure the container is positioned relative so the caption can be positioned absolutely within it */
                            .slider-container {
                                position: relative;
                                max-width: 600px;
                                /* adjust as needed */
                            ...
                            <div class="slider-container">
                                ...
                                <div class="slide">
                                    <figure class="wp-block-image size-full">
                                        <img decoding="async" height="600" src="../wp-content/uploads/2023/08/ceo1.jpg"
                                            alt="CEO 1" class="wp-image-3784" />
                                        <figcaption><?php echo $row['name']; ?> CEO</figcaption>
                                    </figure>
                                </div>
                                ...
                                <div class="slide">
                                    <figure class="wp-block-image size-full">
                                        <img decoding="async" height="600" src="../wp-content/uploads/2023/08/ceo2.jpg"
                                            alt="CEO 2" class="wp-image-3785" />
                                        <figcaption><?php echo $row['name']; ?> CEO</figcaption>
                                    </figure>
                                </div>
                                ...
                                <div class="slide">
                                    <figure class="wp-block-image size-full">
                                        <img decoding="async" height="600" src="../wp-content/uploads/2023/08/ceo3.jpg"
                                            alt="CEO 3" class="wp-image-3786" />
                                        <figcaption><?php echo $row['name']; ?> CEO</figcaption>
                                    </figure>
                                </div>
                            </div>
                            ...
                            function showSlides() {
                                ...
                                if (slideIndex > slides.length) {
                                    slideIndex = 1; // Reset to the first slide when the last one is reached
                                }

                                // Display the current slide
                                slides[slideIndex - 1].style.display = "block";

                                // Set a timeout to change slides every 3 seconds (3000ms)
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-3-columns justify-space-between is-layout-flex wp-container-core-columns-layout-3 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">Management
                                Team</h3>



                            <p class="has-small-font-size">Led by seasoned industry experts, <?php echo $row['name']; ?>
                                has comprehensive knowledge of lumber and building products that is matched by their
                                dedication to exceptional service. Whether you’re a contractor, builder, architect, or a
                                first-time homeowner, <?php echo $row['name']; ?> leadership team is ready to provide
                                tailored solutions and expertise for your unique needs in the
                                <?php echo $row['country']; ?> area.</p>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">The
                                Outside Sales Team</h3>



                            <p class="has-small-font-size">We may work on the outside, but we have the inside track to
                                know about the newest construction products that make your house or building shine. Let
                                us bring our expertise and product knowledge to your next project</p>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">Lumber
                                Yard and Warehouse Staff</h3>



                            <p class="has-small-font-size">Our hands may get a few splinters, but we make sure to
                                assemble your order, load it, and get it to you on time. We pride ourselves on knowing
                                the <?php echo $row['country']; ?> community like the back of our hand, and there isn’t
                                a construction job site that we can’t get to.</p>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-3-columns justify-space-between is-layout-flex wp-container-core-columns-layout-4 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">Kitchen
                                Designers</h3>



                            <p class="has-small-font-size">More than just a place to make food, the kitchen invites
                                everyone to gather after a long day. Our kitchen design staff brings their expertise to
                                every kitchen project with the goal of creating a space with warmth and comfort. Just
                                don’t challenge them to a bake-off!</p>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">Estimating
                                and Inside Sales</h3>



                            <p class="has-small-font-size">Whether it’s a question about opening an account or a concern
                                about a product or process, we’re available. Our engaged and experienced team is to make
                                your construction experience the best it can be.</p>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">Reception
                                and Lumber Counter</h3>



                            <p class="has-small-font-size">Whether it’s a question about opening an account or a concern
                                about a product or process, we’re available. Our engaged and experienced team is to make
                                your <?php echo $row['name']; ?> construction experience the best it can be.</p>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-3-columns justify-space-between is-layout-flex wp-container-core-columns-layout-5 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%">
                            <h3 class="wp-block-heading has-primary-color has-text-color has-large-font-size">Delivery
                                and Dispatch</h3>



                            <p class="has-small-font-size">With a keen understanding of the fast-paced construction
                                industry, <?php echo $row['name']; ?>; dedicated team ensures prompt and precise
                                deliveries, further solidifying <?php echo $row['name']; ?> as a reliable partner.
                                Explore <?php echo $row['name']; ?>; comprehensive services and discover how our
                                delivery and dispatch team streamlines the supply and offers unparalleled support to the
                                construction community.</p>
                        </div>



                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:29%"></div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/about/" /><input type="hidden" name="item_meta[25]"
                                ...
                                <ul class="wp-block-navigation__container  is-vertical wp-block-navigation">
                                    <li class=" wp-block-navigation-item current-menu-item wp-block-navigation-link"><a
                                            ...
                                            aria-current="page"><span
                                                class="wp-block-navigation-item__label">About</span></a></li>
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content" href="careers/index.php"><span
                                                class="wp-block-navigation-item__label">Careers</span></a></li>
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
