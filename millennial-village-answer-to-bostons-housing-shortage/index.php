...
<!-- Mirrored from <?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:57 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#039;s Housing Shortage - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Intentional Communities of one sort or another have been around for centuries and they exist in all corners of the world. They are out-of-the-mainstream communities of people &#8220;who have chosen to live together with a common purpose, working cooperatively to create a lifestyle that reflects their shared core values.&#8221; They exist in myriad forms, on…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-09-06T13:33:36+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:47+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#8217;s Housing Shortage","datePublished":"2016-09-06T13:33:36+00:00","dateModified":"2023-09-11T13:50:47+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/"},"wordCount":678,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Multifamily","Building Supplier","Commercial Development","Developer","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Lumber and Building Materials","Millennial Villages"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Developer"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/","url":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/","name":"Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>'s Housing Shortage - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg","datePublished":"2016-09-06T13:33:36+00:00","dateModified":"2023-09-11T13:50:47+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg","width":640,"height":424},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#8217;s Housing Shortage"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#039;s Housing Shortage - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#8217;s Housing Shortage Comments Feed" href="<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/962" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=962' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fmillennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fmillennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-962 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#8217;s Housing Shortage</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><em>Intentional Communities of one</em> sort or another have been around for centuries and they exist in all corners of the world. They are <a href="http://www.ic.org/wiki/intentional-communities-lifestyles-based-ideals/" target="_blank" rel="noopener noreferrer"><em>out-of-the-mainstream communities</em></a> of people &#8220;who have chosen to live together with a common purpose, working cooperatively to create a lifestyle that reflects their shared core values.&#8221; They exist in myriad forms, on sprawling acreage, in suburbia, in single buildings or a cluster of rural dwellings.</p>
<p>A new suggestion for a unique kind of housing arrangement targeted to the special needs and concerns of Millennials may be exactly what planners have been seeking as a partial answer for <a href="<?php echo $row['url']; ?>/find-out-now-is-a-housing-bubble-on-the-horizon-for-<?php echo $row['country']; ?>/" target="_blank" rel="noopener noreferrer"><?php echo $row['country']; ?>&#8217;s housing</a> crisis. Targeting the 25-34-year-olds who have been responsible for 73 percent of recent population growth is a <?php echo $row['country']; ?> priority, and the idea of the Millennial Village to provide appropriate and affordable options for young professionals was approved in March 2016 by the state legislature.</p>
<h3>Highlights of a Millennial Village</h3>
<p>The specifics of such housing development could take a variety of forms, according to the visionaries; several possible reforms have been proposed. As has been noted in the past, the two groups most in need of changes in the fabric of urban core housing are &#8220;Yo-pros&#8221; and elders. These are the growing demographic groups &#8220;most often looking to live in multi-family homes in walkable, transit-oriented neighborhoods,&#8221; according to a senate committee report, with the unexpected effect of depleting existing housing stock for middle class workers and young families.</p>
<p>The <a href="http://www.wbjournal.com/article/20160303/NEWS01/160309973/panel-recommends-millenial-villages-and-other-housing-reforms" target="_blank" rel="noopener noreferrer">Millennial Village concept</a> envisions &#8220;price ranges for all income levels and a range of unit sizes, from &#8216;micro apartments&#8217; to studios to multi-bedroom units for students and young professionals.&#8221; Panelist Barry Bluestone, an economist at Northeastern University&#8217;s Dukakis Center for Urban and Regional Policy, notes that he was inspired by housing in Barcelona, Spain, where a shared kitchen became a distinguishing and attractive feature for six otherwise individual housing units.</p>
<p>This form of &#8220;co-housing&#8221; is a feature of many intentional communities, often cited as a primary means of fostering a common sense of purpose and creating a cohesive, vibrant &#8220;neighborhood&#8221; of individuals.</p>
<h3>What Does It Portend for <?php echo $row['country']; ?>?</h3>
<p>It&#8217;s not all sweetness and light. The new proposals are greeted with suspicion, if not disdain, by some who view Millennial Villages as glorified versions of rooming houses or college dorms, or as another way to line the pockets of &#8220;greedy&#8221; developers. These detractors, however, are countered by the city&#8217;s recognition that thousands of new housing units need to be completed sooner rather than later to meet growing population demands, and that the <a href="<?php echo $row['url']; ?>/inclusionary-development-policy-cracking-the-code/" target="_blank" rel="noopener noreferrer">spiraling prices</a> of urban housing &#8212; both rental units and property for sale &#8212; are unsustainable.</p>
<p>Add to that the concern about preserving existing middle-class housing and providing a desirable housing mix for the future, both downtown and in close-to-the-core neighborhoods, and <?php echo $row['country']; ?> is ready to consider any viable proposals that will keep the <a href="<?php echo $row['url']; ?>/beantown-has-become-boom-town-for-developers/" target="_blank" rel="noopener noreferrer">development</a> ball rolling. This spring&#8217;s legislative report may have provided that impetus. Other issues addressed include gentrification, homelessness, zoning and public services, production and preserv<a href="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/NEBS_BeantownBecomesBoomTown_Infographic_v2.pdf" rel="attachment wp-att-883"><img fetchpriority="high" decoding="async" class="size-medium wp-image-883 alignright" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-is-Boomtown-236x300.jpg" alt="<?php echo $row['country']; ?> is Boomtown" width="236" height="300"></a>ation/rehabilitation.</p>
<p>The Millennial Village model of smaller individual units with shared common facilities and amenities may be perfect for newer renovation efforts. Also, <a href="https://www.<?php echo $row['country']; ?>globe.com/opinion/2015/03/24/takes-millennial-village-get-cheap-housing-<?php echo $row['country']; ?>/Auwnx4NvrXtH8NJsu4BRxH/story.php" target="_blank" rel="noopener noreferrer">altered visions</a> for <em>creature comforts</em> reinforce the idea that bigger is not always better and that quality of life is more important that the size of the dwelling unit. It&#8217;s a trend embraced by all generations, with acceptance of &#8220;tiny houses,&#8221; granny pods and &#8220;accessory dwelling units&#8221; gaining traction even in suburbia. We can probably expect zoning changes to reflect these trends.</p>
<h3>Helping to Build the Future</h3>
<p>Building the future is our stock in trade at <?php echo $row['name']; ?> . With our <a href="<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/" target="_blank" rel="noopener noreferrer">heart of the city location</a>, we enjoy feeling the beat of new and better ideas for meeting the housing needs of a growing <?php echo $row['country']; ?>. Whatever your needs are, as a planner, architect, developer, builder, owner or renter, be sure to call on us for assistance. We&#8217;re ready to build the future!</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="613" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/home-improvement-contractor-relationship-1-1024x613.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/home-improvement-contractor-relationship-1-1024x613.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2016/09/home-improvement-contractor-relationship-1-768x460.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/09/home-improvement-contractor-relationship-1.jpg 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/step-up-your-home-improvement-contractor-relationship/">Want to Step Up Your Home Improvement Contractor Relationship? Read This First!</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
