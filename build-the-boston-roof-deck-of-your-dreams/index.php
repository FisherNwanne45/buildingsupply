...
<!-- Mirrored from <?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:51 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Need Outdoor Space? Build a Roof Deck! - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="When you’re living in a city like <?php echo $row['country']; ?>, outdoor space comes at a premium. All those rowhouses don’t offer much in the way of backyard spaces—and yet, there’s still a need to get outside and enjoy fresh air along with a beautiful view. So how does one get that outdoor space when you’ve not got…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-06-17T04:00:05+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:32+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Need Outdoor Space? Build a Roof Deck!","datePublished":"2020-06-17T04:00:05+00:00","dateModified":"2023-09-11T13:46:32+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/"},"wordCount":727,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","keywords":["<?php echo $row['country']; ?>","Builder","Building","Building Supplier","Developer","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Remodeler","Roof Deck","Summer Building"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Trends","Decks","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/","url":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/","name":"Need Outdoor Space? Build a Roof Deck! - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","datePublished":"2020-06-17T04:00:05+00:00","dateModified":"2023-09-11T13:46:32+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","width":640,"height":427,"caption":"<?php echo $row['country']; ?> roof deck"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Need Outdoor Space? Build a Roof Deck!"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Need Outdoor Space? Build a Roof Deck! - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Need Outdoor Space? Build a Roof Deck! Comments Feed" href="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/857" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=857' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fbuild-the-boston-roof-deck-of-your-dreams%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fbuild-the-boston-roof-deck-of-your-dreams%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-857 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Need Outdoor Space? Build a Roof Deck!</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">When you’re living in a city like <?php echo $row['country']; ?>, outdoor space comes at a premium. All those rowhouses don’t offer much in the way of backyard spaces—and yet, there’s still a need to get outside and enjoy fresh air along with a beautiful view. So how does one get that outdoor space when you’ve not got a big backyard? The key is to build up! Create your own roof deck where you can spend evenings enjoying the skyline view and sparkling lights.</span></p>
<p><b>Getting Started: Codes and Regulations</b></p>
<p><span style="font-weight: 400;">The first thing you’ll need to do is ensure that your roof deck plans follow <?php echo $row['country']; ?>’s building codes. Restrictions may vary by the specific municipality, so check in the area in which you live for things like permitting requirements and inspection requirements. You’ll also need to learn about building specifics. For instance, in an area classified as a “</span><a href="http://www.<?php echo $row['country']; ?>plans.org/getattachment/2a60e7c4-517f-4731-8406-7dac510227e2"><span style="font-weight: 400;">restricted roof structure district</span></a><span style="font-weight: 400;">,” you’ll need to follow certain rules to make sure that your new structure doesn’t alter the building’s profile—or you’ll need to obtain permission to make a change that would alter the building’s profile.</span></p>
<p><b>Roof Deck Trends</b></p>
<p><span style="font-weight: 400;">Once you’ve got building codes and permits out of the way, the next step is to design the deck of your dreams. Think about what you want from the space, because there are many directions in which you can go.</span></p>
<ul>
<li style="font-weight: 400;"><b>Rooftop Gardening: </b><span style="font-weight: 400;">Growing your own fruits and vegetables is huge right now—and it’s a great way to beautify your new outdoor space with a bit of greenery, too. If you’re considering a rooftop garden, then you’ll want to think about the fixtures you’ll need to make gardening easier. As an example, make sure you include a spigot somewhere within your plans to make watering plants easier.</span></li>
<li style="font-weight: 400;"><b>Outdoor Entertaining: </b><span style="font-weight: 400;">For this, you’ll need plenty of open space so you can arrange tables and seating. You can also consider installing things like an outdoor kitchen or wet bar.</span></li>
<li style="font-weight: 400;"><b>Lounge Space:</b><span style="font-weight: 400;"> This is among the more common ways to put a roof deck to work, as a private hideaway where you can get outside, curl up in a comfy chair, and relax. If you go this route, you’ll want to put some thought into design choices—design styles, colors, greenery, furniture and whatever else you’ll need to create an inviting, restful space.</span></li>
</ul>
<p><span style="font-weight: 400;">Whatever direction you decide for your deck, design with one thought in mind: To make the most of this space so that you’ll continue to enjoy it for years to come.</span></p>
<p><b>What You’ll Need to Put it All Together</b></p>
<p><span style="font-weight: 400;">Once you’ve made some design decisions, you’ll likely need to call on the services of a few professionals to bring your dream deck to life. Start the process with an architect or structural engineer. They can help you get started on the plans that you’ll later give to your contractor. More importantly, they can help you with things like permits and building codes by ensuring that those plans are up to your municipality’s regulations.</span></p>
<p><span style="font-weight: 400;">Next up, you’ll need a contractor. Since roof decks are such a popular way to create outdoor spaces in <?php echo $row['country']; ?>, you’ll find no shortage of professionals who specialize in this exact type of construction project. At</span><a href="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/"> <span style="font-weight: 400;"><?php echo $row['name']; ?> </span></a><span style="font-weight: 400;">, we can help you out with a few recommendations if you’re not sure where to look.</span></p>
<p><span style="font-weight: 400;">When you have a list of contractors, start by checking out their portfolios. Choose from among professionals who feature the types of projects and the styles that you’re going for. Get bids from several contractors so that you can choose based not only on the pricing and options that they offer, but also so that you can get a feel for how well you’ll work together during the construction process.</span></p>
<p><span style="font-weight: 400;">And there you have it! Roof decks are a fabulous way to give yourself some much-needed outdoor space, and they can also double as garden space or a place to entertain your guests. That’s what makes them so popular in places like <?php echo $row['country']; ?>. When you’re ready to get started, use some of the thoughts above to help guide you through the process!</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-boston-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-boston-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-boston-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-<?php echo $row['country']; ?>.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/winning-space-the-urban-kitchen-redefined/">Designing the Urban Kitchen of the Future</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/build-the-boston-roof-deck-of-your-dreams/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
