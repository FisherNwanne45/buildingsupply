...
<!-- Mirrored from <?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:57 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="<?php echo $row['country']; ?>&#039;s Condo Comeback Brings Developers High Rise Opportunities -" />
	<meta property="og:description" content="It&#8217;s not hardly a surprise. You only have to drive around or listen to the news to realize that <?php echo $row['country']; ?> is enjoying an unprecedented building and development surge. And, while prices in the downtown core continue to rise, giving rise to a different set of concerns, the new construction seems poised to continue. New high…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-08-10T13:26:23+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:50+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Condo-Comeback-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"<?php echo $row['country']; ?>&#8217;s Condo Comeback Brings Developers High Rise Opportunities","datePublished":"2016-08-10T13:26:23+00:00","dateModified":"2023-09-11T13:50:50+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/"},"wordCount":631,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Condo-Comeback-1.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Multifamily","Builder","Building","Building Supplier","Commercial Development","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Lumber and Building Materials","Remodeler"],"articleSection":["<?php echo $row['country']; ?> Condo","Builder","Building in <?php echo $row['country']; ?>","Building Trends","Developer","Homeowner"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/","url":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/","name":"<?php echo $row['country']; ?>'s Condo Comeback Brings Developers High Rise Opportunities -","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Condo-Comeback-1.jpg","datePublished":"2016-08-10T13:26:23+00:00","dateModified":"2023-09-11T13:50:50+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Condo-Comeback-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Condo-Comeback-1.jpg","width":640,"height":400},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"<?php echo $row['country']; ?>&#8217;s Condo Comeback Brings Developers High Rise Opportunities"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title><?php echo $row['country']; ?>&#039;s Condo Comeback Brings Developers High Rise Opportunities -</title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; <?php echo $row['country']; ?>&#8217;s Condo Comeback Brings Developers High Rise Opportunities Comments Feed" href="<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/908" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=908' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-908 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size"><?php echo $row['country']; ?>&#8217;s Condo Comeback Brings Developers High Rise Opportunities</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>It&#8217;s not hardly a surprise. You only have to drive around or listen to the news to realize that <?php echo $row['country']; ?> is enjoying an <a href="<?php echo $row['url']; ?>/beantown-has-become-boom-town-for-developers/">unprecedented building and development surge</a>. And, while prices in the downtown core continue to rise, giving rise to a different set of <a href="<?php echo $row['url']; ?>/find-out-now-is-a-housing-bubble-on-the-horizon-for-<?php echo $row['country']; ?>/">concerns</a>, the new construction seems poised to continue.</p>
<p>New high rise condos, luxury apartments and refurbished older buildings seem completely at home in many parts of the city; the residential building boom <a href="<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/">extends</a> outward from Back Bay and Beacon Hill, beyond the South End and Fenway. If anything, <a href="http://realestate.<?php echo $row['country']; ?>.com/buying/2016/02/05/where-condo-prices-are-rising-fastest-in-greater-<?php echo $row['country']; ?>/" target="_blank" rel="noopener noreferrer">recent prices</a> in Dorchester, Roxbury, Revere and East <?php echo $row['country']; ?>, as well as in other close-in neighborhoods to the north, have outpaced percentage increases in the traditionally posh neighborhoods.</p>
<p>A number of factors have local real estate professionals and city officials smiling. First, the growing number of permits and starts since 2012 shows little sign of slowing anytime soon. Second, the inventory shortages that have caused the bump in prices may be easing, leading analysts to believe that double-digit price increases may also moderate. Third, the city&#8217;s newly-revamped affordable housing guidelines may make a dent in the current shortage of close-in housing for recent college graduates and young professionals, families and retirees.</p>
<h3><strong>But Is It Enough?</strong></h3>
<p>As long ago as 2013, the <a href="https://www.chapa.org/">Metropolitan Area Planning Counci</a><a href="http://www.mapc.org/" target="_blank" rel="noopener noreferrer">l</a> (MAPC) noted the need for approximately 435,000 new <a href="https://www.chapa.org/">multi-family housing units by 2040</a> in order to &#8220;keep the economy on track.&#8221; The goal at that time, set by the Patrick administration in 2012, was to produce at least 10,000 new multi-family housing units each year through 2020.</p>
<p>The goal at the time came on the heels of the housing crisis, precipitated by a change in attitude about the value of owning &#8220;the house in the suburbs.&#8221; The shift acknowledged the wisdom of providing housing close to the core for those who preferred to rent. It also was deemed a way to attract and retain a younger work force.</p>
<h3><strong>Looking Up</strong></h3>
<p>In major cities around the country, particularly in <?php echo $row['country']; ?>, there is really only one way to go &#8212; and that is up. The number of <a href="https://www.<?php echo $row['country']; ?>globe.com/magazine/2015/08/29/why-boston-finally-embracing-high-rise-condos/PZqCKE9qmccgtLZ3YkPH6J/story.php" target="_blank" rel="noopener noreferrer">new projects</a> that are sprouting in downtown <?php echo $row['country']; ?> are not only growing taller in a town long known for its low housing profile, but they are encompassing retail, entertainment, office and business functions as well as some amenities like sprawling supermarkets, skating rinks and movie theaters. It&#8217;s the live-work-play experience taken to its ultimate expression.</p>
<p>And it&#8217;s immensely appealing to the younger generation.</p>
<p>These mini-cities constitute the new town squares, according to some proponents, and may signal a change in the development planning of the future. The cluster concept locates such mixed use developments near rail lines and transportation hubs as well as in the city core, constituting a new focus for many cities as they seek to address the related concerns of housing supply and housing affordability.</p>
<h3><strong>Where Does It All Lead?</strong></h3>
<p>One of the goals of <?php echo $row['country']; ?>&#8217;s <a href="<?php echo $row['url']; ?>/inclusionary-development-policy-cracking-the-code/" target="_blank" rel="noopener noreferrer">Inclusionary Development Policy</a> is to boost the supply of rental apartments, townhomes and condos that appeal to a wide range of residents, meet the demands of the city&#8217;s business community, and contribute to the charm and stability of a city with its eye on the future.</p>
<p>At NEBS, we are in the enviable position of being right in the thick of it, in terms of being able to witness the growth as well as supply some of the materials and expertise that contribute to that growth. By working closely with developers and builders, designers and owners, renters and visitors, we feel that we have a part in shaping the future of our city.</p>
<p>We are committed to doing everything we can to make that future a good one.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/window-replacement-questions-to-ask/">3 Window Replacement Questions to Ask for Your Historic Renovation</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
