...
<!-- Mirrored from <?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:11:03 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="The color trend for the year is &#039;living coral&#039;. This color infuses calm into busy spaces. 4 tips to use living coral to bring a sense of calm into your busy <?php echo $row['country']; ?> home." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="4 Tips on How to Use “Living Coral” Pantone Color of the Year - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="The color trend for the year is &#039;living coral&#039;. This color infuses calm into busy spaces. 4 tips to use living coral to bring a sense of calm into your busy <?php echo $row['country']; ?> home." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2019-02-14T14:35:23+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:47:56+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"4 Tips on How to Use “Living Coral” Pantone Color of the Year","datePublished":"2019-02-14T14:35:23+00:00","dateModified":"2023-09-11T13:47:56+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/"},"wordCount":622,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","keywords":["bathroom design","<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Building Supplier","Design Trends","Downtown <?php echo $row['country']; ?> Residential Building","Home Improvement Contractor","Kitchen Design","Kitchen Trends","Lumber and Building Materials","Remodeler"],"articleSection":["Bathroom Renovation","<?php echo $row['country']; ?> Condo","Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer","Homeowner","Kitchen Design","Remodeler","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/","url":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/","name":"4 Tips on How to Use “Living Coral” Pantone Color of the Year - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","datePublished":"2019-02-14T14:35:23+00:00","dateModified":"2023-09-11T13:47:56+00:00","description":"The color trend for the year is 'living coral'. This color infuses calm into busy spaces. 4 tips to use living coral to bring a sense of calm into your busy <?php echo $row['country']; ?> home.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","width":870,"height":482,"caption":"coral pantone color of the year"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"4 Tips on How to Use “Living Coral” Pantone Color of the Year"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>4 Tips on How to Use “Living Coral” Pantone Color of the Year - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2403" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2403' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F4-tips-on-how-to-use-living-coral-pantone-color-of-the-year%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F4-tips-on-how-to-use-living-coral-pantone-color-of-the-year%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2403 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">4 Tips on How to Use “Living Coral” Pantone Color of the Year</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>In December of 2018,&nbsp;<span class="scayt-misspell-word" data-scayt-word="Pantone" data-wsc-lang="en_US">Pantone</span>&nbsp;announced the new 2019 Color of the Year. What’s the shade this year? A beautiful pinky-orange called&nbsp;<a href="https://www.pantone.com/color-intelligence/color-of-the-year/color-of-the-year-2019" target="_blank" rel="noopener noreferrer" data-cke-saved-href="https://www.pantone.com/color-intelligence/color-of-the-year/color-of-the-year-2019">“Living Coral!”</a>&nbsp;This color is described as “an animating and life-affirming coral hue with a golden undertone that energizes and enlivens with a softer edge.” For those of you who are not aware,&nbsp;<span class="scayt-misspell-word" data-scayt-word="Pantone" data-wsc-lang="en_US">Pantone</span>&nbsp;announces these colors each year, and they have done so for almost two decades now, so it’s become something of a tradition in the fashion and design industry.</p>
<p>So how will “Living Coral” factor into <a href="<?php echo $row['url']; ?>/4-must-have-home-design-trends-for-2019/" target="_blank" rel="noopener noreferrer">home design trends</a>? And especially, how will this shade be used in an iconic city like <?php echo $row['country']; ?>? The shade is sure to bring calm into the spaces in which it is used, even into busy places like <?php echo $row['country']; ?>. If you want some ideas on how to use this color, then keep reading!</p>
<h3><strong>1. Living Coral Cabinets</strong></h3>
<p>If you’re looking for a bold design statement, then Living Coral is a good choice as a cabinet color. It’s a shade that works beautifully in the old fashioned kitchens that are so often found in brownstones and <a href="<?php echo $row['url']; ?>/choose-right-flooring-for-boston-triple-decker-remodel/">triple&nbsp;<span class="scayt-misspell-word" data-scayt-word="deckers" data-wsc-lang="en_US">deckers</span></a>, and it pairs wonderfully well with white or creamy walls. If you want to liven up the kitchen a bit, consider <a href="<?php echo $row['url']; ?>/why-brass-is-back-for-kitchen-hardware/" target="_blank" rel="noopener noreferrer">gold</a> or yellow accents to match the pops of Living Coral.</p>
<h3><strong>2. Living Coral in the Bathroom</strong></h3>
<p>This is a shade that reminds people of sunsets, and it’s paradisiacal in nature, which gives it a&nbsp;<span class="scayt-misspell-word" data-scayt-word="beachy" data-wsc-lang="en_US">beachy</span>&nbsp;kind of feel. That’s what makes this an ideal shade for the bathroom. In busy cities like <?php echo $row['country']; ?>, one needs little oases of relaxation, and Living Coral is a great way to lend that tropical, relaxing sense to a bath. Use this shade for little touches, like curtains and&nbsp;<span class="scayt-misspell-word" data-scayt-word="décor" data-wsc-lang="en_US">décor</span>, or try an accent wall in this color to give the room a bright, sunset kind of feeling.</p>
<h3><strong>3. Accenting Furniture with Living Coral</strong></h3>
<p>Another fresh way to work this shade into your home is to use it as a furniture accent. There are a couple of ways to go about this. Second-hand end tables or other small pieces of furniture can be easily repainted in Living Coral to give your living space a nice pop of color. If you don’t want to get into refinishing furniture, however, then look for vases or lamps in this shade. Lamps on an end table will definitely give you that sunset feeling you’re looking for, while vases and other ornaments in this shade make for nice little pops of color on bookshelves, mantles and more.</p>
<h3><strong>4. Living Coral Textiles</strong></h3>
<p>Textiles will be a huge way to bring this color into <?php echo $row['country']; ?> homes, and there are so many directions you can go with this. Look for curtains that feature patterns in this shade or go with solid coral curtains to add some chunky blocks of color to living spaces. An accent chair with Living Color upholstery is another good way to bring a block of this shade into a living room, but if you don’t want to add a new chair, you can also look for throw pillows to add a little of Living Color’s calming warmth to a room. Sheets, pillowcases, wall-hangings and art—all of these are great ways to get a little Living Coral Color!</p>
<p>As you can see, there are so many ways, large and small alike, to bring the relaxing feeling of Living Coral into <?php echo $row['country']; ?>’s homes. Try a couple of these ideas and make yourself a calming space in the midst of a busy city!<br />
&nbsp;</p>
<p><a href="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/“LIVING-CORAL”-PANTONE-COLOR-OF-THE-YEAR.jpg"><img fetchpriority="high" decoding="async" class="size-full wp-image-2405 aligncenter" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/“LIVING-CORAL”-PANTONE-COLOR-OF-THE-YEAR.jpg" alt="LIVING CORAL PANTONE COLOR OF THE YEAR" width="735" height="1102"></a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/boston-bathroom-remodeling-ideas.png" class="attachment-large size-large wp-post-image" alt="<?php echo $row['country']; ?> bathroom remodeling ideas" decoding="async" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/6-small-bathroom-remodeling-solutions-for-spring/">6 Small Bathroom Remodeling Solutions for Spring</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
