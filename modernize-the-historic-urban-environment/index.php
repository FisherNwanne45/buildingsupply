...
<!-- Mirrored from <?php echo $row['url']; ?>/modernize-the-historic-urban-environment/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:54 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="How to Modernize the Historic Urban Environment (without angering the neighborhood!) - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="In cities like <?php echo $row['country']; ?>, noted for their long and storied histories, it can be challenging to modernize. Charter Realty &amp; Development found that out recently when a proposed North End retail building design stirred up controversy among area residents, who felt the design did not reflect the historic nature of the neighborhood. The project has…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-11-09T10:45:42+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:41+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"How to Modernize the Historic Urban Environment (without angering the neighborhood!)","datePublished":"2016-11-09T10:45:42+00:00","dateModified":"2023-09-11T13:50:41+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/"},"wordCount":606,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","Builder","Building Supplier","Commercial Development","Downtown <?php echo $row['country']; ?> Residential Building","Historic Urban Environment","Lumber and Building Materials"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/","url":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/","name":"How to Modernize the Historic Urban Environment (without angering the neighborhood!) - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg","datePublished":"2016-11-09T10:45:42+00:00","dateModified":"2023-09-11T13:50:41+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg","width":640,"height":427,"caption":"modern-blending-with-historic-developing-in-<?php echo $row['country']; ?>"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"How to Modernize the Historic Urban Environment (without angering the neighborhood!)"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>How to Modernize the Historic Urban Environment (without angering the neighborhood!) - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; How to Modernize the Historic Urban Environment (without angering the neighborhood!) Comments Feed" href="<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1133" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1133' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fmodernize-the-historic-urban-environment%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fmodernize-the-historic-urban-environment%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1133 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">How to Modernize the Historic Urban Environment (without angering the neighborhood!)</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>In cities like <?php echo $row['country']; ?>, noted for their long and storied histories, it can be challenging to modernize. <a href="http://<?php echo $row['country']; ?>.curbed.com/2016/9/15/12926410/north-end-retail-development-hanover-street" target="_blank" rel="noopener noreferrer">Charter Realty &amp; Development</a> found that out recently when a proposed North End retail building design stirred up controversy among area residents, who felt the design did not reflect the <a href="<?php echo $row['url']; ?>/3-window-replacement-questions-to-ask-for-your-historic-renovation/" target="_blank" rel="noopener noreferrer">historic nature</a> of the neighborhood. The project has been approved and will be going forward, but other developers may want to avoid these kinds of controversies altogether.</p>
<p>If you want to make sure that you are proposing projects that the city wants, while at the same time meeting the needs of residents, then you’ll need to approach developing in <?php echo $row['country']; ?> with the idea of preserving the historic urban environment. Here are a few tips that can help you accomplish this.</p>
<p><span id="more-1133"></span></p>
<h3><strong>Building Higher is One Solution for Developing in <?php echo $row['country']; ?></strong></h3>
<p>One innovative way that developers are using to blend the old with the new is to build on top of existing historic structures within the city. In fact, several proposals have been reviewed, such as the proposed project for <a href="http://realestate.<?php echo $row['country']; ?>.com/new-developments/2015/04/23/historic-downtown-buildings-could-be-topped-with-modern-flair/" target="_blank" rel="noopener noreferrer">15 and 19 Congress Street</a>, which places an ultra-modern structure directly on top of a historic building.</p>
<p>The keys for this type of development seem to be two things: <strong>First</strong>, the addition needs to be complementary to the neighborhood. These additions are designed to match the shape of the building and accentuate it while adding a modern twist. <strong>Secondly,</strong> designers rely heavily on glass rather than attempting to mimic the original materials of the building below. This helps enhance the modernity of the structures, it alleviates the problems that arise when trying to blend old and new building materials of the same type, and these structures are light — light enough to sit on buildings that weren’t designed to bear a much heavier load.</p>
<h3><strong>Preserve the Character of the Neighborhood</strong></h3>
<p>Preserving a historic urban environment often means developing in accordance with the neighborhood’s character. When developing in <?php echo $row['country']; ?>, there are no hard and fast answers for what characterizes each part of the city. Instead, it is on the developer to decide which designs will please both the city’s approval board and the people. To pinpoint an area’s character, you’ll need to do a bit of research. Ask questions like:</p>
<ul>
<li>Is it acceptable to accentuate existing historic buildings with modern elements, or are people in favor of preserving the exact historical look of each building? In some places, people may appreciate modern additions but others may require you to stick rigidly to the historic theme already in place.</li>
<li>What can be done to not only modernize, but also to enhance the existing architecture? In this case, something like an uncomplicated addition atop an existing tower is helpful because it isn’t distracting from the ground-level architecture.</li>
<li>When creating an entirely new building, is it more important to the approval board and city residents that you create high-end modern architecture or should you have a design made that matches the rest of the neighborhood? In some cities, modern architecture rests right alongside historical buildings in an effort to showcase diversity. Other cities, however, go the opposite route and demand that history be preserved at all costs.</li>
</ul>
<p>The biggest thing to remember is that sometimes it is impossible to satisfy absolutely everyone, no matter what you design. The approval board may approve your project, but there will likely always be at least a couple of naysayers. Rely on innovations such as rooftop additions and always pay attention to the character of the neighborhood to please as many people as possible.</p>
</div>
        ...
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            ...
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/infographic-5-hot-kitchen-design-trends-for-your-next-building-project/">[Infographic] 5 Hot Kitchen Design Trends for Your Next Building Project</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/modernize-the-historic-urban-environment/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
<figure class="wp-block-image size-full is-resized"><a href="https://kodiakbp.com/" target="_blank" rel="noreferrer noopener"><img decoding="async" width="463" height="476" src="<?php echo $row['url']; ?>/wp-content/uploads/2024/06/white-kodiak-logo-w-tagline-crop.png" alt="Kodiak Building Partners" class="wp-image-4152" style="width:125px"/></a></figure>
