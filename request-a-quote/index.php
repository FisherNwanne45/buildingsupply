...
<html lang="en-US">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/request-a-quote/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:06:51 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <meta property="og:title" content="Request A Quote - <?php echo $row['name']; ?> " />
        <meta property="og:description"
            content="Request a Quote Ready to bring your project to life? Fill out the form below to request a quote tailored specifically to your needs, and let <?php echo $row['name']; ?> turn your vision into a reality." />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?> " />
        <meta property="article:publisher"
            content="https://www.facebook.com" />
        <meta property="article:modified_time" content="2023-08-23T15:24:25+00:00" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>/request-a-quote/",
                "url": "<?php echo $row['url']; ?>/request-a-quote/",
                "name": "Request A Quote - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "datePublished": "2023-03-15T20:50:58+00:00",
                "dateModified": "2023-08-23T15:24:25+00:00",
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>/request-a-quote/"]
                }]
            }, {
                "@type": "WebSite",
                "@id": "<?php echo $row['url']; ?>/#website",
        ...
        <title>Request A Quote - <?php echo $row['name']; ?> </title>
        ...
        <link rel='shortlink' href='../indexcbb6.php?p=41' />
        <link rel="alternate" type="application/json+oembed"
            href="../wp-json/oembed/1.0/embed6941.json?url=<?php echo $row['url']; ?>%2Frequest-a-quote%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="../wp-json/oembed/1.0/embede4d9?url=<?php echo $row['url']; ?>%2Frequest-a-quote%2F&amp;format=xml" />
    ...
    <body class="page-template-default page page-id-41 wp-custom-logo wp-embed-responsive without-announcement">
                        ...
                        <div id="site-responsive-nav"
                            ...
                            <div class="wp-block-buttons is-layout-flex wp-block-buttons-is-layout-flex">
                                ...
                                <div class="wp-block-button is-style-bg-primary"><a
                                        class="wp-block-button__link wp-element-button" href="index.php">Request a
                                        Quote</a></div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-cover alignfull is-light" style="min-height:50vh"><span aria-hidden="true"
                                ...
                                decoding="async" class="wp-block-cover__image-background wp-image-205" alt=""
                                src="../wp-content/uploads/2023/03/Yard-18-scaled.jpg" style="object-position:50% 51%"
                                data-object-fit="cover" data-object-position="50% 51%" />
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size"><strong><strong>Ready to bring
                                        your project to life? Fill out the form below to request a quote tailored
                                        specifically to your needs, and let <?php echo $row['name']; ?> turn your vision
                                        into a reality.</strong></strong></p>
                        </div>
                    </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    value="1b393115d0" /><input type="hidden" name="_wp_http_referer"
                                                    value="/request-a-quote/" /><input type="hidden"
                    ...
                    <div
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on Facebook</span></a>
                                </li>
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on Linkedin</span></a>
                                </li>
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on Instagram</span></a>
                                </li>
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on YouTube</span></a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <nav class=" is-vertical wp-block-navigation is-layout-flex wp-container-core-navigation-layout-4 wp-block-navigation-is-layout-flex"
                                ...
                                <ul class="wp-block-navigation__container  is-vertical wp-block-navigation">
                                    ...
                                    <li class=" wp-block-navigation-item current-menu-item wp-block-navigation-link"><a
                                            ...
                                            aria-current="page"><span class="wp-block-navigation-item__label">Request A
                                                Quote</span></a></li>
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content"
                                            href="../credit-application/index.php"><span
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full is-resized"><a href="https://kodiakbp.com/"
                                    target="_blank" rel="noreferrer noopener"><img decoding="async" width="463"
                                        height="476"
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/request-a-quote/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:06:55 GMT -->
