...
<!-- Mirrored from <?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:53 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="5 Questions Answered about Energy Efficient Windows - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="What makes a window more energy efficient than other types of windows? And what do these strange terms like “e-coating” and “u-factor” mean? We have answers to the questions most commonly asked about energy efficient windows! 1. What Type of Frame is Best for Energy Efficient Windows? In the Northeast, winters are harsh and summers…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-01-10T14:08:29+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:49:04+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2018/01/jeld-wen-energy-efficient-windows-.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/"},"author":{"name":"pflood","@id":"<?php echo $row['url']; ?>/#/schema/person/efdb884fa68ac1170a581188b6d24d68"},"headline":"5 Questions Answered about Energy Efficient Windows","datePublished":"2018-01-10T14:08:29+00:00","dateModified":"2023-09-11T13:49:04+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/"},"wordCount":567,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/01/jeld-wen-energy-efficient-windows-.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Energy Efficiency","Energy Efficient","Home Improvement Contractor","Lumber and Building Materials","Remodeler","Windows"],"articleSection":["Building Trends","Contractor","Developer","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/","url":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/","name":"5 Questions Answered about Energy Efficient Windows - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/01/jeld-wen-energy-efficient-windows-.jpg","datePublished":"2018-01-10T14:08:29+00:00","dateModified":"2023-09-11T13:49:04+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/01/jeld-wen-energy-efficient-windows-.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/01/jeld-wen-energy-efficient-windows-.jpg","width":900,"height":676,"caption":"Lorem ipsum dolor sit amet, consectetur adipiscing"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"5 Questions Answered about Energy Efficient Windows"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/efdb884fa68ac1170a581188b6d24d68","name":"pflood","url":"<?php echo $row['url']; ?>/author/pflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>5 Questions Answered about Energy Efficient Windows - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1683" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1683' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F5-questions-answered-about-energy-efficient-windows%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F5-questions-answered-about-energy-efficient-windows%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1683 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2018-01-10T14:08:29-05:00">01.10.2018</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">5 Questions Answered about Energy Efficient Windows</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>What makes a window more <a href="http://www.jeld-wen.com/en-us/planning-projects/planning/energy-efficiency" target="_blank" rel="noopener noreferrer">energy efficient</a> than other types of windows? And what do these strange terms like “e-coating” and “u-factor” mean? We have answers to the questions most commonly asked about energy efficient windows!</p>
<h3><span id="more-1683"></span></h3>
<h3><strong>1. What Type of Frame is Best for Energy Efficient Windows?</strong></h3>
<p>In the Northeast, winters are harsh and summers are hot — and moisture is an issue year-round. This means you’ll want to choose a window frame material to suit. Fiberglass comes as the most&nbsp;<a href="https://blog.marvin.com/2017/05/24/6-tips-for-choosing-energy-efficient-windows/" target="_blank" rel="noopener noreferrer">highly recommended&nbsp;</a>choice because it stands up well to moisture and it also has low thermal conductivity. In other words, less heat is transferred through solid fiberglass or clad fiberglass frames.</p>
<h3><strong>2. Does Window Glaze Matter?</strong></h3>
<p>In a word: yes! Window glaze is a term that refers to the actual glass. Double glazed windows are the current standard (in other words, windows with two layers of glass, not one). Triple glazed windows, with three layers, are just starting to become more popular. Each layer of glass helps to reduce thermal transfer and what’s more, the insulating materials between the layers of glass, like argon gas, glass coatings and films, all add insulating properties of their own. The most energy efficient windows will feature double or triple panes and a combination of argon and specialized coatings to help insulate against thermal transfer and the sun’s rays.</p>
<h3><strong>3. What is an E-Coating?</strong></h3>
<p>Low-E windows first hit the market in the 1980s and although they’re not often talked about, an e-coating is important for energy efficiency. At the outset, low-e windows had a coating that essentially helped to heat homes in cold regions of the United States by allowing UV rays through the glass and then reflecting them back into the room, creating a sort of greenhouse effect. In the summer, however, this proved problematic as people sought to cool their homes. Modern low-e windows solved this problem with low-e windows that not only help hold heat in the winter but reflect certain types of light during the hottest months of the year. Low-e windows are a great way to regulate heating and cooling costs all year round.</p>
<h3><strong>4. What Does the U-Factor Mean?</strong></h3>
<p>The&nbsp;<a href="http://www.efficientwindows.org/ufactor.php" target="_blank" rel="noopener noreferrer">u-factor</a>&nbsp;is to windows what the r-value is to insulation. Windows with lower u-factors are overall better at reducing the flow of heat into and out of the home. This is all based on a variety of things, including the glazing, the frame choice, window coatings and more. To choose energy efficient windows, choose windows with the lowest possible u-factor.</p>
<h3><strong>5. Sliding Versus Swinging: Which is Better?</strong></h3>
<p>Drafty windows are an all too common problem but choosing the right style of window can help you eliminate drafts. If you’re looking to reduce drafts, think about window styles that swing open — awnings and casements, for example. These windows seal by pressing against the weather stripping when shut. As long as the weather stripping is intact and the window is tightly closed, there should be no draft. Sliding windows, on the other hand, tend to be draftier because it is impossible to completely seal the sliding mechanisms without jamming the window shut permanently.</p>
<p>Energy efficient <a href="<?php echo $row['url']; ?>/4-must-have-2018-window-and-door-design-trends/" target="_blank" rel="noopener noreferrer">windows</a> are essential to lowering heating and cooling bills, particularly in the extreme heat and cold of the Northeast! Let these questions be your guide to choosing windows for your home.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="683" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/01/co-living-in-boston--1024x683.jpg" class="attachment-large size-large wp-post-image" alt="co living in <?php echo $row['country']; ?>" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/01/co-living-in-boston--1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/01/co-living-in-boston--768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/01/co-living-in-boston--1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2018/01/co-living-in-boston--2048x1365.jpg 2048w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/co-living-a-new-residential-alternative-for-downtown-<?php echo $row['country']; ?>/">Co-Living Building Design: A New Residential Alternative for Downtown <?php echo $row['country']; ?>?</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/5-questions-answered-about-energy-efficient-windows/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
