...
<!-- Mirrored from <?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:11:01 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="An in-depth look at what air sealing means, six common air sealing strategies, and some specifics pertaining to <?php echo $row['country']; ?> homes through Mass Save program." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="6 Strategies for Air Sealing in New Construction and Retrofits - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="An in-depth look at what air sealing means, six common air sealing strategies, and some specifics pertaining to <?php echo $row['country']; ?> homes through Mass Save program." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2019-07-24T13:47:30+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:55+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"6 Strategies for Air Sealing in New Construction and Retrofits","datePublished":"2019-07-24T13:47:30+00:00","dateModified":"2023-09-11T13:46:55+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/"},"wordCount":915,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png","keywords":["air sealing","<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","Builder","Building Supplier","Insulation","Lumber and Building Materials","Remodeler"],"articleSection":["Builder","Building Trends","Contractor","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/","url":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/","name":"6 Strategies for Air Sealing in New Construction and Retrofits - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png","datePublished":"2019-07-24T13:47:30+00:00","dateModified":"2023-09-11T13:46:55+00:00","description":"An in-depth look at what air sealing means, six common air sealing strategies, and some specifics pertaining to <?php echo $row['country']; ?> homes through Mass Save program.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png","width":1280,"height":859,"caption":"air sealing"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"6 Strategies for Air Sealing in New Construction and Retrofits"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>6 Strategies for Air Sealing in New Construction and Retrofits - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2553" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2553' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F6-strategies-for-air-sealing-in-new-construction-and-retrofits%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F6-strategies-for-air-sealing-in-new-construction-and-retrofits%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2553 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">6 Strategies for Air Sealing in New Construction and Retrofits</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Air sealing is one of those confusing topics that sparks a lot of debate. Is too much sealing a bad thing, something that could be detrimental to indoor air quality? Or should buildings be sealed as tightly as possible to prevent air leaks and save on energy costs? Proper sealing can definitely reduce energy costs, which passes on major savings to homeowners—and, there are ways to mitigate indoor pollutants so that indoor air quality isn’t an issue. Let’s take an in-depth look at what air sealing means, common sealing strategies, and some <a href="<?php echo $row['url']; ?>/ways-to-increase-energy-efficiency/" target="_blank" rel="noopener noreferrer">weatherization specifics </a>pertaining to <?php echo $row['country']; ?> homes!</p>
<p><span id="more-2553"></span></p>
<h3><strong>What is Air Sealing?</strong></h3>
<p>To put it simply, <a href="https://www.<?php echo $row['country']; ?>buildingresources.com/advice/air-sealing-and-insulation" target="_blank" rel="noopener noreferrer">air sealing</a> is the process of stopping drafts. This is done through lots of different strategies, from upgrading insulation to sealing around windows and doors. Weather stripping, caulk and foam insulation are common ways to close up drafts, which tightens the building’s thermal envelope. The process is designed to keep conditioned air where it belongs—cool air indoors in the summer, and cool air outside in the winter.</p>
<h3><strong>Does Air Sealing Trap Indoor Pollutants?</strong></h3>
<p>Good sealing can trap indoor pollutants. However, this doesn’t mean that builders should deliberately allow drafts or weaken the building’s envelope. Rather, if indoor air quality is an issue, then sources of the pollutants should be sought out and eliminated. This means if there are unvented heaters, then proper vents should be installed for them. Another common pollutant is water vapor, particularly in kitchens and bathrooms. This can cause mold problems and other issues, but excess moisture can easily be mitigated with exhaust fans and other venting solutions.</p>
<h3><strong>Common Air Sealing Strategies</strong></h3>
<p>Homes are notoriously full of places for air to escape. Whether the project is new construction or a retrofit of an existing home, there are dozens of places to check for potential air leaks, and each of these areas has its own best solution for stopping a potential leak. Here are some of the places to check as well as strategies to prevent leaks!</p>
<ol>
<li><strong>Attics:</strong>&nbsp;Attics are often one of the major sources of air leaks within a home, and that is because not only does heat tend to rise and escape through the attic, but there are plenty of places for heat to make its escape—around chimneys, through poorly sealed soffits and so forth. To make sure an attic is properly sealed, it helps to create a checklist. Not only will you need to make sure that the space is well insulated, but you’ll need to use spray foam or other materials around chimneys, vents, electrical boxes, the attic hatch or access panel and elsewhere.</li>
<li><strong>Rough Openings for Windows and Doors:</strong>&nbsp;When windows and doors are drafty, the problem is often because the rough opening wasn’t sealed properly. Fortunately, even if this is a retrofit project, it’s a relatively easy fix. Simply remove trim and use spray foam to fill in the gaps between the opening and the window’s frame.</li>
<li><strong>Leaks around Pipes:</strong>&nbsp;This is another common way for air to escape, and it’s another easy fix. Here, you can use spray foam to fill in gaps around pipes or conduit. In moist areas or around pipes prone to sweating, use caulk instead.</li>
<li><strong>Exhaust Fans:</strong>&nbsp;There are a couple of considerations for exhaust fans. The first is the case itself, which should be sealed with metallic tape or caulk to prevent leaks while the fan is in use. Then there’s the opening for the fan, which should be filled with spray foam to prevent additional leaks.</li>
<li><strong>Whole House Fans:</strong>&nbsp;These are popular ways to vent excess heat and humidity, but they’re also a potential source for air leaks. To ensure fans don’t leak air when not in operation, they should come with a couple of important features. Covers for the fans should be gasketed, and the covers themselves should be insulated to at least R10 to help minimize loss of conditioned air. As with any indoor-to-outdoor fixture, you’ll also need to take care to use spray foam or caulk around the fan’s frame to prevent leaks there, too.</li>
<li><strong>Weather Stripping Doors and Windows:</strong>&nbsp;Whether on new installations or on a job to stop leaks in existing doors and windows, weather stripping is key. It should be sturdy enough to withstand things like friction and seasonal temperature changes as well as the wear and tear caused by the opening and closing of the fixtures. For different doors and windows, you’ll need different types of weather stripping, but when installed properly, it can save homeowners up to 20% on heating and air conditioning yearly.</li>
</ol>
<h3><strong>The Mass Save Program</strong></h3>
<p>In Massachusetts, there is a program that can help homeowners tighten up air leaks at little to no cost. If you want to recommend it to clients, it’s called the Mass Save program. This program offers home energy assessments to search for areas in need of air sealing, and if leaks are found, then some sealing is provided to the homeowner at no cost. Learn more about the program <a href="https://www.masssave.com/en/save/air-sealing/">here!</a></p>
<p>As you can see, air sealing is a complex process with lots of places throughout a home that need to be evaluated for leaks. But, it’s a worthwhile process that will end up saving the homeowner lots of money on energy costs!</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-1024x687.png" class="attachment-large size-large wp-post-image" alt="matte black kitchen" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/want-in-on-the-matte-black-kitchen-trend-6-ideas-to-help-you-pull-it-off/">Want in on the Matte Black Kitchen Trend? 6 Ideas to Help You Pull It Off!</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/6-strategies-for-air-sealing-in-new-construction-and-retrofits/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
