...
<!-- Mirrored from <?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:51 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="COVID-19 safety policies that construction workers are following along with site procedures to expect in the future." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="How to Keep Construction Workers Safe Amid COVID-19 Virus Fears - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="COVID-19 safety policies that construction workers are following along with site procedures to expect in the future." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-05-21T04:00:56+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:33+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"How to Keep Construction Workers Safe Amid COVID-19 Virus Fears","datePublished":"2020-05-21T04:00:56+00:00","dateModified":"2023-09-11T13:46:33+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/"},"wordCount":850,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png","keywords":["Builder"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Contractor"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/","url":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/","name":"How to Keep Construction Workers Safe Amid COVID-19 Virus Fears - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png","datePublished":"2020-05-21T04:00:56+00:00","dateModified":"2023-09-11T13:46:33+00:00","description":"COVID-19 safety policies that construction workers are following along with site procedures to expect in the future.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"How to Keep Construction Workers Safe Amid COVID-19 Virus Fears"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>How to Keep Construction Workers Safe Amid COVID-19 Virus Fears - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2683" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2683' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-to-keep-construction-workers-safe-amid-covid-19-virus-fears%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-to-keep-construction-workers-safe-amid-covid-19-virus-fears%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2683 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">How to Keep Construction Workers Safe Amid COVID-19 Virus Fears</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">It’s a real dilemma in the construction industry right now. Some projects must <a href="<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/">move forward</a> despite COVID-19—but there are lots of challenges involved in keeping these projects running while also keeping workers safe. Construction is one industry where social distancing practices can be difficult to follow given the nature of the work.</span></p>
<p><span style="font-weight: 400;">Just look at the example of working on high rises in <?php echo $row['country']; ?>. Workers may need to use an exterior elevator to ride to the floor in which they’re working on, and to carry supplies and tools up to that floor. That means either the elevators are crowded with lots of people along with building materials and gear, or there are delays as labor organizers arrange elevator trips to maintain social distancing policies.</span></p>
<p><span style="font-weight: 400;">Of course, worker safety is paramount, so changes will be implemented to help keep the labor force safe. And, in fact, we’ve already seen quite a few changes on jobsites. If you’re looking for more information, here are some of the safety policies people are already observing along with procedures to expect in the future.</span></p>
<h2><span style="font-weight: 400;">Respirators are Key</span></h2>
<p><span style="font-weight: 400;">This has been one of the larger challenges that the construction industry has faced. Now and in the future, workers need to be wearing N95 respirators to help protect against viral outbreaks—but supplies are short as these respirators are needed for healthcare workers on the front lines of the disease fight. Even so, construction managers need to do the best they can to provide respirators for their workforce. They’re important not only to protect against COVID-19 transmission, but also to protect workers against jobsite dust and debris. Silica dust and other toxic particulates are common construction hazards that workers need to guard against.</span></p>
<h2><span style="font-weight: 400;">How Some Construction Job Sites are Following Social Distancing Policies</span></h2>
<p><span style="font-weight: 400;">Because construction is such a hands-on industry, social distancing has been difficult to follow. It’s not always easy to maintain proper 6-foot distancing between employees when multiple sets of hands might be required to carry things or work on some part of a project together. But contractors everywhere are making it happen one way or another. It has to happen because social distancing is one of the primary ways to prevent the spread of COVID-19.</span></p>
<p><span style="font-weight: 400;">One innovative way that construction contractors are tackling this issue? Wearable technology! For instance, right now, a company called</span><a href="https://www.enr.com/articles/49230-gilbane-looks-to-social-distancing-on-jobsites-and-finding-the-new-normal"> <span style="font-weight: 400;">Triax Technologies</span></a><span style="font-weight: 400;"> is making a wearable monitoring tag that connects with all other tags on a jobsite. These tags help enforce social distancing by alerting employees when they draw too close together.</span></p>
<p><span style="font-weight: 400;">What’s interesting about these tags is that they could be something we see more on the jobsite even after the pandemic has passed. The tags are also capable of locating employees or notifying people when a worker experiences a sudden fall or some other workplace mishap.</span></p>
<h2><span style="font-weight: 400;">Scheduling Adjustments Can Keep Workers Safe</span></h2>
<p><span style="font-weight: 400;">Another way to help keep construction workers safe on the jobsite is to take greater care with shift scheduling so that there are fewer workers working at any given time, thus reducing the chances of exposure. This means taking into account project goals and deadlines, and then planning carefully to make sure that enough workers are onsite to complete the tasks at hand, but the jobsite isn’t so overcrowded that it becomes impossible to maintain social distancing rules.</span></p>
<h2><span style="font-weight: 400;">Sanitation Will Need an Upgrade</span></h2>
<p><span style="font-weight: 400;">Workers should already be wearing masks—and in fact, should have been prior to the pandemic outbreak to protect against dust and particulates. But contractors are also going to need to take greater care to make sure that sanitation is up to the task of keeping laborers safe. This means facilities for handwashing should be available, and managers should opt for things like bottled water instead of shared water coolers on the jobsite. In the event that running water isn’t available, hand sanitizers and other such products should be available so that workers can keep clean throughout the day.</span></p>
<h2><span style="font-weight: 400;">Creating Safety Plans</span></h2>
<p><span style="font-weight: 400;">In <?php echo $row['country']; ?> specifically, there are new rules in place specifically designed to protect contractors. This is something that <?php echo $row['country']; ?>’s Mayor Walsh has putting forward. From now on, contactors must create a</span><a href="https://www.<?php echo $row['country']; ?>herald.com/2020/04/17/boston-rolling-out-construction-coronavirus-rules-even-as-industry-remains-closed/"> <span style="font-weight: 400;">COVID-19 safety plan</span></a><span style="font-weight: 400;"> in order to keep workers safe on the jobsite. What do these plans entail?</span></p>
<ul>
<li style="font-weight: 400;"><span style="font-weight: 400;">They must stipulate how contractors will enforce social distancing policies.</span></li>
<li style="font-weight: 400;"><span style="font-weight: 400;">They must also outline how contractors will provide sanitation for their workers.</span></li>
<li style="font-weight: 400;"><span style="font-weight: 400;">Contractors will need to sign affidavits swearing to follow the safety plan—and if they don’t, they’ll be at risk of losing their permits.</span></li>
</ul>
<p><span style="font-weight: 400;">Keeping workers safe among COVID-19 fears might mean taking entirely new approaches to construction as a whole. Certainly, there are already changes in place to help keep workers safe—and we can expect to see a revolution in the way contractors approach safety in the future. It’ll be challenging to get used to this new normal, but it’s a worthwhile challenge because worker safety is the most important consideration on any project.</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg" class="attachment-large size-large wp-post-image" alt="<?php echo $row['country']; ?> roof deck" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/">Need Outdoor Space? Build a Roof Deck!</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
