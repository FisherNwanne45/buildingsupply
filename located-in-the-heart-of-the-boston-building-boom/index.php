...
<!-- Mirrored from <?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:27 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Located in the Heart of the <?php echo $row['country']; ?> Building Boom - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Seeing a lot of construction around <?php echo $row['country']; ?> these days? You’re not the only one. Both commercially and residentially, <?php echo $row['country']; ?> building is booming these days &#8211; just check out our infographic below showing some of the neighborhoods experiencing the most growth. And that white building right in the center of it all? That’s us over here…" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-07-22T00:29:41+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:51+00:00" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Located in the Heart of the <?php echo $row['country']; ?> Building Boom","datePublished":"2016-07-22T00:29:41+00:00","dateModified":"2023-09-11T13:50:51+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/"},"wordCount":113,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#primaryimage"},"thumbnailUrl":"","keywords":["<?php echo $row['country']; ?>","Builder","Building Supplier","Commercial Development","Developer","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","infographic","Lumber and Building Materials","Remodeler"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Developer","Homeowner"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/","url":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/","name":"Located in the Heart of the <?php echo $row['country']; ?> Building Boom - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#primaryimage"},"thumbnailUrl":"","datePublished":"2016-07-22T00:29:41+00:00","dateModified":"2023-09-11T13:50:51+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#primaryimage","url":"","contentUrl":""},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Located in the Heart of the <?php echo $row['country']; ?> Building Boom"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Located in the Heart of the <?php echo $row['country']; ?> Building Boom - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Located in the Heart of the <?php echo $row['country']; ?> Building Boom Comments Feed" href="feed/index.php" />
<script>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/881.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexacf9.php?p=881' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedf3d9.json?url=<?php echo $row['url']; ?>%2Flocated-in-the-heart-of-the-boston-building-boom%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedea76?url=<?php echo $row['url']; ?>%2Flocated-in-the-heart-of-the-boston-building-boom%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-881 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2016-07-22T00:29:41-04:00">07.22.2016</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Located in the Heart of the <?php echo $row['country']; ?> Building Boom</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">Seeing a lot of <a href="../2019-boston-real-estate-development-predictions/index.php" target="_blank" rel="noopener noreferrer">construction around <?php echo $row['country']; ?></a> these days? You’re not the only one. </span></p>
<p><span style="font-weight: 400;">Both commercially and residentially, <?php echo $row['country']; ?> building is booming these days &#8211; just check out our </span><span style="font-weight: 400;">i</span><span style="font-weight: 400;">nfographic below</span><span style="font-weight: 400;"> showing some of the neighborhoods experiencing the most growth.</span></p>
<p><span style="font-weight: 400;">And that white building right in the center of it all? That’s us over here at </span><a style="line-height: 1.5;" href="../index.php" target="_blank" rel="noopener noreferrer"><?php echo $row['name']; ?> </a><span style="font-weight: 400;"> &#8211; your building supply resource right in the heart of downtown <?php echo $row['country']; ?>.</span></p>
<p><span style="font-weight: 400;">Our location demonstrates our love for this city. Let us provide you with the materials to ensure that <a href="../beantown-has-become-boom-town-for-developers/index.php">Beantown stays a Boom Town</a> for a long time.</span></p>
<p><a href="../wp-content/uploads/2016/07/NEBS_BeantownBecomesBoomTown_Infographic_v2.php"><img fetchpriority="high" decoding="async" class="aligncenter wp-image-883 size-large" src="../wp-content/uploads/2016/07/boston-is-Boomtown-805x1024.php" alt="<?php echo $row['country']; ?> is Boomtown" width="805" height="1024"></a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="576" src="../wp-content/uploads/2016/08/architectural-millwork-1-1-1024x576.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1-1024x576.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1-768x432.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1.jpg 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../use-millwork-to-create-modern-building-masterpiece/index.php">Use Architectural Millwork to Create Your Modern Building Masterpiece</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/located-in-the-heart-of-the-boston-building-boom/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:29 GMT -->
</html>
