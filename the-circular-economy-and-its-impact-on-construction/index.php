...
<!-- Mirrored from <?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:55 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Circular economy is about reusing and recycling. Construction goals include reduce impact on the environment and increase material useable lifespan." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="The Circular Economy and Its Impact on Construction - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Circular economy is about reusing and recycling. Construction goals include reduce impact on the environment and increase material useable lifespan." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2019-08-28T13:24:48+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:54+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy-1024x687.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"The Circular Economy and Its Impact on Construction","datePublished":"2019-08-28T13:24:48+00:00","dateModified":"2023-09-11T13:46:54+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/"},"wordCount":1087,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","Building Supplier","circular economy","eco friendly","Energy Efficiency","Energy Efficient","Green Building","Sustainability"],"articleSection":["Building in <?php echo $row['country']; ?>","Building Policies","Building Trends"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/","url":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/","name":"The Circular Economy and Its Impact on Construction - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png","datePublished":"2019-08-28T13:24:48+00:00","dateModified":"2023-09-11T13:46:54+00:00","description":"Circular economy is about reusing and recycling. Construction goals include reduce impact on the environment and increase material useable lifespan.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png","width":1280,"height":859,"caption":"construction impact on the circular economy"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"The Circular Economy and Its Impact on Construction"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>The Circular Economy and Its Impact on Construction - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2564" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2564' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fthe-circular-economy-and-its-impact-on-construction%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fthe-circular-economy-and-its-impact-on-construction%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2564 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">The Circular Economy and Its Impact on Construction</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>In construction circles, there is a new buzzword making the rounds: The “circular economy.” What does it mean? And how could a circular economy reshape the current construction industry? Read on for answers to these questions and more!</p>
<h3><strong>What is a Circular Economy?</strong></h3>
<p>A circular economy is sometimes referred to as a “cradle-to-cradle” economy. In construction, the circular economy focuses on reusing and recycling. The entire goal is to reduce consumption and the impact on the environment—a growing concern for many since the construction industry, and the demolition associated with it, produce between a third and to half of all waste in the developed world. In essence, it’s an economy that reuses and recycles as many building materials as possible rather than throwing away used materials and producing new. Manufacturers in a circular economy rely on all kinds of reusable materials as building supplies—recycled glass and rubber from tires, cork, paper cellulose and even things like straw and adobe, which can be reused. Modular building materials are also gaining traction as part of a circular economic model, with builders able to take apart buildings and use the modular pieces to create new.<br />
This stands in opposition to the traditional construction market, which is largely linear. In a linear economy, materials are produced, used in construction, then demolished and discarded at the end of their lifespan.</p>
<h3><strong>What Does a Circular Economy Mean for the Future of Construction?</strong></h3>
<p>End users—that is, property managers, homebuyers and so forth—are growing ever more environmentally aware, looking for materials that are both eco-friendly and high quality. Since recycling is a big part of eco-friendliness, experts believe that the circular economy will be a growing trend over the next few years. In fact,&nbsp;<a href="https://www.uschamberfoundation.org/logistics-circular-economy" data-cke-saved-href="https://www.uschamberfoundation.org/logistics-circular-economy">researchers conducting polls</a>&nbsp;among industry leaders and experts discovered that 85% of those who responded see the circular economy as gaining traction already, and they believe that it will become even more important in the next two years. According to this research, the building materials industry will be among the top industries expected to adopt these practices, which means that builders will be expected to follow suit by sourcing reusable and recycled materials for their projects.</p>
<p>Reusing and recycling is only part of the process in a circular economy, however. A big part of the focus is on maintaining and refurbishing materials while they’re in use as a way to increase their useable lifespan to the fullest. Builders are already starting to see this trend manifest in the demand for high-quality materials that will last longer than more conventional materials. The other part to this is that people in the construction industry can expect an increased demand for workers to maintain buildings, and the demand for remodelers to refurbish homes and other buildings is likely to rise, too.</p>
<h3><strong>Will a Circular Economy Increase Construction Costs or Lower Them?</strong></h3>
<p>As with any major transition, experts agree that there will be challenges in transitioning to a circular economy. One of the biggest forecasted challenges are the costs involved. Builders, for instance, may be faced with increased labor costs as they search for ways to disassemble existing construction so that materials can be properly recycled or repurposed. On the manufacturing side of things, manufacturers will be tasked with finding cost-effective ways to remanufacture materials.</p>
<p>At the same time, there is a counterargument to the idea that costs could go up. Many experts believe that a circular economy could actually spark a real estate boom.</p>
<p>In fact, there are already examples of new suppliers popping up that prove the opposite could be true. One example is a company called&nbsp;<a href="https://www.globechain.com/us/about-us.php" data-cke-saved-href="https://www.globechain.com/us/about-us.php">Globechain</a>. This is a business based entirely around circular economic principles. The idea, for Globechain, is to serve as a marketplace that sells discounted materials that were either not used during the construction process, or reusable materials that were salvaged during the demolition process. This is one low-cost alternative to purchasing new building materials, and it is likely that as the construction economy trends toward a circular one, more companies like this will crop up as existing suppliers strive to offer similar services at a competitive price.</p>
<h3><strong>How Builders Can Adopt Circular Economic Principles</strong></h3>
<p>Across the construction industry, people are already starting to see the adoption of circular economic principles. As a builder, there are lots of things you can do to ensure your business stays atop this trend.</p>
<p>A big part of circular economic practice is sourcing materials. That is, finding suppliers who rely on reused and recycled products as well as using modular building materials that can be disassembled for recycling at the end of their useful lifespan.</p>
<p>Waste reduction is another big part of the process. This includes not only reducing building site waste—producing less scrap as the building is under construction—but creating buildings that will produce less wasted material at the end of their use cycle.</p>
<p>Some experts actually suggest that builders and materials manufacturers think in terms of Legos, believe it or not. The idea is to use modular building materials as much as possible so that as the end of a building’s lifespan approaches, pieces can be taken apart and reused or salvaged similar to how one might take apart Lego bricks to build something new. The more pieces that can be reused, the less wastage you will have, which is in line with the principles of a circular economy. There are already some examples of this Lego-like construction method, too. In the UK, for instance,&nbsp;<a href="https://zedpods.com/" data-cke-saved-href="https://zedpods.com/">ZedPods</a>&nbsp;is a company that produces eco-friendly homes built of modular pieces.</p>
<h3><strong>A Circular Economy in <?php echo $row['country']; ?>?</strong></h3>
<p>Already in the <?php echo $row['country']; ?> area, there is a shift in thinking toward a circular economic approach, largely championed by <?php echo $row['country']; ?>’s city government. This is part of <?php echo $row['country']; ?>’s Zero Waste Initiative, which aims to turn the city into one that produces no waste at all. To learn more about it, you can&nbsp;<a href="https://www.<?php echo $row['country']; ?>.gov/departments/environment/zero-waste-<?php echo $row['country']; ?>" data-cke-saved-href="https://www.<?php echo $row['country']; ?>.gov/departments/environment/zero-waste-<?php echo $row['country']; ?>">click here</a>.</p>
<p>Of course, there are always trends to look out for in the construction industry. Eco-friendliness and sustainability have been a focus among builders and suppliers for a long time now as the demand grows for a reduced impact on the environment. A circular economy that relies on as little waste as possible seems the next logical step in the process, and that means that this is a trend you’ll need to stay on top of in the coming years!</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="712" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1024x712.jpg" class="attachment-large size-large wp-post-image" alt="Carbon Fiber Construction Hats DAX" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1024x712.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-768x534.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1536x1068.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-2048x1424.jpg 2048w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/boston-construction-safety-why-carbon-fiber-hard-hats-are-rising-in-popularity/"><?php echo $row['country']; ?> Construction Safety: Why Carbon Fiber Hard Hats are Rising in Popularity</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/the-circular-economy-and-its-impact-on-construction/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
