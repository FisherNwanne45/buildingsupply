...
<!-- Mirrored from <?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:44 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Rent control is one of those tricky topics that Massachusetts voters have debated off and on over the years." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers? - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Rent control is one of those tricky topics that Massachusetts voters have debated off and on over the years." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-01-29T17:30:44+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:48+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2020/01/boston-rent-control-1024x687.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/"},"author":{"name":"pflood","@id":"<?php echo $row['url']; ?>/#/schema/person/efdb884fa68ac1170a581188b6d24d68"},"headline":"Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers?","datePublished":"2020-01-29T17:30:44+00:00","dateModified":"2023-09-11T13:46:48+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/"},"wordCount":561,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control.png","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Condo","Developer","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Sustainability"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/","url":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/","name":"Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers? - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control.png","datePublished":"2020-01-29T17:30:44+00:00","dateModified":"2023-09-11T13:46:48+00:00","description":"Rent control is one of those tricky topics that Massachusetts voters have debated off and on over the years.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control.png","width":1920,"height":1288},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers?"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/efdb884fa68ac1170a581188b6d24d68","name":"pflood","url":"<?php echo $row['url']; ?>/author/pflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers? - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2652.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index5328.php?p=2652' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed1c7e.json?url=<?php echo $row['url']; ?>%2Fwould-rent-control-hurt-or-help-boston-developers%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embededaf?url=<?php echo $row['url']; ?>%2Fwould-rent-control-hurt-or-help-boston-developers%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2652 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers?</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Rent control is one of those tricky topics that Massachusetts voters have debated off and on over the years. Twenty-five years ago, a rent control measure that included <?php echo $row['country']; ?> lost by a narrow margin at the ballot box. These days, though, with rents continuing to rise throughout the city, lawmakers and others concerned about housing affordability are raising the question once more: Could rent control be beneficial? Let’s take a look at the issue to find out!</p>
<h5><strong>What Those in Favor of Rent Control are Saying</strong></h5>
<p>Those in favor of rent control argue that for too many, the burden of high rents is too much to bear on strained finances. Homelessness and displacement are growing concerns, and some have termed increasing costs as a housing emergency.</p>
<p>In fact, Massachusetts legislators have introduced a new bill called “An Act Enabling Local Options for Tenant Protections.” This bill is designed to work on a regional basis. Rent control is one of the measures within it—a provision that would allow cities to enact their own rent control policies to help give tenants more protections against high costs and potential displacement. With this, city lawmakers would also be able to place limitations on evictions if they so desired, and they could develop exemptions for tenants threatened with eviction.</p>
<h5><strong>Arguments Against Rent Control</strong></h5>
<p>Those who are against rent control measures believe the answer to skyrocketing housing prices and the housing shortage in general is to build more housing units. Fix the issue of scarcity, and prices should become more affordable. In the past two decades, Massachusetts’ population has grown by 600,000 whereas housing growth has not kept pace with the increased population.</p>
<p>Landlords in particular are concerned about property improvements. Rent control, they argue, keeps prices low, which reduces available funds for maintenance and upgrades. The result would be lower housing prices—and a decline in the quality of available units.</p>
<h5><strong>So What’s the Verdict? Will Rent Control Help or Hurt Developers?</strong></h5>
<p>Is rent control bad for developers? It could be! Research from MIT shows that rent control does tend to cause a decline in property values. This decline isn’t just limited to the rent-controlled units, but also the entire neighborhood in which they are located. The reason behind that is because rent-controlled apartments do tend to see less maintenance and repair than non-rent controlled, and the dilapidation causes a neighborhood-wide decline in property values. That spells bad news for developers since they want to develop properties in valuable neighborhoods or neighborhoods that show potential for being profitable.</p>
<p>But on the bright side, rent control never was all that popular in Massachusetts, even when there were provisions for it. When rent control legislation was repealed back in 1994, only three municipalities had any form of rent control—<?php echo $row['country']; ?>, Brookline and Cambridge. Even if the current proposed rent control bill does pass, it will leave the option of whether to enact rent control or not in the hands of municipalities, who may decide against it. If history repeats, this means few municipalities will actually adopt rent control.</p>
<p>Whether or not rent control is enacted in <?php echo $row['country']; ?>, the future for developers remains promising. Estimates say that the <?php echo $row['country']; ?> area needs 400,000 housing units in the next two decades—plenty of work to keep developers busy in the coming years!</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="../wp-content/uploads/2020/01/window-and-door-trends-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends-1536x1030.png 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends.png 1920w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../window-and-door-trends-for-2020/index.php">Window and Door Trends for 2020</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/would-rent-control-hurt-or-help-boston-developers/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:45 GMT -->
</html>
