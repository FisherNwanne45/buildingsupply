...
<!-- Mirrored from <?php echo $row['url']; ?>/blog/page/7/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:56 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/blog/page/7/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/blog/page/6/" />
	<link rel="next" href="<?php echo $row['url']; ?>/blog/page/8/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Blog - Page 7 of 23 - <?php echo $row['name']; ?> " />
...
<body class="blog paged wp-custom-logo wp-embed-responsive paged-7 without-announcement">
...
<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained"><ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2548 post type-post status-publish format-standard has-post-thumbnail hentry category-building-trends category-contractor category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-deck tag-deck-design tag-design-trends tag-home-improvement-contractor tag-lumber-and-building-materials tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/" target="_self" >6 Deck Design Trends to try this Summer</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends-768x515.png" class="attachment-medium size-medium wp-post-image" alt="deck design trends" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-07-16T09:00:31-04:00">07.16.2019</time></div>

    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/building-trends/" rel="tag">Building Trends</a>
    </div>
</div>
...
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/best-skylights-for-a-boston-home/" target="_self" >Best Skylights for a <?php echo $row['country']; ?> Home</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-768x515.png" class="attachment-medium size-medium wp-post-image" alt="skylights <?php echo $row['country']; ?> home" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-06-19T20:33:53-04:00">06.19.2019</time></div>
...
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/from-simple-to-advanced-18-summer-home-renovation-ideas-to-do-now/" target="_self" >From Simple to Advanced: 18 Summer Home Renovation Ideas to Do Now</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-768x515.png" class="attachment-medium size-medium wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-06-05T08:43:09-04:00">06.05.2019</time></div>

    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/decks/" rel="tag">Decks</a>
    </div>
</div>
...
</li><li class="wp-block-post post-2532 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-boston-condo category-building-trends category-homeowner category-remodeler tag-bathroom tag-bathroom-design tag-bathroom-remodeling tag-bathroom-renovation tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-building-supplier tag-decor-ideas tag-home-improvement-contractor tag-interior-decor tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/bring-the-beach-home-6-coastal-themed-bathroom-ideas/" target="_self" >Bring the Beach Home: 6 Coastal Themed Bathroom Ideas</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas-768x515.png" class="attachment-medium size-medium wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-05-22T09:21:20-04:00">05.22.2019</time></div>

    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/remodeler/" rel="tag">Remodeler</a>
    </div>
</div>
...
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/why-the-multi-panel-slide-door-is-a-rising-trend-in-residential-homes/" target="_self" >Why the Multi Panel Slide Door is a Rising Trend in Residential Homes</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--768x515.png" class="attachment-medium size-medium wp-post-image" alt="multi panel slider door" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door-.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-05-15T07:29:15-04:00">05.15.2019</time></div>
...
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/8-contemporary-porch-ideas-that-complement-urban-living-2/" target="_self" >8 Contemporary Porch Ideas that Complement Urban Living</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas-768x515.png" class="attachment-medium size-medium wp-post-image" alt="contemporary porch ideas" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-05-08T11:36:17-04:00">05.08.2019</time></div>
...
</li><li class="wp-block-post post-2505 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-trends category-homeowner category-kitchen-design category-remodeler tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-downtown-boston-residential-building tag-home-improvement-contractor tag-interior tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-lumber-and-building-materials">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/9-tips-for-two-tone-kitchen-cabinets-in-a-small-kitchen/" target="_self" >9 Tips for Two Tone Kitchen Cabinets in a Small Kitchen</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-768x515.png" class="attachment-medium size-medium wp-post-image" alt="two tone kitchen cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-04-24T09:18:15-04:00">04.24.2019</time></div>
...
</li><li class="wp-block-post post-2499 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-decks category-homeowner category-remodeler category-triple-decker">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/" target="_self" >7 Small Patio Makeover Ideas</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-768x515.png" class="attachment-medium size-medium wp-post-image" alt="small patio makeover ideas 2" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-04-17T09:09:12-04:00">04.17.2019</time></div>
...
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/your-complete-guide-to-interior-house-trim-styles/" target="_self" >Your Complete Guide to Interior House Trim Styles</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="539" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/Metrie--768x539.jpg" class="attachment-medium size-medium wp-post-image" alt="Metrie M Vintage Industrial" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/Metrie--768x539.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/Metrie-.jpg 800w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-04-10T09:09:03-04:00">04.10.2019</time></div>
...
<a href="<?php echo $row['url']; ?>/blog/page/6/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/6/">6</a>
<span aria-current="page" class="page-numbers current">7</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/8/">8</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/9/">9</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/23/">23</a></div>

<a href="<?php echo $row['url']; ?>/blog/page/8/" class="wp-block-query-pagination-next">Next</a>
</nav></div>
</main>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/blog/page/7/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
