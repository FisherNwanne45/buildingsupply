...
<!-- Mirrored from <?php echo $row['url']; ?>/blog/page/20/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:58 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/blog/page/20/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/blog/page/19/" />
	<link rel="next" href="<?php echo $row['url']; ?>/blog/page/21/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Blog - Page 20 of 23 - <?php echo $row['name']; ?> " />
...
<body class="blog paged wp-custom-logo wp-embed-responsive paged-20 without-announcement">
...
<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained"><ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-1209 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-construction-crew tag-<?php echo $row['country']; ?> tag-builder tag-building tag-building-supplier tag-commercial-development tag-construction-site tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-job-site-safety tag-remodeler tag-winter-construction">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/cold-weather-safety-tips-for-boston-construction-site/" target="_self" >Cold Weather Safety Tips for Your <?php echo $row['country']; ?> Construction Site</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="428" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/01/construction-safety-in-winter-768x428.png" class="attachment-medium size-medium wp-post-image" alt="construction-safety-in-winter" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2017/01/construction-safety-in-winter-768x428.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2017/01/construction-safety-in-winter.png 1010w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2017-01-04T09:49:48-05:00">01.04.2017</time></div>
...
</li><li class="wp-block-post post-1204 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-building tag-building-supplier tag-commercial-development tag-lumber-and-building-materials">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/what-is-ahead-for-boston-building-development-in-2017/" target="_self" >What is Ahead for <?php echo $row['country']; ?> Building Development in 2017</a></h2>

<figure class="wp-block-post-featured-image"><img width="640" height="360" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/12/whats-ahead-boston-2017.jpg" class="attachment-medium size-medium wp-post-image" alt="<?php echo $row['country']; ?> building 2017" style="object-fit:cover;" decoding="async" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-12-28T09:50:53-05:00">12.28.2016</time></div>
...
</li><li class="wp-block-post post-1174 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-policies category-developer tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-boston-homeowner tag-boston-masshousing tag-boston-redevelopment-authority tag-building tag-commercial-development tag-developer tag-downtown-boston-residential-building tag-lumber-and-building-materials tag-masshousing">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/need-to-know-about-partnering-with-mass-housing/" target="_self" >What Developers Need to Know About Partnering with Mass Housing</a></h2>

<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/12/masshousing-boston-.jpg" class="attachment-medium size-medium wp-post-image" alt="masshousing-<?php echo $row['country']; ?>" style="object-fit:cover;" decoding="async" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-12-21T09:04:47-05:00">12.21.2016</time></div>
...
</li><li class="wp-block-post post-1162 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-building-supplier tag-commercial-development tag-developer tag-door-trends tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-home-improvement-contractor tag-interior tag-interior-doors tag-lumber-and-building-materials tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/dressed-to-impress-interior-doors-that-strut-their-stuff/" target="_self" >Dressed to Impress: Interior Doors That Strut Their Stuff</a></h2>

<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/12/Interior-Doors.png" class="attachment-medium size-medium wp-post-image" alt="interior-doors" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-12-07T10:29:24-05:00">12.07.2016</time></div>
...
</li><li class="wp-block-post post-1158 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-developer category-remodeler tag-<?php echo $row['country']; ?> tag-boston-redevelopment-authority tag-builder tag-building-supplier tag-commercial-development tag-developer tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-historic-urban-environment tag-lumber-and-building-materials tag-real-estate tag-seaport">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/innovative-commercial-development-predicted-to-rise/" target="_self" >Innovative Commercial Development Predicted to Rise for <?php echo $row['country']; ?> in 2017</a></h2>

<figure class="wp-block-post-featured-image"><img width="640" height="425" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/boston-commercial-development-seaport.jpg" class="attachment-medium size-medium wp-post-image" alt="boston-commercial-development-seaport" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-11-30T11:11:59-05:00">11.30.2016</time></div>
...
</li><li class="wp-block-post post-1150 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-builder category-contractor category-homeowner category-kitchen-design category-remodeler tag-bathroom-renovation tag-<?php echo $row['country']; ?> tag-boston-homeowner tag-boston-multifamily tag-boston-triple-decker tag-building-supplier tag-home-renovation tag-interior tag-lumber-and-building-materials tag-remodeler tag-triple-decker-renovation tag-triple-decker-repairs tag-window-replacement">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/repairs-and-upgrades-that-triple-decker-owners-want/" target="_self" >The 5 Repairs and Upgrades that <?php echo $row['country']; ?> Triple Decker Owners Want</a></h2>

<figure class="wp-block-post-featured-image"><img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/boston-triple-decker-repairs.jpg" class="attachment-medium size-medium wp-post-image" alt="boston-triple-decker-repairs" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-11-23T12:02:08-05:00">11.23.2016</time></div>
...
</li><li class="wp-block-post post-1148 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-developer category-homeowner category-kitchen-design category-remodeler tag-automation-tech tag-bathroom-design tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-building-supplier tag-energy-efficient tag-home-automation tag-home-improvement-contractor tag-interior tag-kitchen-design tag-lumber-and-building-materials tag-remodeler tag-sustainability">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/jaw-dropping-innovative-home-solutions-of-the-future/" target="_self" >Jaw- Dropping Innovative Home Solutions of the Future</a></h2>

<figure class="wp-block-post-featured-image"><img width="640" height="556" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/innovative-home-solutions.jpg" class="attachment-medium size-medium wp-post-image" alt="innovative-home-solutions" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-11-16T10:37:15-05:00">11.16.2016</time></div>
...
</li><li class="wp-block-post post-1141 post type-post status-publish format-standard hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-developer category-homeowner category-kitchen-design tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-builder tag-downtown-boston-residential-building tag-infographic tag-interior tag-kitchen-design tag-lumber-and-building-materials tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/infographic-5-hot-kitchen-design-trends-for-your-next-building-project/" target="_self" >[Infographic] 5 Hot Kitchen Design Trends for Your Next Building Project</a></h2>




<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-11-14T10:44:57-05:00">11.14.2016</time></div>
...
</li><li class="wp-block-post post-1133 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-builder tag-building-supplier tag-commercial-development tag-downtown-boston-residential-building tag-historic-urban-environment tag-lumber-and-building-materials">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/" target="_self" >How to Modernize the Historic Urban Environment (without angering the neighborhood!)</a></h2>

<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg" class="attachment-medium size-medium wp-post-image" alt="modern-blending-with-historic-developing-in-<?php echo $row['country']; ?>" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2016-11-09T10:45:42-05:00">11.09.2016</time></div>
...
<a href="<?php echo $row['url']; ?>/blog/page/19/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/19/">19</a>
<span aria-current="page" class="page-numbers current">20</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/21/">21</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/22/">22</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/23/">23</a></div>

<a href="<?php echo $row['url']; ?>/blog/page/21/" class="wp-block-query-pagination-next">Next</a>
</nav></div>
</main>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/blog/page/20/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
