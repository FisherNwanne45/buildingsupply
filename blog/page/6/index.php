...
<!-- Mirrored from <?php echo $row['url']; ?>/blog/page/6/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:52 GMT -->
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="blog paged wp-custom-logo wp-embed-responsive paged-6 without-announcement">
...
<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained"><ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2627 post type-post status-publish format-standard has-post-thumbnail hentry category-architect category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-builder tag-building tag-building-materials tag-building-supplier tag-commercial-development tag-construction-outlook tag-contractor tag-developer tag-lumber-and-building-materials">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/boston-construction-outlook-for-2020/" target="_self" ><?php echo $row['country']; ?> Construction Outlook for 2020</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-768x515.png" class="attachment-medium size-medium wp-post-image" alt="<?php echo $row['country']; ?> Construction Outlook" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-11-13T09:08:01-05:00">11.13.2019</time></div>
...
</li><li class="wp-block-post post-2616 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-downtown-boston-residential-building tag-drywall tag-eco-friendly tag-lumber-and-building-materials tag-remodeler tag-sustainability">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/eco-friendly-drywall-options/" target="_self" >Eco-Friendly Drywall Options</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--768x515.jpg" class="attachment-medium size-medium wp-post-image" alt="eco friendly drywall" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--768x515.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--1024x687.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-10-23T09:14:11-04:00">10.23.2019</time></div>
...
</li><li class="wp-block-post post-2614 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-trends category-homeowner category-kitchen-design category-remodeler tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-cabinets tag-countertops tag-home-design tag-kitchen-cabinets tag-kitchen-design tag-kitchen-trends tag-lumber-and-building-materials tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/10-timeless-kitchen-trends-2/" target="_self" >10 Timeless Kitchen Trends</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen-768x515.png" class="attachment-medium size-medium wp-post-image" alt="timeless kitchen trends for <?php echo $row['country']; ?> kitchen" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-10-09T12:23:12-04:00">10.09.2019</time></div>

    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/kitchen-design/" rel="tag">Kitchen Design</a>
    </div>
</div>
...
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/5-construction-contract-clauses-for-your-next-building-project/" target="_self" >5 Construction Contract Clauses for Your Next Building Project</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="512" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/02/construction-contract-clauses-768x512.jpg" class="attachment-medium size-medium wp-post-image" alt="construction-contract-clauses" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2017/02/construction-contract-clauses-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2017/02/construction-contract-clauses-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2017/02/construction-contract-clauses.jpg 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-10-01T00:23:53-04:00">10.01.2019</time></div>
...
</li><li class="wp-block-post post-2584 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-cabinets tag-downtown-<?php echo $row['country']; ?> tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-kitchen-trends tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/4-reasons-to-jump-on-the-navy-cabinet-kitchen-trend/" target="_self" >4 Reasons to Jump on the Navy Cabinet Kitchen Trend</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-768x515.png" class="attachment-medium size-medium wp-post-image" alt="navy blue kitchen cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-09-25T09:22:35-04:00">09.25.2019</time></div>
...
</li><li class="wp-block-post post-2570 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-construction-crew category-contractor category-developer category-remodeler tag-<?php echo $row['country']; ?> tag-boston-construction tag-construction tag-construction-crew tag-hard-hat tag-job-site tag-safety">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/boston-construction-safety-why-carbon-fiber-hard-hats-are-rising-in-popularity/" target="_self" ><?php echo $row['country']; ?> Construction Safety: Why Carbon Fiber Hard Hats are Rising in Popularity</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="534" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-768x534.jpg" class="attachment-medium size-medium wp-post-image" alt="Carbon Fiber Construction Hats DAX" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-768x534.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1024x712.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1536x1068.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-2048x1424.jpg 2048w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-09-11T09:50:58-04:00">09.11.2019</time></div>

    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" rel="tag">Building in <?php echo $row['country']; ?></a>
    </div>
</div>
...
</li><li class="wp-block-post post-2564 post type-post status-publish format-standard has-post-thumbnail hentry category-building-in-<?php echo $row['country']; ?> category-building-policies category-building-trends tag-<?php echo $row['country']; ?> tag-boston-building tag-building-supplier tag-circular-economy tag-eco-friendly tag-energy-efficiency tag-energy-efficient tag-green-building tag-sustainability">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/" target="_self" >The Circular Economy and Its Impact on Construction</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy-768x515.png" class="attachment-medium size-medium wp-post-image" alt="construction impact on the circular economy" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-08-28T09:24:48-04:00">08.28.2019</time></div>
...
</li><li class="wp-block-post post-2558 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-trends category-homeowner category-kitchen-design category-remodeler tag-<?php echo $row['country']; ?> tag-builder tag-downtown-<?php echo $row['country']; ?> tag-kitchen tag-kitchen-design tag-kitchen-hardware tag-kitchen-trend tag-lumber-and-building-materials tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/want-in-on-the-matte-black-kitchen-trend-6-ideas-to-help-you-pull-it-off/" target="_self" >Want in on the Matte Black Kitchen Trend? 6 Ideas to Help You Pull It Off!</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-768x515.png" class="attachment-medium size-medium wp-post-image" alt="matte black kitchen" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-08-14T15:37:53-04:00">08.14.2019</time></div>
...
</li><li class="wp-block-post post-2553 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-trends category-contractor category-homeowner category-remodeler tag-air-sealing tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-building-guidelines tag-boston-condo tag-builder tag-building-supplier tag-insulation tag-lumber-and-building-materials tag-remodeler">
<h2 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/" target="_self" >6 Strategies for Air Sealing in New Construction and Retrofits</a></h2>

<figure class="wp-block-post-featured-image"><img width="768" height="515" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-768x515.png" class="attachment-medium size-medium wp-post-image" alt="air sealing" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png 1280w" sizes="(max-width: 768px) 100vw, 768px" /></figure>


<div class="wp-block-group post-meta has-small-font-size is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex"><div class="wp-block-post-date"><time datetime="2019-07-24T09:47:30-04:00">07.24.2019</time></div>
...
<a href="<?php echo $row['url']; ?>/blog/page/5/" class="wp-block-query-pagination-previous">Previous</a>

<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/blog/">1</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/4/">4</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/5/">5</a>
<span aria-current="page" class="page-numbers current">6</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/7/">7</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/8/">8</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/blog/page/23/">23</a></div>

<a href="<?php echo $row['url']; ?>/blog/page/7/" class="wp-block-query-pagination-next">Next</a>
</nav></div>
</main>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/blog/page/6/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<nav class=" is-vertical wp-block-navigation is-layout-flex wp-container-core-navigation-layout-3 wp-block-navigation-is-layout-flex" aria-label="Footer About"><ul class="wp-block-navigation__container  is-vertical wp-block-navigation"><li class=" wp-block-navigation-item wp-block-navigation-link"><a class="wp-block-navigation-item__content"  href="<?php echo $row['url']; ?>/about/"><span class="wp-block-navigation-item__label">About</span></a></li><li class=" wp-block-navigation-item wp-block-navigation-link"><a class="wp-block-navigation-item__content"  href="<?php echo $row['url']; ?>/about/careers/"><span class="wp-block-navigation-item__label">Careers</span></a></li><li class=" wp-block-navigation-item current-menu-item wp-block-navigation-link"><a class="wp-block-navigation-item__content"  href="<?php echo $row['url']; ?>/blog/" aria-current="page"><span class="wp-block-navigation-item__label">Blog</span></a></li></ul></nav></div>
