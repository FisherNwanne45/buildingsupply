...
<!-- Mirrored from <?php echo $row['url']; ?>/trex-decking-benefits/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:08:50 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Are you thinking about using Trex decking for your home? Contact a <?php echo $row['country']; ?> decking expert at <?php echo $row['name']; ?> today to learn more about Trex decking." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="4 Benefits of Using Trex Decking → Your Local <?php echo $row['country']; ?> Decking Experts" />
	<meta property="og:description" content="Are you thinking about using Trex decking for your home? Contact a <?php echo $row['country']; ?> decking expert at <?php echo $row['name']; ?> today to learn more about Trex decking." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2021-01-21T16:51:43+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:14+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2021/01/trex-composite-decking.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/trex-decking-benefits/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Choosing the Right Decking for Your Home: 4 Benefits of Using Trex Decking","datePublished":"2021-01-21T16:51:43+00:00","dateModified":"2023-09-11T13:46:14+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/trex-decking-benefits/"},"wordCount":747,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking.jpg","articleSection":["Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Decks","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/trex-decking-benefits/","url":"<?php echo $row['url']; ?>/trex-decking-benefits/","name":"4 Benefits of Using Trex Decking → Your Local <?php echo $row['country']; ?> Decking Experts","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking.jpg","datePublished":"2021-01-21T16:51:43+00:00","dateModified":"2023-09-11T13:46:14+00:00","description":"Are you thinking about using Trex decking for your home? Contact a <?php echo $row['country']; ?> decking expert at <?php echo $row['name']; ?> today to learn more about Trex decking.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/trex-decking-benefits/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking.jpg","width":1080,"height":720,"caption":"trex decking"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/trex-decking-benefits/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Choosing the Right Decking for Your Home: 4 Benefits of Using Trex Decking"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>4 Benefits of Using Trex Decking → Your Local <?php echo $row['country']; ?> Decking Experts</title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2758.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexc446.php?p=2758' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed9fd1.json?url=<?php echo $row['url']; ?>%2Ftrex-decking-benefits%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed5851?url=<?php echo $row['url']; ?>%2Ftrex-decking-benefits%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2758 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Choosing the Right Decking for Your Home: 4 Benefits of Using Trex Decking</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Are you thinking about building a deck? Adding or renovating your property’s deck is a great way to add value and beauty to your property— but like every building project, there are some things you need to know before you start. Depending on where you live, your budget, and your personal tastes, your decking material options might differ from others&#8217;. Each decking material comes with its own maintenance requirements, aesthetic appeal, cost, and other important factors to keep in mind when choosing what&#8217;s right for you and your home.</p>
<h2>Introducing Trex Composite Decking</h2>
<p>One of the most popular types of decking in 2021 is Trex. If you’re in the building materials industry world, you’ve probably heard the debate between Trex and wood. Trex decking is a great alternative to wood decking, especially since it looks exactly like wood.</p>
<p>Although it looks like wood, composite decking is a durable composite material that is made from plastic, wood fibers, and a bonding agent— all recycled materials, which is a popular trend in today’s environmentally conscious society. Trex is greener and more durable—what more could you want for your deck?</p>
<h2>Why Trex?</h2>
<p>When picking out any building material, there’s always four factors to consider: cost, maintenance, eco-friendliness, and of course, look and aesthetics. There are many advantages to using composite decking over wood decking.</p>
<h3>Cost</h3>
<p>In general, Trex decking is typically a bigger investment than wood decking. As we mentioned earlier, Trex is a more durable material, which means it lasts longer than wood. With wood decking, you’ll be replacing warped and damaged woods—we know how the weather gets in <?php echo $row['country']; ?>. Although composite decking is a bigger investment, you’ll be saving money in the long run.</p>
<h3>Maintenance</h3>
<p>Not all decking materials are made the same, and not all of them have the same durability. The goal is to get a finished product that will last for years, but that’s not the reality for most decks. Wood decking requires more maintenance than Trex for the following reasons:</p>
<ol>
<li><strong>Weather</strong>. As we mentioned above, living in <?php echo $row['country']; ?> comes with a lot of weather and harsh elements—you’ll have to replace warped or damaged boards and frequently paint and reseal wood.</li>
<li><strong>Critters</strong>. Unwanted critters, especially termites, are a common problem with wood decking. There’s no proven way to stop them from feasting on your deck, which will add up to constant repairs.</li>
</ol>
<h3>Eco-Conscious</h3>
<p>Trex decking is made from 95% recycled materials, making it the ultimate choice for an environmentally-sound conscious. These materials include:</p>
<ul>
<li>Grocery and bakery bags,</li>
<li>Newspaper and produce bags,</li>
<li>Toilet paper packaging and paper towel packaging,</li>
<li>Water bottle packaging,</li>
<li>Dry cleaning plastic.</li>
</ul>
<p>You name it, Trex recycles it into decking! It is possible to find reclaimed wood for your decking project, but most wood decking is made from timber harvested from forests. If you’re looking to lessen your carbon footprint, Trex is definitely the greener choice.</p>
<h3>Look &amp; Aesthetics</h3>
<p>Last but certainly not least, always consider the overall look and aesthetics of your deck—not only should your deck look nice, but it also should match the home it’s attached to. When using wood decking, you must look at color and grain, which are more limited in options than that of Trex decking.</p>
<p>When you choose Trex decking you, you immediately have a bigger variety of colors to choose from, making it much easier to match your vision for your newly renovated home. You also will avoid stains and fading, which a common problem with wood decking.</p>
<h2>Interested in Using Trex Decking? Contact a Decking Expert at <?php echo $row['name']; ?> Today</h2>
...
<p>At NEBS, we carry a variety of <a href="../discover-trex/index.php">Trex decking products</a>, including composite decking, railings, framing, and even outdoor lighting. If you’re interested in learning more about using Trex decking for your project, don’t hesitate to <a href="https://goo.gl/maps/VfTsX6G8PLpbPLt37">stop by our showroom in <?php echo $row['country']; ?></a> or <a href="../contact-us/index.php">give us a call</a> to talk with an experienced decking expert about your project. <?php echo $row['name']; ?> is here for all your decking needs—whatever you need, we’re here.</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="683" src="../wp-content/uploads/2021/02/sidekix-media-KiUg-4xmTwo-unsplash-scaled-1-1024x683.jpg" class="attachment-large size-large wp-post-image" alt="timeless kitchen" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/02/sidekix-media-KiUg-4xmTwo-unsplash-scaled-1-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/02/sidekix-media-KiUg-4xmTwo-unsplash-scaled-1-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/02/sidekix-media-KiUg-4xmTwo-unsplash-scaled-1-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2021/02/sidekix-media-KiUg-4xmTwo-unsplash-scaled-1-2048x1366.jpg 2048w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../designing-a-timeless-kitchen/index.php">5 Rules for Designing a Timeless Kitchen</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/trex-decking-benefits/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/trex-decking-benefits/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:08:52 GMT -->
</html>
