...
<!-- Mirrored from <?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:08:18 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Cliveden Place: 56 unit condo and retail space - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Challenge / Opportunity Cliveden Place: Two 36,000 sq. ft mixed use buildings, including 56 condo units above multiple first-floor retail businesses, all set right in the heart of Quincy, MA. <?php echo $row['name']; ?>  worked on this project with Galvin Structures, Inc. who is a long-time, valued customer of <?php echo $row['name']; ?> and a staple of the…" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:modified_time" content="2023-04-18T15:09:54+00:00" />
	<meta property="og:image" content="../../wp-content/uploads/2023/04/cliveden-gallery.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/","url":"<?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/","name":"Cliveden Place: 56 unit condo and retail space - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery.jpg","datePublished":"2023-04-06T14:40:34+00:00","dateModified":"2023-04-18T15:09:54+00:00","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery.jpg","width":1800,"height":1029},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Cliveden Place: 56 unit condo and retail space - <?php echo $row['name']; ?> </title>
...
<style id='blockshoon-portfolio-meta-style-inline-css'>
.wp-block-blockshoon-portfolio-meta{border-bottom:1px solid var(--wp--preset--color--gray);margin-bottom:7.5rem;padding-bottom:4rem}@media(min-width:782px){.wp-block-blockshoon-portfolio-meta>.wp-block-column{flex:0 0 auto;margin-right:6rem;min-width:20%}}@media(min-width:1024px){.wp-block-blockshoon-portfolio-meta>.wp-block-column{min-width:24.9rem}}@media(max-width:767px){.wp-block-blockshoon-portfolio-meta>.wp-block-column{width:100%}.wp-block-blockshoon-portfolio-meta>.wp-block-column+.wp-block-column{margin-top:4rem}}
...
<link rel="https://api.w.org/" href="../../wp-json/index.php" /><link rel="alternate" type="application/json" href="../../wp-json/wp/v2/bs_portfolio/3118.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../../index039c.php?p=3118' />
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed0e17.json?url=<?php echo $row['url']; ?>%2Fproject%2Fcliveden-place-56-unit-condo-and-retail-space%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed2955?url=<?php echo $row['url']; ?>%2Fproject%2Fcliveden-place-56-unit-condo-and-retail-space%2F&amp;format=xml" />
...
<body class="bs_portfolio-template-default single single-bs_portfolio postid-3118 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull single-portfolio-content animate-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
...
<div class="wp-block-cover alignfull is-light" style="min-height:47vh"><span aria-hidden="true" class="wp-block-cover__background has-transparent-background-color has-background-dim-0 has-background-dim"></span><img fetchpriority="high" decoding="async" width="1800" height="661" class="wp-block-cover__image-background wp-image-3125" alt="" src="../../wp-content/uploads/2023/04/cliveden-banner.jpg" style="object-position:50% 100%" data-object-fit="cover" data-object-position="50% 100%" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-banner.jpg 1800w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-banner-768x282.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-banner-1024x376.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-banner-1536x564.jpg 1536w" sizes="(max-width: 1800px) 100vw, 1800px" /><div class="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">
<p class="has-text-align-center has-large-font-size"></p>
</div></div>



<div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex"><h1 class="wp-block-post-title has-h-2-font-size">Cliveden Place: 56 unit condo and retail space</h1></div>
</div>


    <div class="is-layout-flex alignwide wp-block-blockshoon-portfolio-meta">
                        <div class="wp-block-column is-layout-flow">
                    <h2 class="wp-block-heading has-h-5-font-size" style="margin-bottom:var(--wp--preset--spacing--10)">Client</h2>
                    <p class="has-large-font-size">Cliveden Place</p>
                </div>
                            <div class="wp-block-column is-layout-flow">
                    <h2 class="wp-block-heading has-h-5-font-size" style="margin-bottom:var(--wp--preset--spacing--10)">Industry</h2>
                    <p class="has-large-font-size">Residential</p>
                </div>
                </div>



<figure class="wp-block-image alignwide size-large"><img decoding="async" width="1024" height="585" src="../../wp-content/uploads/2023/04/cliveden-gallery-1024x585.jpg" alt="" class="wp-image-3121" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery-1024x585.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery-768x439.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery-1536x878.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/cliveden-gallery.jpg 1800w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>



<h2 class="wp-block-heading has-h-3-font-size">Challenge / Opportunity</h2>



<p class="has-large-font-size">Cliveden Place: Two 36,000 sq. ft mixed use buildings, including 56 condo units above multiple first-floor retail businesses, all set right in the heart of Quincy, MA.</p>



<p class="has-large-font-size"><?php echo $row['name']; ?>  worked on this project with Galvin Structures, Inc. who is a long-time, valued customer of <?php echo $row['name']; ?> and a staple of the Quincy building community. <?php echo $row['name']; ?> provided extensive pre-construction planning and served as a key vendor partner &#8211; acting as a conduit between the product manufacturer and builder for many of the building components to be installed.</p>



<h2 class="wp-block-heading has-h-3-font-size">The <?php echo $row['name']; ?> Difference</h2>



<p class="has-large-font-size">This project involved some significant challenges &#8211; both in terms of engineering and space constraints. Firstly, there were planning hurdles that were overcome by the <?php echo $row['name']; ?> team in order to construct the building using wood, rather than steel and concrete. By value engineering these materials, and other elements of the build, including the windows, <?php echo $row['name']; ?> was able to lower the overall building cost for the developer. Also, although downtown Quincy provided a historic and highly desirable setting for this project, building in the middle of a bustling metropolitan area brings it’s own challenges, most notably &#8211; space. Building in this dense urban environment meant that space was at a premium. <?php echo $row['name']; ?> was able to alleviate this challenge by providing many of the building materials on boom trucks almost daily, reducing on-site storage to a minimum and<br>conserving valuable space for the tradespeople to operate.</p>



<h3 class="wp-block-heading has-h-5-font-size">The result for the client?</h3>



<p class="has-large-font-size">A more cost effective construction and a better product for the homebuyer, as well as safer, more efficient material handling and site use. That’s the <?php echo $row['name']; ?> difference.</p>



<figure class="wp-block-pullquote"><blockquote><p>“We’ve been working with <?php echo $row['name']; ?> for years. As always, their service on this project is excellent. Simply put, their attention to detail and response time are superior and they do a great job communicating between us and their vendors. Cliveden Place required extensive pre-planning and design, and they were professional and efficient throughout that entire process. Also, the windows on this project are somewhat custom and complicated, and they’ve done a great job of navigating that part of the project &#8211; value engineering the cost for us and solving issues along the way. Working with <?php echo $row['name']; ?> just makes the process go more smoothly.”</p><cite>Sean Galvin, Galvin Construction</cite></blockquote></figure>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="682" src="../../wp-content/uploads/2023/04/endicott-place-1024x682.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/endicott-place-1024x682.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/endicott-place-768x511.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/endicott-place-1536x1023.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/endicott-place.jpg 1781w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Project</h2>
                                    <p class="title-post has-large-font-size"><a href="../endicott-place/index.php">Endicott Place</a></p><p class="link-arrow has-small-font-size">See more</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/project/cliveden-place-56-unit-condo-and-retail-space/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/project/cliveden-place-56-unit-condo-and-retail-space/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:08:20 GMT -->
</html>
