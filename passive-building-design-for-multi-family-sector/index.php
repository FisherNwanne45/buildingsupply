...
<!-- Mirrored from <?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:11:01 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="A passive building design is one that is designed for extreme energy efficiency, it uses about 60% to 70% less energy than average, which far surpasses LEED standards. Energy savings dramatically reduce operating costs each year and property value increases." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Why Passive Building Design for the Multi-Family Sector is Rapidly Being Embraced - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="A passive building design is one that is designed for extreme energy efficiency, it uses about 60% to 70% less energy than average, which far surpasses LEED standards. Energy savings dramatically reduce operating costs each year and property value increases." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-10-17T10:05:38+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:48:15+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/multi-family-home-passive-building-design-.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/"},"author":{"name":"mflood","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46"},"headline":"Why Passive Building Design for the Multi-Family Sector is Rapidly Being Embraced","datePublished":"2018-10-17T10:05:38+00:00","dateModified":"2023-09-11T13:48:15+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/"},"wordCount":558,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/multi-family-home-passive-building-design-.jpg","keywords":["Architect","<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Building Design","Commercial Development","Design Trends","Developer","Energy Efficient","Lumber and Building Materials","Sustainability"],"articleSection":["Architect","<?php echo $row['country']; ?> Condo","Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer","Homeowner","Remodeler","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/","url":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/","name":"Why Passive Building Design for the Multi-Family Sector is Rapidly Being Embraced - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/multi-family-home-passive-building-design-.jpg","datePublished":"2018-10-17T10:05:38+00:00","dateModified":"2023-09-11T13:48:15+00:00","description":"A passive building design is one that is designed for extreme energy efficiency, it uses about 60% to 70% less energy than average, which far surpasses LEED standards. Energy savings dramatically reduce operating costs each year and property value increases.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/multi-family-home-passive-building-design-.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/multi-family-home-passive-building-design-.jpg","width":1920,"height":1440},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/passive-building-design-for-multi-family-sector/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Why Passive Building Design for the Multi-Family Sector is Rapidly Being Embraced"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46","name":"mflood","url":"<?php echo $row['url']; ?>/author/mflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Why Passive Building Design for the Multi-Family Sector is Rapidly Being Embraced - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1963" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1963' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fpassive-building-design-for-multi-family-sector%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fpassive-building-design-for-multi-family-sector%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1963 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Why Passive Building Design for the Multi-Family Sector is Rapidly Being Embraced</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>If there’s one <a href="<?php echo $row['url']; ?>/what-developers-need-to-know-about-the-tall-wood-buildings-trend/" target="_blank" rel="noopener noreferrer">trend</a> in the building industry that is taking off, it’s <a href="https://www.proudgreenhome.com/articles/passive-house-standards-gaining-in-single-family-and-multifamily-projects/" target="_blank" rel="noopener noreferrer">passive house design</a>. This is a design principle that was first envisioned by University of Lund researchers from Sweden back in 1988. Since then, a growing wave of builders have been creating passive houses, and now, estimates say that there are between 40,000 and 50,000 passive homes around the world. The first of these homes to be built in the United States was finished in 2003, but that was by no means the last. Here’s a look at what passive housing is, and what you’ll need to know to get started on your own passive housing project.</p>
<p><span id="more-1963"></span></p>
<h3><strong>What is Passive Design?</strong></h3>
<p>A passive design building is one that is designed for extreme energy efficiency. These buildings use about 60% to 70% less energy than average, which far surpasses LEED standards. Passive design homes can either be single-family or <a href="https://www.usgbc.org/articles/passive-house-design-expands-multifamily-dwelling" target="_blank" rel="noopener noreferrer">multi-family</a>, but all units share a few things in common. Most passive design homes feature super insulated facades and leak-proof building envelopes to prevent drafts or cold areas. Not only does this keep heat inside during the winter, but it reduces the loss of conditioned air in the summer.</p>
<p>In addition, these buildings usually also feature what is known as energy recovery ventilation — a ventilation system that is designed to recover energy while keeping the air within the building fresh. You’ll also see features like triple-paned windows and other energy efficient fixtures to maximize the energy savings that these buildings are capable of. To supplement grid energy use, passive buildings may include solar panels, as well.</p>
<h3><strong>Can Passive Design Principles Apply to Both Single-Family and Multi-Family Units?</strong></h3>
<p>Currently, most passive design homes are single family, and that is because there is an increased cost to build this type of home. Passive homes cost between 5% and 10% more to build than regular homes, and that extra cost means that most of these homes are built in affluent areas.</p>
<p>However, passive design multi-family units cost&nbsp;<a href="http://www.phius.org/what-is-passive-building/passive-house-faqs" target="_blank" rel="noopener noreferrer">at most 3%</a>&nbsp;more to build than a conventional multi-family unit. This is in large part because builders are able to get deeper discounts on bulk orders of building supplies.</p>
<p>What does this mean for investors in multi-family properties? It means that passive homes are the wave of the future. Not only do they cost about the same as conventional units to build, but the energy savings will dramatically reduce operating costs each year. On top of that, these units are attractive to renters for a variety of reasons. Those who are eco-conscious will enjoy living in a green home&nbsp;and will even pay more for a property that uses less energy. The advanced insulation and ventilation systems ensure year-round comfort within the units, which means you’ll have less turnover among renters. Both of these factors together will increase the value of your property, so even though you will be able to pass energy savings along to tenants, you’ll be able to increase profits on collected rent.</p>
<p>Whether you’re interested in building new single-family homes or multi-family units, then passive design is definitely worth a look. The cost to build is slightly higher, but those increased costs will be offset by increased property value and deep energy savings.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="682" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets-1024x682.jpg" class="attachment-large size-large wp-post-image" alt="Beaded inset vs plain inset kitchen cabinets" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets-1024x682.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets-768x511.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets.jpg 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/beaded-inset-and-plain-inset-kitchen-cabinets/">Choosing Between Beaded Inset and Plain Inset Kitchen Cabinets</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/passive-building-design-for-multi-family-sector/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
