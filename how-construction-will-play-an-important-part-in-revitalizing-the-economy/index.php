...
<!-- Mirrored from <?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:51 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="The construction industry will play a large part in the revitalization of our economy with new advancements to eco-friendly and energy efficient technologies" />
	<link rel="canonical" href="<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="How Construction Will Play an Important Part in Revitalizing the Economy - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="The construction industry will play a large part in the revitalization of our economy with new advancements to eco-friendly and energy efficient technologies" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-05-14T04:00:04+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:33+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy-.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/"},"author":{"name":"Justin","@id":"<?php echo $row['url']; ?>/#/schema/person/6e63ef9f98cf37362099fa270f43c591"},"headline":"How Construction Will Play an Important Part in Revitalizing the Economy","datePublished":"2020-05-14T04:00:04+00:00","dateModified":"2023-09-11T13:46:33+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/"},"wordCount":687,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy-.png","keywords":["construction crew","Construction Site"],"articleSection":["Contractor"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/","url":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/","name":"How Construction Will Play an Important Part in Revitalizing the Economy - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy-.png","datePublished":"2020-05-14T04:00:04+00:00","dateModified":"2023-09-11T13:46:33+00:00","description":"The construction industry will play a large part in the revitalization of our economy with new advancements to eco-friendly and energy efficient technologies","breadcrumb":{"@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy-.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy-.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"How Construction Will Play an Important Part in Revitalizing the Economy"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/6e63ef9f98cf37362099fa270f43c591","name":"Justin","url":"<?php echo $row['url']; ?>/author/justin/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>How Construction Will Play an Important Part in Revitalizing the Economy - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2681" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2681' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-construction-will-play-an-important-part-in-revitalizing-the-economy%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-construction-will-play-an-important-part-in-revitalizing-the-economy%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2681 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2020-05-14T00:00:04-04:00">05.14.2020</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">How Construction Will Play an Important Part in Revitalizing the Economy</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">There’s no denying that COVID-19 is going to have massive impacts on the economy—locally, within regional economies, nationally, and the global economy, too. It’s a challenge that every sector will face, construction included.</span></p>
<p><span style="font-weight: 400;">But it’s not all bad! The U.S. economy is resilient, and it relies on things like innovation, growth, and expansion. That’s why the construction industry will play a large part in the revitalization of our economy. Few other sectors see the innovation that the construction industry does what with new advancements to eco-friendly and energy efficient technologies. Growth and expansion? There will always be a demand for new residential and commercial buildings, and in many places, like <?php echo $row['country']; ?>, the population is growing, which demands expansion no matter what the economy is doing.</span></p>
<p><span style="font-weight: 400;">Brighter times are coming. Let’s look at a few of the ways that construction will play a key role in rebuilding our economy.</span></p>
<h2><span style="font-weight: 400;">Climate Change and Energy Efficiency Demand Innovation</span></h2>
<p><span style="font-weight: 400;">This is one area in which construction will grow no matter what happens with COVID-19 and the economy. Climate change is one of the biggest looming issues of the future, and that means homeowners and businesses alike are sharing the burden of retrofitting homes and commercial properties to be more energy efficient. Energy efficiency improvements are also in high demand simply because they save money. Modern innovation means homeowners and property managers can slash utility bills—and that makes the cost of retrofits and green buildings extremely worthwhile.</span></p>
<p><span style="font-weight: 400;">Demand for green building will surge in part because people want to save money and in part because this lowers the carbon emissions contributing to climate change. The construction sector definitely has room to grow here—and that growth will help revitalize the economy.</span></p>
<h2><span style="font-weight: 400;">Reduced Traffic Means Now is the Time to Make Transit Improvements</span></h2>
<p><span style="font-weight: 400;">This is one way that the construction industry can keep working—and help keep the economy moving. Right now, we’re seeing a </span><a href="https://www.sciencemediacentre.org/expert-reaction-to-drop-in-air-pollution-because-of-covid-19/"><span style="font-weight: 400;">worldwide reduction in traffic</span></a><span style="font-weight: 400;"> with all the stay at home orders in place, and that’s likely something that will continue for quite some time as governments continue quarantines and as cautious citizens stay home to protect themselves.</span></p>
<p><span style="font-weight: 400;">For the construction industry, this is a blessing in disguise. Reduced traffic makes it much easier to work on transit projects, be they roads, parking facilities, airports, or bus and rail lines.</span></p>
<h2><span style="font-weight: 400;">Look for Construction to Expand in the Healthcare Sector</span></h2>
<p><span style="font-weight: 400;">If COVID-19 has underscored one thing, it’s the need for more healthcare facilities, not only to tend the population during a pandemic, but to handle normal operating conditions, too. In fact, in <?php echo $row['country']; ?>, we’ve seen healthcare as one of the key construction sectors that never shut down despite the pandemic. Because healthcare projects are considered crucial, work has been ongoing, which has helped construction businesses stay afloat. Expect growth in this sector as we move forward.</span></p>
<h2><span style="font-weight: 400;">An Affordable Housing Boom on the Horizon?</span></h2>
<p><span style="font-weight: 400;">Before the pandemic struck, <?php echo $row['country']; ?> was already facing a serious housing shortage. Rents and housing costs have been on the rise as the population grows and strains the supply of available housing units. Even with COVID-19, that hasn’t changed. Housing is still in high demand in <?php echo $row['country']; ?> and homeowners are still facing high costs and limited availability.</span></p>
<p><span style="font-weight: 400;">This means that at some point, the construction industry within the city will be tasked with tending to this housing shortage. As of right now, construction is still shut down on residential projects, but <?php echo $row['country']; ?>’s Mayor Walsh is hopeful that work will resume on these projects soon.</span></p>
<p><span style="font-weight: 400;">COVID-19 has certainly caused a lot of challenges, but nothing that we can’t overcome in the coming weeks, months and years. If there’s one thing that we can all count on, it’s that the construction industry will be one of the key players involved in the revitalization of the American economy. Even though times may be tight right now, if you’re involved in this industry, then there’s a bright and busy future coming!</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/">How to Keep Construction Workers Safe Amid COVID-19 Virus Fears</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/how-construction-will-play-an-important-part-in-revitalizing-the-economy/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
