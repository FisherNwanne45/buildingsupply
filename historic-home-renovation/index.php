...
<!-- Mirrored from <?php echo $row['url']; ?>/historic-home-renovation/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:08:25 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="How do you modernize a historic home without losing the historical roots? Check out these historic home renovation tips from remodel experts." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Historic Home Renovation 101 → 5 Tips from Remodel Experts at NEBS" />
	<meta property="og:description" content="How do you modernize a historic home without losing the historical roots? Check out these historic home renovation tips from remodel experts." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2021-03-31T15:46:01+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:13+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2021/03/shutterstock_503917549-scaled-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/historic-home-renovation/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/historic-home-renovation/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Historic Home Renovation 101: 5 Tips for Mixing Modern with Historic","datePublished":"2021-03-31T15:46:01+00:00","dateModified":"2023-09-11T13:46:13+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/historic-home-renovation/"},"wordCount":506,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/historic-home-renovation/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/03/shutterstock_503917549-scaled-1.jpg","articleSection":["Architect","Bathroom Renovation","Contractor","Decks","Homeowner","Kitchen Design","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/historic-home-renovation/","url":"<?php echo $row['url']; ?>/historic-home-renovation/","name":"Historic Home Renovation 101 → 5 Tips from Remodel Experts at NEBS","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/historic-home-renovation/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/historic-home-renovation/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/03/shutterstock_503917549-scaled-1.jpg","datePublished":"2021-03-31T15:46:01+00:00","dateModified":"2023-09-11T13:46:13+00:00","description":"How do you modernize a historic home without losing the historical roots? Check out these historic home renovation tips from remodel experts.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/historic-home-renovation/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/historic-home-renovation/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/historic-home-renovation/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2021/03/shutterstock_503917549-scaled-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/03/shutterstock_503917549-scaled-1.jpg","width":2560,"height":1703,"caption":"historic home renovation"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/historic-home-renovation/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Historic Home Renovation 101: 5 Tips for Mixing Modern with Historic"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Historic Home Renovation 101 → 5 Tips from Remodel Experts at NEBS</title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2768.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index8f66.php?p=2768' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed492a.json?url=<?php echo $row['url']; ?>%2Fhistoric-home-renovation%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedf7d0?url=<?php echo $row['url']; ?>%2Fhistoric-home-renovation%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2768 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Historic Home Renovation 101: 5 Tips for Mixing Modern with Historic</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span data-mce-type="bookmark" style="width: 0px;overflow: hidden;line-height: 0" class="mce_SELRES_start"><span data-mce-type="bookmark" style="width: 0px;overflow: hidden;line-height: 0" class="mce_SELRES_start">﻿</span>﻿</span>New England carries a unique charm that no other part of the country can compete with—the historic yet up-and-coming feel of <?php echo $row['country']; ?> is what makes our great city special. These historical beauties are a crowd favorite for their timeless architecture and beauty.</p>
<p>
<?php echo $row['country']; ?>’s historic homes may be beautiful, but anyone who lives in a house that is a century old knows the challenges of renovating them. When it’s time to renovate, how do you honor the historical roots while modernizing the home itself? Here are a few tips to keep in mind during a historic home renovation in <?php echo $row['country']; ?>.</p>
<h3>1. Choose Historic Home Design Experts </h3>
<p>The first step to any renovation project is finding the right people for the job—choose <a href="../meet-the-team/index.php">interior experts</a> who have expertise with historic home renovations. If you choose an interior designer who lacks experience in this area, it will show in your renovation.</p>
<h3>2. Keep Historic Elements </h3>
<p>The second step to modernizing a historic home is choosing which historic elements to keep and which ones to renovate. For example, a house that has 200-year-old millwork might be able to be restored and exposed. Take these elements and pair them with modern touches such as sleek countertops, accent furniture, and new appliances to create a timeless look and feel.</p>
<h3>3. Showcase Lighting </h3>
<p>If you keep it traditional with your décor, appliances, and furniture, you add a contemporary accent by showcasing your lighting. An elegant chandelier or modern floor lamp will add a touch of modern sophistication without taking away from the historical elements.</p>
<h3>4. Outdoor Renovation </h3>
<p>When renovating any home, always remember the deck. Historical homes are known for their spacious piazzas—you might even get lucky with two decks! Porches are a great opportunity to combine modern with historical by adding modern outdoor furniture or classic rocking chairs. Of course, always pay attention to how old your decking is. If the wood is rotting or splintering, it might be worth it to invest in <a href="../discover-trex/index.php">composite decking</a>.</p>
<h3>5. Clean Lines </h3>
<p>After you choose which historical architectural elements you want to keep, it’s time to highlight them. For example, you can emphasize brickwork with clean lines, smooth surfaces, and neutral colors—this showcases the aesthetics and texture of the brick without overshadowing it. Try adding a modern twist to your home with shaker-style cabinets and granite countertops.</p>
<h3>Contact a Home Remodel Experts at <?php echo $row['name']; ?> Today </h3>
<p>When it comes to meshing modern with historical, the key is finding the right elements to complement each other and creating balance. At <?php echo $row['name']; ?> , we carry a variety of building materials for all your historic home renovation needs. </p>
<p>
Whether you’re looking for a modern twist or traditional beauty, we have the products you—molding, countertops, flooring, decking, cabinets, windows, doors—you name it, we can help. <a href="../contact-us/index.php">Give us a call</a> or <a href="https://goo.gl/maps/x6wT35D1AFqYZEf4A" target="_blank" rel="noopener">stop by our showroom</a> today to consult with an experienced remodel expert and find out how we can help with your historic home remodel.  </p>
</div>
        ...
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            ...
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../sustainable-building-trex/index.php">Go Green with Trex Decking: A Sustainable Building Solution</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/historic-home-renovation/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/historic-home-renovation/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:08:27 GMT -->
</html>
