...
<!-- Mirrored from <?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:57 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="[Infographic] Top 4 New England Home Design Trends - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Home design trends can sometimes seem to be an always evolving door. What is &#8216;hot&#8217; one season, may not be the next. Colors can change quickly and whereas contemporary may be popular today, it may not be tomorrow. Here at <?php echo $row['name']; ?> , our talented staff understands that design can change quickly; that is…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-08-31T17:52:54+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:48+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"[Infographic] Top 4 New England Home Design Trends","datePublished":"2016-08-31T17:52:54+00:00","dateModified":"2023-09-11T13:50:48+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/"},"wordCount":118,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg","keywords":["bathroom design","bathroom renovation","<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","Builder","Building","Building Supplier","Commercial Development","Downtown <?php echo $row['country']; ?>","Green Building","infographic","Interior","Kitchen Design","Lumber and Building Materials","Remodeler"],"articleSection":["Bathroom Renovation","Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer","Homeowner","Kitchen Design","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/","url":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/","name":"[Infographic] Top 4 New England Home Design Trends - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg","datePublished":"2016-08-31T17:52:54+00:00","dateModified":"2023-09-11T13:50:48+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg","width":640,"height":427},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"[Infographic] Top 4 New England Home Design Trends"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>[Infographic] Top 4 New England Home Design Trends - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; [Infographic] Top 4 New England Home Design Trends Comments Feed" href="<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/955" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=955' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Finfographic-top-4-new-england-home-design-trends%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Finfographic-top-4-new-england-home-design-trends%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-955 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">[Infographic] Top 4 New England Home Design Trends</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Home design trends can sometimes seem to be an always evolving door. What is &#8216;hot&#8217; one season, may not be the next. Colors can change quickly and whereas contemporary may be popular today, it may not be tomorrow. Here at <?php echo $row['name']; ?> , our talented staff understands that design can change quickly; that is why they have picked four home design trends that they believe will stick around for a few seasons. Whether you are renovating your bathroom or building a new deck, <?php echo $row['name']; ?>  has the knowledge and material to supply your next project. Located in the heart of <?php echo $row['country']; ?>, we look forward to helping you.</p>
<p>&nbsp;</p>
<p><a href="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/NEBS_DesignTrends_Infographic_v2.1.pdf"><img fetchpriority="high" decoding="async" class="aligncenter wp-image-953 size-large" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/New-England-Top-Design-Trends-805x1024.jpg" alt="New England Top Design Trends" width="805" height="1024"></a></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/">What CPA Could Mean for Further Development in <?php echo $row['country']; ?></a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/infographic-top-4-new-england-home-design-trends/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
