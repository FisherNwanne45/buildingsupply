...
<!-- Mirrored from <?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:57 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="What CPA Could Mean for Further Development in <?php echo $row['country']; ?> - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="The Community Preservation Act (CPA) is something that has been adopted by many, many communities throughout Massachusetts. In fact, nearly half of all municipalities are now involved with this 16-year old law, and many say that <?php echo $row['country']; ?> is long overdue in adopting this program. At its heart, the Community Preservation Act is meant to do…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-09-01T08:09:35+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:48+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"What CPA Could Mean for Further Development in <?php echo $row['country']; ?>","datePublished":"2016-09-01T08:09:35+00:00","dateModified":"2023-09-11T13:50:48+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/"},"wordCount":623,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","Building Supplier","Community Preservation Act","Downtown <?php echo $row['country']; ?> Residential Building","Interior","Lumber and Building Materials","Remodeler","Sustainability"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Policies","Building Trends","Developer","Homeowner"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/","url":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/","name":"What CPA Could Mean for Further Development in <?php echo $row['country']; ?> - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg","datePublished":"2016-09-01T08:09:35+00:00","dateModified":"2023-09-11T13:50:48+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg","width":640,"height":427},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"What CPA Could Mean for Further Development in <?php echo $row['country']; ?>"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>What CPA Could Mean for Further Development in <?php echo $row['country']; ?> - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; What CPA Could Mean for Further Development in <?php echo $row['country']; ?> Comments Feed" href="<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/958" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=958' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fcpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fcpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-958 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">What CPA Could Mean for Further Development in <?php echo $row['country']; ?></h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>The <a href="https://www.<?php echo $row['country']; ?>preservation.org/" target="_blank" rel="noopener noreferrer">Community Preservation Act</a> (CPA) is something that has been adopted by many, many communities throughout Massachusetts. In fact, nearly half of all municipalities are now involved with this 16-year old law, and <a href="https://www.<?php echo $row['country']; ?>globe.com/opinion/2016/03/27/boston-losing-out-not-adopting-community-preservation-act/iYFDN040Rjpkbh9pD8eGvI/story.php" target="_blank" rel="noopener noreferrer">many say</a> that <?php echo $row['country']; ?> is long overdue in adopting this program.</p>
<p>At its heart, the Community Preservation Act is meant to do a variety of things that make communities better. Funds can provide more <a href="<?php echo $row['url']; ?>/inclusionary-development-policy-cracking-the-code/" target="_blank" rel="noopener noreferrer">affordable housing</a> options and money has been used to build parks or preserve historical buildings — tasks that enrich communities by making them more beautiful, vibrant and entertaining.</p>
<p>Let’s examine the Community Preservation Act and see what it might mean for further development in <?php echo $row['country']; ?>!</p>
<h3><strong>How the Community Preservation Act Works for <?php echo $row['country']; ?></strong></h3>
<p>The CPA works through a small tax surcharge on properties. Essentially, a homeowner would pay an extra $24 each year on their property taxes. Then, that money is matched by a state trust fund and poured back into the communities that are part of the CPA.</p>
<p>In <?php echo $row['country']; ?>, the <a href="http://www.yesbetter<?php echo $row['country']; ?>.com/" target="_blank" rel="noopener noreferrer">Yes for a Better <?php echo $row['country']; ?> Committee</a> wants the CPA to levy a 1% surcharge on property taxes, but there would be several exemptions. Low-income homeowners and some seniors would be exempted, and the first $100,000 in property value on both business and residential properties would be exempted. Now, that sounds like a lot, but in actuality, it means that someone with a $500,000 property would only owe an extra $25 each year.</p>
<h3><strong>CPA and <?php echo $row['country']; ?> Building Development</strong></h3>
<p>As mentioned above, these tax surcharges go into the CPA fund, where they will be matched with money from the state. The funds are meant to do what municipalities have been unable to do, which is to <a href="http://beverly.wickedlocal.com/news/20160624/cpa-preserves-past-and-future-in-massachusetts" target="_blank" rel="noopener noreferrer">develop communities</a> beyond the absolute bare necessities. This means that in a city that is part of the CPA, communities can work together build the things that they need, whether it be more park space, affordable housing, housing for the elderly and so forth.</p>
<p>That’s where developers come in. If the CPA comes to <?php echo $row['country']; ?>, then the city’s communities will need developers to make their plans come to life. Estimates show that the CPA would raise about $20 million each year for further development in <?php echo $row['country']; ?>. In other words, if Question 5, which is the bill that would bring the CPA to <?php echo $row['country']; ?>, passes in November, then the results could be lucrative for developers across the city. <strong>(Update: the bill did pass, read more <a href="http://www.<?php echo $row['country']; ?>magazine.com/news/blog/2016/11/08/question-5-<?php echo $row['country']; ?>/" target="_blank" rel="noopener noreferrer">here</a>)</strong></p>
<h3><strong>What are the Drawbacks to the CPA?</strong></h3>
<p>There is no denying it — the CPA is a tax hike, though a small one. But, with voters still somewhat pessimistic about the economy, tax increases are difficult to pass.</p>
<p>The other issue with the CPA is that as more communities join, the trust fund that provides matching funds is spread thinner and thinner. In the years between 2002 and 2007, communities received 100% matching funds. However, as more communities joined, and as the housing market took a downturn, that matching amount dwindled — down to 68% in 2008. Nowadays, because the trust fund is shared by all communities involved, that amount is even smaller. In fact, over the past 7 years, only one time has the matching fund exceeded 35%.</p>
<p>There is one bright point to this, however. If the CPA struggles because the state matching funds simply aren’t there, some lawmakers, including <a href="http://communitypreservation.org/FY17_budgetprocess" target="_blank" rel="noopener noreferrer">Governor Charlie Baker</a>, are hopeful that they can allocate more money from the state budget to the CPA fund — potentially as soon as 2017.</p>
<p>The Community Preservation Act could mean good things for further development in <?php echo $row['country']; ?>, even though matching funds aren’t what they used to be. But will the voters agree to a tax surcharge? We’ll have to wait until November to find out!</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="424" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/">Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#8217;s Housing Shortage</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
