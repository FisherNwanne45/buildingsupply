...
<!-- Mirrored from <?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:57 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="<?php echo $row['country']; ?> is known for its beautiful architecture, and one of the most famous features of this city are its triple deckers. These are three-story apartment buildings with their own unique style — tall, narrow and long, with Victorian influences. What you might not know about these buildings is that the City of <?php echo $row['country']; ?> is making…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-08-30T10:54:57+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:49+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Triple-Decker-1-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker","datePublished":"2016-08-30T10:54:57+00:00","dateModified":"2023-09-11T13:50:49+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/"},"wordCount":625,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Triple-Decker-1-1.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> 3D initiative","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Home Center","<?php echo $row['country']; ?> Multifamily","<?php echo $row['country']; ?> Redevelopment Authority","Builder","Building Supplier","Developer","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Lumber and Building Materials","Sustainability","Triple Decker","Window Replacement"],"articleSection":["Building in <?php echo $row['country']; ?>","Building Policies","Contractor","Developer","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/","url":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/","name":"Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Triple-Decker-1-1.jpg","datePublished":"2016-08-30T10:54:57+00:00","dateModified":"2023-09-11T13:50:49+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Triple-Decker-1-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Triple-Decker-1-1.jpg","width":640,"height":480},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker Comments Feed" href="<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/948" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=948' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fknowing-the-3d-when-remodeling-a-boston-triple-decker%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fknowing-the-3d-when-remodeling-a-boston-triple-decker%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-948 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2016-08-30T10:54:57-04:00">08.30.2016</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><?php echo $row['country']; ?> is known for its <a href="<?php echo $row['url']; ?>/3-window-replacement-questions-to-ask-for-your-historic-renovation/">beautiful architecture</a>, and one of the most famous features of this city are its triple deckers. These are three-story apartment buildings with their own unique style — tall, narrow and long, with Victorian influences.</p>
<p>What you might not know about these buildings is that the City of <?php echo $row['country']; ?> is making a huge push to make sure that the triple deckers are remodeled and preserved. To that end, they’ve created the <a href="https://www.<?php echo $row['country']; ?>.gov/departments/neighborhood-development" target="_blank" rel="noopener noreferrer">3D program</a> that helps owner-occupants accomplish this. Let’s take a look at the 3D and what it means for builders and contractors when remodeling a <?php echo $row['country']; ?> triple decker.</p>
<p><span id="more-948"></span></p>
<h3><strong>What is the 3D?</strong></h3>
<p>The <a href="http://dnd.cityof<?php echo $row['country']; ?>.gov/#page/3D_Help" target="_blank" rel="noopener noreferrer">3D is a loan program</a> that lets owners of triple deckers make repairs and upgrades as needed. It starts with an interest-free maximum $30,000 loan. Then, there are a few tools at the owner’s disposal:</p>
<ul>
<li>The owner will have the final say among contractors, but the 3D program can help him or her choose a contractor.</li>
<li>Throughout the construction process, work quality is monitored through inspections.</li>
<li>A final inspection ensures the work quality is up to standards once the project is complete.</li>
</ul>
<p>Of course, not all projects qualify for this assistance, so let’s look at which projects are and are not eligible.</p>
<h3><strong>Remodeling a <?php echo $row['country']; ?> Triple Decker: What is Eligible?</strong></h3>
<p>When it comes to the interior, most projects that you can imagine are approved. This includes things like systems upgrades — heating, electrical upgrades, plumbing, weatherization, and more. The loan can also be used to make upgrades all around the building, including the expensive rooms like the <a href="<?php echo $row['url']; ?>/winning-space-the-urban-kitchen-redefined/" target="_blank" rel="noopener noreferrer">kitchen</a> and <a href="<?php echo $row['url']; ?>/banish-boring-take-your-boston-bathroom-to-new-heights/" target="_blank" rel="noopener noreferrer">bathroom</a>.</p>
<p>On the exterior, the loan can help pay for siding and paint, windows, roofing, masonry and porch repairs. Of course, not all approved projects are listed, so you’ll need to check with the <a href="https://www.<?php echo $row['country']; ?>.gov/departments/neighborhood-development/get-home-repair-loan-your-triple-decker" target="_blank" rel="noopener noreferrer"><?php echo $row['country']; ?> Home Center</a> about your particular project.</p>
<p>There are a few things that are listed as ineligible for assistance. This includes purchasing new appliances, upgrades that would be considered luxury grade (granite countertops over laminate, for instance), landscaping, basement finishing, driveway repairs and more. View the full list of eligibility requirements by <a href="https://www.<?php echo $row['country']; ?>.gov/departments/neighborhood-development" target="_blank" rel="noopener noreferrer">clicking here</a>.</p>
<h3><strong>Who is Eligible for Funds?</strong></h3>
<p>If you’d like to advise a potential client that is remodeling a <?php echo $row['country']; ?> triple decker about this program, then there are two main qualifications that you’ll need to tell them about: <strong>First</strong>, the owner must live on the property (as an owner-occupant).</p>
<p><strong>Second</strong>, in order to qualify for assistance, the owner needs to have a total household income of below 120% of the U.S. Department of Housing and Urban Development’s listed median income for the area. There is a caveat to this, which is that if the owner makes between 100% and 120% of the median income set forth by HUD, then they must provide equal matching funds of their own to match the loan given by the 3D program. At the 100% median income level and lower, there is no need for the owner to provide matching funds.</p>
<h3><strong>Remodeling Isn’t the Only Thing the 3D Program Offers</strong></h3>
<p>This program has a lot of other benefits besides the loan for renovations. There is also a membership option that gives discounts at local hardware stores plus free <a href="http://dnd.cityof<?php echo $row['country']; ?>.gov/#page/classes" target="_blank" rel="noopener noreferrer">classes</a> about repairing and maintaining these homes as well as how to be a landlord.</p>
<p>For potential homeowners, the 3D program has what is called 3D Advantage, which is a down payment assistance program that pays up to $20,000 of the new buyer’s down payment.</p>
<p>Because of this program, more and more people are remodeling <?php echo $row['country']; ?> triple deckers, which is not only a great prospect for your business, but also an important way to preserve history.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/">[Infographic] Top 4 New England Home Design Trends</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/knowing-the-3d-when-remodeling-a-boston-triple-decker/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
