...
<!-- Mirrored from <?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:54 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Trendy deck design ideas to inspire your deck remodel. From rich colors to ideas to maximize shad and comfort, these trends are perfect for a <?php echo $row['country']; ?> deck." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="6 Deck Design Trends to try this Summer - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Trendy deck design ideas to inspire your deck remodel. From rich colors to ideas to maximize shad and comfort, these trends are perfect for a <?php echo $row['country']; ?> deck." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2019-07-16T13:00:31+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:56+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"6 Deck Design Trends to try this Summer","datePublished":"2019-07-16T13:00:31+00:00","dateModified":"2023-09-11T13:46:56+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/"},"wordCount":787,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Building Supplier","Deck","deck design","Design Trends","Home Improvement Contractor","Lumber and Building Materials","Remodeler"],"articleSection":["Building Trends","Contractor","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/","url":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/","name":"6 Deck Design Trends to try this Summer - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png","datePublished":"2019-07-16T13:00:31+00:00","dateModified":"2023-09-11T13:46:56+00:00","description":"Trendy deck design ideas to inspire your deck remodel. From rich colors to ideas to maximize shad and comfort, these trends are perfect for a <?php echo $row['country']; ?> deck.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png","width":1280,"height":859,"caption":"deck design trends"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"6 Deck Design Trends to try this Summer"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>6 Deck Design Trends to try this Summer - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2548" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2548' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F6-deck-design-trends-to-try-this-summer%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F6-deck-design-trends-to-try-this-summer%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2548 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">6 Deck Design Trends to try this Summer</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Summertime means time spent out on the <a href="<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/">deck</a>—and time thinking about how to <a href="<?php echo $row['url']; ?>/mix-composite-and-pressure-treated-wood-for-deck-remodel/">upgrade that deck</a> to turn it into an even nicer place to spend sunny afternoons! If you’re thinking about making some improvements to your deck, then you’re probably wondering what is trendy among deck design ideas right now. Here are a few of the latest trends to help get you inspired!</p>
<h3><strong>1. Rich Colors</strong></h3>
<p>Dark, bold shades are definitely in when it comes to decking. This means avoiding light, bright colors or lighter natural wood shades like pine in favor of darker, richer wood colors like mahogany—at least for the decking boards, not necessarily for the rest of the deck. If you’re looking to paint the deck or install colored composites, browns are a good choice, and they give you a whole range of shades to play with, from rusty red-browns to chocolate shades or even darker hues.</p>
<p>Of course, this doesn’t mean that you need to avoid light colors entirely! To match your home or to give the deck a beautiful two-toned look, you can always keep the decking boards themselves dark and go with light colors for posts and railing.</p>
<h3><strong>2. Get Creative with Lighting</strong></h3>
<p><img fetchpriority="high" decoding="async" class="alignright wp-image-2551 size-large" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-lighting-stair-riser-light-gravel-path-spiced-rum-fascia-image-gallery-TREX-600x376.jpg" alt="" width="600" height="376"></p>
<p>Lighting never used to be a big feature in deck design, but nowadays, with LED lights, there are so many ways to light up your deck at night. One thought is to attach lights to posts and uprights. However, nowadays, you can also find LED lights designed to fit in post caps as well as small lights to fit beneath steps, which not only look beautiful at night, but make it much easer to climb those steps in the dark! To see some of the options in action, check out&nbsp;<a href="https://dealer.trex.com/products/trex-outdoor-lighting/deck-lighting/?utm_id=001j000000KnsDYAAZ&amp;max_width=1050">Trex’s line of outdoor lighting</a>&nbsp;designed specifically for decks.</p>
<h3><strong>3. The Minimalist Look</strong></h3>
<p>One popular trend right now is minimalism. For decks, this means going light on the décor. Make spaces comfortable with simple seating and cozy throw pillows but forego lots of extras like planters and other décor. Just keep it to a few choice pieces to achieve that clean-swept minimalist look!</p>
<p>Railing choices can also help you create that minimalist style. Glass railings give you a smooth, sleek look that doesn’t obstruct the view, and wire railings are another popular choice for modern minimalism.</p>
<h3><strong>4. Try Unconventional Patterns</strong></h3>
<p>When most people think of decking boards, they think of the typical single-direction layout. In other words, when all the decking boards point in the same direction. But, there are lots of other ways to design a deck so that you can have some freedom to play around with patterns. If your deck has more than one level, or if there are obvious sections to it, you can always build a sense of geometry by blocking out those areas with decking boards pointing in different directions. Boards at diagonal angles can create a sense of length, and things like decking boards in herringbone patterns can give a deck a beautiful upscale look.</p>
<h3><strong>5. Add Shrubbery to Your Deck</strong></h3>
<p>There are all kinds of shrubs that do well in planters—things like azaleas and especially boxwoods. A few planters with these shrubs will certainly add some greenery to your deck, and what’s more, they can even add some shape. Especially with easy-to-prune shrubs like the boxwood. These can be clipped into cubes, fluffy green balls or whatever other fanciful shape you’d like to decorate with.</p>
<p><img decoding="async" class="aligncenter wp-image-2549 size-large" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/6-deck-design-trends-400x600.png" alt="6 deck design trends" width="400" height="600"></p>
<h3><strong>6. Maximize Shade, Privacy and Comfort</strong></h3>
<p>One of the biggest emerging trends in deck design comes from homeowners’ need to build on things like privacy and comfort. This means that shaded decks are becoming much more popular—either roofed or covered by an awning so that they stay comfortable on hot, sunny days.</p>
<p>Deck <a href="<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/">enclosures</a> are quite popular, too, though these can take many forms. For privacy, latticework is one of the top choices. And, it doesn’t have to be traditional latticework, either! Shop around, and you’ll find lattice or screening in a variety of pretty patterns. The great thing about latticework is that while it gives you privacy, it also doesn’t obscure the view completely. More than that, it lets the breeze in!</p>
<p>If privacy isn’t a concern, then a screened deck may be the way to go. This lets you enjoy both the view and the breeze, but it keeps pests like mosquitoes away.</p>
<p>These are some of the current trends in deck design, but if you’re looking to make an upgrade, there’s lots more that you can do. Check out some of our <a href="<?php echo $row['url']; ?>/builder/" target="_blank" rel="noopener noreferrer">suppliers</a> for even more great ideas!</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-1024x687.png" class="attachment-large size-large wp-post-image" alt="air sealing" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/">6 Strategies for Air Sealing in New Construction and Retrofits</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/6-deck-design-trends-to-try-this-summer/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
