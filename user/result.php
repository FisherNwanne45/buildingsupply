                ...
                <main class="wp-block-group alignfull is-layout-constrained wp-block-group-is-layout-constrained">
                    <div
                        ...
                        <div
                            ...
                            <div class="wp-block-cover alignfull is-light" style="min-height:47vh"><span
                                    aria-hidden="true"
...
if (!isset($_POST['Submit'])) { 
    ...
    if ($num > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div id="true" style="width: 100%; max-width: 1200px; padding: 20px; background: #f9f9f9; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0,0,0,0.2); margin-bottom: 20px;">
                 <img src="../wp-content/uploads/2023/03/nebs-logo-300x79.png" id="logos" alt="Logo"
                            style="width: 100px; height: auto;">
            
            <h5 style="text-align: center; color: #333;">Payment Status: '.$status.'</h5>
                <p style="text-align: center; font-size: 1rem;">Find the details of payment for your service below</p>
                 
                
                <div style="display: flex; align-items: center; gap: 20px;">
                    <div style="flex-shrink: 0;">
                        <img src="img/'.$image.'" alt="QR Code" style="width: 100px; border-radius: 8px;">
                    </div>
                    <div style="flex-grow: 1;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            <strong>Payment Amount:</strong> <span>'.$amt.'</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            <strong>Currency Type:</strong> <span>'.$rate.'</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                            <strong>Wallet Address:</strong> <span>'.$rank.'</span>
                        </div>
                    </div>
                </div>
                <hr style="margin: 20px 0;">
                
                <h5 style="color: #666; margin-bottom: 10px;">Payment Information</h5>
                <div style="display: flex; flex-wrap: wrap;">
                    <div style="width: 50%; padding: 5px;">
                        <strong>Invoice Number:</strong> '.$cid.'
                    </div>
                    <div style="width: 50%; padding: 5px;">
                ...
                <h5 style="color: #666; margin-bottom: 10px;">Repayment Information</h5>
                <div style="display: flex; flex-wrap: wrap;">
                    <div style="width: 50%; padding: 5px;">
                        <strong>Service:</strong> '.$dur.'
                    </div>
                    <div style="width: 50%; padding: 5px;">
                        <strong>Loan Status:</strong> '.$status.'
                    </div>
                </div>

                <hr style="margin: 20px 0;">

                <h5 style="color: #666; margin-bottom: 10px;">Instructions</h5>
                <p>'.$remark.'</p>
            </div>';
        }
        ...
        echo "<div style='text-align: center; margin-top: 20px;'><h4>No Results Found</h4><a href='../contact/payment.php'>&#x1F50D; Try a New Search</a></div>";
    }
}
?>
                    ...
                    <script>
                    function printDiv() {
                        var printContents = document.getElementById("true").innerHTML;
