...
<!-- Mirrored from <?php echo $row['url']; ?>/credit-application/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:06:42 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Credit Application - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Credit Application <?php echo $row['name']; ?>  offers a complete line of quality building material products for your construction project. Maximize our services when you open a <?php echo $row['name']; ?>  credit account to make it easier for you to get what you need and get right back to work. Fill out your Credit Application &amp; Sales…" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:modified_time" content="2024-09-13T18:54:38+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2023/06/credit-application-banner.jpg" />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@NEBS_<?php echo $row['country']; ?>" />
	<meta name="twitter:label1" content="Est. reading time" />
	<meta name="twitter:data1" content="1 minute" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/credit-application/","url":"<?php echo $row['url']; ?>/credit-application/","name":"Credit Application - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/credit-application/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/credit-application/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner.jpg","datePublished":"2023-03-15T20:51:08+00:00","dateModified":"2024-09-13T18:54:38+00:00","inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/credit-application/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/credit-application/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner.jpg","width":2560,"height":800},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Credit Application - <?php echo $row['name']; ?> </title>
...
.wp-container-core-navigation-layout-1.wp-container-core-navigation-layout-1{flex-wrap:nowrap;}.wp-container-core-group-layout-1.wp-container-core-group-layout-1{flex-wrap:nowrap;justify-content:flex-start;}.wp-container-core-group-layout-2.wp-container-core-group-layout-2{flex-wrap:nowrap;justify-content:space-between;}.wp-container-core-group-layout-5.wp-container-core-group-layout-5{flex-direction:column;align-items:flex-start;}.wp-container-core-group-layout-7.wp-container-core-group-layout-7 > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width:65.3%;margin-left:0 !important;margin-right:auto !important;}.wp-container-core-group-layout-7.wp-container-core-group-layout-7 > .alignwide{max-width:65.3%;}.wp-container-core-group-layout-7.wp-container-core-group-layout-7 .alignfull{max-width:none;}.wp-container-core-columns-layout-1.wp-container-core-columns-layout-1{flex-wrap:nowrap;}.wp-container-core-navigation-layout-2.wp-container-core-navigation-layout-2{flex-direction:column;align-items:flex-start;}.wp-container-core-navigation-layout-3.wp-container-core-navigation-layout-3{flex-direction:column;align-items:flex-start;}.wp-container-core-navigation-layout-4.wp-container-core-navigation-layout-4{flex-direction:column;align-items:flex-start;}.wp-container-core-columns-layout-2.wp-container-core-columns-layout-2{flex-wrap:nowrap;}.wp-container-core-group-layout-11.wp-container-core-group-layout-11{flex-wrap:nowrap;justify-content:space-between;}
</style>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/43.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index4170.php?p=43' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embeda2da.json?url=<?php echo $row['url']; ?>%2Fcredit-application%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed48c4?url=<?php echo $row['url']; ?>%2Fcredit-application%2F&amp;format=xml" />
...
<body class="page-template-default page page-id-43 wp-custom-logo wp-embed-responsive without-announcement">
...
<div class="wp-block-cover alignfull is-light" style="min-height:47vh"><span aria-hidden="true" class="wp-block-cover__background has-transparent-background-color has-background-dim-0 has-background-dim"></span><img fetchpriority="high" decoding="async" width="2560" height="800" class="wp-block-cover__image-background wp-image-3756" alt="" src="../wp-content/uploads/2023/06/credit-application-banner.jpg" data-object-fit="cover" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner-768x240.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner-1024x320.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner-1536x480.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/credit-application-banner-2048x640.jpg 2048w" sizes="(max-width: 2560px) 100vw, 2560px" /><div class="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">
...
<h1 class="wp-block-heading alignwide has-primary-color has-text-color has-h-2-font-size">Credit Application</h1>



<p class="has-primary-color has-text-color has-h-3-font-size"><strong><?php echo $row['name']; ?>  offers a complete line of quality building material products for your construction project.</strong></p>
</div>
</div>



<div class="wp-block-group alignwide pattern-section-intro is-content-justification-left is-layout-constrained wp-container-core-group-layout-7 wp-block-group-is-layout-constrained">
<p>Maximize our services when you open a <?php echo $row['name']; ?>  credit account to make it easier for you to get what you need and get right back to work.</p>



<p>Fill out your Credit Application &amp; Sales Agreement linked below, print, sign, then email it to our Credit Manager for review.</p>



<div class="wp-block-buttons alignwide is-layout-flex wp-block-buttons-is-layout-flex">
<div class="wp-block-button is-style-bg-primary"><a class="wp-block-button__link wp-element-button" href="mailto:<?php echo $row['email']; ?>">Email Credit Manager</a></div>



<div class="wp-block-button is-style-bg-dark"><a class="wp-block-button__link wp-element-button" href="../wp-content/uploads/2023/06/NEBS-Credit-Application-and-TCs-6.22.23.pdf" target="_blank" rel="noreferrer noopener">Download Credit Application</a></div>
</div>
</div>
</div>
</main>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/credit-application/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/credit-application/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:06:46 GMT -->
</html>
