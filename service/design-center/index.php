...
<html lang="en-US">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/service/design-center/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:05:31 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <meta property="og:title" content="Design Center - <?php echo $row['name']; ?> " />
        <meta property="og:description"
            content="Design Center Let your design vision come true. Welcome to our design center, where we showcase a wide variety of options for creating the perfect home. We specialize in bathrooms, kitchens, decks, windows, and doors, all designed to enhance your living space and elevate your lifestyle.&nbsp; At our design center, our goal is to provide…" />
        <meta property="og:url" content="index.php" />
        <meta property="og:site_name" content="<?php echo $row['name']; ?> " />
        <meta property="article:publisher"
            content="https://www.facebook.com" />
        <meta property="article:modified_time" content="2024-04-02T17:09:43+00:00" />
        <meta property="og:image" content="../../wp-content/uploads/2023/06/design-center-banner2.jpg" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>/service/design-center/",
                "url": "<?php echo $row['url']; ?>/service/design-center/",
                "name": "Design Center - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/service/design-center/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/service/design-center/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2.jpg",
                "datePublished": "2023-03-15T20:57:44+00:00",
                "dateModified": "2024-04-02T17:09:43+00:00",
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>/service/design-center/"]
                }]
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/service/design-center/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2.jpg",
                "width": 2560,
                "height": 804
            }, {
                "@type": "WebSite",
        ...
        <title>Design Center - <?php echo $row['name']; ?> </title>
        ...
        <link rel='stylesheet' id='wp-block-gallery-css'
            href='../../wp-includes/blocks/gallery/style.min75e4.css?ver=6.4.5' media='all' />
        ...
        <link rel='stylesheet' id='blockshoon-basic-carousel-styles-css'
            href='../../wp-content/themes/blockshoon/blocks/carousels/build/swiper.basicbbff.css?ver=f1d8160a6ff55ab79802'
            media='all' />
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/bs_service/61.json" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
        <link rel='shortlink' href='../../index094d.php?p=61' />
        <link rel="alternate" type="application/json+oembed"
            href="../../wp-json/oembed/1.0/embed6a6a.json?url=<?php echo $row['url']; ?>%2Fservice%2Fdesign-center%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="../../wp-json/oembed/1.0/embed745e?url=<?php echo $row['url']; ?>%2Fservice%2Fdesign-center%2F&amp;format=xml" />
    ...
    <body
        class="bs_service-template-default single single-bs_service postid-61 wp-custom-logo wp-embed-responsive without-announcement">
        ...
        <div class="wp-site-blocks">
            <header class="site-header wp-block-template-part">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-site-logo"><a href="../../index.php" class="custom-logo-link"
                                rel="home"><img width="210" height="55"
                                    src="../../wp-content/uploads/2023/03/nebs-logo.png" class="custom-logo"
                                    alt="<?php echo $row['name']; ?> " decoding="async"
                                ...
                                <ul
                                    ...
                                    <li data-wp-context="{ &quot;core&quot;: { &quot;navigation&quot;: { &quot;submenuOpenedBy&quot;: {}, &quot;type&quot;: &quot;submenu&quot; } } }"
                                        ...
                                        <button data-wp-bind--aria-expanded="selectors.core.navigation.isMenuOpen"
                                            ...
                                            class="wp-block-navigation-item__content wp-block-navigation-submenu__toggle current-menu-ancestor"
                                            aria-expanded="false"><span
                                        ...
                                        <ul data-wp-on--focus="actions.core.navigation.openMenuOnFocus"
                                            ...
                                            <li
                                                ...
                                                <a class="wp-block-navigation-item__content" href="index.php"
                                                    aria-current="page"><span
                                                        class="wp-block-navigation-item__label">Design Center</span></a>
                                            </li>
                                            <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                                    class="wp-block-navigation-item__content"
                                                    href="../estimating/index.php"><span
            ...
            <main
                class="wp-block-group alignfull single-service-content is-layout-constrained wp-block-group-is-layout-constrained">
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-cover alignfull is-light" style="min-height:47vh"><span aria-hidden="true"
                                ...
                                fetchpriority="high" decoding="async" width="2560" height="804"
                                class="wp-block-cover__image-background wp-image-3631" alt=""
                                src="../../wp-content/uploads/2023/06/design-center-banner2.jpg"
                                style="object-position:50% 100%" data-object-fit="cover" data-object-position="50% 100%"
                                srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2-768x241.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2-1024x322.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2-1536x482.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-banner2-2048x643.jpg 2048w"
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size"><strong>Let your design vision
                                    come true.</strong></p>
                            ...
                            <p class="has-medium-font-size">Welcome to our design center, where we showcase a wide
                                variety of options for creating the perfect home. We specialize in bathrooms, kitchens,
                                decks, windows, and doors, all designed to enhance your living space and elevate your
                                lifestyle.&nbsp;</p>



                            <p class="has-medium-font-size">At our design center, our goal is to provide you with the
                                highest quality products and services, paired with exceptional customer service. We take
                                the time to understand your unique needs and preferences, so we can help you create the
                                perfect space for your home. Come visit us today and see why we’re the leading choice
                                for home design and renovation.</p>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignwide carousel-basic swiper pattern-carousel-basic is-layout-flow wp-block-group-is-layout-flow">
                        <figure
                            class="wp-block-gallery alignwide has-nested-images columns-1 is-cropped swiper-wrapper wp-block-gallery-4 is-layout-flex wp-block-gallery-is-layout-flex">
                            <figure class="wp-block-image size-full swiper-slide"><img decoding="async" width="1200"
                                    height="537" src="../../wp-content/uploads/2023/10/nebs-design-center.jpg" alt=""
                                    class="wp-image-3873"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/nebs-design-center.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/nebs-design-center-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/nebs-design-center-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Design Center</figcaption>
                            </figure>



                            <figure class="wp-block-image size-full swiper-slide"><img decoding="async" width="1200"
                                    height="537" src="../../wp-content/uploads/2023/10/design-center-bath.jpg" alt=""
                                    class="wp-image-3877"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-bath.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-bath-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-bath-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Bath</figcaption>
                            </figure>



                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-cabinets.jpg" alt=""
                                    class="wp-image-3867"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-cabinets.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-cabinets-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-cabinets-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Cabinets</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-deck-railing.jpg" alt=""
                                    class="wp-image-3879"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-deck-railing.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-deck-railing-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-deck-railing-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Decking</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-decks.jpg" alt=""
                                    class="wp-image-3878"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-decks.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-decks-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-decks-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Decks</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-doors-hardware.jpg" alt=""
                                    class="wp-image-3874"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-doors-hardware.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-doors-hardware-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-doors-hardware-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Doors &#8211; Hardware</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-hardware.jpg" alt=""
                                    class="wp-image-3872"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-hardware.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-hardware-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-hardware-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Hardware</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-kitchen-cabinets.jpg" alt=""
                                    class="wp-image-3870"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-kitchen-cabinets.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-kitchen-cabinets-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-kitchen-cabinets-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Kitchen Cabinets</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/nebs-kitchen-design-services.jpg" alt=""
                                    class="wp-image-3868"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/nebs-kitchen-design-services.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/nebs-kitchen-design-services-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/nebs-kitchen-design-services-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Kitchen Design Services</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-kitchen-design.jpg" alt=""
                                    class="wp-image-3869"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-kitchen-design.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-kitchen-design-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-kitchen-design-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Kitchen Design</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-millwork.jpg" alt=""
                                    class="wp-image-3871"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-millwork.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-millwork-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-millwork-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Millwork</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-outdoor-kitchen.jpg" alt=""
                                    class="wp-image-3876"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-outdoor-kitchen.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-outdoor-kitchen-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-outdoor-kitchen-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Outdoor Kitchen</figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1200" height="537"
                                    src="../../wp-content/uploads/2023/10/design-center-windows.jpg" alt=""
                                    class="wp-image-3866"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-windows.jpg 1200w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-windows-768x344.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/10/design-center-windows-1024x458.jpg 1024w"
                                    sizes="(max-width: 1200px) 100vw, 1200px" />
                                <figcaption class="wp-element-caption">Windows</figcaption>
                            </figure>
                        </figure>



                        <div class="nav-carousel nav-basic-carousel" role="group"
                            aria-label="Design Center gallery controls">
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-flow wp-block-group-is-layout-flow">
                        <h2 class="wp-block-heading alignwide has-primary-color has-text-color has-h-3-font-size"><a
                                href="../../product/windows-skylights-roof-hatches/index.php">Window &amp; Doors</a>
                        </h2>



                        <p class="alignwide has-text-align-wide has-medium-font-size">Our selection of windows and doors
                            is unmatched in quality and performance. Whether you’re looking for energy-efficient options
                            or simply want to add some style to your home’s exterior, we’ve got you covered. We offer a
                            wide variety of sizes, shapes, and colors so that you can find the perfect fit for your
                            home.</p>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-2-col-imgs is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652" src="../../wp-content/uploads/2023/06/Design-Center-Window-Doors-1.jpg"
                                    alt="" class="wp-image-3619"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/Design-Center-Window-Doors-1.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Design-Center-Window-Doors-1-768x578.jpg 768w"
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652" src="../../wp-content/uploads/2023/06/Design-Center-Window-Door-2.jpg"
                                    alt="" class="wp-image-3620"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/Design-Center-Window-Door-2.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Design-Center-Window-Door-2-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-flow wp-block-group-is-layout-flow">
                        <h2 class="wp-block-heading alignwide has-primary-color has-text-color has-h-3-font-size"><a
                                href="../../product/decking-composite-railings/index.php">Decks </a></h2>



                        <p class="alignwide has-text-align-wide has-medium-font-size">If you’re looking to expand your
                            living space, our decking partners offer a perfect blend of elegance and functionality. With
                            a wide range of styles and materials to choose from, our expert team can help you design a
                            deck that reflects your personality and meets all your outdoor living needs.&nbsp;</p>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-2-col-imgs is-layout-flex wp-container-core-columns-layout-2 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652" src="../../wp-content/uploads/2023/04/design-center-deck-railings.jpg"
                                    alt="" class="wp-image-3243"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/design-center-deck-railings.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/design-center-deck-railings-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="708"
                                    height="533"
                                    src="../../wp-content/uploads/2023/04/design-center-deck-railings-2.jpg" alt=""
                                    class="wp-image-3244" /></figure>
                        </div>
                    </div>



                    <hr class="wp-block-separator alignwide has-alpha-channel-opacity" style="margin-top:0" />
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-flow wp-block-group-is-layout-flow">
                        <h2 class="wp-block-heading alignwide has-primary-color has-text-color has-h-3-font-size"><a
                                href="../../product/kitchens/index.php">Kitchen &amp; Bath Design Team</a></h2>



                        <p class="alignwide has-text-align-wide has-medium-font-size">The kitchen is the heart of any
                            home. Our design center offers a wide variety of options to help you create the perfect
                            space for cooking, entertaining, and enjoying time with family and friends. From cabinets
                            and countertops to appliances and lighting, we have everything you need to make your dream
                            kitchen a reality.</p>



                        <p class="has-medium-font-size">When it comes to creating your dream bathroom, we offer a full
                            range of styles and designs, from clean and modern to classic and traditional. Our expert
                            team can help you select everything from tiles to fixtures, ensuring that your bathroom is
                            not only beautiful but functional as well.</p>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-2-col-imgs is-layout-flex wp-container-core-columns-layout-3 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="598"
                                    height="450" src="../../wp-content/uploads/2023/06/Kitchen-Bath-Design-Team-1.jpg"
                                    alt="" class="wp-image-3621" /></figure>
                        </div>



                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="640"
                                    height="481" src="../../wp-content/uploads/2023/06/Kitchen-Bath-Design-Team-2.jpg"
                                    alt="" class="wp-image-3622" /></figure>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-flow wp-block-group-is-layout-flow">
                        <h2 class="wp-block-heading alignwide has-primary-color has-text-color has-h-3-font-size"><a
                                href="../../product/millwork/index.php">Millwork</a></h2>



                        <p class="alignwide has-text-align-wide has-medium-font-size">Transform your space with timeless
                            elegance and impeccable craftsmanship. Discover the finest trim and interior solutions at
                            <?php echo $row['name']; ?> &#8217;s Design Center, where innovation meets tradition for a
                            captivating home experience.</p>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-2-col-imgs is-layout-flex wp-container-core-columns-layout-4 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652" src="../../wp-content/uploads/2023/06/design-center-trim-1.jpg" alt=""
                                    class="wp-image-3624"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-trim-1.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-trim-1-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full is-resized"><img loading="lazy" decoding="async"
                                    width="533" height="401"
                                    src="../../wp-content/uploads/2023/06/design-center-trim-2.jpg" alt=""
                                    class="wp-image-3625" style="width:593px;height:446px" /></figure>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-flow wp-block-group-is-layout-flow">
                        <h2 class="wp-block-heading alignwide has-primary-color has-text-color has-h-3-font-size"><a
                                href="../../product/kitchens/index.php">Kitchen Hardware</a></h2>



                        <p class="alignwide has-text-align-wide has-medium-font-size">Elevate your kitchen design to new
                            heights with the exceptional range of kitchen hardware at <?php echo $row['name']; ?>
                            &#8217;s Design Center. Discover a world of possibilities with our exquisite selection of
                            knobs, pulls, and hinges, designed to add a touch of elegance and functionality to your
                            dream culinary space.</p>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-2-col-imgs is-layout-flex wp-container-core-columns-layout-5 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652"
                                    src="../../wp-content/uploads/2023/06/design-center-kitchen-hardware-1.jpg" alt=""
                                    class="wp-image-3627"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-kitchen-hardware-1.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-kitchen-hardware-1-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652"
                                    src="../../wp-content/uploads/2023/06/design-center-kitchen-hardware-2.jpg" alt=""
                                    class="wp-image-3628"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-kitchen-hardware-2.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-kitchen-hardware-2-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-flow wp-block-group-is-layout-flow">
                        <h2 class="wp-block-heading alignwide has-primary-color has-text-color has-h-3-font-size"><a
                                href="../../product/roofing-product-category/index.php">Roofing and Siding</a></h2>



                        <p class="alignwide has-text-align-wide has-medium-font-size">Protect your home in style with
                            the superior roofing and siding solution from <?php echo $row['name']; ?> &#8217;s Design
                            Center. From durable and weather-resistant materials to stunning designs that enhance your
                            home&#8217;s curb appeal, our products are your gateway to a secure and visually captivating
                            exterior.</p>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-2-col-imgs is-layout-flex wp-container-core-columns-layout-6 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652" src="../../wp-content/uploads/2023/04/design-center-roofing-siding.jpg"
                                    alt="" class="wp-image-3245"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/design-center-roofing-siding.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/design-center-roofing-siding-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="867"
                                    height="652"
                                    src="../../wp-content/uploads/2023/06/design-center-roofing-siding-2-1.jpg" alt=""
                                    class="wp-image-3630"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-roofing-siding-2-1.jpg 867w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/design-center-roofing-siding-2-1-768x578.jpg 768w"
                                    sizes="(max-width: 867px) 100vw, 867px" /></figure>
                        </div>
                    </div>
                </div>
            ...
            <footer class="site-footer wp-block-template-part">
                <div
                    ...
                    <div
                        class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-7 wp-block-columns-is-layout-flex">
                        <div
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/service/design-center/" /><input type="hidden"
                                                    name="item_meta[25]" id="field_a913j" value=""
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-large force-right-edge"><img loading="lazy"
                                    decoding="async" width="1024" height="394"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            <figure class="wp-block-image size-full is-resized"><img loading="lazy" decoding="async"
                                    width="318" height="84" src="../../wp-content/uploads/2023/03/nebs-logo-white.png"
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on Facebook</span></a></li>
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on Linkedin</span></a></li>
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on Instagram</span></a></li>
                                ...
                                <li style="color: #ffffff; "
                                    ...
                                    <a rel=" noopener nofollow" target="_blank"
                                        ...
                                        class="wp-block-social-link-anchor"><svg width="24" height="24"
                                            ...
                                            <?php echo $row['name']; ?> on YouTube</span></a></li>
                            </ul>
                        </div>
                                ...
                                <ul class="wp-block-navigation__container  is-vertical wp-block-navigation">
                                    ...
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            ...
                                            href="../../portfolio/index.php"><span
                                                class="wp-block-navigation-item__label">Our Work</span></a></li>
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content" href="../delivery/index.php"><span
                                                class="wp-block-navigation-item__label">Delivery</span></a></li>
                                    <li class=" wp-block-navigation-item current-menu-item wp-block-navigation-link"><a
                                            ...
                                            aria-current="page"><span class="wp-block-navigation-item__label">Design
                                                Center</span></a></li>
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content"
                                            href="../estimating/index.php"><span
                ...
                <div
                    ...
                    <div
                        class="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-layout-17 wp-block-group-is-layout-flex">
        ...
        <script
            src="../../wp-content/themes/blockshoon/blocks/carousels/build/swiper.basic6c39.js?ver=eb868f2d179d693c13bf"
            id="blockshoon-basic-carousel-scripts-js"></script>
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/service/design-center/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:05:59 GMT -->
