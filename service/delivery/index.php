...
<html lang="en-US">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/service/delivery/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:05:08 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <meta property="og:title" content="Delivery - <?php echo $row['name']; ?> " />
        <meta property="og:description"
            content="Delivery Our fleet consists of boom trucks, moffett trucks, box and flatbed trucks to allow building materials to get delivered efficiently and in a timely manner. With a location in the heart of <?php echo $row['country']; ?>, our fleet and team can get your products to you quickly anywhere in the boston-metro area. <?php echo $row['name']; ?> has you covered with…" />
        ...
        <meta property="article:modified_time" content="2023-09-06T21:24:43+00:00" />
        <meta property="og:image" content="../../wp-content/uploads/2023/03/Picture-2-1-1.jpg" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>/service/delivery/",
                "url": "<?php echo $row['url']; ?>/service/delivery/",
                "name": "Delivery - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/service/delivery/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/service/delivery/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1.jpg",
                "datePublished": "2023-03-15T20:57:36+00:00",
                "dateModified": "2023-09-06T21:24:43+00:00",
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>/service/delivery/"]
                }]
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/service/delivery/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1.jpg",
                "width": 2560,
                "height": 752
            }, {
                "@type": "WebSite",
        ...
        <title>Delivery - <?php echo $row['name']; ?> </title>
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/bs_service/60.json" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
        <link rel='shortlink' href='../../index0721.php?p=60' />
        <link rel="alternate" type="application/json+oembed"
            href="../../wp-json/oembed/1.0/embed0b0a.json?url=<?php echo $row['url']; ?>%2Fservice%2Fdelivery%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="../../wp-json/oembed/1.0/embed734d?url=<?php echo $row['url']; ?>%2Fservice%2Fdelivery%2F&amp;format=xml" />
    ...
    <body
        class="bs_service-template-default single single-bs_service postid-60 wp-custom-logo wp-embed-responsive without-announcement">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-cover alignfull" style="min-height:50vh"><span aria-hidden="true"
                                ...
                                class="wp-block-cover__image-background wp-image-3844" alt=""
                                src="../../wp-content/uploads/2023/03/Picture-2-1-1.jpg" style="object-position:44% 50%"
                                data-object-fit="cover" data-object-position="44% 50%"
                                srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1-768x226.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1-1024x301.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1-1536x451.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/Picture-2-1-1-2048x602.jpg 2048w"
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size"><strong>Our fleet consists of
                                    boom trucks, moffett trucks, box and flatbed trucks to allow building materials to
                                    get delivered efficiently and in a timely manner.</strong></p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            ...
                            <figure class="wp-block-image size-full"><img decoding="async" width="900" height="515"
                                    src="../../wp-content/uploads/2023/08/nebs-delivery-1.jpg" alt=""
                                    class="wp-image-3833"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-delivery-1.jpg 900w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-delivery-1-768x439.jpg 768w"
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:33.34%">
                            <figure class="wp-block-image size-full"><img decoding="async" width="900" height="515"
                                    src="../../wp-content/uploads/2023/08/nebs-delivery-2.jpg" alt=""
                                    class="wp-image-3834"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-delivery-2.jpg 900w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-delivery-2-768x439.jpg 768w"
                                    sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        </div>
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                            ...
                            <figure class="wp-block-image size-full"><img loading="lazy" decoding="async" width="900"
                                    height="515" src="../../wp-content/uploads/2023/08/nebs-delivery-3.jpg" alt=""
                                    class="wp-image-3835"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-delivery-3.jpg 900w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/nebs-delivery-3-768x439.jpg 768w"
                                    sizes="(max-width: 900px) 100vw, 900px" /></figure>
                        </div>
                    </div>
                    ...
                    <figure class="wp-block-pullquote alignwide">
                        <blockquote>
                            <p>With a location in the heart of <?php echo $row['country']; ?>, our fleet and team can
                                get your products to you quickly anywhere in the boston-metro
                                area. <?php echo $row['name']; ?> has you covered with our smooth scheduling process,
                                experienced fleet drivers, delivery notifications, and fast in-store pick-up.</p>
                        </blockquote>
                    </figure>



                    <figure class="wp-block-image alignwide size-large"><img loading="lazy" decoding="async"
                            width="1024" height="441" src="../../wp-content/uploads/2023/03/delivery-1024x441.jpg"
                            alt="" class="wp-image-3842"
                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/03/delivery-1024x441.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/delivery-768x331.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/delivery.jpg 1200w"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    value="1b393115d0" /><input type="hidden" name="_wp_http_referer"
                                                    value="/service/delivery/" /><input type="hidden"
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/service/delivery/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:05:31 GMT -->
