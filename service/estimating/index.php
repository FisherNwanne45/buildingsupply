...
<html lang="en-US">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/service/estimating/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:05:59 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <meta property="og:title" content="Estimating - <?php echo $row['name']; ?> " />
        <meta property="og:description"
            content="Estimating Our team has years of experience estimating projects in the <?php echo $row['country']; ?> market. We know our material lists and take-offs will be accurate so you can be confident in your budget. Let our skilled estimators help you plan your next project and ensure you order the right amount of materials, to reduce both overhead and…" />
        ...
        <meta property="article:modified_time" content="2023-06-07T17:39:39+00:00" />
        <meta property="og:image" content="../../wp-content/uploads/2023/03/estimating-banner.jpg" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "<?php echo $row['url']; ?>/service/estimating/",
                "url": "<?php echo $row['url']; ?>/service/estimating/",
                "name": "Estimating - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/service/estimating/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/service/estimating/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner.jpg",
                "datePublished": "2023-03-15T20:57:55+00:00",
                "dateModified": "2023-06-07T17:39:39+00:00",
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["<?php echo $row['url']; ?>/service/estimating/"]
                }]
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/service/estimating/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner.jpg",
                "width": 2560,
                "height": 752
            }, {
                "@type": "WebSite",
        ...
        <title>Estimating - <?php echo $row['name']; ?> </title>
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/bs_service/62.json" />
        <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
        <link rel='shortlink' href='../../index5c36.php?p=62' />
        <link rel="alternate" type="application/json+oembed"
            href="../../wp-json/oembed/1.0/embed899d.json?url=<?php echo $row['url']; ?>%2Fservice%2Festimating%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="../../wp-json/oembed/1.0/embeda3b6?url=<?php echo $row['url']; ?>%2Fservice%2Festimating%2F&amp;format=xml" />
    ...
    <body
        class="bs_service-template-default single single-bs_service postid-62 wp-custom-logo wp-embed-responsive without-announcement">
        ...
        <div class="wp-site-blocks">
                                ...
                                <ul
                                    ...
                                    <li data-wp-context="{ &quot;core&quot;: { &quot;navigation&quot;: { &quot;submenuOpenedBy&quot;: {}, &quot;type&quot;: &quot;submenu&quot; } } }"
                                        ...
                                        <ul data-wp-on--focus="actions.core.navigation.openMenuOnFocus"
                                            ...
                                            <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                                    class="wp-block-navigation-item__content"
                                                    href="../design-center/index.php"><span
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-cover alignfull is-light" style="min-height:47vh"><span aria-hidden="true"
                                ...
                                class="wp-block-cover__image-background wp-image-3614" alt=""
                                src="../../wp-content/uploads/2023/03/estimating-banner.jpg" data-object-fit="cover"
                                srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner-768x226.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner-1024x301.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner-1536x451.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/03/estimating-banner-2048x602.jpg 2048w"
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size"><strong>Our team has years of
                                    experience estimating projects in the <?php echo $row['country']; ?>
                                    market.</strong></p>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-columns alignwide pattern-offset-img-columns justify-space-between is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column img-col is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:48%">
                            <figure class="wp-block-image size-full is-resized"><img decoding="async"
                                    src="../../wp-content/uploads/2023/03/estimating-sm.jpg" alt=""
                                    class="wp-image-3572" width="246" height="246" /></figure>



                            <figure class="wp-block-image size-full is-resized"><img decoding="async"
                                    src="../../wp-content/uploads/2023/03/estimating-lg.jpg" alt=""
                                    class="wp-image-3571" width="469" height="503" /></figure>
                        </div>



                        <div class="wp-block-column content-col is-layout-flow wp-block-column-is-layout-flow"
                            style="flex-basis:42.5%">
                            <p class="has-primary-color has-text-color has-x-large-font-size"
                                style="font-style:normal;font-weight:700">We know our material lists and take-offs will
                                be accurate so you can be confident in your budget.</p>



                            <p class="has-large-font-size">Let our skilled estimators help you plan your next project
                                and ensure you order the right amount of materials, to reduce both overhead and waste.
                                We use the latest estimating and engineering software for all manner of material
                                take-offs, including lumber, drywall, doors, windows, siding, roofing, hardware, and
                                kitchen and bath.</p>



                            <p class="has-red-color has-text-color has-h-5-font-size"
                                style="font-style:normal;font-weight:700;text-transform:uppercase">Experienced Team |
                                Detailed Take-offs | Value Designing</p>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignfull pattern-bg-highlight has-light-blue-background-color has-background is-content-justification-center is-layout-constrained wp-block-group-is-layout-constrained">
                        <div
                            class="wp-block-columns alignwide justify-space-between is-layout-flex wp-container-core-columns-layout-2 wp-block-columns-is-layout-flex">
                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:34%">
                                <h2 class="wp-block-heading has-primary-color has-text-color has-h-3-font-size">We offer
                                    estimating on materials including:</h2>
                            </div>
                            ...
                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:40%">
                                <ul class="has-primary-color has-text-color has-h-5-font-size"
                                    style="font-style:normal;font-weight:700">
                                    <li>Lumber and Millwork</li>
                                    ...
                                    <li>Exterior Building Materials and Hardware</li>



                                    <li>Roofing and Flooring</li>



                                    <li>Trusses and Wall Panels</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <h2 class="wp-block-heading has-text-align-center alignnarrow has-h-3-font-size">Interested in a
                            quote?</h2>



                        <p class="has-text-align-center alignnarrow has-large-font-size">Just let us know what you’re
                            looking for and we’ll let you know how we can help.</p>
                    </div>
            ...
            <footer class="site-footer wp-block-template-part">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    value="1b393115d0" /><input type="hidden" name="_wp_http_referer"
                                                    value="/service/estimating/" /><input type="hidden"
                ...
                <div
                    ...
                    <div
                        class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-4 wp-block-columns-is-layout-flex">
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                ...
                <div
                    ...
                    <div
                        class="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/service/estimating/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:06:05 GMT -->
