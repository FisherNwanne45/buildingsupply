...
<!-- Mirrored from <?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:14 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job -" />
	<meta property="og:description" content="There&#8217;s no doubt about it: Summer in <?php echo $row['country']; ?> can sizzle. However, it&#8217;s not just the temperatures that are hot around downtown. The multitude of construction projects &#8212; from the Seaport to Back Bay, from Fenway to Roxbury and from massive in scope to individual kitchen remodels &#8212; has us all hopping, trying to keep schedules…" />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-06-22T14:30:43+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:51:22+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2016/06/Build-in-boston-1-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job","datePublished":"2016-06-22T14:30:43+00:00","dateModified":"2023-09-11T13:51:22+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/"},"wordCount":713,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/Build-in-boston-1-1.jpg","keywords":["<?php echo $row['country']; ?>","Builder","Building","Building Supplier","Commercial Development","Developer","Downtown <?php echo $row['country']; ?> Residential Building","Lumber and Building Materials","Remodeler","Summer Building"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Construction Crew"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/","url":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/","name":"Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job -","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/Build-in-boston-1-1.jpg","datePublished":"2016-06-22T14:30:43+00:00","dateModified":"2023-09-11T13:51:22+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/Build-in-boston-1-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/Build-in-boston-1-1.jpg","width":560,"height":315},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job -</title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job Comments Feed" href="feed/index.php" />
<script>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/853.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index9fe1.php?p=853' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embede3eb.json?url=<?php echo $row['url']; ?>%2Fsimple-ways-to-stay-cool-on-the-job%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedbf49?url=<?php echo $row['url']; ?>%2Fsimple-ways-to-stay-cool-on-the-job%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-853 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2016-06-22T14:30:43-04:00">06.22.2016</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Too Hot To Build in <?php echo $row['country']; ?>? 5 Simple Ways to Stay Cool on the Job</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>There&#8217;s no doubt about it: Summer in <?php echo $row['country']; ?> can sizzle. However, it&#8217;s not just the temperatures that are hot around downtown. The multitude of <a href="../beantown-has-become-boom-town-for-developers/index.php">construction projects</a> &#8212; from the Seaport to Back Bay, from Fenway to Roxbury and from <a href="../<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/index.php">massive in scope</a> to individual <a href="../winning-space-the-urban-kitchen-redefined/index.php">kitchen remodels</a> &#8212; has us all hopping, trying to keep schedules under control, and trying to stay cool, both literally and figuratively.</p>
<p>Summer is, of course, the best time, for both work and play. Days are longer, but the heat itself can be a drain on human and mechanical well being, and you sometimes have to work harder to stay comfortable.</p>
<h3><strong>Start early, Quit Early</strong></h3>
<p>Although it&#8217;s not always possible to compensate by adjusting work hours, one of the best ways to get a full day&#8217;s work done is to start earlier. Benefits range from beating the traffic to beating the heat, and that&#8217;s no small feat in downtown <?php echo $row['country']; ?>. Start early in the day &#8212; after all, it gets light much earlier in the summer &#8212; and knock off when the sun reaches its zenith in the early afternoon. It&#8217;s a good practice for both the crew and the machinery.</p>
<p>Here are 5 additional tips: None of these are new idea but they are just as important as it is to prepare for winter&#8217;s ice and snow.</p>
<ol>
<li><strong>Think hydration: </strong>Bodies need water to function at peak performance levels. Forego the fancy energy drinks and the sugary sodas. Keep buckets of cool, clear water available on the job. Drink it, of course, at every opportunity. But you can also use a wet bandana tied around the head or draped over your neck and shoulders. Wipe your face and arms with cool water each time you take a break.</li>
<li><strong>Take breaks, seek shade: </strong>Whether you&#8217;re working with concrete or working with structural steel, materials and equipment are hotter and harder to handle. Accidents occur when workers get tired. Combat fatigue and stay alert by scheduling regular break times more often when it&#8217;s hot. Provide sunshades, when appropriate, for mechanized equipment and for work areas. Refresh your body with liquids and light snacks; they are the fuel that will allow you to meet those construction deadlines.</li>
<li><strong>Dress properly: </strong>It may seem logical to shed clothing during the heat of the day, but it&#8217;s actually better to keep your body covered. Wear lighter colors, if possible, to reflect some of those rays. Even if it&#8217;s only a psychological boost, lighter colors and natural fabrics tend to help you feel cooler. Whether you wear a uniform or not, investigate new varieties of self-wicking fabrics. Initial cost may be higher, but the benefits in terms of comfort are immense. Wear a hat, use sunblock, and protect your body not only from the sunburn, but from the effects of wind and from insects.</li>
<li><strong>Change your diet:</strong> Eat a healthy breakfast to jump start your day, but then go easy on food as temperatures climb. It&#8217;s better to eat several smaller snacks throughout the workday than to load up on carbs and &#8220;energy food&#8221; that tend to slow you down. Fresh fruit will keep you going in a healthy way; lighter fare can help counteract that need to nap! As odd as it may sound, spicy food may also help you feel cooler! Hot salsa and chips, spicy curry or Jamaican jerk chicken can be a good choice for a summer lunch!</li>
<li><strong>Know the signs of heat exhaustion:</strong> Feeling faint, dizzy or disoriented is not normal. If your skin is dry, and you stop sweating, be suspicious. If you recognize subtle signs in yourself or a coworker, get help immediately. Every downtown construction site should have a shaded area; don&#8217;t hesitate to call for help. Heat stroke can be life threatening, and the disorientation and associated hazards of not paying attention to warning signs can be catastrophic.</li>
</ol>
<p>And finally, if you need a break from the heat, we would love for you to stop by our air-conditioned showroom located right in the heart of downtown <?php echo $row['country']; ?>! Stop in and say hi over a nice cold glass of ice water!</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="560" height="315" src="../wp-content/uploads/2016/07/boston-Redevelopment-Authority-Working-With-1.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../learning-to-work-with-boston-redevelopment-authority/index.php">Charting a Course to <?php echo $row['country']; ?>&#8217;s Future: Learning to Work with the <?php echo $row['country']; ?> Redevelopment Authority</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/simple-ways-to-stay-cool-on-the-job/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/simple-ways-to-stay-cool-on-the-job/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:15 GMT -->
</html>
