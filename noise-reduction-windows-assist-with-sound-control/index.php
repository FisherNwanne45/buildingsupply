...
<!-- Mirrored from <?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:50 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Soundproofing is an important consideration in high-noise environments, and when it comes to windows, in order to get the most sound reduction for your money, you’ll need to consider the window’s STC rating. Duble paned windows with an STC rating around 27 could reduce sound transfer by as much as 40%," />
	<link rel="canonical" href="<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Soundproofing is an important consideration in high-noise environments, and when it comes to windows, in order to get the most sound reduction for your money, you’ll need to consider the window’s STC rating. Duble paned windows with an STC rating around 27 could reduce sound transfer by as much as 40%," />
	<meta property="og:url" content="<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-11-15T09:14:31+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:48:01+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo","datePublished":"2018-11-15T09:14:31+00:00","dateModified":"2023-09-11T13:48:01+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/"},"wordCount":662,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Building Supplier","Condo","Double Pane Windows","Downtown <?php echo $row['country']; ?> Residential Building","Energy Efficient","Lumber and Building Materials","Noise Reduction","Remodeler","STC windows","Window Design"],"articleSection":["Architect","<?php echo $row['country']; ?> Condo","Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer","Home Technology","Homeowner","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/","url":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/","name":"How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg","datePublished":"2018-11-15T09:14:31+00:00","dateModified":"2023-09-11T13:48:01+00:00","description":"Soundproofing is an important consideration in high-noise environments, and when it comes to windows, in order to get the most sound reduction for your money, you’ll need to consider the window’s STC rating. Duble paned windows with an STC rating around 27 could reduce sound transfer by as much as 40%,","breadcrumb":{"@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg","width":2048,"height":1601,"caption":"Integrity-Noise-Reducing-Windows"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2044" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2044' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fnoise-reduction-windows-assist-with-sound-control%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fnoise-reduction-windows-assist-with-sound-control%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2044 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>As more and more people flock to cities, interior noise reduction is becoming a major concern for both builders and buyers. In fact, the EPA now classifies noise as a type of pollution because it can have adverse effects on health, especially where stress and sleep quality are concerned. Anyone who lives near an airport or has a neighbor that likes to mow the yard first thing Saturday morning will agree! Soundproofing is definitely something to consider in <a href="<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/">high-noise environments</a>, and when it comes to windows, in order to get the most sound reduction for your money, you’ll need to consider the window’s STC rating. Let’s take a look at what this means, and how much difference it will make.</p>
<p><span id="more-2044"></span></p>
<h3>What is an STC Rating?</h3>
<p>The acronym “STC” stands for “sound transmission class.” Originally, this was a method that engineers used to measure sound transfer between <a href="<?php echo $row['url']; ?>/your-complete-guide-to-interior-house-trim-styles/">interior walls</a>, but over time, STC became the standard for measuring a window’s ability to reduce sound transfer. To choose windows with the best STC ratings, look for higher ratings, since higher numbers mean better sound reduction.</p>
<p>To give you an idea of how these ratings relate to sound reduction, the average single-pane window has a rating of between 18 and 20. Double paned windows can have an STC rating between 28 and 32, and windows with excellent sound reduction can have an STC of 40 or more. Windows with an STC between 45 and 50 will cut between 90% and 95% of exterior noise, earning them the “soundproof” classification.</p>
<h3>How Do Windows with High STC Ratings Work?</h3>
<p>In windows that have higher STC ratings, there are several design features that engineers use to help reduce noise transfer. Air space between the panes is one of these features. Windows with panes that are farther apart transfer less noise from the outside because the extra space makes it more difficult for&nbsp;<span class="scayt-misspell-word" data-scayt-word="soundwaves" data-wsc-lang="en_US">soundwaves</span>&nbsp;to travel through the window. In other words, windows with panes that are closer together are likely to transfer more sound.</p>
<p>Other design considerations that help increase a window’s STC rating are its thickness, particularly the thickness of the glass panes, and any sound-absorbing insulation weather stripping that may be used within the window frame or to seal gaps. In general, thicker, better insulated windows will offer less sound transfer and thus, higher STC ratings. If you want to learn more about the science behind soundproof window design, check out this&nbsp;<a href="https://marvin-architectural.co.uk/wp-content/uploads/2015/04/Sound-Reduction-Through-Window-Choices.pdf" target="_blank" rel="noopener noreferrer" data-cke-saved-href="https://marvin-architectural.co.uk/wp-content/uploads/2015/04/Sound-Reduction-Through-Window-Choices.pdf">slideshow from Marvin</a>.</p>
<p><img fetchpriority="high" decoding="async" class="wp-image-2046 size-large aligncenter" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/noise-reducing-windows-in-boston-400x600.png" alt="" width="400" height="600"></p>
<h3>Are High STC Windows Worth the Expense?</h3>
<p>Noise pollution is a big concern for buyers, particularly those who are shopping for condos in busy neighborhoods. This means that the more soundproofing a unit has, the more attractive with will be.</p>
<p>How do you decide how much soundproofing you’ll need? One way to settle on an appropriate STC rating for windows is to hire an acoustic professional to determine the STC rating of the condo’s walls. On average, a wall constructed with&nbsp;<span class="scayt-misspell-word" data-scayt-word="2x4s" data-wsc-lang="en_US">2x4s</span>&nbsp;and insulation in a typical stick-built structure will have an STC rating of 36. Going higher than this with your windows won’t offer more sound reduction since the walls will allow some transfer of sound.</p>
<p>And then there is the question of how much sound reduction you will see. If the building features single paned windows, an upgrade to double paned windows with an STC rating around 27 could reduce sound transfer by as much as 40%, which represents a dramatic sound reduction in high-noise environments. In general, upgrading windows by two STC points may not give you a noticeable difference in sound reduction, while upgrades of 10 points could reduce sound transfer by half.</p>
<p>Quiet interiors can be the deciding factor when it comes to home and condo sales in busy neighborhoods. To learn more about how <a href="<?php echo $row['url']; ?>/discover/" target="_blank" rel="noopener noreferrer"><?php echo $row['name']; ?> and Marvin windows</a> can help reduce sound in <?php echo $row['country']; ?>’s busiest neighborhoods, check out the video below!</p>
<p style="text-align: center;"><iframe src="https://www.youtube.com/embed/TmyxGNxp_Qw" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="683" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1024x683.jpg" class="attachment-large size-large wp-post-image" alt="3 Barriers Blocking <?php echo $row['country']; ?>&#039;s Housing Start Initiative" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg 2048w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/">3 Barriers Blocking <?php echo $row['country']; ?>&#8217;s Housing Start Initiative</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/noise-reduction-windows-assist-with-sound-control/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
