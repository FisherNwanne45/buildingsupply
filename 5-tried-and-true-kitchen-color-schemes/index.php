...
<!-- Mirrored from <?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:51 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="5 Tried and True Kitchen Color Schemes - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="There&#8217;s a lot to think about when you&#8217;re remodeling a kitchen: the layout, the appliances, what kind of cabinets you&#8217;ll choose — the list goes on and on. One thing that could get lost in the shuffle is the color scheme. You might have a clear idea of what colors you like, but it&#8217;s important…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-03-21T10:48:18+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:48:45+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2018/03/Kitchen-Color-Schemes.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/"},"author":{"name":"Jazmin","@id":"<?php echo $row['url']; ?>/#/schema/person/2a20a294791cefa5ea6e76266642121c"},"headline":"5 Tried and True Kitchen Color Schemes","datePublished":"2018-03-21T10:48:18+00:00","dateModified":"2023-09-11T13:48:45+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/"},"wordCount":679,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/Kitchen-Color-Schemes.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Homeowner","Condo","Downtown <?php echo $row['country']; ?> Residential Building","Home Design","Interior","Kitchen Cabinets","Kitchen Colors","Kitchen Design","Paint Colors","Remodeler","Triple Decker"],"articleSection":["<?php echo $row['country']; ?> Condo","Building Trends","Contractor","Homeowner","Kitchen Design","Remodeler","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/","url":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/","name":"5 Tried and True Kitchen Color Schemes - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/Kitchen-Color-Schemes.jpg","datePublished":"2018-03-21T10:48:18+00:00","dateModified":"2023-09-11T13:48:45+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/Kitchen-Color-Schemes.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/Kitchen-Color-Schemes.jpg","width":623,"height":414,"caption":"Kitchen Color Schemes"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/5-tried-and-true-kitchen-color-schemes/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"5 Tried and True Kitchen Color Schemes"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/2a20a294791cefa5ea6e76266642121c","name":"Jazmin","url":"<?php echo $row['url']; ?>/author/jazmin/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>5 Tried and True Kitchen Color Schemes - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1725" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1725' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F5-tried-and-true-kitchen-color-schemes%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F5-tried-and-true-kitchen-color-schemes%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1725 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2018-03-21T10:48:18-04:00">03.21.2018</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">5 Tried and True Kitchen Color Schemes</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>There&#8217;s a lot to think about when you&#8217;re remodeling a kitchen: the <a href="<?php echo $row['url']; ?>/from-small-to-spacious-kitchen-layout-ideas-for-every-home/">layout</a>, the appliances, what kind of <a href="<?php echo $row['url']; ?>/kitchen-cabinetry-semi-custom-cabinets-vs-stock-cabinets/">cabinets</a> you&#8217;ll choose — the list goes on and on. One thing that could get lost in the shuffle is the color scheme. You might have a clear idea of what colors you like, but it&#8217;s important to keep your color palette at the forefront of your planning. If you don&#8217;t, you could end up with a mish-mash of hues that looked nice&nbsp;on the showroom floor&nbsp;but don&#8217;t actually go well together in your home.</p>
<p><span id="more-1725"></span></p>
<p>Not sure where to begin? It can be intimidating to make a final decision on your kitchen&#8217;s color scheme, because it means you&#8217;re finally locked in to some design choices — possibly pretty expensive ones. Take a look at some of our favorite kitchen color combos to get inspired by looks that&nbsp;stand the test of time.</p>
<h2>5 Excellent&nbsp;Kitchen Color Ideas</h2>
<h3>1. White on White</h3>
<p>When you choose an all-white kitchen, you are choosing the cleanest possible look for your home. Painted white cabinets, a white tile backsplash and marble countertops are easy&nbsp;to&nbsp;pull together for an effortless, timeless look. For variety, you could choose stainless steel appliances instead of white ones and a light-toned wood floor instead of white tile.</p>
<h3>2. Gray and White</h3>
<p>Gray is&nbsp;<em>the</em>&nbsp;<a href="http://designingidea.com/kitchen-color-trends/" target="_blank" rel="noopener noreferrer">hot color</a> in home decor today, and it looks great on cabinets and&nbsp;walls. It&#8217;s generally pretty easy to mix and match gray and white elements — &nbsp;just be careful when blending stainless steel appliances with gray to make sure the tones work together. Two-tone cabinetry lets you have white upper cabinets and gray lower ones for an on-trend take on the look.</p>
<h3>3. Buttery Yellow</h3>
<p>Creamy yellow walls are&nbsp;a great way to make your kitchen <a href="https://www.thisoldhouse.com/ideas/editors-picks-our-favorite-yellow-kitchens" target="_blank" rel="noopener noreferrer">glow with warmth</a>. This color works well with white cabinets or with medium to dark wood tones like oak and walnut. If you&#8217;re feeling adventurous, yellow cabinets against a neutral backdrop also work&nbsp;well. Paint samples on the walls before committing to a&nbsp;shade of yellow: This color changes a lot throughout&nbsp;the day depending on the quality of light.</p>
<h3>4. Black, White and Red</h3>
<p>This is a great choice when you love the clean look of white but need more color in your life. Adding <a href="<?php echo $row['url']; ?>/infographic-5-hot-kitchen-design-trends-for-your-next-building-project/" target="_blank" rel="noopener noreferrer">black and red</a> to the mix can be ultra-modern with glossy,&nbsp;lacquered&nbsp;cabinets, or it can hearken back to the classic good looks of a 1950s&nbsp;diner. This is a great&nbsp;color scheme for anyone who doesn&#8217;t love stainless steel appliances or&nbsp;would like to save some cash by selecting black or white ones, too.</p>
<h3>5. Sandy Neutrals</h3>
<p>If you like wood tone cabinets and&nbsp;want an overall restful look in your kitchen, paint the walls in a similar shade of beige or tan. For a fresh, up-to-the-minute look, choose shades of &#8220;greige&#8221; — a grayish beige&nbsp;— instead of warm khaki colors. Complete the look with tan granite or&nbsp;a sandstone&nbsp;backsplash for a tone-on-tone look.</p>
<p><strong>Pro Tip:&nbsp;</strong>When shopping for any element of your kitchen, bring your color scheme with you. Carry paint chips, a loose tile and&nbsp;small cabinet samples — or at least a good photo of the pieces you&#8217;ve chosen. This will allow to see all the colors together to make sure each color works well as part of a single, harmonious whole.</p>
<p>Choosing the color scheme for your kitchen should be a fun adventure! There aren&#8217;t really any rules as long as you check to make sure your colors look good together before you swipe your credit card. Use these color schemes as a jumping off point for your inspiration, but feel free to change them up. You can&nbsp;always add your favorite color as an accent to personalize one of these designer-approved color schemes. It&#8217;s&nbsp;all up to you!</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1000" height="688" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg" class="attachment-large size-large wp-post-image" alt="double pane or triple pane windows" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg 1000w, <?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows-768x528.jpg 768w" sizes="(max-width: 1000px) 100vw, 1000px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/">Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/5-tried-and-true-kitchen-color-schemes/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
