(() => {
  ...
  function P(e) {
    ...
    if (c > i.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (w >= i.longSwipesRatio
          ? t.slideTo(i.rewind && t.isEnd ? m : u + b)
          : t.slideTo(u)),
    ...
    N = {
      attachEvents: function () {
        ...
        (e.onTouchStart = $.bind(e)),
          ...
          (e.onClick = A.bind(e)),
          n.touch && !D && (t.addEventListener("touchstart", z), (D = !0)),
          G(e, "on");
      },
  ...
  Object.keys(V).forEach((e) => {
    ...
    new R(".carousel-products", {
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
          ...
          function u(t) {
            ...
            e.navigation &&
              ...
              e.pagination &&
                i.is(W(e.params.pagination.bulletClass)) &&
                i[0].click();
          }
          function f() {
            return (
          ...
          const m = (e, t, s) => {
            ...
            T = () => {
              ...
              t.itemRoleDescriptionMessage &&
                l(h(e.slides), t.itemRoleDescriptionMessage),
                t.slideRole && o(h(e.slides), t.slideRole);
              ...
              e.params.a11y.enabled &&
                (() => {
                  ...
                  (o = r),
                    ...
                    c && c.length && m(c, r, t.nextSlideMessage),
                    p && p.length && m(p, r, t.prevSlideMessage),
                    g() &&
                      e.pagination.$el.on(
                        "keydown",
            ...
            s("fromEdge toEdge afterInit lock unlock", () => {
              e.params.a11y.enabled &&
                (function () {
                  ...
                  s &&
                    s.length > 0 &&
                    (e.isBeginning ? (c(s), a(s)) : (p(s), r(s))),
                    t &&
                      t.length > 0 &&
                      (e.isEnd ? (c(t), a(t)) : (p(t), r(t)));
                })();
            }),
            s("paginationUpdate", () => {
              e.params.a11y.enabled &&
      ...
      slidesPerView: "auto",
      spaceBetween: 10,
      wrapperClass: "list-products",
      breakpoints: { 992: { spaceBetween: 45 } },
      on: {
        init: function () {
