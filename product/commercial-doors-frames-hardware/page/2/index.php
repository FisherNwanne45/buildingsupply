...
<!-- Mirrored from <?php echo $row['url']; ?>/product/commercial-doors-frames-hardware/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:30 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Commercial Doors, Frames &amp; Hardware Archives - Page 2 of 2 - <?php echo $row['name']; ?> " />
...
<body class="archive paged tax-product_category term-commercial-doors-frames-hardware term-282 wp-custom-logo wp-embed-responsive paged-2 without-announcement">
...
<main class="wp-block-group alignfull archive-product animate-content is-layout-constrained wp-block-group-is-layout-constrained">
        ...
        <div class="wp-block-query alignfull query-loop-main query-loop-products is-layout-constrained wp-block-query-is-layout-constrained">
            <ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-3297 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-commercial-doors-frames-hardware">
                <figure class="wp-block-post-featured-image"><img width="640" height="427" src="../../../../wp-content/uploads/2023/05/Steelcraft-Allegion.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>

                <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Steelcraft Allegion</h3>

                <div class="wp-block-post-excerpt"><p class="wp-block-post-excerpt__excerpt">Secure your commercial space with Steelcraft Allegion’s premium doors, frames, and hardware—the ultimate combination of strength, innovation, and style. </p></div>

                        <p><a href="https://www.allegion.com/corp/en/brands/steelcraft.php" class="link-arrow" target="_blank">Learn more<span class="screen-reader-text"> about Steelcraft Allegion</span></a></p>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/product/commercial-doors-frames-hardware/page/2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
