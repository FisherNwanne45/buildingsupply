...
<html lang="en-US">
    ...
    <head>
        ...
        <meta property="og:title"
            content="Windows, Skylights &amp; Roof Hatches Archives - <?php echo $row['name']; ?> " />
        <meta property="og:description"
            content="Illuminate your spaces with natural light and architectural beauty by exploring our exceptional range of windows, skylights, and roof hatches from renowned vendors at <?php echo $row['name']; ?>. Let <?php echo $row['name']; ?>  provide the highest quality products to transform your space into an inviting haven filled with warmth, beauty, and connection to the outdoors." />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "CollectionPage",
                "@id": "<?php echo $row['url']; ?>/product/windows-skylights-roof-hatches/",
                "url": "<?php echo $row['url']; ?>/product/windows-skylights-roof-hatches/",
                "name": "Windows, Skylights &amp; Roof Hatches Archives - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/product/windows-skylights-roof-hatches/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/product/windows-skylights-roof-hatches/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/Babcock-Davis.jpg",
                "inLanguage": "en-US"
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/product/windows-skylights-roof-hatches/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/Babcock-Davis.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/Babcock-Davis.jpg",
                "width": 640,
                "height": 427
            }, {
                "@type": "WebSite",
        ...
        <link rel="alternate" type="application/rss+xml"
            title="<?php echo $row['name']; ?>  &raquo; Windows, Skylights &amp; Roof Hatches Category Feed"
            href="feed/index.php" />
        <script>
        ...
        <link rel='stylesheet' id='wp-block-library-css'
            href='../../wp-includes/css/dist/block-library/common.min75e4.css?ver=6.4.5' media='all' />
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/product_category/279.json" />
    ...
    <body
        class="archive tax-product_category term-windows-skylights-roof-hatches term-279 wp-custom-logo wp-embed-responsive without-announcement">
        ...
        <div class="wp-site-blocks">
            ...
            <main
                class="wp-block-group alignfull archive-product animate-content is-layout-constrained wp-block-group-is-layout-constrained">
                ...
                <div
                    ...
                    <div class="wp-block-cover alignfull is-light is-taxonomy-cover" style="min-height:47vh">
                        <span aria-hidden="true"
                            class="wp-block-cover__background has-transparent-background-color has-background-dim-0 has-background-dim"></span>
                        <img class="wp-block-cover__image-background wp-image-205" alt=""
                            src="../../wp-content/uploads/2023/03/Yard-18-scaled.jpg" style="object-position:47% 13%"
                            data-object-fit="cover" data-object-position="47% 13%" />
                        <div class="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">

                            <p class="has-text-align-center has-large-font-size"></p>


                            <img src="../../wp-content/uploads/2023/06/Windows-Skylights-Roof-Hatches.jpg"
                                srscet="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/Windows-Skylights-Roof-Hatches.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Windows-Skylights-Roof-Hatches-768x235.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Windows-Skylights-Roof-Hatches-1024x313.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Windows-Skylights-Roof-Hatches-1536x470.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Windows-Skylights-Roof-Hatches-2048x626.jpg 2048w"
                                alt="" class="wp-block-blockshoon-taxonomy-img">
                    ...
                    <div
                        ...
                        <h1
                            class="alignwide has-text-color has-primary-color wp-block-heading wp-block-query-title has-h-2-font-size">
                            Windows, Skylights &amp; Roof Hatches</h1>

                        <div class="wp-block-term-description has-large-font-size">
                            <p><span style="font-weight: 400">Illuminate your spaces with natural light and
                                    architectural beauty by exploring our exceptional range of windows, skylights, and
                                    roof hatches from renowned vendors at <?php echo $row['name']; ?>. Let
                                    <?php echo $row['name']; ?> provide the highest quality products to transform your
                                    space into an inviting haven filled with warmth, beauty, and connection to the
                                    outdoors.</span></p>
                        </div>
                    </div>
                ...
                <div
                    class="wp-block-query alignfull query-loop-main query-loop-products is-layout-constrained wp-block-query-is-layout-constrained">
                    <ul
                        class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow">
                        <li
                            class="wp-block-post post-3535 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Babcock-Davis.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">
                                Babcock-Davis</h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Experience the perfect blend of durability,
                                    functionality, and style with Babcock-Davis windows, the go-to solution for
                                    commercial and institutional projects. </p>
                            </div>

                            <p><a href="https://www.babcockdavis.com/products/access-doors" class="link-arrow"
                                    target="_blank">Learn more<span class="screen-reader-text"> about
                                        Babcock-Davis</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3536 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Bilco-1.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Bilco
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Discover a world of possibilities with Bilco
                                    windows and provide secure and effortless access to your basement while letting
                                    natural light and fresh air pour in. </p>
                            </div>

                            <p><a href="https://www.bilco.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Bilco</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3537 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/boston-Sash-_-Millwork.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">
                                <?php echo $row['country']; ?> Sash Millwork</h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Unleash the timeless charm and unparalleled
                                    craftmanship of <?php echo $row['country']; ?> Sash &amp; Millwork windows—the
                                    perfect addition to any home seeking to capture the essence of New England elegance.
                                </p>
                            </div>

                            <p><a href="https://<?php echo $row['country']; ?>sash.com/" class="link-arrow"
                                    target="_blank">Learn more<span class="screen-reader-text"> about
                                        <?php echo $row['country']; ?> Sash Millwork</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3534 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Jeld-Wen-2.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Jeld Wen
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Let natural light flood your home and
                                    transform your view with Jeld-Wen windows—where innovative design and superior
                                    craftmanship come together to create windows that enhance your lifestyle. </p>
                            </div>

                            <p><a href="https://www.jeld-wen.com/en-us" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Jeld Wen</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3539 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Kawneer.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Kawneer
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Elevate your architectural design with Kawneer
                                    windows, where sleek aesthetics and exceptional performance unite to bring your
                                    vision to life. </p>
                            </div>

                            <p><a href="https://www.kawneer.us/products/windows/" class="link-arrow"
                                    target="_blank">Learn more<span class="screen-reader-text"> about Kawneer</span></a>
                            </p>


                        </li>
                        <li
                            class="wp-block-post post-3541 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Marvin.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Marvin
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Bring your vision to life with Marvin windows
                                    and unlock a world of endless possibilities at <?php echo $row['name']; ?> to
                                    transform your living spaces into havens of warmth and beauty. </p>
                            </div>

                            <p><a href="https://www.marvin.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Marvin</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3543 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Stergis.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Stergis
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">From stunning aesthetics to unmatched
                                    performance, Stergis windows are the perfect solution to elevate your home’s
                                    comfort, style, and energy efficiency. </p>
                            </div>

                            <p><a href="https://www.stergis.com/pages/Home.cfm" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Stergis</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3545 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/TrimLine.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">TrimLine
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Maximize your home’s energy efficiency and
                                    aesthetic appeal with TrimLine windows, the perfect combination of classic style and
                                    advanced technology. </p>
                            </div>

                            <p><a href="https://www.trimlinewindows.com/" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about TrimLine</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3558 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-windows-skylights-roof-hatches">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Velux.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Velux
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Transform any space into a brighter, more
                                    inviting environment with Velux windows. </p>
                            </div>

                            <p><a href="https://www.veluxusa.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Velux</span></a></p>


                        </li>
                    </ul>

                    <nav class="wp-block-query-pagination is-content-justification-center is-layout-flex wp-container-core-query-pagination-layout-1 wp-block-query-pagination-is-layout-flex"
            ...
            <footer class="site-footer wp-block-template-part">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/product/windows-skylights-roof-hatches/" /><input
                                                    type="hidden" name="item_meta[25]" id="field_a913j" value=""
                ...
                <div
                    ...
                    <div
                        class="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
