...
<html lang="en-US">
    ...
    <head>
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "CollectionPage",
                "@id": "<?php echo $row['url']; ?>/product/flooring-product-category/",
                "url": "<?php echo $row['url']; ?>/product/flooring-product-category/",
                "name": "Flooring Archives - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/product/flooring-product-category/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/product/flooring-product-category/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/04/Daltile.jpg",
                "inLanguage": "en-US"
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/product/flooring-product-category/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/04/Daltile.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/04/Daltile.jpg",
                "width": 549,
                "height": 366
            }, {
                "@type": "WebSite",
        ...
        <link rel="alternate" type="application/rss+xml"
            title="<?php echo $row['name']; ?>  &raquo; Flooring Category Feed" href="feed/index.php" />
        <script>
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/product_category/287.json" />
    ...
    <body
        class="archive tax-product_category term-flooring-product-category term-287 wp-custom-logo wp-embed-responsive without-announcement">
            ...
            <main
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-term-description has-large-font-size">
                            <p><span style="font-weight: 400">Transform your space by exploring our exceptional range of
                                    flooring products at <?php echo $row['name']; ?>. From timeless hardwood to
                                    cutting-edge luxury vinyl, we offer an array of styles, finishes, and textures to
                                    suit every design vision. Whether creating a warm and inviting ambiance or a sleek
                                    and modern aesthetic, <?php echo $row['name']; ?> provides the perfect flooring
                                    solutions to elevate your space to new heights of beauty and sophistication.</span>
                            </p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <ul
                        ...
                        <li
                            class="wp-block-post post-3264 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-flooring-product-category">
                            <figure class="wp-block-post-featured-image"><img width="549" height="366"
                                    src="../../wp-content/uploads/2023/04/Daltile.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Daltile
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Step into luxury with Daltile flooring,
                                    expertly crafted with the finest materials and cutting-edge design, providing
                                    unparalleled beauty and durability for your home or business. </p>
                            </div>

                            <p><a href="http://www.daltile.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Daltile</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3800 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-flooring-product-category">
                            <figure class="wp-block-post-featured-image"><img width="549" height="366"
                                    src="../../wp-content/uploads/2023/08/Hallmark-Floors.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Hallmark
                                Floors</h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Elevate your space with Hallmark Floors, where
                                    timeless elegance meets expectational craftsmanship. As a spotlight dealer for
                                    Hallmark Floors, <?php echo $row['name']; ?> proudly offers a curated selection of
                                    premium hardwood, luxury vinyl, and laminate flooring options. Explore our
                                    collection today and discover the perfect flooring to transform your home or
                                    business with style and sophistication. </p>
                            </div>

                            <p><a href="https://hallmarkfloors.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Hallmark Floors</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3262 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-flooring-product-category">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/04/Somerset-Hardwood-Flooring-1.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Somerset
                                Hardwood Flooring</h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Bring the timeless beauty of nature to your
                                    home with Somerset Hardwood Flooring. </p>
                            </div>

                            <p><a href="https://www.somersetfloors.com/" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Somerset Hardwood Flooring</span></a>
                            </p>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/product/flooring-product-category/" /><input type="hidden"
