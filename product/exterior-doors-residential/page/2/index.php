...
<!-- Mirrored from <?php echo $row['url']; ?>/product/exterior-doors-residential/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:35 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Residential Exterior Doors Archives - Page 2 of 2 - <?php echo $row['name']; ?> " />
...
<body class="archive paged tax-product_category term-exterior-doors-residential term-280 wp-custom-logo wp-embed-responsive paged-2 without-announcement">
...
<main class="wp-block-group alignfull archive-product animate-content is-layout-constrained wp-block-group-is-layout-constrained">
        ...
        <div class="wp-block-query alignfull query-loop-main query-loop-products is-layout-constrained wp-block-query-is-layout-constrained">
            <ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-3322 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-exterior-doors-residential">
                <figure class="wp-block-post-featured-image"><img width="640" height="427" src="../../../../wp-content/uploads/2023/05/Upstate-Door.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>

                <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Upstate Door</h3>

                <div class="wp-block-post-excerpt"><p class="wp-block-post-excerpt__excerpt">Experience the perfect blend of timeless craftmanship and modern innovation with Upstate Door’s exterior doors. </p></div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/product/exterior-doors-residential/page/2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/product/exterior-doors-residential/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:36 GMT -->
</html>
