...
<html lang="en-US">
    ...
    <head>
        ...
        <meta property="og:description"
            content="Experience the artistry of fine craftsmanship with our collection of millwork products at <?php echo $row['name']; ?>. From intricately carved moldings to custom-designed cabinetry, <?php echo $row['name']; ?>  offers the perfect blend of beauty and functionality to elevate any space." />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "CollectionPage",
                "@id": "<?php echo $row['url']; ?>/product/millwork/",
                "url": "<?php echo $row['url']; ?>/product/millwork/",
                "name": "Millwork Archives - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/product/millwork/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/product/millwork/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/Alexandria-Moulding_.jpg",
                "inLanguage": "en-US"
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/product/millwork/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/Alexandria-Moulding_.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/Alexandria-Moulding_.jpg",
                "width": 640,
                "height": 427
            }, {
                "@type": "WebSite",
        ...
        <link rel="alternate" type="application/rss+xml"
            title="<?php echo $row['name']; ?>  &raquo; Millwork Category Feed" href="feed/index.php" />
        <script>
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/product_category/294.json" />
    ...
    <body
        class="archive tax-product_category term-millwork term-294 wp-custom-logo wp-embed-responsive without-announcement">
            ...
            <main
                ...
                <div
                    ...
                    <div class="wp-block-cover alignfull is-light is-taxonomy-cover" style="min-height:47vh">
                        ...
                        <div class="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">
                            ...
                            <img src="../../wp-content/uploads/2023/06/Moulding-Trim-Columns.jpg"
                    ...
                    <div
                        ...
                        <div class="wp-block-term-description has-large-font-size">
                            <p><span style="font-weight: 400">Experience the artistry of fine craftsmanship with our
                                    collection of millwork products at <?php echo $row['name']; ?>. From intricately
                                    carved moldings to custom-designed cabinetry, <?php echo $row['name']; ?> offers the
                                    perfect blend of beauty and functionality to elevate any space.</span></p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <ul
                        ...
                        <li
                            class="wp-block-post post-3425 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Alexandria-Moulding_.jpg"
                            ...
                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">
                                Alexandria Moulding</h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Explore Alexandria Moulding’s remarkable
                                    collection of millwork products at <?php echo $row['name']; ?> and bring your vision
                                    to life with unmatched craftsmanship and style. </p>
                            </div>

                            <p><a href="https://alexandriamoulding.com/" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Alexandria Moulding</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3433 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/BlueLinx.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">BlueLinx
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Unleash your creativity with BlueLinx
                                    millwork, the ultimate source for high-quality, customizable mouldings and trim.
                                </p>
                            </div>

                            <p><a href="https://bluelinxco.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about BlueLinx</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3434 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/BROSCO.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">BROSCO
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Discover the perfect finishing touch for your
                                    space with Brosco millwork products—expertly crafted with the finest materials and
                                    attention to detail. </p>
                            </div>

                            <p><a href="https://www.brosco.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about BROSCO</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3435 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Flex-Trim.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Flex Trim
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Transform any room into a work of art with
                                    Flex Trim millwork products, where creativity and craftsmanship meet. </p>
                            </div>

                            <p><a href="http://www.flextrim.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Flex Trim</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3436 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/HB_G.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
                            ...
                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Experience the beauty and durability of
                                    HB&amp;G millwork and let your space exude timeless grandeur. </p>
                            </div>

                            <p><a href="https://www.hbgcolumns.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about HBG</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3437 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Metrie.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Metrie
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Elevate your space with Metrie millwork—the
                                    perfect blend of timeless elegance and modern sophistication. </p>
                            </div>

                            <p><a href="https://www.metrie.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Metrie</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3438 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-millwork">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Turncraft.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Turncraft
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Experience the artistry and precision of
                                    Turncraft millwork—where beauty meets craftmanship to create stunning architectural
                                    details and transform your home or business into a masterpiece. </p>
                            </div>

                            <p><a href="https://turncraft.com/" class="link-arrow" target="_blank">Learn more<span
                                        class="screen-reader-text"> about Turncraft</span></a></p>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/product/millwork/" /><input type="hidden"
