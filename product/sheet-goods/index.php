...
<html lang="en-US">
    ...
    <head>
        ...
        <meta property="og:description"
            content="Unleash your creativity and craftsmanship with our extensive range of sheet goods vendors and products. With <?php echo $row['name']; ?>, you can count on top-quality sheet goods that provide the strength, stability, and versatility needed to bring your visions to life." />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "CollectionPage",
                "@id": "<?php echo $row['url']; ?>/product/sheet-goods/",
                "url": "<?php echo $row['url']; ?>/product/sheet-goods/",
                "name": "Sheet Goods Archives - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/product/sheet-goods/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/product/sheet-goods/#primaryimage"
                },
        ...
        <link rel="alternate" type="application/rss+xml"
            title="<?php echo $row['name']; ?>  &raquo; Sheet Goods Category Feed" href="feed/index.php" />
        <script>
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/product_category/292.json" />
    ...
    <body
        class="archive tax-product_category term-sheet-goods term-292 wp-custom-logo wp-embed-responsive without-announcement">
            ...
            <main
                ...
                <div
                    ...
                    <div class="wp-block-cover alignfull is-light is-taxonomy-cover" style="min-height:47vh">
                        ...
                        <div class="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">
                            ...
                            <img src="../../wp-content/uploads/2023/06/Sheet-Goods.jpg"
                                srscet="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/Sheet-Goods.jpg 1920w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Sheet-Goods-768x239.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Sheet-Goods-1024x319.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Sheet-Goods-1536x478.jpg 1536w"
                    ...
                    <div
                        ...
                        <div class="wp-block-term-description has-large-font-size">
                            <p><span style="font-weight: 400">Unleash your creativity and craftsmanship with our
                                    extensive range of sheet goods vendors and products. With
                                    <?php echo $row['name']; ?>, you can count on top-quality sheet goods that provide
                                    the strength, stability, and versatility needed to bring your visions to
                                    life.</span></p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <ul
                        ...
                        <li
                            class="wp-block-post post-3279 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-sheet-goods">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Durastrand.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                            ...
                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Built tough with superior strength and
                                    moisture resistance, Durastrand sheet goods by West Fraser are the perfect
                                    foundation for your subfloor needs. </p>
                            </div>

                            <p><a href="https://osb.westfraser.com/sub-floor/durastrand/" class="link-arrow"
                                    target="_blank">Learn more<span class="screen-reader-text"> about
                                        Durastrand</span></a></p>
                        ...
                        <li
                            class="wp-block-post post-3280 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-sheet-goods">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/TruFlor-1.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">TruFlor
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Get the performance you deserve with TruFlor
                                    sheet goods by West Fraser, engineered to withstand the toughest loads, moisture,
                                    and wear and tear. </p>
                            </div>

                            <p><a href="https://osb.westfraser.com/sub-floor/truflor/" class="link-arrow"
                                    target="_blank">Learn more<span class="screen-reader-text"> about TruFlor</span></a>
                            </p>


                        </li>
                        <li
                            class="wp-block-post post-3285 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-sheet-goods">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/05/Zip-System.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" loading="lazy" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Zip
                                System</h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">“Zip System sheet goods are the revolutionary
                                    all-in-one solution that combines superior strength, moisture resistance, and
                                    weather protection.” </p>
                            </div>

                            <p><a href="https://www.huberwood.com/zip-system" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Zip System</span></a></p>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/product/sheet-goods/" /><input type="hidden"
