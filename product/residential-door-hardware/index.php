...
<html lang="en-US">
    ...
    <head>
        ...
        <meta property="og:description"
            content="Enhance the functionality and security of your home with our exceptional range of residential door hardware from top-tier vendors at <?php echo $row['name']; ?>. Whether you&#8217;re looking to upgrade your entryway or transform your interior doors, trust <?php echo $row['name']; ?>  to provide the highest quality door hardware for your residential spaces." />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "CollectionPage",
                "@id": "<?php echo $row['url']; ?>/product/residential-door-hardware/",
                "url": "<?php echo $row['url']; ?>/product/residential-door-hardware/",
                "name": "Residential Door Hardware Archives - <?php echo $row['name']; ?> ",
                "isPartOf": {
                    "@id": "<?php echo $row['url']; ?>/#website"
                },
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/product/residential-door-hardware/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/product/residential-door-hardware/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/baldwin-residential-door-hardware.jpg",
                "inLanguage": "en-US"
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/product/residential-door-hardware/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/baldwin-residential-door-hardware.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/05/baldwin-residential-door-hardware.jpg",
                "width": 640,
                "height": 428
            }, {
                "@type": "WebSite",
        ...
        <link rel="alternate" type="application/rss+xml"
            title="<?php echo $row['name']; ?>  &raquo; Residential Door Hardware Category Feed"
            href="feed/index.php" />
        <script>
        ...
        <link rel="alternate" type="application/json" href="../../wp-json/wp/v2/product_category/283.json" />
    ...
    <body
        class="archive tax-product_category term-residential-door-hardware term-283 wp-custom-logo wp-embed-responsive without-announcement">
            ...
            <main
                ...
                <div
                    ...
                    <div
                        ...
                        <h1
                            ...
                            Residential Door Hardware</h1>

                        <div class="wp-block-term-description has-large-font-size">
                            <p><span style="font-weight: 400">Enhance the functionality and security of your home with
                                    our exceptional range of residential door hardware from top-tier vendors at
                                    <?php echo $row['name']; ?>. Whether you&#8217;re looking to upgrade your entryway
                                    or transform your interior doors, trust <?php echo $row['name']; ?> to provide the
                                    highest quality door hardware for your residential spaces.</span></p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <ul
                        ...
                        <li
                            class="wp-block-post post-3447 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-residential-door-hardware">
                            <figure class="wp-block-post-featured-image"><img width="640" height="428"
                                    src="../../wp-content/uploads/2023/05/baldwin-residential-door-hardware.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Baldwin
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Experience the perfect fusion of style and
                                    security with Baldwin’s exceptional residential door hardware, available at
                                    <?php echo $row['name']; ?> . </p>
                            </div>

                            <p><a href="https://www.baldwinhardware.com/" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Baldwin</span></a></p>


                        </li>
                        <li
                            class="wp-block-post post-3712 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-residential-door-hardware">
                            <figure class="wp-block-post-featured-image"><img width="640" height="427"
                                    src="../../wp-content/uploads/2023/06/Schlage-residential-door-hardware.jpg"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt=""
                                    style="object-fit:cover;" decoding="async" /></figure>

                            <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Schlage
                            </h3>

                            <div class="wp-block-post-excerpt">
                                <p class="wp-block-post-excerpt__excerpt">Elevate the entrance to your home with
                                    Schlage’s sleek and innovative residential door hardware, designed to provide
                                    uncompromising security and style. </p>
                            </div>

                            <p><a href="https://www.schlage.com/en/home.php" class="link-arrow" target="_blank">Learn
                                    more<span class="screen-reader-text"> about Schlage</span></a></p>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/product/residential-door-hardware/" /><input type="hidden"
