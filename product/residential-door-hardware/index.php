...
<!-- Mirrored from <?php echo $row['url']; ?>/product/residential-door-hardware/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:04:44 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Residential Door Hardware Archives - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Enhance the functionality and security of your home with our exceptional range of residential door hardware from top-tier vendors at NEBS. Whether you&#8217;re looking to upgrade your entryway or transform your interior doors, trust <?php echo $row['name']; ?>  to provide the highest quality door hardware for your residential spaces." />
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Residential Door Hardware Category Feed" href="feed/index.php" />
<script>
...
<link rel="https://api.w.org/" href="../../wp-json/index.php" /><link rel="alternate" type="application/json" href="../../wp-json/wp/v2/product_category/283.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
...
<body class="archive tax-product_category term-residential-door-hardware term-283 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull archive-product animate-content is-layout-constrained wp-block-group-is-layout-constrained">
        ...
        <div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
            ...
            <div class="wp-block-cover alignfull is-light is-taxonomy-cover" style="min-height:47vh">
                ...
                <div class="wp-block-cover__inner-container is-layout-flow wp-block-cover-is-layout-flow">
                    ...
                    <p class="has-text-align-center has-large-font-size"></p>
                        ...
                        <img src="../../wp-content/uploads/2023/06/Residential-Hardware-banner.jpg" srscet="<?php echo $row['url']; ?>/wp-content/uploads/2023/06/Residential-Hardware-banner.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Residential-Hardware-banner-768x240.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Residential-Hardware-banner-1024x320.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Residential-Hardware-banner-1536x480.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2023/06/Residential-Hardware-banner-2048x640.jpg 2048w" alt=""class="wp-block-blockshoon-taxonomy-img">
            ...
            <div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex">
                <h1 class="alignwide has-text-color has-primary-color wp-block-heading wp-block-query-title has-h-2-font-size">Residential Door Hardware</h1>

                <div class="wp-block-term-description has-large-font-size"><p><span style="font-weight: 400">Enhance the functionality and security of your home with our exceptional range of residential door hardware from top-tier vendors at NEBS. Whether you&#8217;re looking to upgrade your entryway or transform your interior doors, trust <?php echo $row['name']; ?>  to provide the highest quality door hardware for your residential spaces.</span></p>
</div>
            </div>
        ...
        <div class="wp-block-query alignfull query-loop-main query-loop-products is-layout-constrained wp-block-query-is-layout-constrained">
            <ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-3447 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-residential-door-hardware">
                <figure class="wp-block-post-featured-image"><img width="640" height="428" src="../../wp-content/uploads/2023/05/baldwin-residential-door-hardware.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>

                <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Baldwin</h3>

                <div class="wp-block-post-excerpt"><p class="wp-block-post-excerpt__excerpt">Experience the perfect fusion of style and security with Baldwin’s exceptional residential door hardware, available at <?php echo $row['name']; ?> . </p></div>

                        <p><a href="https://www.baldwinhardware.com/" class="link-arrow" target="_blank">Learn more<span class="screen-reader-text"> about Baldwin</span></a></p>


            </li><li class="wp-block-post post-3712 bs_product type-bs_product status-publish has-post-thumbnail hentry product_category-residential-door-hardware">
                <figure class="wp-block-post-featured-image"><img width="640" height="427" src="../../wp-content/uploads/2023/06/Schlage-residential-door-hardware.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" /></figure>

                <h3 class="has-text-color has-primary-color wp-block-post-title has-h-5-font-size">Schlage</h3>

                <div class="wp-block-post-excerpt"><p class="wp-block-post-excerpt__excerpt">Elevate the entrance to your home with Schlage’s sleek and innovative residential door hardware, designed to provide uncompromising security and style. </p></div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/product/residential-door-hardware/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/product/residential-door-hardware/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:04:46 GMT -->
</html>
