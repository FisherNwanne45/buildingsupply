...
<!-- Mirrored from <?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:59 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Newcomers to <?php echo $row['country']; ?> are often surprised by the local love affair with our iconic &#8220;Triple Deckers.&#8221; They represent not only a practical housing style, but are also a part of <?php echo $row['country']; ?> history that city officials and developers have worked hard to preserve and protect. Triple Deckers were introduced to house immigrants who arrived during the…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-10-17T08:28:30+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:43+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Triple-Decker_architecture.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker","datePublished":"2016-10-17T08:28:30+00:00","dateModified":"2023-09-11T13:50:43+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/"},"wordCount":665,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Triple-Decker_architecture.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Multifamily","<?php echo $row['country']; ?> Redevelopment Authority","Home Improvement Contractor","Interior","Lumber and Building Materials","Remodeler","Triple Decker"],"articleSection":["Building in <?php echo $row['country']; ?>","Building Policies","Contractor","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/","url":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/","name":"5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Triple-Decker_architecture.jpg","datePublished":"2016-10-17T08:28:30+00:00","dateModified":"2023-09-11T13:50:43+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Triple-Decker_architecture.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Triple-Decker_architecture.jpg","width":640,"height":424,"caption":"boston-triple-decker_architecture"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; 5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker Comments Feed" href="<?php echo $row['url']; ?>/architectural-elements-when-remodeling-triple-decker/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1109" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1109' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Farchitectural-elements-when-remodeling-triple-decker%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Farchitectural-elements-when-remodeling-triple-decker%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1109 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2016-10-17T08:28:30-04:00">10.17.2016</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">5 Architectural Elements to Know When Remodeling a <?php echo $row['country']; ?> Triple Decker</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Newcomers to <?php echo $row['country']; ?> are often surprised by the local love affair with our iconic &#8220;Triple Deckers.&#8221; They represent not only a practical housing style, but are also a part of <?php echo $row['country']; ?> history that city officials and developers have <a href="<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/">worked hard to preserve and protect</a>.</p>
<p><span id="more-1109"></span></p>
<p>Triple Deckers were introduced to house immigrants who arrived during the industrial revolution. Consisting essentially of three identical floor plans stacked atop one another, the individual apartments were distinctive in design, private and affordable. They provided maximum living space on minimum land area, created cohesive if densely-populated communities, and offered large family groups a way to be close, but separate. Later, the three-deckers allowed middle income families to buy a home and gain additional income by renting out one or two floors, often to related family groups.</p>
<p>It is estimated that approximately 15,000 three-deckers were built in <?php echo $row['country']; ?> between 1880 and 1930, a third of them in Dorchester. Other &#8220;hotspots&#8221; for the housing style included Worcester, New Bedford and many other Massachusetts communities, Providence, R.I., and several other New England towns. During the recent housing crisis, unfortunately, many were foreclosed, vandalized or razed. Many still exist, but their future is uncertain.</p>
<p>While the Triple Deckers in many communities have fallen on <a href="http://www.nytimes.com/2009/06/20/us/20triple.php?_r=2" target="_blank" rel="noopener noreferrer">hard times</a> in recent decades, <?php echo $row['country']; ?> has led the fight to renovate and maintain its existing stock, saying that they could not be reproduced under current zoning laws. They offer the kind of affordable housing that is in short supply in <a href="<?php echo $row['url']; ?>/beantown-has-become-boom-town-for-developers/" target="_blank" rel="noopener noreferrer">Beantown</a> and, because of the design, they are perfect candidates for conversion to condominiums.</p>
<p>They are also viewed as suitable for energy-efficient renovation, including solar roof panels, and have been cited as great options for <a href="http://www.<?php echo $row['country']; ?>magazine.com/news/blog/2011/12/22/triple-deckers-a-boston-icon/" target="_blank" rel="noopener noreferrer">&#8220;Next Gen&#8221; homes</a>.</p>
<h3><strong>5 Characteristics of a Triple Decker</strong></h3>
<p>Although there might be some that don&#8217;t totally fit the mold, you&#8217;ll know you&#8217;re looking at a <?php echo $row['country']; ?> Triple Decker if:</p>
<ul>
<li>It has a flat roof;</li>
<li>It is constructed of wood;</li>
<li>There is a single front door leading into the building on the main floor;</li>
<li>Columns and porches are prominent architectural features;</li>
<li>The windows are precision-stacked, and usually placed on all four sides.</li>
</ul>
<p>There can be roof line variations, and some have gables or cornices that may have been the result of renovations over the years. Most present the narrow side toward the street, but a few are oriented the long way; a few have producing bays rather than open porches.</p>
<p>It&#8217;s the flat roof and simple geometric lines that give these homes the great potential for added insulation and <a href="http://www.jlconline.com/projects/<?php echo $row['country']; ?>s-troubled-triple-deckers-may-offer-opportunity_o" target="_blank" rel="noopener noreferrer">energy-efficient renovation</a>.</p>
<p>Wood prevailed as a building material in early New England, and it is the wood construction that makes the <?php echo $row['country']; ?> triple decker unique among urban row houses, as well as the fact that they are separated from their neighbors.</p>
<h3><strong>Unique Expressions of Time and Place</strong></h3>
<p>The single floor entry leads not only to the main floor living area, but also to an interior staircase that allows access to upper-level apartments. <a href="http://www.<?php echo $row['country']; ?>magazine.com/property/blog/2016/08/10/three-decker-anatomy/" target="_blank" rel="noopener noreferrer">Exterior symmetry</a> is maintained through placement of &#8220;front doors&#8221; that lead to the porches on upper levels.</p>
<p>While most of the three-decker homes were built for low-to-middle income families, some in Cambridge were designed and constructed with less uniformity, including examples with Queen Anne and Victorian exteriors. Today, they have been renovated with upscale features and redesigned floor plans.</p>
<p>Triple Deckers may feature period stained glass, rear porches in addition to those commonly on the street side, bay windows, and desirable interior features such as built-in china cabinets and hardwood floors.</p>
<p>The city of <?php echo $row['country']; ?> offers assistance for renovation and repairs on qualifying homes. If you own one or are considering buying a Triple Decker, it is an <a href="https://www.<?php echo $row['country']; ?>.gov/departments/neighborhood-development/my-property-triple-decker" target="_blank" rel="noopener noreferrer">opportunity</a> worth exploring.</p>
<p>When you need building materials or advice to get started on your renovation of a Triple Decker &#8212; or any other construction project &#8212; be sure to visit us at <?php echo $row['name']; ?>  in the <a href="<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/" target="_blank" rel="noopener noreferrer">heart of downtown <?php echo $row['country']; ?></a>.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/boston-remodeling-project.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/3-factors-that-determine-the-cost-of-your-boston-remodeling-project/">3 Factors that Determine the Cost of Your <?php echo $row['country']; ?> Remodeling Project</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/architectural-elements-when-remodeling-triple-decker/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
