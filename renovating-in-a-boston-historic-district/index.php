...
<!-- Mirrored from <?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:58 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Part of <?php echo $row['country']; ?>&#8217;s charm is its vast array of historically significant buildings. After all, when your city is one of the oldest in the country, you&#8217;ve got a lot of homes from many different eras in the mix. Unlike some other big cities we could name, <?php echo $row['country']; ?> has always put a premium on historic preservation,…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2017-10-04T08:45:34+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:49:12+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2017/10/boston-historic-renovation-south-end.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/"},"author":{"name":"pflood","@id":"<?php echo $row['url']; ?>/#/schema/person/efdb884fa68ac1170a581188b6d24d68"},"headline":"Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know","datePublished":"2017-10-04T08:45:34+00:00","dateModified":"2023-09-11T13:49:12+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/"},"wordCount":682,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2017/10/boston-historic-renovation-south-end.png","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Homeowner","Building Codes","Building Supplier","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Historic Renovation","Home Improvement Contractor","Interior"],"articleSection":["Building in <?php echo $row['country']; ?>","Building Policies","Building Trends","Contractor","Homeowner","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/","url":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/","name":"Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2017/10/boston-historic-renovation-south-end.png","datePublished":"2017-10-04T08:45:34+00:00","dateModified":"2023-09-11T13:49:12+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2017/10/boston-historic-renovation-south-end.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2017/10/boston-historic-renovation-south-end.png","width":560,"height":315,"caption":"<?php echo $row['country']; ?> historic renovation south end"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/efdb884fa68ac1170a581188b6d24d68","name":"pflood","url":"<?php echo $row['url']; ?>/author/pflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know Comments Feed" href="<?php echo $row['url']; ?>/renovating-in-a-boston-historic-district/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1616" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1616' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Frenovating-in-a-boston-historic-district%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Frenovating-in-a-boston-historic-district%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1616 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2017-10-04T08:45:34-04:00">10.04.2017</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Renovating in a <?php echo $row['country']; ?> Historic District? Guidelines You Need to Know</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Part of <?php echo $row['country']; ?>&#8217;s charm is its vast array of historically significant buildings. After all, when your city is one of the oldest in the country, you&#8217;ve got a lot of homes from many different eras in the mix. Unlike some other big cities we could name, <?php echo $row['country']; ?> has always put a premium on historic preservation, which is why you can still see the Old State House nestled among the skyscrapers and very modern buildings of Government Center. It&#8217;s that mix that makes us special.</p>
<p><span id="more-1616"></span></p>
<p>It&#8217;s also that mix that sometimes makes homeowners and contractors want to tear their hair out when they&#8217;re ready to renovate one of those older buildings. In&nbsp;order to keep old stuff looking historically accurate, there<a href="<?php echo $row['url']; ?>/remodeling-your-boston-home-structural-changes-that-require-a-permit/"> are a&nbsp;<em>lot</em>&nbsp;of regulations</a> regarding proposed changes to certain buildings — including private residences. Here&#8217;s what you need to know before you take a hammer to those old clapboards or try to <a href="<?php echo $row['url']; ?>/3-window-replacement-questions-to-ask-for-your-historic-renovation/">replace your draft windows with modern models</a>.</p>
<h2>Are You in a Historic District?</h2>
<p>If you live in a building that&#8217;s been &#8220;landmarked&#8221; — that is,&nbsp;<a href="https://www.<?php echo $row['country']; ?>.gov/departments/landmarks-commission/landmarks-design-review-process" target="_blank" rel="noopener noreferrer">designated as an official historic landmark in the city</a>&nbsp;— you have to get approval before making any changes to the exterior. These include replacing windows or&nbsp;changing porches, decks, awnings, etc. Interior changes are fine,&nbsp;<em>unless</em>&nbsp;the interior of your building has also been landmarked, in which case you&#8217;ll need to get approval for that as well. Keep in mind that some changes that are mostly on the inside&nbsp;can also affect the facade of your building; for example, a new air conditioning system.</p>
<p>There are also several official Historic Districts in <?php echo $row['country']; ?>:</p>
<ul>
<li>Aberdeen</li>
<li>Back Bay (there are actually two different historic districts within Back Bay)</li>
<li>Bay Village</li>
<li>Beacon Hill</li>
<li>Fort Point Channel</li>
<li>Mission Hill</li>
<li>South End</li>
<li>St. Botolph</li>
</ul>
<p>Each of these districts has its own rules about renovations. It&#8217;s always best to check the guidelines for your area before doing any work so you plan your project according to the&nbsp;<a href="https://www.<?php echo $row['country']; ?>.gov/departments/landmarks-commission" target="_blank" rel="noopener noreferrer">architectural guidelines laid out for each neighborhood</a>.</p>
<h2>The <?php echo $row['country']; ?> Landmarks Design Review Process</h2>
<p>Fortunately, there&#8217;s a single,&nbsp;<a href="https://www.cityof<?php echo $row['country']; ?>.gov/images_documents/Application for Certificate of Appropriateness, Design Approval and Exemption REVISED 2014_tcm3-46975.pdf" target="_blank" rel="noopener noreferrer">standard application for renovations</a>&nbsp;to any official landmark in <?php echo $row['country']; ?>. Complete the form and submit it to the city along with drawings of your proposed design and color photos of your property as it looks today. There&#8217;s also an&nbsp;<a href="https://www.<?php echo $row['country']; ?>.gov/departments/landmarks-commission/how-apply-landmarks-design-review" target="_blank" rel="noopener noreferrer">application fee</a>&nbsp;that varies based on how complex the proposed renovation is.</p>
<p>From there, the city will review your application and place your project on the public hearing list. These are held&nbsp;once per month, but the schedule varies depending on your Historic District. Your application must be received&nbsp;at least 15 days prior to your hearing date, so depending on the cut-off, you might have to wait until the following month. Once the committee votes, you&#8217;ll get a&nbsp;Certificate of Design Approval — or they&#8217;ll work with you to revise your design so you can try again at the next month&#8217;s&nbsp;hearing.</p>
<h2>Historic Buildings&nbsp;Outside of <?php echo $row['country']; ?></h2>
<p>Live in Cambridge, Somerville&nbsp;or Brookline? You&#8217;re not off the hook. Each of these communities has its own historic districts with their&nbsp;own rules, too. If your house was built more than 50 years ago, it&#8217;s best to check with your local boards before you do any work that can be seen from the outside. These websites will help you get started:</p>
<ul>
<li><a href="http://www.cambridgema.gov/Historic" target="_blank" rel="noopener noreferrer">Cambridge Historical&nbsp;Commission</a></li>
<li><a href="http://archive.somervillema.gov/departments/historic-preservation-commission" target="_blank" rel="noopener noreferrer">Somerville&nbsp;Historic Preservation Commission</a></li>
<li><a href="http://www.brooklinema.gov/744/Preservation-Commission" target="_blank" rel="noopener noreferrer">Brookline Preservation Commission</a></li>
</ul>
<p>If you live farther out in Metro West or the North or South Shore, check your city or town&#8217;s website for more details on exactly what the process is like in your neighborhood. Massachusetts is one of the oldest settled areas of the country, and there&#8217;s a lot to protect. Give yourself plenty of time to learn the rules and plan accordingly, and your next project should go smoothly.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/10/quartz-countertops-for-kitchen.jpg" class="attachment-large size-large wp-post-image" alt="quartz countertops for kitchen" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/quartz-continues-to-latest-kitchen-countertop-trend/">Why Quartz Continues to be the Latest Kitchen Countertop Trend</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/renovating-in-a-boston-historic-district/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
