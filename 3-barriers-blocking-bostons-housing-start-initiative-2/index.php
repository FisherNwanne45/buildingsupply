...
<!-- Mirrored from <?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:42 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Experts forecast that housing will stay at a premium in <?php echo $row['country']; ?>. Lawmakers are working on solutions that will increase housing start initiatives while alleviating concerns about traffic, strained public schools and quality of life. 15 communities are hoping to add 185,000 new homes in the next decade." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="3 Barriers Blocking <?php echo $row['country']; ?>&#039;s Housing Start Initiative - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Experts forecast that housing will stay at a premium in <?php echo $row['country']; ?>. Lawmakers are working on solutions that will increase housing start initiatives while alleviating concerns about traffic, strained public schools and quality of life. 15 communities are hoping to add 185,000 new homes in the next decade." />
	...
	<meta property="og:image" content="../wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/"},"author":{"name":"mflood","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46"},"headline":"3 Barriers Blocking <?php echo $row['country']; ?>&#8217;s Housing Start Initiative","datePublished":"2018-11-21T14:26:21+00:00","dateModified":"2023-09-11T13:48:01+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/"},"wordCount":619,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Redevelopment Authority","Builder","Building","building in <?php echo $row['country']; ?>","Commercial Development","Condo","Developer","Downtown <?php echo $row['country']; ?> Residential Building","homeowner","housing start initiative","Lumber and Building Materials","Triple Decker"],"articleSection":["Architect","<?php echo $row['country']; ?> Condo","Builder","Building in <?php echo $row['country']; ?>","Developer","Homeowner","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/","url":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/","name":"3 Barriers Blocking <?php echo $row['country']; ?>'s Housing Start Initiative - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg","datePublished":"2018-11-21T14:26:21+00:00","dateModified":"2023-09-11T13:48:01+00:00","description":"Experts forecast that housing will stay at a premium in <?php echo $row['country']; ?>. Lawmakers are working on solutions that will increase housing start initiatives while alleviating concerns about traffic, strained public schools and quality of life. 15 communities are hoping to add 185,000 new homes in the next decade.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg","width":2048,"height":1365,"caption":"3 Barriers Blocking <?php echo $row['country']; ?>'s Housing Start Initiative"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"3 Barriers Blocking <?php echo $row['country']; ?>&#8217;s Housing Start Initiative"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46","name":"mflood","url":"<?php echo $row['url']; ?>/author/mflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>3 Barriers Blocking <?php echo $row['country']; ?>&#039;s Housing Start Initiative - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2064.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexb415.php?p=2064' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed626c.json?url=<?php echo $row['url']; ?>%2F3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedc701?url=<?php echo $row['url']; ?>%2F3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2064 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">3 Barriers Blocking <?php echo $row['country']; ?>&#8217;s Housing Start Initiative</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>It’s no secret that <?php echo $row['country']; ?> is facing a serious housing shortage, and in fact, one mayor in the area has <a href="https://www.<?php echo $row['country']; ?>globe.com/business/2018/10/02/citing-housing-emergency-local-mayors-pledge-dramatically-boost-construction/plYlzBr3OoM6W6la3L1zTL/story.php" target="_blank" rel="noopener noreferrer">called the situation</a> an “emergency.” In some areas of this city, rent and home prices are skyrocketing, making it one of the most expensive places to live in the United States. This has led to a <a href="https://www.bdcnetwork.com/boston-‘housing-emergency’-prompts-regional-initiative-new-residential-construction" target="_blank" rel="noopener noreferrer">coalition of mayors</a> in 15 cities around <?php echo $row['country']; ?> to make a pledge to increase the number of homes built in the area. According to the housing start initiative pledge, these 15 communities are hoping to add 185,000 new homes in just over a decade. A housing increase on this scale is forecasted to be enough to keep up with area job growth and <?php echo $row['country']; ?>’s current population boom.</p>
<p><span id="more-2064"></span></p>
<h3><strong><?php echo $row['country']; ?> Housing Challenges</strong></h3>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="606" src="../wp-content/uploads/2018/11/Integrity-Fiberglass-Windows.jpg" class="attachment-large size-large wp-post-image" alt="Integrity Fiberglass Windows" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows-768x455.jpg 768w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../fiberglass-vs-vinyl-windows-for-your-boston-residential-home/index.php">Fiberglass vs. Vinyl Windows for Your <?php echo $row['country']; ?> Residential Home</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:44 GMT -->
</html>
