...
<!-- Mirrored from <?php echo $row['url']; ?>/category/building-trends/page/3/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:55 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/building-trends/page/3/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/building-trends/page/2/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/building-trends/page/4/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Building Trends Archives - Page 3 of 14 - <?php echo $row['name']; ?> " />
	<meta property="og:url" content="<?php echo $row['url']; ?>/category/building-trends/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@NEBS_<?php echo $row['country']; ?>" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"CollectionPage","@id":"<?php echo $row['url']; ?>/category/building-trends/","url":"<?php echo $row['url']; ?>/category/building-trends/page/3/","name":"Building Trends Archives - Page 3 of 14 - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/category/building-trends/page/3/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/category/building-trends/page/3/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png","inLanguage":"en-US"},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/category/building-trends/page/3/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png","width":1280,"height":859,"caption":"fiber cement siding"},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Building Trends Archives - Page 3 of 14 - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Building Trends Category Feed" href="<?php echo $row['url']; ?>/category/building-trends/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/30" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive paged category category-building-trends category-30 wp-custom-logo wp-embed-responsive paged-3 category-paged-3 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2637 post type-post status-publish format-standard has-post-thumbnail hentry category-architect category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-commercial-development tag-fiber-cement tag-home-design tag-home-improvement-contractor tag-remodeler tag-siding tag-siding-materials tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/why-fiber-cement-siding-is-perfect-for-your-boston-building-project/" target="_self" >Why Fiber Cement Siding is Perfect for Your <?php echo $row['country']; ?> Building Project</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="fiber cement siding" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/boston-construction-outlook-for-2020/" target="_self" ><?php echo $row['country']; ?> Construction Outlook for 2020</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> Construction Outlook" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/eco-friendly-drywall-options/" target="_self" >Eco-Friendly Drywall Options</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="eco friendly drywall" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--768x515.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--1024x687.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/10-timeless-kitchen-trends-2/" target="_self" >10 Timeless Kitchen Trends</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="timeless kitchen trends for <?php echo $row['country']; ?> kitchen" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/timeless-kitchen-trends-for-boston-kitchen-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-10-09T12:23:12-04:00">10.09.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/kitchen-design/" rel="tag">Kitchen Design</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="navy blue kitchen cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/the-circular-economy-and-its-impact-on-construction/" target="_self" >The Circular Economy and Its Impact on Construction</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="construction impact on the circular economy" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/construction-impact-on-the-circular-economy-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-08-28T09:24:48-04:00">08.28.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" rel="tag">Building in <?php echo $row['country']; ?></a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/want-in-on-the-matte-black-kitchen-trend-6-ideas-to-help-you-pull-it-off/" target="_self" >Want in on the Matte Black Kitchen Trend? 6 Ideas to Help You Pull It Off!</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="matte black kitchen" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/08/matte-black-kitchen-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-08-14T15:37:53-04:00">08.14.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/kitchen-design/" rel="tag">Kitchen Design</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/6-strategies-for-air-sealing-in-new-construction-and-retrofits/" target="_self" >6 Strategies for Air Sealing in New Construction and Retrofits</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="air sealing" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/air-sealing-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-07-24T09:47:30-04:00">07.24.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			</li><li class="wp-block-post post-2548 post type-post status-publish format-standard has-post-thumbnail hentry category-building-trends category-contractor category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-deck tag-deck-design tag-design-trends tag-home-improvement-contractor tag-lumber-and-building-materials tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/6-deck-design-trends-to-try-this-summer/" target="_self" >6 Deck Design Trends to try this Summer</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="deck design trends" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/07/deck-design-trends-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-07-16T09:00:31-04:00">07.16.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/building-trends/" rel="tag">Building Trends</a>
			...
			<a href="<?php echo $row['url']; ?>/category/building-trends/page/2/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/">1</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/2/">2</a>
<span aria-current="page" class="page-numbers current">3</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/4/">4</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/5/">5</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/14/">14</a></div>

			<a href="<?php echo $row['url']; ?>/category/building-trends/page/4/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/building-trends/page/3/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
