...
<!-- Mirrored from <?php echo $row['url']; ?>/category/building-trends/page/14/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:55 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/building-trends/page/14/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/building-trends/page/13/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Building Trends Archives - Page 14 of 14 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-building-trends category-30 wp-custom-logo wp-embed-responsive paged-14 category-paged-14 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-1133 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-builder tag-building-supplier tag-commercial-development tag-downtown-boston-residential-building tag-historic-urban-environment tag-lumber-and-building-materials">
			...
			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="modern-blending-with-historic-developing-in-<?php echo $row['country']; ?>" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-property-development-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/building-trends/page/13/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/12/">12</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/13/">13</a>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/building-trends/page/14/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<div class="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-layout-18 wp-block-group-is-layout-flex">
