...
<!-- Mirrored from <?php echo $row['url']; ?>/category/building-trends/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:55 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/building-trends/page/2/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/building-trends/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/building-trends/page/3/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Building Trends Archives - Page 2 of 14 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-building-trends category-30 wp-custom-logo wp-embed-responsive paged-2 category-paged-2 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-1215 post type-post status-publish format-standard has-post-thumbnail hentry category-building-trends category-contractor category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-boston-homeowner tag-builder tag-building tag-building-supplier tag-downtown-boston-residential-building tag-home-improvement-contractor tag-home-renovation tag-insulation tag-interior tag-lumber-and-building-materials tag-remodeler tag-winter-weatherization">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/ways-to-increase-energy-efficiency/" target="_self" >2 Ways to Increase Energy Efficiency by Weatherizing Your Home</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="425" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/01/boston-Winter-Winterization-Tips-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> winterization" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/building-trends/" rel="tag">Building Trends</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/strong-demand-and-tight-supply-have-caused-lumber-prices-to-soar/" target="_self" >Why Strong Demand and Tight Supply Have Caused Lumber Prices to Soar</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="853" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/05/Why-Strong-Demand-and-Tight-Supply-Have-Caused-Lumber-Prices-to-Soar.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Why Strong Demand and Tight Supply Have Caused Lumber Prices to Soar" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/05/Why-Strong-Demand-and-Tight-Supply-Have-Caused-Lumber-Prices-to-Soar.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2018/05/Why-Strong-Demand-and-Tight-Supply-Have-Caused-Lumber-Prices-to-Soar-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/05/Why-Strong-Demand-and-Tight-Supply-Have-Caused-Lumber-Prices-to-Soar-1024x682.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-luxury-apartment-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/" target="_self" >How Has COVID-19 Affected Lumber Prices?</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2020-07-16T00:00:45-04:00">07.16.2020</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/building-trends/" rel="tag">Building Trends</a>
			...
			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> roof deck" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/window-and-door-trends-for-2020/" target="_self" >Window and Door Trends for 2020</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1920" height="1288" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends.png 1920w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/window-and-door-trends-1536x1030.png 1536w" sizes="(max-width: 1920px) 100vw, 1920px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/building-trends/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/3/">3</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-trends/page/14/">14</a></div>
			...
			<a href="<?php echo $row['url']; ?>/category/building-trends/page/3/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/building-trends/page/2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
