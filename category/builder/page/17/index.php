...
<!-- Mirrored from <?php echo $row['url']; ?>/category/builder/page/17/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:53 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/builder/page/17/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/builder/page/16/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/builder/page/18/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Builder Archives - Page 17 of 18 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-builder category-5 wp-custom-logo wp-embed-responsive paged-17 category-paged-17 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-962 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-developer tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-boston-condo tag-boston-multifamily tag-building-supplier tag-commercial-development tag-developer tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-lumber-and-building-materials tag-millennial-villages">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/millennial-village-answer-to-<?php echo $row['country']; ?>s-housing-shortage/" target="_self" >Why the Millennial Village Might be the Answer to <?php echo $row['country']; ?>&#8217;s Housing Shortage</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="424" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Millennial-Villages.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-09-06T13:33:36-04:00">09.06.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/cpa-could-mean-for-further-development-in-<?php echo $row['country']; ?>/" target="_self" >What CPA Could Mean for Further Development in <?php echo $row['country']; ?></a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/CPA-and-Further-Development-in-boston-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-09-01T08:09:35-04:00">09.01.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/infographic-top-4-new-england-home-design-trends/" target="_self" >[Infographic] Top 4 New England Home Design Trends</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Design-Trends_4.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-08-31T17:52:54-04:00">08.31.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/bathroom-renovation/" rel="tag">Bathroom Renovation</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/window-replacement-questions-to-ask/" target="_self" >3 Window Replacement Questions to Ask for Your Historic Renovation</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-08-25T10:10:11-04:00">08.25.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/<?php echo $row['country']; ?>s-condo-comeback-brings-high-rise-opportunities/" target="_self" ><?php echo $row['country']; ?>&#8217;s Condo Comeback Brings Developers High Rise Opportunities</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="400" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Condo-Comeback-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-08-10T13:26:23-04:00">08.10.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/use-millwork-to-create-modern-building-masterpiece/" target="_self" >Use Architectural Millwork to Create Your Modern Building Masterpiece</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="720" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1-768x432.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/08/architectural-millwork-1-1-1024x576.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-08-02T23:09:05-04:00">08.02.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/" target="_self" >Located in the Heart of the <?php echo $row['country']; ?> Building Boom</a></h3>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/need-to-know-about-boston-construction-guidelines/" target="_self" >What You Need to Know about <?php echo $row['country']; ?> Construction Guidelines</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="853" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Construction-guidelines.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Construction-guidelines.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Construction-guidelines-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-Construction-guidelines-1024x682.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/learning-to-work-with-boston-redevelopment-authority/" target="_self" >Charting a Course to <?php echo $row['country']; ?>&#8217;s Future: Learning to Work with the <?php echo $row['country']; ?> Redevelopment Authority</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-Redevelopment-Authority-Working-With-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/builder/page/16/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/">1</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/15/">15</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/16/">16</a>
<span aria-current="page" class="page-numbers current">17</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/18/">18</a></div>

			<a href="<?php echo $row['url']; ?>/category/builder/page/18/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/builder/page/17/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
