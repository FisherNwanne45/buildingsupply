...
<!-- Mirrored from <?php echo $row['url']; ?>/category/builder/page/5/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:52 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Builder Category Feed" href="<?php echo $row['url']; ?>/category/builder/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/5" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive paged category category-builder category-5 wp-custom-logo wp-embed-responsive paged-5 category-paged-5 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2541 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-builder category-building-trends category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-bathroom-design tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-energy-efficiency tag-home-improvement-contractor tag-interior tag-kitchen tag-lumber-and-building-materials tag-remodeler tag-skylights tag-trip8 tag-window-design tag-window-replacement tag-windows">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/best-skylights-for-a-boston-home/" target="_self" >Best Skylights for a <?php echo $row['country']; ?> Home</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="skylights <?php echo $row['country']; ?> home" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/from-simple-to-advanced-18-summer-home-renovation-ideas-to-do-now/" target="_self" >From Simple to Advanced: 18 Summer Home Renovation Ideas to Do Now</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/decks/" rel="tag">Decks</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/why-the-multi-panel-slide-door-is-a-rising-trend-in-residential-homes/" target="_self" >Why the Multi Panel Slide Door is a Rising Trend in Residential Homes</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door-.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="multi panel slider door" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door-.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/decks/" rel="tag">Decks</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/8-contemporary-porch-ideas-that-complement-urban-living-2/" target="_self" >8 Contemporary Porch Ideas that Complement Urban Living</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="contemporary porch ideas" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/contemporary-porch-ideas-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/decks/" rel="tag">Decks</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/9-tips-for-two-tone-kitchen-cabinets-in-a-small-kitchen/" target="_self" >9 Tips for Two Tone Kitchen Cabinets in a Small Kitchen</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="two tone kitchen cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-04-24T09:18:15-04:00">04.24.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/" target="_self" >7 Small Patio Makeover Ideas</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="small patio makeover ideas 2" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-04-17T09:09:12-04:00">04.17.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/your-complete-guide-to-interior-house-trim-styles/" target="_self" >Your Complete Guide to Interior House Trim Styles</a></h3>

			<figure class="wp-block-post-featured-image"><img width="800" height="561" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/Metrie-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Metrie M Vintage Industrial" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/Metrie-.jpg 800w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/Metrie--768x539.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			</li><li class="wp-block-post post-2490 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-building tag-downtown-boston-residential-building tag-interior tag-kitchen-cabinets tag-kitchen-design tag-kitchen-trends tag-lumber-and-building-materials tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/the-pros-and-cons-of-a-kitchen-island-for-your-boston-home/" target="_self" >The Pros and Cons of a Kitchen Island for Your <?php echo $row['country']; ?> Home</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Kitchen Island Pros and Cons" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-03-27T09:23:12-04:00">03.27.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<a href="<?php echo $row['url']; ?>/category/builder/page/4/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/">1</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/3/">3</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/4/">4</a>
<span aria-current="page" class="page-numbers current">5</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/6/">6</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/7/">7</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/18/">18</a></div>

			<a href="<?php echo $row['url']; ?>/category/builder/page/6/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/builder/page/5/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
