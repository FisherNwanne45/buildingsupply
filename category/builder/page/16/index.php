...
<!-- Mirrored from <?php echo $row['url']; ?>/category/builder/page/16/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:53 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/builder/page/16/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/builder/page/15/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/builder/page/17/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Builder Archives - Page 16 of 18 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-builder category-5 wp-custom-logo wp-embed-responsive paged-16 category-paged-16 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-1148 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-developer category-homeowner category-kitchen-design category-remodeler tag-automation-tech tag-bathroom-design tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-building-supplier tag-energy-efficient tag-home-automation tag-home-improvement-contractor tag-interior tag-kitchen-design tag-lumber-and-building-materials tag-remodeler tag-sustainability">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/jaw-dropping-innovative-home-solutions-of-the-future/" target="_self" >Jaw- Dropping Innovative Home Solutions of the Future</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="556" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/innovative-home-solutions.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="innovative-home-solutions" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-11-16T10:37:15-05:00">11.16.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/infographic-5-hot-kitchen-design-trends-for-your-next-building-project/" target="_self" >[Infographic] 5 Hot Kitchen Design Trends for Your Next Building Project</a></h3>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-11-14T10:44:57-05:00">11.14.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/modernize-the-historic-urban-environment/" target="_self" >How to Modernize the Historic Urban Environment (without angering the neighborhood!)</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/modern-blending-with-historic-developing-in-boston-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="modern-blending-with-historic-developing-in-<?php echo $row['country']; ?>" style="object-fit:cover;" decoding="async" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-11-09T10:45:42-05:00">11.09.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/" target="_self" >3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/mixed-use-development-projects-.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-10-26T17:32:18-04:00">10.26.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/3-boston-property-development-mistakes-to-avoid/" target="_self" >3 <?php echo $row['country']; ?> Property Development Mistakes to Avoid</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-property-development-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-10-12T09:41:35-04:00">10.12.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/technology-streamlines-registration-process/" target="_self" >Technology Streamlines Registration Process for Home Improvement Contractors</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/home-improvement-contractor-registration-<?php echo $row['country']; ?>.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/boston-housing-trend-moves-from-rental-to-ownership/" target="_self" >Developers Wanted as <?php echo $row['country']; ?> Housing Trend Moves from Rental to Ownership</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="424" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/boston-housing-trend.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-09-21T09:06:26-04:00">09.21.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/automation-tech-vital-topic-for-builders-and-developers/" target="_self" >Automation Tech: Another Vital Topic for <?php echo $row['country']; ?> Builders and Developers</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="426" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/home-automation-tech-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-09-15T09:09:58-04:00">09.15.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/" target="_self" >What Builders Need to Know About the Stretch Energy Code</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-stretch-energy-code-1-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2016-09-13T10:25:02-04:00">09.13.2016</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/builder/page/15/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/">1</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/14/">14</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/15/">15</a>
<span aria-current="page" class="page-numbers current">16</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/17/">17</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/18/">18</a></div>

			<a href="<?php echo $row['url']; ?>/category/builder/page/17/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/builder/page/16/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
