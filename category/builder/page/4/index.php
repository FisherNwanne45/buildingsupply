...
<!-- Mirrored from <?php echo $row['url']; ?>/category/builder/page/4/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:52 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/builder/page/4/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/builder/page/3/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/builder/page/5/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Builder Archives - Page 4 of 18 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-builder category-5 wp-custom-logo wp-embed-responsive paged-4 category-paged-4 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2631 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-construction-crew category-contractor category-remodeler tag-<?php echo $row['country']; ?> tag-builder tag-construction tag-construction-supplies tag-contractor tag-pro tag-remodeler tag-tool-belt">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/how-to-choose-a-quality-tool-belt/" target="_self" >How to Choose a Quality Tool Belt</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/boston-construction-safety-why-carbon-fiber-hard-hats-are-rising-in-popularity/" target="_self" ><?php echo $row['country']; ?> Construction Safety: Why Carbon Fiber Hard Hats are Rising in Popularity</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2560" height="1780" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-scaled.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Carbon Fiber Construction Hats DAX" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-scaled.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-768x534.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1024x712.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-1536x1068.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/Carbon-Fiber-Construction-Hats-DAX-2048x1424.jpg 2048w" sizes="(max-width: 2560px) 100vw, 2560px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-09-11T09:50:58-04:00">09.11.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/builder/page/3/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/">1</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/2/">2</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/3/">3</a>
<span aria-current="page" class="page-numbers current">4</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/5/">5</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/builder/page/18/">18</a></div>
			...
			<a href="<?php echo $row['url']; ?>/category/builder/page/5/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/builder/page/4/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
