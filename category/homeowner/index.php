...
<!-- Mirrored from <?php echo $row['url']; ?>/category/homeowner/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:56 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Homeowner Category Feed" href="<?php echo $row['url']; ?>/category/homeowner/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/28" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive category category-homeowner category-28 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
			...
			<div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex">
				<h1 class="alignwide wp-block-heading wp-block-query-title has-h-2-font-size">Category: <span>Homeowner</span></h1>
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/building-better-with-acre-trim/" target="_self" >Building Better with ACRE Trim</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1680" height="984" src="<?php echo $row['url']; ?>/wp-content/uploads/2022/10/acre-trim-nebs.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/10/acre-trim-nebs.jpg 1680w, <?php echo $row['url']; ?>/wp-content/uploads/2022/10/acre-trim-nebs-768x450.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/10/acre-trim-nebs-1024x600.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2022/10/acre-trim-nebs-1536x900.jpg 1536w" sizes="(max-width: 1680px) 100vw, 1680px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/4-benefits-of-marvin-windows-where-style-meets-strength/" target="_self" >4 Benefits of Marvin Windows: Where Style Meets Strength</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1661" height="1262" src="<?php echo $row['url']; ?>/wp-content/uploads/2022/08/NEBS-Marvin-Windows-2022.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/08/NEBS-Marvin-Windows-2022.jpg 1661w, <?php echo $row['url']; ?>/wp-content/uploads/2022/08/NEBS-Marvin-Windows-2022-768x584.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/08/NEBS-Marvin-Windows-2022-1024x778.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2022/08/NEBS-Marvin-Windows-2022-1536x1167.jpg 1536w" sizes="(max-width: 1661px) 100vw, 1661px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/interior-door-trends/" target="_self" >How to Stylize Your Space with Interior Doors</a></h3>

			<figure class="wp-block-post-featured-image"><img width="940" height="788" src="<?php echo $row['url']; ?>/wp-content/uploads/2022/06/Untitled-design-2.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/06/Untitled-design-2.png 940w, <?php echo $row['url']; ?>/wp-content/uploads/2022/06/Untitled-design-2-768x644.png 768w" sizes="(max-width: 940px) 100vw, 940px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/lumber-prices-canadian-tariff/" target="_self" >Lumber Prices on the Rise: How the Canadian Softwood Tariff Affects <?php echo $row['country']; ?> Builders</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2560" height="1707" src="<?php echo $row['url']; ?>/wp-content/uploads/2022/02/shutterstock_1470717023-scaled-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="lumber prices" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/02/shutterstock_1470717023-scaled-1.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2022/02/shutterstock_1470717023-scaled-1-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/02/shutterstock_1470717023-scaled-1-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2022/02/shutterstock_1470717023-scaled-1-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2022/02/shutterstock_1470717023-scaled-1-2048x1366.jpg 2048w" sizes="(max-width: 2560px) 100vw, 2560px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/2022-outdoor-living-trends/" target="_self" >2022 Outdoor Living Trends You Don’t Want to Miss</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2560" height="1707" src="<?php echo $row['url']; ?>/wp-content/uploads/2022/01/shutterstock_2051707550-scaled-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="outdoor living trends" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2022/01/shutterstock_2051707550-scaled-1.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2022/01/shutterstock_2051707550-scaled-1-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2022/01/shutterstock_2051707550-scaled-1-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2022/01/shutterstock_2051707550-scaled-1-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2022/01/shutterstock_2051707550-scaled-1-2048x1366.jpg 2048w" sizes="(max-width: 2560px) 100vw, 2560px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/maximize-small-kitchen/" target="_self" >10 Tips to Maximize Your Small Kitchen</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2560" height="1707" src="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/shutterstock_1196809243-scaled-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="maximize small kitchen" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/shutterstock_1196809243-scaled-1.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/shutterstock_1196809243-scaled-1-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/shutterstock_1196809243-scaled-1-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/shutterstock_1196809243-scaled-1-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/shutterstock_1196809243-scaled-1-2048x1366.jpg 2048w" sizes="(max-width: 2560px) 100vw, 2560px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1640" height="1162" src="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="weatherproof outdoor cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets.png 1640w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-768x544.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1024x726.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1536x1088.png 1536w" sizes="(max-width: 1640px) 100vw, 1640px" /></figure>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/homeowner/page/2/">2</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/homeowner/page/3/">3</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/homeowner/page/16/">16</a></div>

			<a href="<?php echo $row['url']; ?>/category/homeowner/page/2/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/homeowner/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
