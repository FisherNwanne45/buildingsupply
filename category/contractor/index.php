...
<!-- Mirrored from <?php echo $row['url']; ?>/category/contractor/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:52 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Contractor Category Feed" href="<?php echo $row['url']; ?>/category/contractor/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/40" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive category category-contractor category-40 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
			...
			<div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex">
				<h1 class="alignwide wp-block-heading wp-block-query-title has-h-2-font-size">Category: <span>Contractor</span></h1>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/benefits-green-building/" target="_self" >Benefits of Green Building: The Importance of Building a Greener Future</a></h3>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/contractor/page/2/">2</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/contractor/page/3/">3</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/contractor/page/15/">15</a></div>

			<a href="<?php echo $row['url']; ?>/category/contractor/page/2/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/contractor/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
