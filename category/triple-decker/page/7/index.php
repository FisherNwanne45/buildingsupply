...
<!-- Mirrored from <?php echo $row['url']; ?>/category/triple-decker/page/7/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:48 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/triple-decker/page/7/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/triple-decker/page/6/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Triple Decker Archives - Page 7 of 7 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-triple-decker category-100 wp-custom-logo wp-embed-responsive paged-7 category-paged-7 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-1581 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-trends category-contractor category-developer category-homeowner category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-construction tag-boston-homeowner tag-boston-housing tag-builder tag-building tag-building-supplier tag-developer tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-home-improvement-contractor tag-home-renovation tag-lumber-and-building-materials tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/floor-options-for-your-boston-remodel/" target="_self" >Closed, Semi or Open Floor: Options for Your <?php echo $row['country']; ?> Remodel</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2048" height="1365" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/07/floor-plan-options-boston-remodel-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="floor plan options <?php echo $row['country']; ?> remodel" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2017/07/floor-plan-options-boston-remodel-.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2017/07/floor-plan-options-boston-remodel--768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2017/07/floor-plan-options-boston-remodel--1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2017/07/floor-plan-options-boston-remodel--1536x1024.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2017-07-26T09:08:43-04:00">07.26.2017</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			</li><li class="wp-block-post post-1562 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-construction-crew category-contractor category-developer category-homeowner category-remodeler category-triple-decker tag-bathroom-renovation tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-boston-multifamily tag-building-codes tag-building-supplier tag-condo tag-downtown-boston-residential-building tag-gut-rehab tag-gut-renovation tag-home-renovation tag-interior tag-kitchen-design tag-lumber-and-building-materials tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/boston-gut-renovation-not-for-the-faint-heart/" target="_self" >Why Tackling a <?php echo $row['country']; ?> Gut Renovation Is Not for the Faint of Heart</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="426" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/06/boston-Gut-Renovation-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> Gut Renovation" style="object-fit:cover;" decoding="async" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2017-06-21T08:21:09-04:00">06.21.2017</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/bathroom-renovation/" rel="tag">Bathroom Renovation</a>
			...
			</li><li class="wp-block-post post-1560 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-contractor category-developer category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-homeowner tag-building-supplier tag-deck tag-downtown-boston-residential-building tag-home-improvement-contractor tag-lumber-and-building-materials tag-roof-deck tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/pros-vs-cons-of-redecking-your-boston-triple-decker/" target="_self" >Pros vs. Cons of Redecking Your <?php echo $row['country']; ?> Triple Decker</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="431" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/06/redecking-triple-decker-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="redecking triple decker" style="object-fit:cover;" decoding="async" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2017-06-14T09:12:13-04:00">06.14.2017</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			</li><li class="wp-block-post post-1556 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-policies category-building-trends category-contractor category-developer category-homeowner category-triple-decker tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-boston-redevelopment-authority tag-builder tag-building tag-building-codes tag-commercial-development tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-home-improvement-contractor tag-lumber-and-building-materials tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/complying-with-massachusetts-home-improvement/" target="_self" >5 Tips for Complying With Massachusetts Home Improvement Contractor Law</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/06/tips-for-working-with-boston-HIC-laws.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="tips for working with <?php echo $row['country']; ?> HIC laws" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2017-06-07T09:31:45-04:00">06.07.2017</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			</li><li class="wp-block-post post-1534 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-policies category-contractor category-developer category-homeowner category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-building-codes tag-building-supplier tag-diy-home-improvement tag-downtown-boston-residential-building tag-lumber-and-building-materials tag-permits-and-regulations tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/remodel-boston-home-structural-changes/" target="_self" >Remodeling your <?php echo $row['country']; ?> Home? Structural Changes that Require a Permit</a></h3>

			<figure class="wp-block-post-featured-image"><img width="956" height="589" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/04/boston-neighborhood-home-improvement.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> neighborhood home improvement" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2017/04/boston-neighborhood-home-improvement.png 956w, <?php echo $row['url']; ?>/wp-content/uploads/2017/04/boston-neighborhood-home-improvement-768x473.png 768w" sizes="(max-width: 956px) 100vw, 956px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2017-04-26T12:08:29-04:00">04.26.2017</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			</li><li class="wp-block-post post-1512 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-boston-multifamily tag-building tag-building-supplier tag-condo tag-downtown-boston-residential-building tag-home-improvement-contractor tag-lumber-and-building-materials tag-real-estate tag-remodeler tag-triple-decker tag-triple-decker-condo-conversion">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/improve-your-triple-decker-condo-conversion/" target="_self" >6 Creative Ways You Can Improve Your Triple Decker Condo Conversion</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="425" src="<?php echo $row['url']; ?>/wp-content/uploads/2017/03/triple-deckers-boston-renovations.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="triple deckers <?php echo $row['country']; ?> renovations conversion" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2017-03-29T09:57:09-04:00">03.29.2017</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<a href="<?php echo $row['url']; ?>/category/triple-decker/page/6/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/6/">6</a>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/triple-decker/page/7/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
