...
<!-- Mirrored from <?php echo $row['url']; ?>/category/triple-decker/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:47 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/triple-decker/page/2/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/triple-decker/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/triple-decker/page/3/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Triple Decker Archives - Page 2 of 7 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-triple-decker category-100 wp-custom-logo wp-embed-responsive paged-2 category-paged-2 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2499 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-decks category-homeowner category-remodeler category-triple-decker">
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="small patio makeover ideas 2" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Kitchen Island Pros and Cons" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/03/Kitchen-Island-Pros-and-Cons-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<figure class="wp-block-post-featured-image"><img width="938" height="479" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/boston-Development-predictions-2019.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> Development predictions 2019" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/boston-Development-predictions-2019.jpg 938w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/boston-Development-predictions-2019-768x392.jpg 768w" sizes="(max-width: 938px) 100vw, 938px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/galley-kitchen.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="galley kitchen" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			</li><li class="wp-block-post post-2308 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-trends category-homeowner category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-downtown-boston-residential-building tag-exterior-door tag-lumber-and-building-materials tag-remodeler tag-triple-decker tag-window-trends">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/window-and-door-design-trends-2/" target="_self" >2019 Window and Door Design Trends</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1590" height="962" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/12/window-and-door-design-trends.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="window and door design trends" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/12/window-and-door-design-trends.png 1590w, <?php echo $row['url']; ?>/wp-content/uploads/2018/12/window-and-door-design-trends-768x465.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/12/window-and-door-design-trends-1024x620.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/12/window-and-door-design-trends-1536x929.png 1536w" sizes="(max-width: 1590px) 100vw, 1590px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-12-19T09:27:17-05:00">12.19.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/triple-decker/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/3/">3</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/7/">7</a></div>
			...
			<a href="<?php echo $row['url']; ?>/category/triple-decker/page/3/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/triple-decker/page/2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
