...
<!-- Mirrored from <?php echo $row['url']; ?>/category/triple-decker/page/3/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:47 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Triple Decker Category Feed" href="<?php echo $row['url']; ?>/category/triple-decker/feed/" />
<script>
...
<link rel='stylesheet' id='wp-block-cover-css' href='<?php echo $row['url']; ?>/wp-includes/blocks/cover/style.min.css?ver=6.4.5' media='all' />
...
<link rel='stylesheet' id='wp-block-library-css' href='<?php echo $row['url']; ?>/wp-includes/css/dist/block-library/common.min.css?ver=6.4.5' media='all' />
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/100" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive paged category category-triple-decker category-100 wp-custom-logo wp-embed-responsive paged-3 category-paged-3 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
			...
			<div class="wp-block-cover alignfull is-light" style="min-height:569px">
				...
				<img class="wp-block-cover__image-background wp-image-205" alt="" src="<?php echo $row['url']; ?>/wp-content/uploads/2023/03/Yard-18-scaled.jpg" style="object-position:47% 13%" data-object-fit="cover" data-object-position="47% 13%"/>
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2304 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-building-supplier tag-downtown-<?php echo $row['country']; ?> tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-kitchen-planning tag-kitchen-showroom tag-kitchen-trends tag-remodeler tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/what-to-expect-when-designing-your-new-boston-kitchen/" target="_self" >What to Expect When Designing Your New <?php echo $row['country']; ?> Kitchen</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1590" height="962" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="what to expect when designing your <?php echo $row['country']; ?> kitchen" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen.png 1590w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen-768x465.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen-1024x620.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen-1536x929.png 1536w" sizes="(max-width: 1590px) 100vw, 1590px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-12-13T19:12:32-05:00">12.13.2018</time></div>

				    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
    </div>
			...
			</li><li class="wp-block-post post-2146 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-trends category-contractor category-developer category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-commercial-development tag-downtown-boston-residential-building tag-energy-efficient-windows tag-fiberglass-windows tag-home-improvement-contractor tag-lumber-and-building-materials tag-vinyl-windows tag-window-replacement tag-windows">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/fiberglass-vs-vinyl-windows-for-your-boston-residential-home/" target="_self" >Fiberglass vs. Vinyl Windows for Your <?php echo $row['country']; ?> Residential Home</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1024" height="606" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Integrity Fiberglass Windows" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows-768x455.jpg 768w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-11-28T08:30:44-05:00">11.28.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/3-barriers-blocking-<?php echo $row['country']; ?>s-housing-start-initiative-2/" target="_self" >3 Barriers Blocking <?php echo $row['country']; ?>&#8217;s Housing Start Initiative</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2048" height="1365" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="3 Barriers Blocking <?php echo $row['country']; ?>&#039;s Housing Start Initiative" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1536x1024.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-11-21T09:26:21-05:00">11.21.2018</time></div>
				    ...
				    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
    </div>
			...
			</li><li class="wp-block-post post-2044 post type-post status-publish format-standard has-post-thumbnail hentry category-architect category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-home-technology category-homeowner category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-condo tag-double-pane-windows tag-downtown-boston-residential-building tag-energy-efficient tag-lumber-and-building-materials tag-noise-reduction tag-remodeler tag-stc-windows tag-window-design">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/noise-reduction-windows-assist-with-sound-control/" target="_self" >How Noise Reduction Windows Assist with Sound Control for Your <?php echo $row['country']; ?> Condo</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2048" height="1601" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Integrity-Noise-Reducing-Windows" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows-768x600.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows-1024x801.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Noise-Reducing-Windows-1536x1201.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-11-15T09:14:31-05:00">11.15.2018</time></div>
				    ...
				    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
    </div>
			...
			</li><li class="wp-block-post post-1975 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-bathroom-renovation tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-home-improvement-contractor tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-kitchen-remodel tag-kitchen-renovation tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/pros-cons-of-inset-cabinets-vs-full-overlay-cabinets/" target="_self" >The Pros and Cons of Inset Cabinets vs. Full Overlay Cabinets</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2048" height="1365" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/full-vs-overlay-kitchen-cabinets.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="full vs overlay kitchen cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/full-vs-overlay-kitchen-cabinets.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/full-vs-overlay-kitchen-cabinets-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/full-vs-overlay-kitchen-cabinets-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/full-vs-overlay-kitchen-cabinets-1536x1024.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-11 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-10-31T08:05:07-04:00">10.31.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/beaded-inset-and-plain-inset-kitchen-cabinets/" target="_self" >Choosing Between Beaded Inset and Plain Inset Kitchen Cabinets</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="852" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Beaded inset vs plain inset kitchen cabinets" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets-768x511.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/Beaded-inset-vs-plain-inset-kitchen-cabinets-1024x682.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			</li><li class="wp-block-post post-1957 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-condo tag-downtown-boston-residential-building tag-home-improvement-contractor tag-kitchen-design tag-remodeler tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/kitchen-islands-add-pop-of-color-to-design-scheme/" target="_self" >Why Contrasting Kitchen Islands Add a Pop of Color to Your Design Scheme</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2048" height="1365" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="contrasting kitchen island colors" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors-1536x1024.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-14 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-10-10T09:59:33-04:00">10.10.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			</li><li class="wp-block-post post-1952 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-contractor category-developer category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-downtown-boston-residential-building tag-home-improvement-contractor tag-lumber tag-lumber-and-building-materials tag-lumber-dealer tag-lumber-tariffs tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/" target="_self" >The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="853" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry-1024x682.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-15 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-10-02T14:12:57-04:00">10.02.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/triple-decker/page/2/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/">1</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/2/">2</a>
<span aria-current="page" class="page-numbers current">3</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/4/">4</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/5/">5</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/triple-decker/page/7/">7</a></div>

			<a href="<?php echo $row['url']; ?>/category/triple-decker/page/4/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/triple-decker/page/3/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
<figure class="wp-block-image size-full is-resized"><img loading="lazy" decoding="async" width="318" height="84" src="<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo-white.png" alt="<?php echo $row['name']; ?> " class="wp-image-76" style="width:159px;height:undefinedpx"/></figure>
