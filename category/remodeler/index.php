...
<!-- Mirrored from <?php echo $row['url']; ?>/category/remodeler/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:59 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Remodeler Category Feed" href="<?php echo $row['url']; ?>/category/remodeler/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/8" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive category category-remodeler category-8 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
			...
			<div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex">
				<h1 class="alignwide wp-block-heading wp-block-query-title has-h-2-font-size">Category: <span>Remodeler</span></h1>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/remodeler/page/2/">2</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/remodeler/page/3/">3</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/remodeler/page/16/">16</a></div>

			<a href="<?php echo $row['url']; ?>/category/remodeler/page/2/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/remodeler/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
