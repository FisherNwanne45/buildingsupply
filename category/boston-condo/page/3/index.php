...
<!-- Mirrored from <?php echo $row['url']; ?>/category/boston-condo/page/3/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:49 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/boston-condo/page/3/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/boston-condo/page/2/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/boston-condo/page/4/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="<?php echo $row['country']; ?> Condo Archives - Page 3 of 9 - <?php echo $row['name']; ?> " />
	<meta property="og:url" content="<?php echo $row['url']; ?>/category/boston-condo/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@NEBS_<?php echo $row['country']; ?>" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"CollectionPage","@id":"<?php echo $row['url']; ?>/category/boston-condo/","url":"<?php echo $row['url']; ?>/category/boston-condo/page/3/","name":"<?php echo $row['country']; ?> Condo Archives - Page 3 of 9 - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/category/boston-condo/page/3/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/category/boston-condo/page/3/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","inLanguage":"en-US"},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/category/boston-condo/page/3/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png","width":870,"height":482,"caption":"coral pantone color of the year"},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]}]}</script>
	<!-- / Yoast SEO plugin. -->


<title><?php echo $row['country']; ?> Condo Archives - Page 3 of 9 - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; <?php echo $row['country']; ?> Condo Category Feed" href="<?php echo $row['url']; ?>/category/boston-condo/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/37" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive paged category category-boston-condo category-37 wp-custom-logo wp-embed-responsive paged-3 category-paged-3 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2403 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-bathroom-design tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-design-trends tag-downtown-boston-residential-building tag-home-improvement-contractor tag-kitchen-design tag-kitchen-trends tag-lumber-and-building-materials tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/4-tips-on-how-to-use-living-coral-pantone-color-of-the-year/" target="_self" >4 Tips on How to Use “Living Coral” Pantone Color of the Year</a></h3>

			<figure class="wp-block-post-featured-image"><img width="870" height="482" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="coral pantone color of the year" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png 870w, <?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year--768x425.png 768w" sizes="(max-width: 870px) 100vw, 870px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-02-14T09:35:23-05:00">02.14.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/2019-boston-real-estate-development-predictions/" target="_self" >2019 <?php echo $row['country']; ?> Real Estate Development Predictions</a></h3>

			<figure class="wp-block-post-featured-image"><img width="938" height="479" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/boston-Development-predictions-2019.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> Development predictions 2019" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/boston-Development-predictions-2019.jpg 938w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/boston-Development-predictions-2019-768x392.jpg 768w" sizes="(max-width: 938px) 100vw, 938px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/10-galley-kitchen-remodeling-ideas-2/" target="_self" >10 Galley Kitchen Remodeling Ideas</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/galley-kitchen.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="galley kitchen" style="object-fit:cover;" decoding="async" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			</li><li class="wp-block-post post-2315 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-boston-building tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-condo tag-design-trends tag-downtown-boston-residential-building tag-home-design tag-kitchen-design tag-lumber-and-building-materials tag-remodeler tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/4-must-have-home-design-trends-for-2019/" target="_self" >4 Must-Have Home Design Trends for 2019</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/12/4-must-have-home-design-trends.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="4 must have home design trends" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-10 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-12-27T09:15:04-05:00">12.27.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			</li><li class="wp-block-post post-2304 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-building-supplier tag-downtown-<?php echo $row['country']; ?> tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-kitchen-planning tag-kitchen-showroom tag-kitchen-trends tag-remodeler tag-triple-decker">
			...
			<figure class="wp-block-post-featured-image"><img width="1590" height="962" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="what to expect when designing your <?php echo $row['country']; ?> kitchen" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen.png 1590w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen-768x465.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen-1024x620.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/01/what-to-expect-when-designing-your-boston-kitchen-1536x929.png 1536w" sizes="(max-width: 1590px) 100vw, 1590px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			</li><li class="wp-block-post post-2296 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-trends category-homeowner category-kitchen-design category-remodeler tag-boston-condo tag-builders tag-homeowners tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-kitchen-storage tag-kitchen-trends tag-remodelers tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/6-must-have-kitchen-cabinet-organizers-and-accessories-2/" target="_self" >6 Must Have Kitchen Cabinet Organizers and Accessories</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1590" height="962" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/12/6-Must-Have-Kitchen-Cabinet-Organizers-and-Accessories.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="6 Must Have Kitchen Cabinet Organizers and Accessories" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/12/6-Must-Have-Kitchen-Cabinet-Organizers-and-Accessories.png 1590w, <?php echo $row['url']; ?>/wp-content/uploads/2018/12/6-Must-Have-Kitchen-Cabinet-Organizers-and-Accessories-768x465.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/12/6-Must-Have-Kitchen-Cabinet-Organizers-and-Accessories-1024x620.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/12/6-Must-Have-Kitchen-Cabinet-Organizers-and-Accessories-1536x929.png 1536w" sizes="(max-width: 1590px) 100vw, 1590px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2018-12-05T09:53:11-05:00">12.05.2018</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1024" height="606" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Integrity Fiberglass Windows" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/Integrity-Fiberglass-Windows-768x455.jpg 768w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<figure class="wp-block-post-featured-image"><img width="2048" height="1365" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="3 Barriers Blocking <?php echo $row['country']; ?>&#039;s Housing Start Initiative" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/11/3-Barriers-Blocking-<?php echo $row['country']; ?>s-Housing-Start-Initiative-1536x1024.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<a href="<?php echo $row['url']; ?>/category/boston-condo/page/2/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/">1</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/page/2/">2</a>
<span aria-current="page" class="page-numbers current">3</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/page/4/">4</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/page/5/">5</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/page/9/">9</a></div>

			<a href="<?php echo $row['url']; ?>/category/boston-condo/page/4/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/boston-condo/page/3/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
