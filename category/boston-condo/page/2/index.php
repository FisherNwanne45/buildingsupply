...
<!-- Mirrored from <?php echo $row['url']; ?>/category/boston-condo/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:48 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/boston-condo/page/2/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/boston-condo/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/boston-condo/page/3/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="<?php echo $row['country']; ?> Condo Archives - Page 2 of 9 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-boston-condo category-37 wp-custom-logo wp-embed-responsive paged-2 category-paged-2 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2584 post type-post status-publish format-standard has-post-thumbnail hentry category-boston-condo category-builder category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-cabinets tag-downtown-<?php echo $row['country']; ?> tag-kitchen tag-kitchen-cabinets tag-kitchen-design tag-kitchen-trends tag-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/4-reasons-to-jump-on-the-navy-cabinet-kitchen-trend/" target="_self" >4 Reasons to Jump on the Navy Cabinet Kitchen Trend</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="navy blue kitchen cabinets" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/09/navy-blue-kitchen-cabinets-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-09-25T09:22:35-04:00">09.25.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/remodeler/" rel="tag">Remodeler</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door-.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="multi panel slider door" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door-.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/multi-panel-slider-door--1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<a href="<?php echo $row['url']; ?>/category/boston-condo/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/page/3/">3</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/boston-condo/page/9/">9</a></div>
			...
			<a href="<?php echo $row['url']; ?>/category/boston-condo/page/3/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/boston-condo/page/2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
