...
<!-- Mirrored from <?php echo $row['url']; ?>/category/bathroom-renovation/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:48 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Bathroom Renovation Category Feed" href="<?php echo $row['url']; ?>/category/bathroom-renovation/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/47" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive category category-bathroom-renovation category-47 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
			...
			<div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex">
				<h1 class="alignwide wp-block-heading wp-block-query-title has-h-2-font-size">Category: <span>Bathroom Renovation</span></h1>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/5-top-fall-projects-for-your-boston-condo-renovation/" target="_self" >8 Top Fall Projects for Your <?php echo $row['country']; ?> Condo Renovation</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/bathroom-renovation/" rel="tag">Bathroom Renovation</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/take-your-boston-bathroom-to-new-heights/" target="_self" >Banish Boring with These Top <?php echo $row['country']; ?> Bathroom Trends</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="skylights <?php echo $row['country']; ?> home" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/skylights-boston-home-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/triple-decker/" rel="tag">Triple Decker</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/06/18-home-renovation-products-to-do-this-summer-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/decks/" rel="tag">Decks</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/bring-the-beach-home-6-coastal-themed-bathroom-ideas/" target="_self" >Bring the Beach Home: 6 Coastal Themed Bathroom Ideas</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/05/Beach-Themed-Bathroom-Ideas-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-05-22T09:21:20-04:00">05.22.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/remodeler/" rel="tag">Remodeler</a>
			...
			</li><li class="wp-block-post post-2426 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-homeowner category-remodeler tag-bathroom tag-bathroom-design tag-bathroom-remodel tag-bathroom-renovation tag-<?php echo $row['country']; ?> tag-boston-building tag-boston-condo tag-boston-homeowner tag-building-supplier tag-home-improvement-contractor tag-lumber-and-building-materials tag-remodeler tag-triple-decker">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/6-small-bathroom-remodeling-solutions-for-spring/" target="_self" >6 Small Bathroom Remodeling Solutions for Spring</a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/boston-bathroom-remodeling-ideas.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> bathroom remodeling ideas" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-13 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2019-02-26T09:02:26-05:00">02.26.2019</time></div>
        ...
        <a href="<?php echo $row['url']; ?>/category/bathroom-renovation/" rel="tag">Bathroom Renovation</a>
			...
			</li><li class="wp-block-post post-2403 post type-post status-publish format-standard has-post-thumbnail hentry category-bathroom-renovation category-boston-condo category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-contractor category-developer category-homeowner category-kitchen-design category-remodeler category-triple-decker tag-bathroom-design tag-<?php echo $row['country']; ?> tag-boston-condo tag-boston-homeowner tag-builder tag-building-supplier tag-design-trends tag-downtown-boston-residential-building tag-home-improvement-contractor tag-kitchen-design tag-kitchen-trends tag-lumber-and-building-materials tag-remodeler">
			...
			<figure class="wp-block-post-featured-image"><img width="870" height="482" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="coral pantone color of the year" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year-.png 870w, <?php echo $row['url']; ?>/wp-content/uploads/2019/02/coral-pantone-color-of-the-year--768x425.png 768w" sizes="(max-width: 870px) 100vw, 870px" /></figure>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/bathroom-renovation/page/2/">2</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/bathroom-renovation/page/3/">3</a></div>

			<a href="<?php echo $row['url']; ?>/category/bathroom-renovation/page/2/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/bathroom-renovation/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
