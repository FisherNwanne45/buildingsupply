...
<!-- Mirrored from <?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:50 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/2/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/4/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Building in <?php echo $row['country']; ?> Archives - Page 3 of 14 - <?php echo $row['name']; ?> " />
	<meta property="og:url" content="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:site" content="@NEBS_<?php echo $row['country']; ?>" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"CollectionPage","@id":"<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/","url":"<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/","name":"Building in <?php echo $row['country']; ?> Archives - Page 3 of 14 - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","inLanguage":"en-US"},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg","width":640,"height":427,"caption":"<?php echo $row['country']; ?> roof deck"},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Building in <?php echo $row['country']; ?> Archives - Page 3 of 14 - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Building in <?php echo $row['country']; ?> Category Feed" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/categories/6" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
...
<body class="archive paged category category-building-in-<?php echo $row['country']; ?> category-6 wp-custom-logo wp-embed-responsive paged-3 category-paged-3 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-857 post type-post status-publish format-standard has-post-thumbnail hentry category-builder category-building-in-<?php echo $row['country']; ?> category-building-trends category-decks category-homeowner category-remodeler tag-<?php echo $row['country']; ?> tag-builder tag-building tag-building-supplier tag-developer tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-remodeler tag-roof-deck tag-summer-building">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/" target="_self" >Need Outdoor Space? Build a Roof Deck!</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="427" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/boston-roof-deck.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> roof deck" style="object-fit:cover;" decoding="async" fetchpriority="high" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/how-to-keep-construction-workers-safe-amid-covid-19-virus-fears/" target="_self" >How to Keep Construction Workers Safe Amid COVID-19 Virus Fears</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-to-keep-construction-workers-safe-during-covid-19-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/what-is-a-carbon-neutral-building/" target="_self" >What is a Carbon Neutral Building?</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/03/carbon-neutral-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" rel="tag">Building in <?php echo $row['country']; ?></a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/would-rent-control-hurt-or-help-boston-developers/" target="_self" >Would Rent Control Hurt or Help <?php echo $row['country']; ?> Developers?</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1920" height="1288" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control.png 1920w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/01/boston-rent-control-1536x1030.png 1536w" sizes="(max-width: 1920px) 100vw, 1920px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="fiber cement siding" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/12/fiber-cement-siding-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/construction-tool-belts-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="<?php echo $row['country']; ?> Construction Outlook" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/architect/" rel="tag">Architect</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="eco friendly drywall" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--768x515.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall--1024x687.jpg 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/2/" class="wp-block-query-pagination-previous">Previous</a>

			<div class="wp-block-query-pagination-numbers"><a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/">1</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/2/">2</a>
<span aria-current="page" class="page-numbers current">3</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/4/">4</a>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/5/">5</a>
<span class="page-numbers dots">&hellip;</span>
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/14/">14</a></div>

			<a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/4/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/building-in-<?php echo $row['country']; ?>/page/3/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
