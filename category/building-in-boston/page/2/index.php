...
<!-- Mirrored from <?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/2/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:50 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/2/" />
	<link rel="prev" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" />
	<link rel="next" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Building in <?php echo $row['country']; ?> Archives - Page 2 of 14 - <?php echo $row['name']; ?> " />
...
<body class="archive paged category category-building-in-<?php echo $row['country']; ?> category-6 wp-custom-logo wp-embed-responsive paged-2 category-paged-2 without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-2814 post type-post status-publish format-standard has-post-thumbnail hentry category-building-in-<?php echo $row['country']; ?> category-building-trends category-decks category-homeowner category-kitchen-design category-remodeler">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/weatherproof-outdoor-cabinets-2/" target="_self" >Weatherproof Outdoor Cabinets: What Material Should I Use?</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1640" height="1162" src="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="weatherproof outdoor cabinets" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets.png 1640w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-768x544.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1024x726.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1536x1088.png 1536w" sizes="(max-width: 1640px) 100vw, 1640px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" rel="tag">Building in <?php echo $row['country']; ?></a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/type-x-type-c-drywall/" target="_self" >Type X &#038; Type C Drywall: What You Need to Know About Fire-Rated Drywall</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2560" height="1707" src="<?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="type c vs type x drywall" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1-2048x1366.jpg 2048w" sizes="(max-width: 2560px) 100vw, 2560px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/sustainable-building-trex/" target="_self" >Go Green with Trex Decking: A Sustainable Building Solution</a></h3>

			<figure class="wp-block-post-featured-image"><img width="2048" height="1071" src="<?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="sustainable building" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n.jpg 2048w, <?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n-768x402.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n-1024x536.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/04/39883124_10161020890015554_7179577394825527296_n-1536x803.jpg 1536w" sizes="(max-width: 2048px) 100vw, 2048px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/trex-decking-benefits/" target="_self" >Choosing the Right Decking for Your Home: 4 Benefits of Using Trex Decking</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1080" height="720" src="<?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="trex decking" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking.jpg 1080w, <?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/01/trex-composite-decking-1024x683.jpg 1024w" sizes="(max-width: 1080px) 100vw, 1080px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/decks/" rel="tag">Decks</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/high-end-amenities-could-be-the-key-to-success/" target="_self" >The Amenities <?php echo $row['country']; ?> Condo Owners are Looking for Today</a></h3>

			<figure class="wp-block-post-featured-image"><img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-luxury-apartment-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/boston-condo/" rel="tag"><?php echo $row['country']; ?> Condo</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/sustainability-is-the-name-of-the-game/" target="_self" >Sustainability is the Name of the Game when Building in <?php echo $row['country']; ?></a></h3>

			<figure class="wp-block-post-featured-image"><img width="560" height="315" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/Building-in-Boston-1.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-condo-renovation-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/bathroom-renovation/" rel="tag">Bathroom Renovation</a>
			...
			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="<?php echo $row['url']; ?>/winning-space-the-urban-kitchen-redefined/" target="_self" >Designing the Urban Kitchen of the Future</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1280" height="859" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-<?php echo $row['country']; ?>.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" loading="lazy" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-<?php echo $row['country']; ?>.png 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-boston-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/06/small-urban-kitchen-in-boston-1024x687.png 1024w" sizes="(max-width: 1280px) 100vw, 1280px" /></figure>
        ...
        <a href="<?php echo $row['url']; ?>/category/builder/" rel="tag">Builder</a>
			...
			<a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/" class="wp-block-query-pagination-previous">Previous</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/">3</a>
...
<a class="page-numbers" href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/14/">14</a></div>
			...
			<a href="<?php echo $row['url']; ?>/category/building-in-<?php echo $row['country']; ?>/page/3/" class="wp-block-query-pagination-next">Next</a>
			</nav>
		</div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/building-in-<?php echo $row['country']; ?>/page/2/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
