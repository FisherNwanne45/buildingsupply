...
<!-- Mirrored from <?php echo $row['url']; ?>/category/uncategorized/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:49 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:title" content="Uncategorized Archives - <?php echo $row['name']; ?> " />
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; Uncategorized Category Feed" href="feed/index.php" />
<script>
...
.wp-container-core-navigation-layout-1.wp-container-core-navigation-layout-1{flex-wrap:nowrap;}.wp-container-core-group-layout-1.wp-container-core-group-layout-1{flex-wrap:nowrap;justify-content:flex-start;}.wp-container-core-group-layout-2.wp-container-core-group-layout-2{flex-wrap:nowrap;justify-content:space-between;}.wp-container-core-group-layout-5.wp-container-core-group-layout-5{flex-direction:column;align-items:flex-start;}.wp-container-core-group-layout-7.wp-container-core-group-layout-7{justify-content:space-between;}.wp-container-core-group-layout-8.wp-container-core-group-layout-8{justify-content:space-between;}.wp-container-core-columns-layout-1.wp-container-core-columns-layout-1{flex-wrap:nowrap;}.wp-container-core-navigation-layout-2.wp-container-core-navigation-layout-2{flex-direction:column;align-items:flex-start;}.wp-container-core-navigation-layout-3.wp-container-core-navigation-layout-3{flex-direction:column;align-items:flex-start;}.wp-container-core-navigation-layout-4.wp-container-core-navigation-layout-4{flex-direction:column;align-items:flex-start;}.wp-container-core-columns-layout-2.wp-container-core-columns-layout-2{flex-wrap:nowrap;}.wp-container-core-group-layout-12.wp-container-core-group-layout-12{flex-wrap:nowrap;justify-content:space-between;}
</style>
...
<link rel="https://api.w.org/" href="../../wp-json/index.php" /><link rel="alternate" type="application/json" href="../../wp-json/wp/v2/categories/1.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../../xmlrpc0db0.php?rsd" />
...
<body class="archive category category-uncategorized category-1 wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content is-layout-constrained wp-block-group-is-layout-constrained">
		...
		<div class="wp-block-group alignfull pattern-intro-banner is-layout-constrained wp-block-group-is-layout-constrained">
			...
			<div class="wp-block-group alignwide intro-content is-vertical is-layout-flex wp-container-core-group-layout-5 wp-block-group-is-layout-flex">
				<h1 class="alignwide wp-block-heading wp-block-query-title has-h-2-font-size">Category: <span>Uncategorized</span></h1>
		...
		<div class="wp-block-query alignfull query-loop-main is-layout-constrained wp-block-query-is-layout-constrained">
			<ul class="is-flex-container columns-3 alignwide wp-block-post-template is-layout-flow wp-block-post-template-is-layout-flow"><li class="wp-block-post post-3920 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="../../3920-2/index.php" target="_self" >Toys for Tots 2023</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1530" height="807" src="../../wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="object-fit:cover;" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px.png 1530w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px-768x405.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/11/NEBS-Toys-for-Tots-1530-x-807-px-1024x540.png 1024w" sizes="(max-width: 1530px) 100vw, 1530px" /></figure>
			...
			<div class="wp-block-group post-meta is-content-justification-space-between is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
				<div class="wp-block-post-date"><time datetime="2023-11-15T13:26:06-05:00">11.15.2023</time></div>

				    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="index.php" rel="tag">Uncategorized</a>
    </div>
			...
			</li><li class="wp-block-post post-1573 post type-post status-publish format-standard has-post-thumbnail hentry category-building-in-<?php echo $row['country']; ?> category-uncategorized tag-<?php echo $row['country']; ?> tag-boston-building-guidelines tag-boston-condo tag-boston-homeowner tag-building-supplier tag-commercial-development tag-developer tag-downtown-<?php echo $row['country']; ?> tag-downtown-boston-residential-building tag-interior tag-lumber-and-building-materials tag-micro-condo tag-millennial">
			<h3 style="text-transform:uppercase;" class="wp-block-post-title has-h-5-font-size"><a href="../../micro-condo-answer-to-boston-millennial-housing-crisis/index.php" target="_self" >The Micro-Condo Could Be the Answer to <?php echo $row['country']; ?> Millennial Housing Crisis</a></h3>

			<figure class="wp-block-post-featured-image"><img width="1024" height="682" src="../../wp-content/uploads/2017/07/mico-condo-boston-.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="mico condo <?php echo $row['country']; ?>" style="object-fit:cover;" decoding="async" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2017/07/mico-condo-boston-.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2017/07/mico-condo-boston--768x512.jpg 768w" sizes="(max-width: 1024px) 100vw, 1024px" /></figure>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/category/uncategorized/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<div class="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-layout-12 wp-block-group-is-layout-flex">
...
<!-- Mirrored from <?php echo $row['url']; ?>/category/uncategorized/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:07:50 GMT -->
</html>
