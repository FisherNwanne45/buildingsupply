...
<!-- Mirrored from <?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:58 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Developers in <?php echo $row['country']; ?> are very familiar with the concept of urban infill. After all, the neighborhoods in and around the city are already in place, so now it is a matter of filling in the empty or disused spaces in these areas. One way to go about urban infill is to tackle housing projects, but…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-10-26T17:32:18+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:42+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/mixed-use-development-projects-.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects","datePublished":"2016-10-26T17:32:18+00:00","dateModified":"2023-09-11T13:50:42+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/"},"wordCount":631,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/mixed-use-development-projects-.png","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Redevelopment Authority","Commercial Development","Developer","Downtown <?php echo $row['country']; ?> Residential Building","Mixed Use Development","Real Estate","Urban Infill"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Policies","Building Trends","Contractor","Developer"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/","url":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/","name":"3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/mixed-use-development-projects-.png","datePublished":"2016-10-26T17:32:18+00:00","dateModified":"2023-09-11T13:50:42+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/mixed-use-development-projects-.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/11/mixed-use-development-projects-.png","width":560,"height":315},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; 3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects Comments Feed" href="<?php echo $row['url']; ?>/3-challenges-facing-boston-mixed-use-development-projects/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1139" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1139' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F3-challenges-facing-boston-mixed-use-development-projects%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F3-challenges-facing-boston-mixed-use-development-projects%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1139 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">3 Challenges Facing <?php echo $row['country']; ?> Mixed Use Development Projects</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Developers in <?php echo $row['country']; ?> are very familiar with the concept of <a href="https://cre.nerej.com/developers-looking-suburban-properties-revitalized-downtowns-access-transit-david-osullivan/" target="_blank" rel="noopener noreferrer">urban infill</a>. After all, the neighborhoods in and around the city are already in place, so now it is a matter of filling in the empty or disused spaces in these areas. One way to go about urban infill is to tackle housing projects, but more and more housing units are being completed all the time, so developers that really want to maximize profits are starting to turn towards mixed use development.</p>
<p>And it isn’t just developers that want <a href="http://bradvisors.com/large-mixed-use-developments-transforming-<?php echo $row['country']; ?>/" target="_blank" rel="noopener noreferrer">mixed use development projects</a>. Residents, along with prospective buyers and renters want it, too. To put it simply, in some areas, there simply aren’t many of the basic amenities that make life easy, such as nearby supermarkets, restaurants, health services and more.</p>
<p><span id="more-1139"></span></p>
<p>To that end, mixed use development is a boon for everyone — developers and residents alike. However, there are a few challenges that you might face should you decide to tackle these projects. Let’s take a look at three of the biggest challenges, and how you can overcome them.</p>
<h3><strong>1. The Project Approval Process May Not Be Easy</strong></h3>
<p>One of the biggest challenges that any developer faces is getting a project approved. Fortunately, the <a href="<?php echo $row['url']; ?>/charting-a-course-to-<?php echo $row['country']; ?>s-future-learning-to-work-with-the-boston-redevelopment-authority/" target="_blank" rel="noopener noreferrer"><?php echo $row['country']; ?> Redevelopment Authority</a> has gone through quite a lot of <a href="http://dailyfreepress.com/2016/03/18/mayor-martin-walsh-announces-reform-for-the-bra/" target="_blank" rel="noopener noreferrer">reform</a> over the past year with the goal of streamlining the organization so that developers can proceed through the approval pipeline more quickly and easily.<br />
To make the approvals process even easier, there are a couple of things that developers can do. <em><strong>First,</strong></em> check with the BRA to see which neighborhoods they are focusing on, and what vision they have for those neighborhoods. This allows you to propose development projects that are in high demand. <em><strong>Second,</strong></em> be sure to familiarize yourself with the BRA’s Development Review Guidelines, which you can see <a href="http://www.<?php echo $row['country']; ?>plans.org/" target="_blank" rel="noopener noreferrer">here</a>, so that you know what to expect.</p>
<h3><strong>2. What if You Want to Build Both Housing and Retail Space?</strong></h3>
<p>In areas with more open space, mixed use development often means using available empty lots for commercial buildings. In <?php echo $row['country']; ?>, however, there is a shortage on space, but still a large demand for both residential buildings and commercial spaces, which means developers are getting creative.</p>
<p>In order to get the best of both the residential and commercial worlds, developers are creating buildings that use the ground floor space and lower stories as retail space, while upper stories are devoted to housing units. One great example of this is the <a href="http://gbdmagazine.com/2013/24-samuels-associates/" target="_blank" rel="noopener noreferrer">Van Ness in the Fenway Triangle</a>. In this building, the ground floor features retail space, while the second through fourth floors have a Target. The remaining upper floors are devoted to housing, with an urban gardening space separating the two housing towers.</p>
<h3><strong>3. Choose Professionals That Know How to Build in <?php echo $row['country']; ?></strong></h3>
<p>Urban infill is tough, particularly in cities that are tightly packed. You can’t exactly close down streets for months on end to make way for building equipment, nor will you have a place to store building materials on-site. In other words, you’ll need to find builders and suppliers that can work around your project’s needs, not the other way around.</p>
<p>To see an example of what we mean, check out this case study on the <a href="<?php echo $row['url']; ?>/wp-content/uploads/2016/10/NEBS_theDot_CaseStudy_v1-1.pdf" target="_blank" rel="noopener noreferrer">488 Dot Project</a>. In order to save space on the ground, boom trucks were used to lift materials up into the tower. Supply deliveries were scheduled so that they arrived when they were needed, which eliminated any potential storage issues while ensuring that the builders weren’t delayed.</p>
<p>Developers are well aware that urban infill projects, particularly mixed use development projects, can be complicated affairs. However, by overcoming these three challenges, you can ensure that your project proceeds smoothly.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="681" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/homebuilder-client-expectations-1024x681.jpg" class="attachment-large size-large wp-post-image" alt="homebuilder-client-expectations" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/11/homebuilder-client-expectations-1024x681.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2016/11/homebuilder-client-expectations-768x511.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/11/homebuilder-client-expectations.jpg 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/tactics-to-manage-homebuilder-client-expectations/">Apply These 5 Tactics to Manage Your Homebuilder Client Expectations</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/3-challenges-facing-boston-mixed-use-development-projects/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
