...
<!-- Mirrored from <?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:52 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Construction contractors here is what to watch for in the coming months, so you can stay in business through the worst of this crisis." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="How to Move Forward, Not Backward, as a Construction Contractor During COVID-19 - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Construction contractors here is what to watch for in the coming months, so you can stay in business through the worst of this crisis." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-04-24T04:00:42+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:34+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"How to Move Forward, Not Backward, as a Construction Contractor During COVID-19","datePublished":"2020-04-24T04:00:42+00:00","dateModified":"2023-09-11T13:46:34+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/"},"wordCount":767,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid.png","keywords":["Contractor","Covid-19"],"articleSection":["Contractor"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/","url":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/","name":"How to Move Forward, Not Backward, as a Construction Contractor During COVID-19 - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid.png","datePublished":"2020-04-24T04:00:42+00:00","dateModified":"2023-09-11T13:46:34+00:00","description":"Construction contractors here is what to watch for in the coming months, so you can stay in business through the worst of this crisis.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"How to Move Forward, Not Backward, as a Construction Contractor During COVID-19"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>How to Move Forward, Not Backward, as a Construction Contractor During COVID-19 - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2676" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2676' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2676 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2020-04-24T00:00:42-04:00">04.24.2020</time></div>

		    <div style="text-transform:uppercase;" class="taxonomy-category wp-block-post-terms wp-block-blockshoon-primary-category">
        <a href="<?php echo $row['url']; ?>/category/contractor/" rel="tag">Contractor</a>
    </div>

	</div>
	

	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">How to Move Forward, Not Backward, as a Construction Contractor During COVID-19</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">There’s no doubt that COVID-19 is posing a major challenge around the world, not only to human health, but to business as well. How is the construction industry faring? We can expect to see some difficulties, of course, but construction is one of those trades that is truly necessary to keep the world moving forward. So long as you know what to watch for in the coming months, you’ll be able to move forward and stay in business through the worst of this crisis.</span></p>
<p><span style="font-weight: 400;">What can Contractors Expect?</span></p>
<p><span style="font-weight: 400;">Project delays and even cancellations are a very likely possibility for construction contractors—something that some have likely already experienced as the COVID-19 crisis has worsened. In fact, on March 17, <?php echo $row['country']; ?>’s Mayor announced a two-week ban on all construction throughout the city. Recently, however, Massachusetts Governor Charlie Baker made an exception for new housing projects—and that’s because of the serious shortage in housing units across the state. Some unions, however, are protesting this, insisting that their workers stay home for all but emergency and critical infrastructure projects.</span></p>
<p><span style="font-weight: 400;">Another issue may be among the construction industry’s supply chain. With manufacturers temporarily closed, and with imports of things like steel and glass from Asia slowed, delays in material delivery are to be expected.</span></p>
<p><span style="font-weight: 400;">Subcontractors may be hit hardest in all of this. As smaller businesses with less capital in reserve struggle to pay wages and keep up with operating costs, some could end up declaring bankruptcy as the crisis wears on.</span></p>
<p><span style="font-weight: 400;">All of this uncertainty also leads to uncertainty among markets, with both clients and lenders nervous about taking on new projects in light of the uncertain future. This can make it harder to secure new projects and to get the financing needed to complete those projects.</span></p>
<p><span style="font-weight: 400;">Bright Side: Stimulus is on the Way</span></p>
<p><span style="font-weight: 400;">On March 27, President Trump signed the Coronavirus Aid, Relief and Economic Security (CARES) Act, which looks like it will provide emergency relief across a variety of industries. The CARES Act features a total $339.9 billion in funds, and current estimates from </span><a href="https://www.enr.com/articles/49069-construction-eyes-an-expected-new-stimulus-bill"><span style="font-weight: 400;">Engineering News Record</span></a><span style="font-weight: 400;"> say that at least $40 billion of this could go into the construction industry.</span></p>
<p><span style="font-weight: 400;">With this, CARES allows some funding recipients to decide how those funds will be used. For example, part of this stimulus package features $10 billion as part of an Airport Improvement Program that provides grants to airports. According to this new law, that $10 billion can be used for any purpose that an airport might normally use revenues—including things like infrastructure construction.</span></p>
<p><span style="font-weight: 400;">Other potential construction opportunities provided through CARES include $5 billion to the Housing and Urban Development Department as block grants, plus $1.5 billion to the Defense Department as part of a package to expand hospitals and construct modular field hospitals.</span></p>
<p><span style="font-weight: 400;">For subcontractors and small businesses struggling to pay employees, CARES features the Paycheck Protection Program. Through this, companies with 500 or fewer employees can receive loans of up to $10 million. Employers who use these loans to cover payroll and health insurance will not have to repay those loans.</span></p>
<p><span style="font-weight: 400;">CARES is unlikely to be the only stimulus package on the way, either. Politicians are already looking ahead at not just mitigating the current state of affairs, but also developing new stimulus packages to help the economy recover as the pandemic begins to wane.</span></p>
<p><span style="font-weight: 400;">Preparing Your Construction Business to Move Forward</span></p>
<p><span style="font-weight: 400;">Aside from the CARES Act, there are lots of steps you can take to mitigate potential losses and keep your construction business moving forward.</span></p>
<ul>
<li style="font-weight: 400;"><span style="font-weight: 400;">On the financial side of things, review your budgets thoroughly. Can loans be refinanced? Are there material stores that ought to be liquidated to prevent value loss or taxation on these things? Trim costs where possible to keep operations running smoothly.</span></li>
<li style="font-weight: 400;"><span style="font-weight: 400;">Your workforce needs protection, too. Make sure employees know how to protect themselves on the jobsite, and if needed, provide additional personal protective equipment to help them stay healthy.</span></li>
<li style="font-weight: 400;"><span style="font-weight: 400;">Because supply chain issues may become problematic, it’s a wise idea to develop a list of alternate suppliers. This way, if your usual suppliers are unable to provide building materials, you’ll know where to turn to keep a project going.</span></li>
</ul>
<p><span style="font-weight: 400;">Times will be tight moving forward, but despite the COVID-19 crisis, it is possible for construction contractors to keep moving forward. The primary concerns will be taking extra measures to keep employees safe and healthy on the jobsite while looking at ways to trim overhead. With these things in mind, construction contractors can keep forging ahead instead of moving backward.</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy--1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy--1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy--768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/05/how-construction-plays-an-important-part-in-revitalizing-economy-.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/how-construction-will-play-an-important-part-in-revitalizing-the-economy/">How Construction Will Play an Important Part in Revitalizing the Economy</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
