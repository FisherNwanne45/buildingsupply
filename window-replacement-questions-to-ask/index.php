...
<!-- Mirrored from <?php echo $row['url']; ?>/window-replacement-questions-to-ask/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:57 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/window-replacement-questions-to-ask/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="3 Window Replacement Questions to Ask for Your Historic Renovation - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Despite the inherent charm of older buildings with unique and original windows, there can be overriding reasons for installing replacements. If you realize, when you look at &#8212; or through &#8212; your old glass, that the view isn&#8217;t quite what it should be, you might be thinking it&#8217;s time to set your sights on improvement.…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/window-replacement-questions-to-ask/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-08-25T10:10:11+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:49+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"3 Window Replacement Questions to Ask for Your Historic Renovation","datePublished":"2016-08-25T10:10:11+00:00","dateModified":"2023-09-11T13:50:49+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/"},"wordCount":675,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Multifamily","Builder","Building Supplier","Downtown <?php echo $row['country']; ?>","Downtown <?php echo $row['country']; ?> Residential Building","Historic Window Replacement","Lumber and Building Materials","Remodeler","Window Replacement"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Policies","Contractor","Developer","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/","url":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/","name":"3 Window Replacement Questions to Ask for Your Historic Renovation - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg","datePublished":"2016-08-25T10:10:11+00:00","dateModified":"2023-09-11T13:50:49+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/window-replacement-questions-to-ask/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-replacement-windows-1.jpg","width":640,"height":427},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/window-replacement-questions-to-ask/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"3 Window Replacement Questions to Ask for Your Historic Renovation"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>3 Window Replacement Questions to Ask for Your Historic Renovation - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; 3 Window Replacement Questions to Ask for Your Historic Renovation Comments Feed" href="<?php echo $row['url']; ?>/window-replacement-questions-to-ask/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/943" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=943' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fwindow-replacement-questions-to-ask%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fwindow-replacement-questions-to-ask%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-943 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">3 Window Replacement Questions to Ask for Your Historic Renovation</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Despite the inherent charm of older buildings with unique and original windows, there can be overriding reasons for installing replacements. If you realize, when you look at &#8212; or through &#8212; your old glass, that the view isn&#8217;t quite what it should be, you might be thinking it&#8217;s time to set your sights on improvement. Before you move ahead, however, there are some factors to consider:</p>
<p><span id="more-943"></span></p>
<h2>5 Factors to Consider</h2>
<ul>
<li><strong>Historical Accuracy:</strong> Is it important to preserve historic details? Is <a href="https://www.cityof<?php echo $row['country']; ?>.gov/images_documents/NTHP_Repair_or_Replace_Old_Windows_a_Visual_Look_at_the_Impacts_tcm3-17735.pdf" target="_blank" rel="noopener noreferrer">authenticity</a> a neighborhood requirement?</li>
<li><strong>Heat Loss and Energy Savings:</strong> Windows typically account for no more than 25 percent of heat loss in a building. If your primary goal is to save on energy bills, will replacing windows be cost effective?</li>
<li><strong>Ongoing Upkeep and Maintenance Cost</strong>: Whether your windows are old or new, there will be some continuing costs to keep them in prime condition. Weigh the costs, time and effort associated with maintaining older wood windows and storm units against newer materials that are more apt to be maintenance free.</li>
<li><strong>Overall Costs of Materials and Labor:</strong> What will the total bill be for replacement?</li>
<li><strong>Finally, consider how the replacement windows will &#8220;coexist&#8221; with existing trim and materials</strong>. Appropriate decisions hinge not only on the look, but also the performance of each component in tandem with other materials and elements of design.</li>
</ul>
<h2>3 Window Replacement Questions to Ask</h2>
<ul>
<li style="list-style-type: none;">
<ul>
<li><strong>Are the current windows damaged?</strong><br />
Windows of unusual size or design and those that feature stained, tinted or leaded glass inserts, have carved trim or unique muntin patterns, are often sought-after architectural features, and sometimes they are difficult to duplicate with modern materials. If the glass is broken or damaged, of course, you have no choice but to go with contemporary replacements.</li>
<li><strong>Do you need to retain historic purity?<br />
</strong>There are up-to-date options that can simulate an older look, if that is what you require. The &#8220;look&#8221; of old windows, particularly in historic neighborhoods, is a distinguishing feature, and some <?php echo $row['country']; ?> residents opt to forego the benefits of insulated glass and low-E qualities in favor of historic purity.</li>
<li><strong>Efficiency requirements?</strong><br />
If you are in the market for new windows with all the appeal of the old ones, what must you do to retain the character of the original architecture? Are wood windows more or less efficient than metal frames or vinyl cladding? Are storm windows necessary? Will modern replacements last as long as the originals? What special considerations does <?php echo $row['country']; ?> weather require? These are all good questions.</li>
</ul>
</li>
</ul>
<h2>Out with the Old, In with the New</h2>
<p>Today, you&#8217;re in luck, because <a href="<?php echo $row['url']; ?>/builder/" target="_blank" rel="noopener noreferrer">several manufacturers</a> supply window units built to replicate historic sizes and styles. Often, it is a relatively simple matter for your contractor to remove the old and insert the new. In some cases, there might be slight differences in mullion width and trim adjustments in trim size necessary, but an experienced contractor will be familiar with varying requirements and should be able to help you with ideas.</p>
<p>Several companies also offer the option of custom sizing and will work with you to mimic historical details. In effect, they can help you make those new windows look old!</p>
<h2>Improve Your View</h2>
<p><?php echo $row['name']; ?>  has the resources to offer you great options, whether you&#8217;re interested in redoing an existing brownstone or building a new version of an earlier Victorian. We can also help with replacement windows for old factory buildings, as well as more energy efficient solutions for industrial plate glass and drafty mid-Century metal casements. We&#8217;ll work with you or your contractor to help you improve your view to the outside world. But, it&#8217;s up to you to check with the city and with your neighborhood about those <a href="http://www.<?php echo $row['country']; ?>buildingresources.com/advice/building-permit" target="_blank" rel="noopener noreferrer">permits and specific guidelines</a>.</p>
<p>There&#8217;s a lot to know about windows &#8212; more than we can explain here, but we&#8217;ll be happy to talk more with you! Just stop by to talk with us located right here in the <a href="<?php echo $row['url']; ?>/located-in-the-heart-of-the-boston-building-boom/" target="_blank" rel="noopener noreferrer">heart of the city.</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="480" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/08/boston-Triple-Decker-1-1.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/knowing-the-3d-when-remodeling-a-boston-triple-decker/">Knowing the 3D When Remodeling a <?php echo $row['country']; ?> Triple Decker</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/window-replacement-questions-to-ask/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
