...
<!-- Mirrored from <?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:11:00 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="What Builders Need to Know About the Stretch Energy Code - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="It can be challenging to stay up to date with building codes and guidelines, but if you are a builder, then staying current is an absolute must. In Massachusetts, a new stretch energy code was recently adopted. So what does this mean? Read on to find out! What is the Stretch Energy Code? In a…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2016-09-13T10:25:02+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:50:46+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-stretch-energy-code-1-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"What Builders Need to Know About the Stretch Energy Code","datePublished":"2016-09-13T10:25:02+00:00","dateModified":"2023-09-11T13:50:46+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/"},"wordCount":583,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-stretch-energy-code-1-1.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building Guidelines","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Building","Building Codes","Developer","Energy Efficient","Lumber and Building Materials","Remodeler","Stretch Energy Code"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Policies","Construction Crew","Contractor","Developer","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/","url":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/","name":"What Builders Need to Know About the Stretch Energy Code - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-stretch-energy-code-1-1.jpg","datePublished":"2016-09-13T10:25:02+00:00","dateModified":"2023-09-11T13:50:46+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-stretch-energy-code-1-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2016/09/boston-stretch-energy-code-1-1.jpg","width":640,"height":480},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"What Builders Need to Know About the Stretch Energy Code"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>What Builders Need to Know About the Stretch Energy Code - <?php echo $row['name']; ?> </title>
...
<link rel="alternate" type="application/rss+xml" title="<?php echo $row['name']; ?>  &raquo; What Builders Need to Know About the Stretch Energy Code Comments Feed" href="<?php echo $row['url']; ?>/what-builders-need-to-know-about-the-stretch-energy-code/feed/" />
<script>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/971" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=971' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fwhat-builders-need-to-know-about-the-stretch-energy-code%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fwhat-builders-need-to-know-about-the-stretch-energy-code%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-971 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">What Builders Need to Know About the Stretch Energy Code</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>It can be challenging to stay up to date with building codes and <a href="<?php echo $row['url']; ?>/what-you-need-to-know-about-boston-construction-guidelines/">guidelines</a>, but if you are a builder, then staying current is an absolute must. In Massachusetts, a new stretch energy code was recently adopted. So what does this mean? Read on to find out!</p>
<h3><strong>What is the Stretch Energy Code?</strong></h3>
<p>In a nutshell, the stretch code in Massachusetts is an optional part of the building code that deals with energy efficiency. Municipalities can adopt the stretch code, which then increases energy efficiency requirements in that municipality. This applies to both commercial and residential structures, and it applies to new construction as well as remodeling that is extensive enough to require code enforcement.</p>
<p>Because the stretch code is optional, it isn’t in effect in every municipality in Massachusetts. As of June 2016, 176 municipalities have adopted it. <a href="https://www.mass.gov/" target="_blank" rel="noopener noreferrer">Click here</a> to see a map showing where the stretch code is enforced.</p>
<h3><strong><img fetchpriority="high" decoding="async" class="size-medium wp-image-972 alignright" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/stretch-code-adoption-massachusetts-300x201.png" alt="stretch-code-adoption-massachusetts" width="300" height="201"></strong><strong>When Does the New Code Take Effect?<br />
</strong></h3>
<p>The new stretch energy code went into effect on August 12, 2016. However, that doesn’t mean you have to be up to the code immediately. The updated code comes with a concurrency period, which means that between August 12, 2016 and January 1, 2017, builders can use either code — the new one or the old one. By January 2, 2017, all builders working under the stretch code will need to comply with the updated version.</p>
<h3>What Are the Provisions of the New Stretch Code?</h3>
<p>By energy efficiency standards, the new code is roughly 20% more energy efficient than the base code for Massachusetts in communities that have not adopted the stretch energy code. It applies to all new construction, and major renovations on homes but not on commercial buildings.</p>
<p>Essentially, to comply with the residential stretch code, builders need to adhere to the <a href="https://www.energystar.gov/ia/partners/bldrs_lenders_raters/downloads/ES_Combined_Path_v3.1.pdf" target="_blank" rel="noopener noreferrer">Energy Star 3.1 standards</a> in order to be compliant. In order to get a building permit, builders will need to submit plans with a preliminary Home Energy Ratings System (HERS) rating. You can see the qualifying HERS ratings along with some of the other requirements by <a href="http://static1.squarespace.com/static/50a59650e4b00720f42cc9f5/t/5644e6bae4b06918602bc913/1447356090461/StretchCode+excerpt+from+Mass+9th+Residential+Draft+2015-06-23.pdf" target="_blank" rel="noopener noreferrer">clicking here</a>. There is also an Energy Rating Index (ERI) compliance that you’ll need to follow. In order for a building to meet ERI compliance, you’ll need to meet certain ERI scores, which you can find on <a href="https://www.mass.gov/" target="_blank" rel="noopener noreferrer">page 72 of this document.</a></p>
<p>As far as actual building requirements go, the stretch code is meant to bring several factors that contribute to energy efficiency up to standard. First, compliant homes should be well sealed. Insulation must also be up to par to ensure that the heating, cooling and lighting systems are all operating as efficiently as possible. Things like energy efficient windows and doors can help you to meet code, as can <a href="<?php echo $row['url']; ?>/sustainability-is-the-name-of-the-game-when-building-in-<?php echo $row['country']; ?>/" target="_blank" rel="noopener noreferrer">renewable energy options</a> like solar panels — although it should be noted that renewables are not a requirement.</p>
<p>Sounds complicated, right? Well, this new stretch code change actually represents a drastic simplification over the old stretch energy code. Energy efficiency requirements have gone up across the board, but the code is much more standardized than the previous version. For the forms that you’ll need, visit the <a href="http://www.mass.gov/eopss/consumer-prot-and-bus-lic/license-type/csl/stretch-energy-code-information.php" target="_blank" rel="noopener noreferrer">Massachusetts Stretch Energy Code page</a>.</p>
<p>If you have more questions about the stretch energy code, check out some of the resource links that we have provided. As a builder, you’ll want to take a look at all of this information so that you can make sure that the jobs you complete are up to code!</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="640" height="426" src="<?php echo $row['url']; ?>/wp-content/uploads/2016/09/home-automation-tech-1.jpg" class="attachment-large size-large wp-post-image" alt="" decoding="async" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/automation-tech-vital-topic-for-builders-and-developers/">Automation Tech: Another Vital Topic for <?php echo $row['country']; ?> Builders and Developers</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/what-builders-need-to-know-about-the-stretch-energy-code/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
