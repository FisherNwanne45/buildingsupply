...
<!-- Mirrored from <?php echo $row['url']; ?>/7-small-patio-makeover-ideas/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:11:02 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Get a little lift by converting your small patio to a deck this spring! Add some greenery and comfy touches and you are ready for a backyard oasis." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="7 Small Patio Makeover Ideas - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Get a little lift by converting your small patio to a deck this spring! Add some greenery and comfy touches and you are ready for a backyard oasis." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2019-04-17T13:09:12+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:47:52+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"7 Small Patio Makeover Ideas","datePublished":"2019-04-17T13:09:12+00:00","dateModified":"2023-09-11T13:47:52+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/"},"wordCount":665,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png","articleSection":["<?php echo $row['country']; ?> Condo","Builder","Building in <?php echo $row['country']; ?>","Building Trends","Decks","Homeowner","Remodeler","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/","url":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/","name":"7 Small Patio Makeover Ideas - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png","datePublished":"2019-04-17T13:09:12+00:00","dateModified":"2023-09-11T13:47:52+00:00","description":"Get a little lift by converting your small patio to a deck this spring! Add some greenery and comfy touches and you are ready for a backyard oasis.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/04/small-patio-makeover-ideas-2.png","width":1280,"height":859,"caption":"small patio makeover ideas 2"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/7-small-patio-makeover-ideas/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"7 Small Patio Makeover Ideas"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>7 Small Patio Makeover Ideas - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2499" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2499' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F7-small-patio-makeover-ideas%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F7-small-patio-makeover-ideas%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2499 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">7 Small Patio Makeover Ideas</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>In <?php echo $row['country']; ?>, where small backyards are the norm, so are small patios! With spring on the way, most homeowners will be looking at makeover ideas in order to get their patio spruced up and ready for summer. If you need some inspiration, here are a few of our favorite ideas!</p>
<p><span id="more-2499"></span></p>
<h3><strong>1. Get a Little Lift by Converting the Patio to a Deck</strong></h3>
<p>Small <a href="<?php echo $row['url']; ?>/which-is-the-best-decking-material-treated-wood-vs-composite/" target="_blank" rel="noopener noreferrer">decks</a> are great places to spend the afternoon with a good book or even host small summertime barbecues. They’re advantageous, too, in that they remove the need for you to walk down a short flight of steps to get to the patio, which is handy when you’re carrying food or other dinner party necessities from indoors to outside. With the addition of some furniture, perhaps a bar or maybe even an outdoor fireplace, it’s totally possible to turn a small deck or patio into a beautiful, comfortable outdoor living room. Just check out <a href="https://www.trex.com/inspiration/gallery/bigstyleinsmallspaces/" target="_blank" rel="noopener noreferrer" data-cke-saved-href="https://www.trex.com/inspiration/gallery/bigstyleinsmallspaces/">Trex’s gallery of small decks</a>&nbsp;to see what we mean!</p>
<h3><strong>2. Turn Your Patio into an Outdoor Kitchen</strong></h3>
<p>Just because space may be limited, that doesn’t mean you don’t get to have an outdoor kitchen! It’s perfectly possible, even with a small patio, to create a kitchen with plenty of functionality. Start with a cabinet manufacturer like&nbsp;<a href="https://www.naturekast.com/" target="_blank" rel="noopener noreferrer" data-cke-saved-href="https://www.naturekast.com/">NatureKast</a>&nbsp;to find durable, weatherproof cabinetry, and design your small-space <a href="<?php echo $row['url']; ?>/3-tips-for-choosing-weatherproof-outdoor-cabinets/" target="_blank" rel="noopener noreferrer">outdoor kitchen</a> with efficiency in mind. For instance, you can install cabinets beneath a built-in grill to give you both storage and a place to barbecue!</p>
<h3><strong>3. Focus on Comfort</strong></h3>
<p>Small patios by nature have a cozy feeling, and this is something you can enhance further with clever furniture choices. To create a lounge-like atmosphere, go with low furniture—low-slung chairs, cushions and seating options directly on the ground, and so forth. Or, you can capture the cabana kind of feeling with a couple of comfy hammocks.</p>
<h3><strong>4. Go for Green</strong></h3>
<p>Small patios have a big advantage in that they’re easy to surround in plenty of beautiful foliage. In fact, lots of homeowners use small trees and shrubs to create a kind of living wall around the patio to ramp up that comfortable, natural feeling. Invest in a few large planters, and you’ll find that it’s easy to create your own little backyard hideaway.</p>
<h3><strong>5. Make Your Patio Cozy at Night, Too</strong></h3>
<p>Patios aren’t just for enjoying the sunshine. They’re a great place to enjoy the cool evening air, too. If you have the space, try a small firepit. Otherwise, tiki lamps, candles, blankets and other creature comfort needs are an ideal way to cuddle up outdoors after dark!</p>
<h3><strong>6. Make a Statement with Furniture</strong></h3>
<p>You may think it’s tough to decorate such a small space because there just isn’t much room for a lot of extras. But, if you place a focus on the furniture, you can definitely create a specific mood, even if you don’t have a lot of room for planters, tables and décor. Depending on the styles you like, there are lots of options you can choose. In general, though, you’ll want to look for things like chairs and small tables that double not only as seating and useful surfaces, but eye-catching parts of the décor, too.</p>
<h3><strong>7. Go Big on Theme</strong></h3>
<p>No matter what theme you choose for your small patio, the best way to make it over is to choose a theme and tie into it as much as possible. So, for example, if you want a cabana-style theme, then don’t just stop at wicker chairs and a hammock! Add some tropical foliage, tiki lamps and all the rest of the details to really make your patio feel like a tiny getaway spot.</p>
<p>Even in busy cities like <?php echo $row['country']; ?>, it’s possible to create a small oasis! Use these ideas to give your patio a makeover, and you’ll find yourself enjoying it all summer long!</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-1024x687.png" class="attachment-large size-large wp-post-image" alt="two tone kitchen cabinets" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/04/two-tone-kitchen-cabinets.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/9-tips-for-two-tone-kitchen-cabinets-in-a-small-kitchen/">9 Tips for Two Tone Kitchen Cabinets in a Small Kitchen</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/7-small-patio-makeover-ideas/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
