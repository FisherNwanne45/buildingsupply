...
<!-- Mirrored from <?php echo $row['url']; ?>/summer-deck-design-trends/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:43 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Now that summer is in full swing, you’ll be spending a lot more time on your deck. Spend the summer in style by making sure your deck is up to date with the latest trends. If you’re looking to revamp your deck, here are some tips to help you make your deck the best it can be." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Summer Deck Design Trends - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Now that summer is in full swing, you’ll be spending a lot more time on your deck. Spend the summer in style by making sure your deck is up to date with the latest trends. If you’re looking to revamp your deck, here are some tips to help you make your deck the best it can be." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-07-21T04:00:55+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:30+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2020/07/boston-deck-trends-1024x687.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/"},"author":{"name":"mflood","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46"},"headline":"Summer Deck Design Trends","datePublished":"2020-07-21T04:00:55+00:00","dateModified":"2023-09-11T13:46:30+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/"},"wordCount":719,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends.png","keywords":["Deck","deck design","decking"],"articleSection":["Decks"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/","url":"<?php echo $row['url']; ?>/summer-deck-design-trends/","name":"Summer Deck Design Trends - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends.png","datePublished":"2020-07-21T04:00:55+00:00","dateModified":"2023-09-11T13:46:30+00:00","description":"Now that summer is in full swing, you’ll be spending a lot more time on your deck. Spend the summer in style by making sure your deck is up to date with the latest trends. If you’re looking to revamp your deck, here are some tips to help you make your deck the best it can be.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/summer-deck-design-trends/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/summer-deck-design-trends/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Summer Deck Design Trends"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46","name":"mflood","url":"<?php echo $row['url']; ?>/author/mflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Summer Deck Design Trends - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2696.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexf9c3.php?p=2696' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedc1f1.json?url=<?php echo $row['url']; ?>%2Fsummer-deck-design-trends%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed2711?url=<?php echo $row['url']; ?>%2Fsummer-deck-design-trends%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2696 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Summer Deck Design Trends</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">Now that summer is in full swing, you’ll be spending a lot more time on your deck. Spend the summer in style by making sure your deck is up to date with the latest trends. If you’re looking to </span><a href="../6-deck-design-trends-to-try-this-summer/index.php"><span style="font-weight: 400;">revamp your deck</span></a><span style="font-weight: 400;">, here are some tips to help you make your deck the best it can be.</span></p>
<p><b>Go for an Industrial Look</b></p>
<p><span style="font-weight: 400;">A modern, industrial style is quickly gaining popularity over traditional rustic designs. Cable or glass railings can provide an unobstructed view of the landscape beyond your deck, with the added bonus of not requiring much maintenance. For flooring, use composite deck boards with sleek and sophisticated lines to create a simple yet elegant look. These lines don’t have to move in the same direction—get creative by laying out some boards diagonally or perpendicular to each other.</span></p>
<p><span style="font-weight: 400;">Stamped concrete is another versatile great way to get an industrial look. It can be used for the deck floor or support pillars, and it comes in many colors. Neutral tones such as earthy browns, muted grays, and cooler blues are the current trending colors, but you should choose whatever colors work best for you.</span></p>
<p><b>Set up a Covered Area</b></p>
<p><span style="font-weight: 400;">Transform your deck into an extension of your living room with this trend that blends practicality with style. A covered area provides ample shade, so you can spend time outside even in the heat of a summer afternoon. You can add a latticework enclosure for greater privacy while still being able to enjoy the view. If you’re going for a more natural look, fast-growing vines can also provide privacy.</span></p>
<p><span style="font-weight: 400;">Covered areas come in different sizes and shapes. The arbor is the smallest option. It has two to four posts and an open slatted roof. A pergola traditionally has four posts and an open roof that can be covered by fabric, offering flexibility with how covered the deck is. A gazebo offers the most room and privacy and comes in a variety of shapes, typically hexagonal or octagonal. Finally, the attached overhead is a roof that connects to the back wall of your house and is supported on the deck by strong pillars. The type of covered area you choose depends on your preferences and what fits best with your deck.</span></p>
<p><b>Include an Outdoor Television</b></p>
<p><span style="font-weight: 400;">This trend started last year and is still going strong. With an outdoor TV, you can experience the best of both worlds—relaxing with a good show and enjoying the great outdoors at the same time. An outdoor TV allows you to transform your deck into a second family room.</span></p>
<p><span style="font-weight: 400;">If you followed the previous tip and added a covered area, you can feel comfortable placing your TV outside without concern about rain damage. For extra protection, you can invest in a waterproof TV that can survive wind, rain, and even snow. Either way, you don’t want to miss out on the chance to host outdoor gaming or movie nights with your friends and family.</span></p>
<p><b>Make Use of Underdeck Spaces</b></p>
<p><span style="font-weight: 400;">If you have a raised deck, this trend is perfect for you. Underdeck spaces have been undervalued for years, with people using them mainly for storage. Now, people are realizing the untapped potential of this space. It’s essentially a built-in covered area with plenty of room for furniture. Add outdoor couches for comfort or a table for having snacks, and you’ll turn your underdeck space into one of the most relaxing parts of the house.</span></p>
<p><b>Play with Lighting</b></p>
<p><span style="font-weight: 400;">Lighting is essential to enjoying your deck at night. In addition to helping you see in the darkness, the type of lighting you choose can set the atmosphere of your deck and create ambience. You can have illuminated risers if your deck is made of multiple levels. If your deck has a small fountain or pond, you can put small lights in the water to create a magical glowing effect. You can even hang up a simple string of lights for an exceptionally cozy look. There are countless opportunities here, and it really depends on the mood you’re going for.</span></p>
<p><span style="font-weight: 400;">These are a few of this summer’s biggest deck design trends. By following these tips, you can transform your deck into the perfect backyard retreat.</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="../wp-content/uploads/2016/07/boston-bathroom-trends-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2016/07/boston-bathroom-trends.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../take-your-boston-bathroom-to-new-heights/index.php">Banish Boring with These Top <?php echo $row['country']; ?> Bathroom Trends</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/summer-deck-design-trends/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/summer-deck-design-trends/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:45 GMT -->
</html>
