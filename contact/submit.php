...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $lastName = $_POST['item_meta'][7] ?? '';
    $email = $_POST['item_meta'][8] ?? '';
    $phone = $_POST['item_meta'][9] ?? '';
    $customerType = $_POST['item_meta'][28] ?? '';
    $projectType = $_POST['item_meta'][10] ?? '';
    $serviceType = $_POST['item_meta'][29] ?? '';
    $projectZip = $_POST['item_meta'][27] ?? '';
    $projectDetails = $_POST['item_meta'][12] ?? '';
    ...
    try {
        ...
        $mail->Body = "<h2>New Quote Request</h2>
                       ...
                       <p><strong>Project Zip Code:</strong> $projectZip</p>
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="has-primary-color has-text-color has-h-3-font-size">
