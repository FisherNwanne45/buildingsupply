                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h2 class="wp-block-heading has-text-align-left has-h-3-font-size">Payment Details</h2>
                            ...
                            <div class="frm_forms  with_frm_style frm_style_footer-form-style"
                                ...
                                <form method="post" action="../user/result.php#yes"
                                    ...
                                    <div class="frm_form_fields ">
                                        ...
                                        <fieldset>
                                            <legend class="frm_screen_reader">Payment Details</legend>

                                            <div class="frm_fields_container">

                                                <div id="frm_field_24_container"
                                                    class="frm_form_field form-field  frm_inside_container">
                                                    <label for="field_5jngu" id="field_5jngu_label" class=" ">Invoice
                                                        Number
                                                        <span class="frm_required" aria-hidden="true"></span>
                                                    </label><br>
                                                    <input type="text" name="search" value="" minlength="4" />


                                                </div>

                                                <div class="frm_description">
                                                    <p>Enter invoice number to get payment details</p>
                                                </div>
