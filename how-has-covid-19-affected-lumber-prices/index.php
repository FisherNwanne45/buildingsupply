...
<!-- Mirrored from <?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:51 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="A while ago, we featured information about soaring lumber prices in the United States. Back then, factors like Hurricane Harvey were affecting markets, and as of reporting, the National Association of Home Builders showed that prices had gone up by 30% between August 2017 and January 2018." />
	<link rel="canonical" href="<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="How Has COVID-19 Affected Lumber Prices? - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="A while ago, we featured information about soaring lumber prices in the United States. Back then, factors like Hurricane Harvey were affecting markets, and as of reporting, the National Association of Home Builders showed that prices had gone up by 30% between August 2017 and January 2018." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-07-16T04:00:45+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:31+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"How Has COVID-19 Affected Lumber Prices?","datePublished":"2020-07-16T04:00:45+00:00","dateModified":"2023-09-11T13:46:31+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/"},"wordCount":719,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png","keywords":["lumber","Lumber prices"],"articleSection":["Building Trends"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/","url":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/","name":"How Has COVID-19 Affected Lumber Prices? - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png","datePublished":"2020-07-16T04:00:45+00:00","dateModified":"2023-09-11T13:46:31+00:00","description":"A while ago, we featured information about soaring lumber prices in the United States. Back then, factors like Hurricane Harvey were affecting markets, and as of reporting, the National Association of Home Builders showed that prices had gone up by 30% between August 2017 and January 2018.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/07/how-has-covid-19-affected-lumber-pricing.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/how-has-covid-19-affected-lumber-prices/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"How Has COVID-19 Affected Lumber Prices?"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>How Has COVID-19 Affected Lumber Prices? - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/2694" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=2694' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-has-covid-19-affected-lumber-prices%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Fhow-has-covid-19-affected-lumber-prices%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2694 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">How Has COVID-19 Affected Lumber Prices?</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">A while ago, we featured information about</span><a href="<?php echo $row['url']; ?>/strong-demand-and-tight-supply-have-caused-lumber-prices-to-soar/"> <span style="font-weight: 400;">soaring lumber prices</span></a><span style="font-weight: 400;"> in the United States. Back then, factors like Hurricane Harvey were affecting markets, and as of reporting, the</span><a href="http://nahbnow.com/2018/01/softwood-lumber-prices-climb-to-record-highs/"> <span style="font-weight: 400;">National Association of Home Builders</span></a><span style="font-weight: 400;"> showed that prices had gone up by 30% between August 2017 and January 2018. This cost was the highest on record since the NAHB had started keeping records back in 1995.</span></p>
<p><span style="font-weight: 400;">A combination of things affected lumber prices. There was a construction boom, with</span><a href="https://www.wsj.com/articles/u-s-home-construction-rose-9-7-in-january-1518787911"> <span style="font-weight: 400;">single family home construction increasing 7%</span></a><span style="font-weight: 400;"> between January 2017 and January 2018, and there were also more exports going out to places like China, which tightened demand. Wood-destroying insects in British Columbia and wildfires were causing deforestation and import duties on Canadian lumber tightened supply even more.</span></p>
<p><span style="font-weight: 400;">Back then, economists were saying that the chaos in lumber markets meant that prices would almost certainly stay high through 2020—and this could potentially cause a surge in home prices, though homebuyers in general were comfortable with the increase and still purchasing homes.</span></p>
<p><span style="font-weight: 400;">Of course, all of this was long before COVID-19 took over the world, so these are big questions at the forefront of everyone’s mind right now: Where are lumber prices, and what will happen among lumber markets as the pandemic continues? Below, you’ll find updated answers to shed light on these questions!</span></p>
<p><b>First, What’s Happening in the Construction Industry?</b></p>
<p><span style="font-weight: 400;">Where lumber prices are concerned, it’s all about supply and demand. As long as construction is moving forward, lumber will be in demand—and prices go up when there’s not as much supply to meet that demand.</span></p>
<p><span style="font-weight: 400;">Right now, construction is still moving strong in the United States. In many areas, this industry never really fully shut down because so many construction projects were considered essential business. New infrastructure, new housing projects, new commercial projects—these things were still needed despite COVID-19. Even in areas where some construction did shut down, we are now starting to see projects reopen. For instance, <?php echo $row['country']; ?> is currently working on the implementation of a</span><a href="https://www.enr.com/articles/49607-boston-implements-full-construction-reopening-plan"> <span style="font-weight: 400;">full construction reopening plan</span></a><span style="font-weight: 400;">, and many areas around the United States are following suit.</span></p>
<p><b>Troubles in the Timber Industry</b></p>
<p><span style="font-weight: 400;">Even though construction is still moving forward, the timber industry as a whole is struggling. Oregon is one example of an area plagued with problems, and there are many other areas reporting similar issues. The problem is, timber doesn’t rely solely on the construction industry to stay afloat. Paper manufacturing, home goods, and all kinds of other industries rely on timber, and many of these industries are experiencing significant downturns.</span></p>
<p><span style="font-weight: 400;">What this means is that as lumber companies struggle to find places to sell wood among decreasing demand in some of these other industries, they are experiencing layoffs and reduced output. Further, the timber industry is a very hands-on job, one in which social distancing proves difficult at best, so workers have had to contend with additional safety issues, which increases risk and leads some to want to stay home.</span></p>
<p><b>Where are Lumber Prices Now?</b></p>
<p><span style="font-weight: 400;">Although demand has dropped somewhat for timber, there is still a surprisingly strong need for lumber, largely driven by the construction industry. As one might expect, this is liable to lead to soaring lumber prices.</span><a href="https://www.nasdaq.com/market-activity/commodities/lbs"> <span style="font-weight: 400;">Nasdaq’s commodities index</span></a><span style="font-weight: 400;"> shows that this is true. February 2020 saw lumber futures spiking to their highest point at $463. By early April, those futures had plummeted as the full effects of the pandemic took hold, dropping to $259. Then futures started climbing back up again. Early July closings showed futures as high as $432.</span></p>
<p><b>And in the Future?</b></p>
<p><span style="font-weight: 400;">In this instance, the future is a little bit difficult to predict simply because the COVID-19 pandemic is an unprecedented event with effects that economists are only just beginning to understand. But as with any commodity, it’s reasonable to assume that supply and demand will continue to drive prices. This means that lumber prices are likely to continue fluctuating as the construction industry and other areas of trade continue moving forward on essential projects. Meanwhile, between job loss and downturns in other sectors that require timber, lumber producers are struggling to keep up. In the short term, lumber prices could very well go higher, but there may be periodic drops in price as shutdowns or other delays cause precipitous drops in demand.</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="<?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/07/boston-deck-trends.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/summer-deck-design-trends/">Summer Deck Design Trends</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/how-has-covid-19-affected-lumber-prices/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
