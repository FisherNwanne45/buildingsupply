...
<!-- Mirrored from <?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:39 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Over recent months, the canadian lumber industry has been in a bit of a pinch: Production prices have risen across the board while supplies are shrinking due to wildfires and wood-destroying insects." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Over recent months, the canadian lumber industry has been in a bit of a pinch: Production prices have risen across the board while supplies are shrinking due to wildfires and wood-destroying insects." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-10-02T14:12:57+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:48:16+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/"},"author":{"name":"mflood","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46"},"headline":"The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry","datePublished":"2018-10-02T14:12:57+00:00","dateModified":"2023-09-11T13:48:16+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/"},"wordCount":632,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Building Supplier","Downtown <?php echo $row['country']; ?> Residential Building","Home Improvement Contractor","lumber","Lumber and Building Materials","lumber dealer","lumber tariffs","Remodeler"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Contractor","Developer","Remodeler","Triple Decker"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/","url":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/","name":"The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg","datePublished":"2018-10-02T14:12:57+00:00","dateModified":"2023-09-11T13:48:16+00:00","description":"Over recent months, the canadian lumber industry has been in a bit of a pinch: Production prices have risen across the board while supplies are shrinking due to wildfires and wood-destroying insects.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/10/The-Impact-of-Canadian-Lumber-Tariffs-for-the-boston-Building-Industry.jpg","width":1280,"height":853,"caption":"The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46","name":"mflood","url":"<?php echo $row['url']; ?>/author/mflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/1952.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexaa37.php?p=1952' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed3322.json?url=<?php echo $row['url']; ?>%2Fcanadian-lumber-tariffs-for-boston-building-industry%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embeddfa2?url=<?php echo $row['url']; ?>%2Fcanadian-lumber-tariffs-for-boston-building-industry%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1952 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">The Impact of Canadian Lumber Tariffs for the <?php echo $row['country']; ?> Building Industry</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Over recent months, the lumber industry has been in a&nbsp;<a href="../why-strong-demand-and-tight-supply-have-caused-lumber-prices-to-soar-2/index.php" target="_blank" rel="noopener noreferrer">bit of a pinch</a>: Production prices have risen across the board while supplies are shrinking due to wildfires and wood-destroying insects. This is coupled with labor shortages and rising wages, all of which has combined to drive the cost of lumber sky-high. And, there’s another factor at play here, too. The recent Canadian lumber tariffs are having a big impact on lumber prices — and the construction industry as a whole. Let’s take a look at the specifics.</p>
<p><span id="more-1952"></span></p>
<h3><strong>A Brief Overview of Canadian Lumber Tariffs</strong></h3>
<p>Tariffs are taxes on imported goods, a cost that the purchaser must pay in order to import the goods — in this case, lumber from Canada. In January 2018, the Trump administration&nbsp;<a href="https://www.cbsnews.com/news/lumber-tariffs-are-making-new-homes-even-more-costly/" target="_blank" rel="noopener noreferrer">imposed a 20%</a>&nbsp;tariff on imported Canadian softwood lumber. This represents a large portion of the lumber used in the U.S., particularly the lumber used to build new homes. Canadian softwoods make up about 28% of all softwoods sold in the U.S. (Read the latest news regarding <a href="https://www.washingtonpost.com/business/2018/10/01/us-canada-mexico-just-reached-sweeping-new-nafta-deal-heres-whats-it/?noredirect=on&amp;utm_term=.13413af49400" target="_blank" rel="noopener noreferrer">USMCA trade deal agreement</a> and Chapter 19 Dispute Resolution Process which affects&nbsp;<a href="https://ottawacitizen.com/news/canada/usmca-canada/wcm/1771bce4-c669-4380-aca4-98c8a2dbb8b3" target="_blank" rel="noopener noreferrer">U.S. tariffs on softwood lumber</a>).&nbsp;</p>
<h3><strong>Is the Tariff Driving Up Housing Prices?</strong></h3>
<p>Experts say that yes, these tariffs are absolutely influencing housing prices. In fact, even the anticipation of the proposed tariffs drove prices up nationwide by 7% prior to December 2017. Currently, the <a href="https://www.housingwire.com/articles/43788-cbc-canadian-lumber-producers-tell-us-consumers-you-can-take-your-tariffs-back-eh" target="_blank" rel="noopener noreferrer">National Association of Homebuilders</a> says that Canadian lumber tariffs are adding an average of $9,000 to the price of a new home. The tariffs, coupled with other supply problems, have led to a 40% increase in the cost of lumber for 2018, and an 80% year-over-year increase overall. Even the rental market is affected: Multi-family units have increased in price by up to $3,000.</p>
<h3><strong>Will This Have a Chilling Effect on the Housing Industry?</strong></h3>
<p>Builders and the housing industry are already experiencing a squeeze. For new homeowners, the added cost to build a home often proves to be too much. Many buyers are turning toward older homes, but inventory across the country is already lean, which means the price of real estate is going up as people compete for the few houses available. Currently, the median cost of a home in the U.S. is $312,000, a price that many first-time buyers simply can’t afford. To make ends meet, builders are increasing costs on entry-level homes that are more likely to sell, and many are reporting a sharp decline in sales as a result.</p>
<p>In the future, builders are expecting to see a wave of job loss throughout the construction industry. As more and more Americans choose to buy or rent older homes, housing starts will go down as will the demand for builders to complete those projects.</p>
<h3><strong>Solution in Sight, But Could Be Slow</strong></h3>
<p>So what is the solution? Many are looking toward American lumber production to increase supply, but it’s a slow process and experts anticipate that it could be years before American lumber producers are able to meet the supply that Canada can provide. Right now, manufacturers are increasing production at a rate of 4.4% yearly, which is not fast enough to stave off increasing prices.</p>
<p>In the meantime, industry experts hope that the tariffs will come down to help ease the strain on the construction industry. Some may start looking at steel framing as a replacement for stick framing, but this comes with its share of problems, too. Steel is expensive, faces rising tariffs of its own, and availability is sometimes a challenge.</p>
<p>Politicians on both sides of the aisle, as well as lobbyists and political think tanks, are urging the current administration to reconsider Canadian lumber tariffs. If these tariffs are renegotiated, then prices could come back down.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="683" src="../wp-content/uploads/2018/10/contrasting-kitchen-island-colors-1024x683.jpg" class="attachment-large size-large wp-post-image" alt="contrasting kitchen island colors" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors-1536x1024.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2018/10/contrasting-kitchen-island-colors.jpg 2048w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../kitchen-islands-add-pop-of-color-to-design-scheme/index.php">Why Contrasting Kitchen Islands Add a Pop of Color to Your Design Scheme</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/canadian-lumber-tariffs-for-boston-building-industry/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/canadian-lumber-tariffs-for-boston-building-industry/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:41 GMT -->
</html>
