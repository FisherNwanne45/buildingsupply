...
<!-- Mirrored from <?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:33 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="In the <?php echo $row['country']; ?> construction industry, we’re liable to see a slow return to work as new cases of the virus lessen while state and city officials gradually lift restrictions." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="<?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="In the <?php echo $row['country']; ?> construction industry, we’re liable to see a slow return to work as new cases of the virus lessen while state and city officials gradually lift restrictions." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2020-04-17T04:00:19+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:34+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2020/04/boston-construction-moratorium-impact-1024x687.png" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/"},"author":{"name":"Justin","@id":"<?php echo $row['url']; ?>/#/schema/person/6e63ef9f98cf37362099fa270f43c591"},"headline":"<?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback","datePublished":"2020-04-17T04:00:19+00:00","dateModified":"2023-09-11T13:46:34+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/"},"wordCount":844,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact.png","keywords":["<?php echo $row['country']; ?>","Covid-19"],"articleSection":["Architect"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/","url":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/","name":"<?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact.png","datePublished":"2020-04-17T04:00:19+00:00","dateModified":"2023-09-11T13:46:34+00:00","description":"In the <?php echo $row['country']; ?> construction industry, we’re liable to see a slow return to work as new cases of the virus lessen while state and city officials gradually lift restrictions.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2020/04/boston-construction-moratorium-impact.png","width":1280,"height":859},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"<?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/6e63ef9f98cf37362099fa270f43c591","name":"Justin","url":"<?php echo $row['url']; ?>/author/justin/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title><?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2674.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index8191.php?p=2674' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embeda662.json?url=<?php echo $row['url']; ?>%2Fboston-construction-moratorium-impact-response-and-future-comeback%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed969f?url=<?php echo $row['url']; ?>%2Fboston-construction-moratorium-impact-response-and-future-comeback%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2674 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size"><?php echo $row['country']; ?> Construction Moratorium Impact, Response and Future Comeback</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p><span style="font-weight: 400;">With the COVID-19 crisis, there’s lots of buzz flying around about how this affects the construction industry in <?php echo $row['country']; ?>. Right now, there is an indefinite moratorium on construction within the city. But what exactly does that mean? Let’s take a look at who is impacted by this and who is able to respond during this challenging time. Of course, a comeback will be coming, too, so we’ll examine what that comeback could look like.</span></p>
<p><span style="font-weight: 400;">Impact</span></p>
<p><span style="font-weight: 400;">As the COVID-19 pandemic picked up steam, officials in <?php echo $row['country']; ?> and the state of Massachusetts took measures to limit the spread of the virus. On March 17, Mayor Walsh put a two-week ban on all projects that the city of <?php echo $row['country']; ?> had permitted, this in an effort to slow the virus’s spread. By March 25, the Mayor announced that this ban would be indefinite—even though Governor Charlie Baker has said that construction should continue throughout Massachusetts in view of the state’s housing crisis. In a letter from the governor’s office, Walsh stated that to prevent economic disruption, projects should continue as long as social distancing protocols are observed. In <?php echo $row['country']; ?>, however, Mayor Walsh’s moratorium still stands.</span></p>
<p><span style="font-weight: 400;">Some projects are still continuing, however. In <?php echo $row['country']; ?>, the work stoppage is specifically limited to projects that the city itself has approved. And that is quite a few projects, including everything from apartments and condos to commercials spaces like laboratories and hotels. State-approved construction projects, however, are still ongoing although work is at the discretion of developers and contractors, which means that some project managers have called a halt on their projects in an effort to keep their workers safe.</span></p>
<p><span style="font-weight: 400;"><?php echo $row['country']; ?>’s building moratorium does have a few caveats to be aware of. Some specific projects are still allowed to continue. These include projects like hospitals and other buildings to promote public health and safety, work that makes residential buildings fully habitable is still allowed, and residential construction for buildings that include three units or less are still ongoing.</span></p>
<p><span style="font-weight: 400;">Overall, the moratorium’s impact is far-reaching given the number of city projects that have come to a halt. But there are still some opportunities out there what with state-approved projects still underway.</span></p>
<p><span style="font-weight: 400;">Response</span></p>
<p><span style="font-weight: 400;">And how are people responding? Many suppliers—including NEBS—are still open for business in order to supply the essential goods that operating construction projects need.</span></p>
<p><span style="font-weight: 400;">On state and even nationwide levels, we’re seeing varied responses—just as the city of <?php echo $row['country']; ?>’s moratorium conflicts with the Governor’s request to keep construction going. In some places in the United States, construction is considered essential, particularly in places experiencing serious housing shortages. Other places have done just as <?php echo $row['country']; ?> has done by ordering work stoppages.</span></p>
<p><span style="font-weight: 400;">Meanwhile, many construction industry groups are lobbying for construction to be considered an essential industry. At the smaller scale, employers and contracting businesses are torn—and this is something we’re seeing in <?php echo $row['country']; ?>. Workers need a steady paycheck plus access to health insurance, and contractors often have contractual obligations to finish a project by a certain date, which now may not be possible given work stoppages. At the same time, these people are concerned about health and safety, too. That’s why we’ve seen two unions so far—the North Atlantic Regional Council of Carpenters and the Painters and Allied Trades Union—call for their workers to walk off construction sites. The fear is that these workers don’t have enough personal protective equipment to reduce exposure, and that they are unable to properly practice social distancing.</span></p>
<p><span style="font-weight: 400;">Making a Comeback</span></p>
<p><span style="font-weight: 400;">There’s no doubt that a comeback will happen. After all, construction is one of those industries that just can’t stop. We will always have a demand for new homes, commercial spaces and more. So it’s not a question of whether or not that comeback will take place, but what shape it will take. In the construction industry, we’re liable to see a slow return to work as new cases of the virus lessen while state and city officials gradually lift restrictions.</span></p>
<p><span style="font-weight: 400;">Supply chain issues may be a problem for a while as suppliers scramble to make up for lost time. The big supply challenge to watch out for will be materials buying sprees that may occur as the industry picks up steam again. Such mass buyouts of supplies could result in shortages.</span></p>
<p><span style="font-weight: 400;">While consumer confidence may be shaky, it’s likely that lenders—who were doing quite well before this crisis—will be eager to resume their business. That means during the recovery process, it may be easier for people within the construction industry to secure financing for new projects as people across sectors work hard to get the economy moving again.</span></p>
<p><span style="font-weight: 400;">There’s no doubt that challenging times are before us. But the construction industry within <?php echo $row['country']; ?> and elsewhere, too, will make a comeback. It’s only a matter of time before this crisis passes and we can all get back to work!</span></p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="../wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid-1024x687.png" class="attachment-large size-large wp-post-image" alt="" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2020/04/moving-forward-as-a-construction-contractor-after-covid.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../how-to-move-forward-not-backward-as-a-construction-contractor-during-covid-19/index.php">How to Move Forward, Not Backward, as a Construction Contractor During COVID-19</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/boston-construction-moratorium-impact-response-and-future-comeback/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/boston-construction-moratorium-impact-response-and-future-comeback/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:34 GMT -->
</html>
