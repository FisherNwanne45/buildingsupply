...
<html lang="en-US">
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:02:48 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <meta property="og:title" content="Home - <?php echo $row['name']; ?> " />
        <meta property="og:description"
            content="Your Trusted <?php echo $row['country']; ?> Construction Supplier   offers a diverse range of products and materials catering to residential and commercial projects and serving the <?php echo $row['country']; ?> community&#8217;s builders, developers, architects, and homeowners. Builder &amp; Developer Triple Decker / CommercialApartment / High RiseCondo / High Rise / Mix Use Learn more Architect Product SpecificationsApartmentTurnkey Learn more Homeowner Single-FamilySuburbs…" />
        ...
        <meta property="article:modified_time" content="2024-09-13T18:57:15+00:00" />
        <meta property="og:image" content="wp-content/uploads/2023/08/home-builder.jpg" />
        ...
        <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                ...
                "primaryImageOfPage": {
                    "@id": "<?php echo $row['url']; ?>/#primaryimage"
                },
                "image": {
                    "@id": "<?php echo $row['url']; ?>/#primaryimage"
                },
                "thumbnailUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-builder.jpg",
                "datePublished": "2023-03-15T21:05:59+00:00",
                "dateModified": "2024-09-13T18:57:15+00:00",
                "breadcrumb": {
                ...
                "inLanguage": "en-US",
                "@id": "<?php echo $row['url']; ?>/#primaryimage",
                "url": "<?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-builder.jpg",
                "contentUrl": "<?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-builder.jpg",
                "width": 462,
                "height": 462
            }, {
                "@type": "BreadcrumbList",
        ...
        <link rel='stylesheet' id='blockshoon-product-carousel-styles-css'
            href='wp-content/themes/blockshoon/blocks/carousels/build/swiper.product2d30.css?ver=bc21607fef9c6b218598'
            media='all' />
        <link rel='stylesheet' id='wp-block-gallery-css' href='wp-includes/blocks/gallery/style.min75e4.css?ver=6.4.5'
            media='all' />
        ...
        <link rel="alternate" type="application/json+oembed"
            href="wp-json/oembed/1.0/embed6a80.json?url=<?php echo $row['url']; ?>%2F" />
        <link rel="alternate" type="text/xml+oembed"
            href="wp-json/oembed/1.0/embed1f45?url=<?php echo $row['url']; ?>%2F&amp;format=xml" />
    ...
    <body class="home page-template-default page page-id-63 wp-custom-logo wp-embed-responsive without-announcement">
        ...
        <div class="wp-site-blocks">
            <header class="site-header wp-block-template-part">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="wp-block-site-logo"><a href="index.php" class="custom-logo-link" rel="home"
                                aria-current="page"><img width="210" height="55"
                        ...
                        <div id="site-responsive-nav"
                            ...
                            <nav class=" no-wrap site-responsive-nav wp-block-navigation is-nowrap is-layout-flex wp-container-core-navigation-layout-1 wp-block-navigation-is-layout-flex"
                                ...
                                <ul
                                    ...
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content" href="contact/index.php"><span
            ...
            <main class="wp-block-group alignfull is-layout-constrained wp-block-group-is-layout-constrained">
                <div
                    ...
                    <div class="wp-block-cover alignfull is-light has-custom-content-position is-position-bottom-center pattern-hero"
                        style="min-height:82vh"><span aria-hidden="true"
                            class="wp-block-cover__background has-background-dim wp-block-cover__gradient-background has-background-gradient has-transparent-to-black-gradient-background"></span><video
                            class="wp-block-cover__video-background intrinsic-ignore" autoplay muted loop playsinline
                            src="wp-content/uploads/2023/09/NEBS_Video_Final.mp4" data-object-fit="cover"></video>
                    ...
                    <div class="wp-block-group alignfull pattern-product-list has-blue-3-background-color has-background is-layout-constrained wp-block-group-is-layout-constrained"
                        style="margin-bottom:var(--wp--preset--spacing--80)">
                        <h1 class="wp-block-heading alignwide has-text-align-center is-style-default has-primary-color has-text-color has-h-3-font-size"
                            style="margin-bottom:var(--wp--preset--spacing--40)">Your Trusted
                            <?php echo $row['country']; ?> Construction
                            Supplier</h1>
                        ...
                        <p class="has-text-align-center has-primary-color has-text-color has-x-large-font-size">
                            <?php echo $row['name']; ?>
                            offers a diverse range of products and materials catering to residential and commercial
                            projects and serving the <?php echo $row['country']; ?> community&#8217;s builders,
                        ...
                        <div
                            class="wp-block-group alignwide carousel-products swiper-products is-layout-flow wp-block-group-is-layout-flow">
                            <div
                                class="wp-block-columns alignwide list-products swiper is-layout-flex wp-container-core-columns-layout-1 wp-block-columns-is-layout-flex">
                                <div
                                    class="wp-block-column has-link-arrow is-layout-flow wp-block-column-is-layout-flow">
                                    <figure class="wp-block-image size-full"><img fetchpriority="high" decoding="async"
                                            width="462" height="462" src="wp-content/uploads/2023/08/home-builder.jpg"
                                            alt="" class="wp-image-3836"
                                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-builder.jpg 462w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-builder-375x375.jpg 375w"
                                            sizes="(max-width: 462px) 100vw, 462px" /></figure>



                                    <h2 class="wp-block-heading has-text-align-center has-h-5-font-size"><a
                                            href="builder-developer/index.php">Builder &amp; Developer</a></h2>



                                    <p class="has-text-align-center">Triple Decker / Commercial<br>Apartment / High
                                        Rise<br>Condo / High Rise / Mix Use</p>



                                    <p class="has-text-align-center link-arrow has-small-font-size">Learn more</p>
                                </div>
                                ...
                                <div
                                    class="wp-block-column has-link-arrow is-layout-flow wp-block-column-is-layout-flow">
                                    <figure class="wp-block-image size-full"><img decoding="async" width="462"
                                            height="462" src="wp-content/uploads/2023/08/home-architect.jpg" alt=""
                                            class="wp-image-3837"
                                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-architect.jpg 462w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-architect-375x375.jpg 375w"
                                            sizes="(max-width: 462px) 100vw, 462px" /></figure>



                                    <h2 class="wp-block-heading has-text-align-center has-h-5-font-size"><a
                                            href="architect/index.php">Architect</a></h2>



                                    <p class="has-text-align-center">Product Specifications<br>Apartment<br>Turnkey</p>
                                ...
                                <div
                                    class="wp-block-column has-link-arrow is-layout-flow wp-block-column-is-layout-flow">
                                    <figure class="wp-block-image size-full"><img decoding="async" width="462"
                                            height="462" src="wp-content/uploads/2023/08/home-homeowner.jpg" alt=""
                                            class="wp-image-3838"
                                            srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-homeowner.jpg 462w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/home-homeowner-375x375.jpg 375w"
                                            sizes="(max-width: 462px) 100vw, 462px" /></figure>



                                    <h2 class="wp-block-heading has-text-align-center has-h-5-font-size"><a
                                            href="homeowner/index.php">Homeowner</a></h2>



                                    <p class="has-text-align-center">Single-Family<br>Suburbs / Downtown<br>Products /
                                        Services</p>
                            ...
                            <div class="nav-carousel" role="group" aria-label="Service carousel controls">
                    ...
                    <h2
                        class="wp-block-heading alignwide is-style-with-border has-primary-color has-text-color has-h-3-font-size">
                        Our Services</h2>



                    <div
                        class="wp-block-group alignwide pattern-alternating-columns is-layout-flow wp-block-group-is-layout-flow">
                        <div
                            class="wp-block-columns alignwide are-vertically-aligned-center is-layout-flex wp-container-core-columns-layout-2 wp-block-columns-is-layout-flex">
                            <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:34.7%">
                                <h2 class="wp-block-heading has-primary-color has-text-color has-x-large-font-size"><a
                                        href="service/design-center/index.php">Design Center</a></h2>



                                <p>Our design center is open to the public and conveniently located right off I-93 in
                                    downtown <?php echo $row['country']; ?>. See windows, doors, cabinets, kitchens,
                                    bath designs, countertops,
                                    flooring materials, siding and roofing displays, and more. Our on-site customer
                                    support team can answer your questions, recommend products or services, and walk you
                                    through product details.&nbsp;</p>



                                <div
                                    class="wp-block-group pattern-icon-list is-nowrap is-layout-flex wp-container-core-group-layout-7 wp-block-group-is-layout-flex">
                                    <figure class="wp-block-image size-full is-resized"><img loading="lazy"
                                            decoding="async" width="92" height="92"
                                            src="wp-content/uploads/2023/03/icon-windows.png" alt=""
                                            class="wp-image-134" style="width:46px;height:46px" /></figure>



                                    <p>Windows, Doors, and Cabinets</p>
                                </div>



                                <div
                                    class="wp-block-group pattern-icon-list is-nowrap is-layout-flex wp-container-core-group-layout-8 wp-block-group-is-layout-flex">
                                    <figure class="wp-block-image size-full is-resized"><img loading="lazy"
                                            decoding="async" width="92" height="92"
                                            src="wp-content/uploads/2023/06/icon-kitchens.png" alt=""
                                            class="wp-image-3633" style="width:46px;height:46px" /></figure>



                                    <p>Kitchens, Baths, Flooring, and Countertops</p>
                                </div>



                                <div
                                    class="wp-block-group pattern-icon-list is-nowrap is-layout-flex wp-container-core-group-layout-9 wp-block-group-is-layout-flex">
                                    <figure class="wp-block-image size-full is-resized"><img loading="lazy"
                                            decoding="async" width="92" height="92"
                                            src="wp-content/uploads/2023/06/icon-roof.png" alt="" class="wp-image-3634"
                                            style="width:46px;height:46px" /></figure>



                                    <p>Siding, Roofing, and more!</p>
                                </div>
                            ...
                            <div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                                ...
                                <figure class="wp-block-image size-full"><img loading="lazy" decoding="async"
                                        width="875" height="672" src="wp-content/uploads/2023/09/nebs-design-center.jpg"
                                        alt="" class="wp-image-3852"
                                        srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/09/nebs-design-center.jpg 875w, <?php echo $row['url']; ?>/wp-content/uploads/2023/09/nebs-design-center-768x590.jpg 768w"
                                        sizes="(max-width: 875px) 100vw, 875px" /></figure>
                            </div>
                        </div>
                        ...
                        <div
                            class="wp-block-columns alignwide are-vertically-aligned-center is-layout-flex wp-container-core-columns-layout-3 wp-block-columns-is-layout-flex">
                            <div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:50%">
                                <figure class="wp-block-image size-full"><img loading="lazy" decoding="async"
                                        width="875" height="583"
                                        src="wp-content/uploads/2023/04/estimating-services.jpg" alt=""
                                        class="wp-image-3217"
                                        srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/estimating-services.jpg 875w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/estimating-services-768x512.jpg 768w"
                                        sizes="(max-width: 875px) 100vw, 875px" /></figure>
                            </div>
                            ...
                            <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:34.7%">
                                <h2 class="wp-block-heading has-primary-color has-text-color has-x-large-font-size"><a
                                        href="service/estimating/index.php">Estimating</a></h2>



                                <p>Let our skilled estimators help you plan your next project and ensure you order
                                    suitable materials to reduce overhead and waste. We use the latest estimating and
                                    engineering software for all material take-offs, including lumber, drywall, doors,
                                    windows, siding, roofing, hardware, and kitchen and bath.</p>
                        ...
                        <div
                            ...
                            <div class="wp-block-column is-vertically-aligned-center content-col is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:34.7%">
                                <h2 class="wp-block-heading has-primary-color has-text-color has-x-large-font-size"><a
                                        href="service/delivery/index.php">Delivery</a></h2>



                                <p>Our fleet consists of boom trucks, Moffett trucks, and box and flatbed trucks to
                                    allow building materials to get delivered efficiently and in a timely manner.</p>
                            ...
                            <div class="wp-block-column is-vertically-aligned-center is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:50%">
                                <figure class="wp-block-image size-full"><img loading="lazy" decoding="async"
                                        width="875" height="583" src="wp-content/uploads/2023/04/delivery-services.jpg"
                                        alt="" class="wp-image-3219"
                                        srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/delivery-services.jpg 875w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/delivery-services-768x512.jpg 768w"
                                        sizes="(max-width: 875px) 100vw, 875px" /></figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignfull pattern-lg-feature-bg has-background-color has-primary-background-color has-text-color has-background is-layout-constrained wp-block-group-is-layout-constrained">
                        <figure class="wp-block-image aligncenter size-large"><img loading="lazy" decoding="async"
                                width="1024" height="683"
                                src="wp-content/uploads/2023/04/the-nebs-difference-1024x683.jpg" alt=""
                                class="wp-image-3221"
                                srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/04/the-nebs-difference-1024x683.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/the-nebs-difference-768x512.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/04/the-nebs-difference.jpg 1290w"
                                sizes="(max-width: 1024px) 100vw, 1024px" /></figure>



                        <div class="wp-block-group alignnarrow is-layout-flow wp-block-group-is-layout-flow">
                            <h2 class="wp-block-heading has-text-align-center has-h-3-font-size"
                                style="margin-top:var(--wp--preset--spacing--60);margin-bottom:var(--wp--preset--spacing--20)">
                                What Makes <?php echo $row['name']; ?> Different</h2>



                            <p class="has-text-align-center has-large-font-size">What makes
                                <?php echo $row['name']; ?> different? We have
                                exceptional customer service, a convenient downtown <?php echo $row['country']; ?>
                                location, and a wide range of
                                product capabilities, making <?php echo $row['name']; ?> the go-to destination for all
                                your building needs.</p>
                        </div>



                        <div class="wp-block-columns alignwide are-vertically-aligned-top justify-space-between alignmid is-layout-flex wp-container-core-columns-layout-5 wp-block-columns-is-layout-flex"
                            style="padding-top:var(--wp--preset--spacing--80)">
                            <div class="wp-block-column is-vertically-aligned-top is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:30%">
                                <h3 class="wp-block-heading has-light-blue-color has-text-color has-large-font-size">
                                    From Frame to Finish</h3>



                                <p class="has-small-font-size"><?php echo $row['name']; ?> has everything you need to
                                    build your dream construction project from the ground up. Whether you’re a
                                    construction pro looking for bulk building materials or a homeowner embarking on a
                                    DIY project, we have it all. Choose from top-notch framing timbers, dimensional
                                    lumber, and a whole showroom of sliding windows, doors, and more to create the exact
                                    look you want. Looking for the perfect finishing touch with molding and trim work?
                                    We have that too, along with expert advice and superior customer service to ensure
                                    your project gets done right.</p>
                            </div>
                            ...
                            <div class="wp-block-column is-vertically-aligned-top is-layout-flow wp-block-column-is-layout-flow"
                                style="flex-basis:30%">
                                <h3 class="wp-block-heading has-light-blue-color has-text-color has-large-font-size">
                                    <?php echo $row['country']; ?>’s Hometown Building Supplier</h3>



                                <p class="has-small-font-size"><?php echo $row['name']; ?> is the only independent
                                    building supplier and
                                    lumberyard in the downtown <?php echo $row['country']; ?> area. Although
                                    <?php echo $row['country']; ?> holds both national and
                                    historical significance, it’s also a thriving, modern city— and one that is
                                    constantly growing and evolving. From saltbox colonials to triple-deckers, we know
                                    what works in the <?php echo $row['country']; ?> community and beyond. Stop by our
                                    showroom in downtown
                                    <?php echo $row['country']; ?> to see how we can help you with your next building
                                    project.</p>
                            </div>
                            ...
                            <div class="wp-block-column is-vertically-aligned-top is-layout-flow wp-block-column-is-layout-flow"
                                ...
                                <p class="has-small-font-size"><?php echo $row['name']; ?> offers high-quality building
                                    materials for
                                    commercial and residential construction in a convenient downtown
                                    <?php echo $row['country']; ?> area. We
                                    have a wide selection of lumber, building materials, siding, decking, kitchen and
                                    bath cabinets and countertops, windows, doors, flooring materials, hardware, power
                                    tools, and much more! Visit our showroom or arrange delivery to your jobsite.</p>
                            </div>
                        </div>



                        <p class="has-text-align-center has-medium-font-size"><a href="about/index.php">Learn more
                                about us</a></p>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignfull pattern-icon-stats is-layout-constrained wp-block-group-is-layout-constrained">
                        <div
                            class="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-6 wp-block-columns-is-layout-flex">
                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                <figure class="wp-block-image aligncenter size-full is-resized"><img loading="lazy"
                                        decoding="async" width="290" height="290"
                                        src="wp-content/uploads/2023/03/icon-trucks.png" alt="" class="wp-image-121"
                                        style="width:145px;height:145px" /></figure>



                                <p class="has-text-align-center"><strong>4</strong><br>Boom <br>Trucks</p>
                            </div>
                            ...
                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                <figure class="wp-block-image aligncenter size-full is-resized"><img loading="lazy"
                                        decoding="async" width="290" height="290"
                                        src="wp-content/uploads/2023/03/icon-projects.png" alt="" class="wp-image-125"
                                        style="width:145px;height:145px" /></figure>



                                <p class="has-text-align-center"><strong>250</strong><br>Projects<br>Per Year</p>
                            </div>
                            ...
                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                <figure class="wp-block-image aligncenter size-full is-resized"><img loading="lazy"
                                        decoding="async" width="290" height="290"
                                        src="wp-content/uploads/2023/03/icon-experience.png" alt="" class="wp-image-126"
                                        style="width:145px;height:145px" /></figure>



                                <p class="has-text-align-center"><strong>847</strong><br>Years Personnel<br>Experience
                                </p>
                            </div>
                            ...
                            <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                <figure class="wp-block-image aligncenter size-full is-resized"><img loading="lazy"
                                        decoding="async" width="290" height="290"
                                        src="wp-content/uploads/2023/03/icon-fenway.png" alt="" class="wp-image-127"
                                        style="width:145px;height:145px" /></figure>



                                <p class="has-text-align-center"><strong>2</strong><br>Miles To<br>Fenway Park</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="wp-block-group alignwide pattern-section-intro is-layout-constrained wp-block-group-is-layout-constrained">
                        <h2
                            class="wp-block-heading alignwide has-text-align-center has-primary-color has-text-color has-h-3-font-size">
                            Our Work in Action</h2>



                        <p class="has-text-align-center has-primary-color has-text-color has-x-large-font-size">Explore
                            our gallery of completed construction projects and jobsites showcasing the exceptional
                            quality materials and craftsmanship that set us apart. See our work in action and get
                    ...
                    <div
                        ...
                        <figure
                            class="wp-block-gallery alignwide has-nested-images columns-1 is-cropped swiper-wrapper wp-block-gallery-3 is-layout-flex wp-block-gallery-is-layout-flex">
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1280" height="875" src="wp-content/uploads/2023/08/Taber-Street.jpg" alt=""
                                    class="wp-image-3809"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/Taber-Street.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Taber-Street-768x525.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Taber-Street-1024x700.jpg 1024w"
                                    sizes="(max-width: 1280px) 100vw, 1280px" />
                                <figcaption class="wp-element-caption">10 Taber Street | <?php echo $row['country']; ?>
                                    | 2023 Construction
                                    (left) 16 Taber Street | <?php echo $row['country']; ?> | 2023 Construction (right)
                                </figcaption>
                            </figure>



                            <figure class="wp-block-image size-large swiper-slide"><img loading="lazy" decoding="async"
                                    width="1024" height="700"
                                    src="wp-content/uploads/2023/08/Somerville-Ave-and-Hawkins-1024x700.jpg" alt=""
                                    class="wp-image-3815"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/Somerville-Ave-and-Hawkins-1024x700.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Somerville-Ave-and-Hawkins-768x525.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Somerville-Ave-and-Hawkins.jpg 1280w"
                                    sizes="(max-width: 1024px) 100vw, 1024px" />
                                <figcaption class="wp-element-caption">346 Somerville Ave | Somerville | 2021
                                    Construction (left) 3 Hawkins Street | Somerville | 2022 Construction (right)
                                </figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="1280" height="875" src="wp-content/uploads/2023/08/Hancock-Street.jpg" alt=""
                                    class="wp-image-3807"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/Hancock-Street.jpg 1280w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Hancock-Street-768x525.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Hancock-Street-1024x700.jpg 1024w"
                                    sizes="(max-width: 1280px) 100vw, 1280px" />
                                <figcaption class="wp-element-caption">151 Hancock Street | Quincy | 2022-2023
                            ...
                            <figure class="wp-block-image size-large swiper-slide"><img loading="lazy" decoding="async"
                                    width="1024" height="700" src="wp-content/uploads/2023/08/Warren-Ave-1024x700.jpg"
                                    alt="" class="wp-image-3808"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2023/08/Warren-Ave-1024x700.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Warren-Ave-768x525.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2023/08/Warren-Ave.jpg 1280w"
                                    sizes="(max-width: 1024px) 100vw, 1024px" />
                                <figcaption class="wp-element-caption">124 Warren Ave | <?php echo $row['country']; ?> |
                                    2022 Construction
                                </figcaption>
                            </figure>
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="2560" height="1917" src="wp-content/uploads/2024/05/01-0009-scaled.jpg"
                                    alt="" class="wp-image-4112"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2024/05/01-0009-scaled.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/01-0009-768x575.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/01-0009-1024x767.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/01-0009-1536x1150.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/01-0009-2048x1534.jpg 2048w"
                                    sizes="(max-width: 2560px) 100vw, 2560px" />
                                <figcaption class="wp-element-caption">500 Talbot Ave | <?php echo $row['country']; ?> |
                            ...
                            <figure class="wp-block-image size-full swiper-slide"><img loading="lazy" decoding="async"
                                    width="2560" height="1917" src="wp-content/uploads/2024/05/02-DJI_0186-scaled.jpg"
                                    alt="" class="wp-image-4109"
                                    srcset="<?php echo $row['url']; ?>/wp-content/uploads/2024/05/02-DJI_0186-scaled.jpg 2560w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/02-DJI_0186-768x575.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/02-DJI_0186-1024x767.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/02-DJI_0186-1536x1150.jpg 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2024/05/02-DJI_0186-2048x1534.jpg 2048w"
                                    sizes="(max-width: 2560px) 100vw, 2560px" />
                                <figcaption class="wp-element-caption">87 Oxford St | <?php echo $row['country']; ?> |
                                    2023-2024 Construction
                                </figcaption>
                            </figure>
                        </figure>
                        ...
                        <div class="nav-carousel nav-basic-carousel" role="group" aria-label="Project gallery controls">
                            <button type="button" class="carousel-btn-prev"></button>
            ...
            <footer class="site-footer wp-block-template-part">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="frm_fields_container">
                                                ...
                                                <input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4"
                                                    ...
                                                    value="/" /><input type="hidden" name="item_meta[25]"
                    ...
                    <div
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            ...
                            <nav class=" is-vertical wp-block-navigation is-layout-flex wp-container-core-navigation-layout-2 wp-block-navigation-is-layout-flex"
                                ...
                                <ul class="wp-block-navigation__container  is-vertical wp-block-navigation">
                                    ...
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content" href="portfolio/index.php"><span
                                                class="wp-block-navigation-item__label">Our Work</span></a></li>
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content"
                                            href="service/delivery/index.php"><span
                        ...
                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                            ...
                            <nav class=" is-vertical wp-block-navigation is-layout-flex wp-container-core-navigation-layout-4 wp-block-navigation-is-layout-flex"
                                ...
                                <ul class="wp-block-navigation__container  is-vertical wp-block-navigation">
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content" href="homeowner/index.php"><span
                                    ...
                                    <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                            class="wp-block-navigation-item__content" href="architect/index.php"><span
                ...
                <div
                    ...
                    <div
                        class="wp-block-group alignwide is-content-justification-space-between is-nowrap is-layout-flex wp-container-core-group-layout-19 wp-block-group-is-layout-flex">
                        ...
                        <nav class="wp-block-navigation is-layout-flex wp-block-navigation-is-layout-flex"
                            ...
                            <ul class="wp-block-navigation__container  wp-block-navigation">
                                <li class=" wp-block-navigation-item wp-block-navigation-link"><a
                                        class="wp-block-navigation-item__content" href="privacy-policy/index.php"><span
        ...
        <script src="wp-content/themes/blockshoon/blocks/carousels/build/swiper.product52e8.js?ver=810b40d6097e8b0b30d2"
            id="blockshoon-product-carousel-scripts-js"></script>
        <script src="wp-content/themes/blockshoon/blocks/carousels/build/swiper.basic6c39.js?ver=eb868f2d179d693c13bf"
    ...
    <!-- Mirrored from <?php echo $row['url']; ?>/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:03:55 GMT -->
