...
<!-- Mirrored from <?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:10:50 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Before you choose window glazing for your <?php echo $row['country']; ?> home, you’ll need to know a bit about window glazing. Today, triple pane and double pane windows are the two most popular options because they offer the energy efficiency that homes in cold climates like <?php echo $row['country']; ?> need. But, which type of window glaze is the right choice…" />
	<meta property="og:url" content="<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-03-28T09:22:37+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:48:44+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/"},"author":{"name":"mflood","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46"},"headline":"Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home","datePublished":"2018-03-28T09:22:37+00:00","dateModified":"2023-09-11T13:48:44+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/"},"wordCount":531,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg","keywords":["<?php echo $row['country']; ?> Homeowner","<?php echo $row['country']; ?> Triple Decker","DIY Home Improvement","Home Improvement Contractor","Home Renovation","Lumber and Building Materials","Remodeler","Triple Decker","Window Replacement","Windows"],"articleSection":["Builder","Building Trends","Contractor","Developer","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/","url":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/","name":"Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg","datePublished":"2018-03-28T09:22:37+00:00","dateModified":"2023-09-11T13:48:44+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/03/double-pane-or-triple-pane-windows.jpg","width":1000,"height":688,"caption":"double pane or triple pane windows"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/triple-pane-windows-vs-double-pane-for-boston-home/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/401c99f5df9ff73a1f9822d6d4c93a46","name":"mflood","url":"<?php echo $row['url']; ?>/author/mflood/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1728" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1728' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Ftriple-pane-windows-vs-double-pane-for-boston-home%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2Ftriple-pane-windows-vs-double-pane-for-boston-home%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1728 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2018-03-28T09:22:37-04:00">03.28.2018</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Window Glaze: Triple Pane Windows vs. Double Pane for a <?php echo $row['country']; ?> Home</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Before you choose window glazing for your <?php echo $row['country']; ?> home, you’ll need to know a bit about window glazing. Today, <a href="http://www.finehomebuilding.com/2016/09/14/tough-choice-double-pane-vs-triple-pane-windows" target="_blank" rel="noopener noreferrer">triple pane and double pane windows</a> are the two most popular options because they offer the <a href="<?php echo $row['url']; ?>/5-questions-answered-about-energy-efficient-windows/" target="_blank" rel="noopener noreferrer">energy efficiency</a> that homes in cold climates like <?php echo $row['country']; ?> need. But, which type of window glaze is the right choice for your home? Let’s take a look at the pros and cons of triple pane windows so that you can decide.</p>
<p><span id="more-1728"></span></p>
<h3><strong>Triple Pane Pros</strong></h3>
<p>The main advantage to triple pane window glaze is the <a href="<?php echo $row['url']; ?>/2-ways-to-increase-energy-efficiency-by-weatherizing-your-home/" target="_blank" rel="noopener noreferrer">energy efficiency</a>. On average, these windows have an increased 20% to 30% energy efficiency as compared to dual pane windows. What does that mean as far as heating bills go? In New England, this translates to about 2% to 3% off the yearly bill. Here are a few other good points to know about triple glazed windows:</p>
<ul>
<li>Energy efficiency isn’t the only aspect to consider. Homeowners with triple pane window glaze report vastly increased comfort within the home. These windows tend to seal better, which dramatically cuts down on drafts.</li>
<li>If you’ve ever found yourself annoyed by the condensation that sometimes builds in between the glass of dual pane windows, you may like triple panes better. The added layer of glass along with the sturdy seals that hold the glazing together help prevent condensation throughout the life of the window.</li>
<li>There is some small soundproofing benefit with triple pane windows. One more layer of glass serves as a buffer between you and the outdoors, not only cutting down on heat but on noise from whatever is happening outside. The reduction in sound isn’t huge but it isn’t something that homeowners in noisy neighborhoods should disregard, either.</li>
</ul>
<h3><strong>What are the Cons of Triple Window Glaze?</strong></h3>
<p>The biggest drawback to triple pane window glaze is the cost — and there are two different ways in which you will pay a premium for these windows. Triple pane glazing costs about&nbsp;<a href="https://www.familyhandyman.com/windows/are-tripleglazed-windows-worth-the-extra-cost/view-all/" target="_blank" rel="noopener noreferrer">10% to 15% more</a>&nbsp;than their dual pane counterparts. At a 2% to 3% savings on heating each year, it could take quite a few years to recoup the additional cost of these windows. Another issue is that these windows are heavier than double pane windows, which means you’ll pay a bit more in time and labor to have them installed, though the added installation cost won’t be astronomical.</p>
<h3><strong>Which Should You Choose?</strong></h3>
<p>If energy savings and increased comfort are important to you, then triple glazed windows may just be the way to go. However, if you plan on selling the home before these windows have paid for themselves, then double paned windows will be the option that will see more of your cost recouped on the sale price. Keep in mind, too, that there are many other ways to make&nbsp;<a href="http://en.jeld-wen.ca/blog/2018/01/05/help-homeowners-get-comfortable-with-winter-windows/" target="_blank" rel="noopener noreferrer">windows more energy efficient</a>: Low-E coatings, for instance, as well as window frames that are designed and insulated for <?php echo $row['country']; ?>’s cold climate.</p>
<p>In the case of triple versus double paned windows, the right choice is the one fits your budget: Either long-term energy savings or short-term cost recoupment!</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1010" height="627" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/04/boston-spring-home-improvements.png" class="attachment-large size-large wp-post-image" alt="<?php echo $row['country']; ?> spring home improvements" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/04/boston-spring-home-improvements.png 1010w, <?php echo $row['url']; ?>/wp-content/uploads/2018/04/boston-spring-home-improvements-768x477.png 768w" sizes="(max-width: 1010px) 100vw, 1010px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/top-6-boston-spring-home-improvements/">Top 6 <?php echo $row['country']; ?> Spring Home Improvements</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/triple-pane-windows-vs-double-pane-for-boston-home/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
