...
<!-- Mirrored from <?php echo $row['url']; ?>/eco-friendly-drywall-options/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:47 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Green products are a growing priority among homeowners and buyers in <?php echo $row['country']; ?>. Eco-friendly drywall options include rising stars such as MgO board." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Eco-Friendly Drywall Options - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Green products are a growing priority among homeowners and buyers in <?php echo $row['country']; ?>. Eco-friendly drywall options include rising stars such as MgO board." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2019-10-23T13:14:11+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:51+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2019/10/eco-friendly-drywall-.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"Eco-Friendly Drywall Options","datePublished":"2019-10-23T13:14:11+00:00","dateModified":"2023-09-11T13:46:51+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/"},"wordCount":558,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Condo","<?php echo $row['country']; ?> Homeowner","Builder","Downtown <?php echo $row['country']; ?> Residential Building","drywall","eco friendly","Lumber and Building Materials","Remodeler","Sustainability"],"articleSection":["Builder","Building in <?php echo $row['country']; ?>","Building Trends","Contractor","Developer","Homeowner","Remodeler"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/","url":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/","name":"Eco-Friendly Drywall Options - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg","datePublished":"2019-10-23T13:14:11+00:00","dateModified":"2023-09-11T13:46:51+00:00","description":"Green products are a growing priority among homeowners and buyers in <?php echo $row['country']; ?>. Eco-friendly drywall options include rising stars such as MgO board.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/eco-friendly-drywall-options/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2019/10/eco-friendly-drywall-.jpg","width":1280,"height":859,"caption":"eco friendly drywall"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/eco-friendly-drywall-options/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Eco-Friendly Drywall Options"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Eco-Friendly Drywall Options - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2616.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../indexb208.php?p=2616' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embedd5b3.json?url=<?php echo $row['url']; ?>%2Feco-friendly-drywall-options%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedf3c5?url=<?php echo $row['url']; ?>%2Feco-friendly-drywall-options%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2616 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2019-10-23T09:14:11-04:00">10.23.2019</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Eco-Friendly Drywall Options</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>Green products are a growing priority among homeowners and buyers in <?php echo $row['country']; ?> and beyond. Many are becoming more aware of just how <a href="../the-circular-economy-and-its-impact-on-construction/index.php">environmentally unfriendly building materials</a> like drywall can be. In fact, when it comes to CO2 emissions, 52% of the world’s total comes from buildings—the energy they use, and the emissions created when the building supplies that go into them are manufactured.</p>
<p>Drywall in particular is the most popular form of interior wallboard, and its manufacturing requires a lot of energy—which means a lot of CO2 emissions. That’s why some homeowners are now looking for eco friendly drywall options. Let’s take a look at a few of the options available so that you know what to recommend when homeowners, buyers or developers start asking about green wallboard!</p>
<h3><strong>MgO Board as an Alternative</strong></h3>
<p>MgO board is a rising star among eco friendly drywall alternatives. Companies like ExtremeGreen produce this unique product, which comes with a lot of benefits. On the environmental side of things, this type of wallboard uses on average 50% less energy during the manufacturing process than drywall production. It’s also a recyclable product, and it’s one that can be composted to use as plant nutrients, too. Plus, it’s made up of non-toxic ingredients, which means that even if it does end up in a landfill someday, it won’t leech harmful chemicals into soil and water supplies.</p>
<p>When it comes to building concerns, MgO board is sturdy, making it resistant to impacts, scratches, and dents, which means it’s ideal in high-traffic locations. It’s also Class A1 fire rated so that it will fit with whatever local building codes require. To learn more about it, check out <a href="https://extremegreenbp.com/products/#wallboard" data-cke-saved-href="https://extremegreenbp.com/products/#wallboard">ExtremeGreen’s website</a>!</p>
<h3><strong>Agricultural Waste Might Be the Answer</strong></h3>
<p>One up and coming eco friendly drywall option are wallboards manufactured from agricultural waste like wheat remnants or straw. Ortech is an Australian company prominent among others manufacturing this type of product. Their <a href="https://www.ortech.com.au/durra-panels/" data-cke-saved-href="https://www.ortech.com.au/durra-panels/">Durra Panels</a> not only boast a high level of recycled agricultural waste, but they also have no formaldehyde or other chemical binders to hold the particles and fibers together. The result is a green alternative to drywall, one that homeowners love because since it doesn’t release chemical vapors, it doesn’t create indoor air pollution.</p>
<h3><strong>Look at Companies Like Homasote</strong></h3>
<p>Some companies specialize in eco-friendly manufacturing processes. Homasote is one of them. This building supply manufacturer operates on a closed-loop system, which means that all waste products produced by the manufacturing process—water, dust, rejected products, scrap, and more—is all recycled back into product manufacture. Companies with closed loop systems produce virtually no waste material.</p>
<p>What’s more, Homasote’s products are comprised largely of recycled material. For instance, their <a href="http://www.homasote.com/products/designwall-interior-panels" data-cke-saved-href="http://www.homasote.com/products/designwall-interior-panels">DesignWall 440</a>, which is a pre-finished, fabric laminated wallboard, is made of 98% recycled materials. If you’d like to learn about the rest of their product line, here’s a <a href="http://www.homasote.com/assets/files/post-consumer-recycled.pdf" data-cke-saved-href="http://www.homasote.com/assets/files/post-consumer-recycled.pdf">breakdown of each product</a> and their recycled material percentages.</p>
<p>This is just a sampling of the eco friendly drywall options available at <?php echo $row['name']; ?> . If you’re looking for more options—or things like eco-friendly insulation and other products—feel free to take a look at all our suppliers have to offer, or contact us for more information!</p>
<p style="text-align: center;">[yotuwp type=&#8221;videos&#8221; id=&#8221;WC-bYJQpbDM&#8221; ]</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="687" src="../wp-content/uploads/2019/11/boston-Construction-Outlook-1024x687.png" class="attachment-large size-large wp-post-image" alt="<?php echo $row['country']; ?> Construction Outlook" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-1024x687.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook-768x515.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2019/11/boston-Construction-Outlook.png 1280w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../boston-construction-outlook-for-2020/index.php"><?php echo $row['country']; ?> Construction Outlook for 2020</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/eco-friendly-drywall-options/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/eco-friendly-drywall-options/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:49 GMT -->
</html>
