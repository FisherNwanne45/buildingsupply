...
<!-- Mirrored from <?php echo $row['url']; ?>/3-factors-to-guide-your-decision/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:11:02 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<link rel="canonical" href="<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Wood vs. Composite Decking: 3 Factors to Guide Your Decision - <?php echo $row['name']; ?> " />
	<meta property="og:description" content="Durability, appearance and cost are three factors to consider when purchasing new wood vs. composite decking. Here are the tips you need to weigh the pros and cons of each for your new deck upgrade in <?php echo $row['country']; ?>." />
	<meta property="og:url" content="<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2018-04-25T13:02:11+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:48:42+00:00" />
	<meta property="og:image" content="<?php echo $row['url']; ?>/wp-content/uploads/2018/04/wood-vs-composite-decking-<?php echo $row['country']; ?>.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/"},"author":{"name":"Richie","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77"},"headline":"Wood vs. Composite Decking: 3 Factors to Guide Your Decision","datePublished":"2018-04-25T13:02:11+00:00","dateModified":"2023-09-11T13:48:42+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/"},"wordCount":709,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/04/wood-vs-composite-decking-<?php echo $row['country']; ?>.jpg","keywords":["<?php echo $row['country']; ?>","<?php echo $row['country']; ?> Building","<?php echo $row['country']; ?> Homeowner","Building Supplier","Composite Deck","Deck Materials","Downtown <?php echo $row['country']; ?>","Lumber and Building Materials","Remodeler","Roof Deck","Triple Decker"],"articleSection":["<?php echo $row['country']; ?> Condo","Builder","Building Trends","Contractor","Homeowner"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/","url":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/","name":"Wood vs. Composite Decking: 3 Factors to Guide Your Decision - <?php echo $row['name']; ?> ","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/04/wood-vs-composite-decking-<?php echo $row['country']; ?>.jpg","datePublished":"2018-04-25T13:02:11+00:00","dateModified":"2023-09-11T13:48:42+00:00","breadcrumb":{"@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2018/04/wood-vs-composite-decking-<?php echo $row['country']; ?>.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2018/04/wood-vs-composite-decking-<?php echo $row['country']; ?>.jpg","width":1280,"height":853,"caption":"wood vs composite decking <?php echo $row['country']; ?>"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/3-factors-to-guide-your-decision/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Wood vs. Composite Decking: 3 Factors to Guide Your Decision"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/cce20b450ad58b39f4a09fbaa37ccb77","name":"Richie","url":"<?php echo $row['url']; ?>/author/richie/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Wood vs. Composite Decking: 3 Factors to Guide Your Decision - <?php echo $row['name']; ?> </title>
...
<link rel="https://api.w.org/" href="<?php echo $row['url']; ?>/wp-json/" /><link rel="alternate" type="application/json" href="<?php echo $row['url']; ?>/wp-json/wp/v2/posts/1810" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="<?php echo $row['url']; ?>/xmlrpc.php?rsd" />
<link rel='shortlink' href='<?php echo $row['url']; ?>/?p=1810' />
<link rel="alternate" type="application/json+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F3-factors-to-guide-your-decision%2F" />
<link rel="alternate" type="text/xml+oembed" href="<?php echo $row['url']; ?>/wp-json/oembed/1.0/embed?url=<?php echo $row['url']; ?>%2F3-factors-to-guide-your-decision%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-1810 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<div class="wp-block-group single-post_meta is-layout-flex wp-block-group-is-layout-flex">
		<div class="wp-block-post-date"><time datetime="2018-04-25T13:02:11-04:00">04.25.2018</time></div>
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Wood vs. Composite Decking: 3 Factors to Guide Your Decision</h1>

	<div class="entry-content alignfull animate-content wp-block-post-content is-layout-constrained wp-block-post-content-is-layout-constrained"><p>As the weather&nbsp;starts to warm up and the nor&#8217;easters&nbsp;call it quits, it&#8217;s time to think&nbsp;about spring and summer projects. If you have your eye on enjoying the great outdoors this season, nothing is better than a well-designed <a href="<?php echo $row['url']; ?>/build-the-boston-roof-deck-of-your-dreams/">deck</a> to add value to your house and create a transition between indoor and outdoor living.&nbsp;</p>
<p><span id="more-1810"></span></p>
<p>So what kind of deck should you build? Your&nbsp;biggest decision is about the materials.&nbsp;Wood decking&nbsp;is exactly what it sounds like, but you can choose from <a href="https://www.hgtv.com/remodel/outdoors/wood-decking-materials" target="_blank" rel="noopener noreferrer">two major types</a>. First is pressure-treated lumber, which is inexpensive&nbsp;Southern Yellow Pine boards that are chemically treated to resist mold, rot and insect damage. The other choices are redwood or cedar, which naturally have the properties that pressure-treating gives to pine.&nbsp;</p>
<p>The other best wood for outdoor deck building isn&#8217;t&nbsp;wood at all, but rather a manufactured combination of wood and recycled plastic.&nbsp;Composite decking&nbsp;is made by mixing these materials and pressing&nbsp;them into molds to create perfect boards that have a very even appearance. Because they are made with a considerable amount of plastic, <a href="https://www.thisoldhouse.com/ideas/all-about-composite-decking" target="_blank" rel="noopener noreferrer">composite boards</a> will not rot or suffer from insect damage.</p>
<p>Each type of decking material&nbsp;has its particular advantages and disadvantages, so you&#8217;ll need to weigh&nbsp;them to make the best decision for your property. To do so, consider these three major features:</p>
<h2>Durability</h2>
<p>When it comes to durability, composite boards come out on top. They are dense and water-resistant, so they never warp, crack or split, meaning&nbsp;your deck will stay in great shape for many years. You also&nbsp;<a href="https://www.popularmechanics.com/home/outdoor-projects/how-to/a7889/should-you-build-your-deck-from-wood-or-plastic-11226815/" target="_blank" rel="noopener noreferrer">won&#8217;t have to worry about annual maintenance tasks</a>&nbsp;like sanding and re-staining your deck — a quick hose-down is all it takes to keep it looking good. Though some homeowners complain that&nbsp;<a href="https://www.realcedar.com/blog/cedar-vs-composite-decks-despite-trendy-substiutes-wood-is-still-good/" target="_blank" rel="noopener noreferrer">composite boards can become worn in high-traffic areas</a>, denting and pitting are equally common in natural wood.</p>
<p>As for wood options, a cedar wood deck is generally more durable than a pressure-treated one, since pressure-treated pine is a soft wood that can more easily dent and splinter. Any type of wood will require yearly resealing and/or staining to maintain good&nbsp;color, so there&#8217;s built-in work to be done when you go this route.</p>
<h2>Appearance</h2>
<p>Opinions vary, but many people find the natural good looks of real wood to be far superior to the plastic, too-perfect look of composite decking. Composite boards are typically only available in a few colors, and the brown tones can come off as flat or fake looking. This is probably why a real wood deck adds more value to your&nbsp;home&#8217;s resale value than a composite one.&nbsp;<a href="http://www.remodeling.hw.net/cost-vs-value/2018/" target="_blank" rel="noopener noreferrer">According to Remodeling Magazine</a>, you can expect to recoup 83 percent of the cost of a wood deck when you sell, but only 64 percent of a composite deck&#8217;s installation price — proof positive that most people value the look of&nbsp;wood over composite, even if they have to put in extra work to keep cedar and pressure-treated lumber at their best.</p>
<h2>Cost</h2>
<p>Pressure-treated lumber is by far the cheapest option, which makes it a perennially popular choice at the lumberyard. To have a pressure-treated pine deck installed, expect to pay between $15 and $25 per square foot. Pro tip: Spending a little more for kiln-dried lumber will keep splitting and checking to a minimum for better results.&nbsp;A redwood or cedar deck will cost between $25 and $30 per square foot.</p>
<p>Composite decking is the most expensive at $30 to $45 per square foot, but this is a one-time investment. With composite, you won&#8217;t need to purchase sealer or stain every year or two, which makes its price the final price.</p>
<h2>The Bottom Line</h2>
<p>Ultimately, your choice of <a href="<?php echo $row['url']; ?>/pros-vs-cons-of-redecking-your-boston-triple-decker/" target="_blank" rel="noopener noreferrer">deck materials</a> will come down to your personal tastes, your budget and how much time you want to spend maintaining your deck. If you value maintenance-free living, spring for the composite decking. If you love the look of wood and don&#8217;t mind some annual work, get cedar. If keeping costs down is your primary goal, pressure-treated lumber&nbsp;is for you.</p>
<p>&nbsp;</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="768" src="<?php echo $row['url']; ?>/wp-content/uploads/2018/05/naturkast-weatherproof-cabinets-1024x768.jpg" class="attachment-large size-large wp-post-image" alt="naturkast weatherproof cabinets" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2018/05/naturkast-weatherproof-cabinets-1024x768.jpg 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2018/05/naturkast-weatherproof-cabinets-768x576.jpg 768w, <?php echo $row['url']; ?>/wp-content/uploads/2018/05/naturkast-weatherproof-cabinets.jpg 1200w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="<?php echo $row['url']; ?>/3-tips-for-choosing-weatherproof-outdoor-cabinets/">3 Tips for Choosing Weatherproof Outdoor Cabinets</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/3-factors-to-guide-your-decision/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
