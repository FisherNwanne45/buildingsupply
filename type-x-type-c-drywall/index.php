...
<!-- Mirrored from <?php echo $row['url']; ?>/type-x-type-c-drywall/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:02 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta name="description" content="Whether you’re doing a renovation or building something new, it’s important to understand the difference between type x and type c drywall." />
	<link rel="canonical" href="index.php" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Type X vs. Type C Drywall → Quality Fire Rated Drywall from NEBS" />
	<meta property="og:description" content="Whether you’re doing a renovation or building something new, it’s important to understand the difference between type x and type c drywall." />
	<meta property="og:url" content="index.php" />
	<meta property="og:site_name" content="<?php echo $row['name']; ?> " />
	<meta property="article:publisher" content="https://www.facebook.com" />
	<meta property="article:published_time" content="2021-08-13T15:38:00+00:00" />
	<meta property="article:modified_time" content="2023-09-11T13:46:10+00:00" />
	<meta property="og:image" content="../wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"Article","@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#article","isPartOf":{"@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/"},"author":{"name":"briannabeetstra","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356"},"headline":"Type X &#038; Type C Drywall: What You Need to Know About Fire-Rated Drywall","datePublished":"2021-08-13T15:38:00+00:00","dateModified":"2023-09-11T13:46:10+00:00","mainEntityOfPage":{"@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/"},"wordCount":546,"publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"image":{"@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg","articleSection":["Builder","Building in <?php echo $row['country']; ?>","Contractor","Developer"],"inLanguage":"en-US"},{"@type":"WebPage","@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/","url":"<?php echo $row['url']; ?>/type-x-type-c-drywall/","name":"Type X vs. Type C Drywall → Quality Fire Rated Drywall from NEBS","isPartOf":{"@id":"<?php echo $row['url']; ?>/#website"},"primaryImageOfPage":{"@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#primaryimage"},"image":{"@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#primaryimage"},"thumbnailUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg","datePublished":"2021-08-13T15:38:00+00:00","dateModified":"2023-09-11T13:46:10+00:00","description":"Whether you’re doing a renovation or building something new, it’s important to understand the difference between type x and type c drywall.","breadcrumb":{"@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?php echo $row['url']; ?>/type-x-type-c-drywall/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#primaryimage","url":"<?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2021/08/shutterstock_1326321488-scaled-1.jpg","width":2560,"height":1707,"caption":"type c vs type x drywall"},{"@type":"BreadcrumbList","@id":"<?php echo $row['url']; ?>/type-x-type-c-drywall/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Blog","item":"<?php echo $row['url']; ?>/blog/"},{"@type":"ListItem","position":2,"name":"Type X &#038; Type C Drywall: What You Need to Know About Fire-Rated Drywall"}]},{"@type":"WebSite","@id":"<?php echo $row['url']; ?>/#website","url":"<?php echo $row['url']; ?>/","name":"<?php echo $row['name']; ?> ","description":"<?php echo $row['country']; ?>&#039;s hometown building supplier, delivering to construction sites around <?php echo $row['country']; ?>. Lumber delivery, windows, kitchen and bath design for homeowners, builders, developers, remodelers and architects.","publisher":{"@id":"<?php echo $row['url']; ?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?php echo $row['url']; ?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?php echo $row['url']; ?>/#organization","name":"<?php echo $row['name']; ?> ","url":"<?php echo $row['url']; ?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?php echo $row['url']; ?>/#/schema/logo/image/","url":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","contentUrl":"<?php echo $row['url']; ?>/wp-content/uploads/2023/03/nebs-logo.png","width":318,"height":84,"caption":"<?php echo $row['name']; ?> "},"image":{"@id":"<?php echo $row['url']; ?>/#/schema/logo/image/"},"sameAs":["https://www.facebook.com","https://twitter.com/NEBS_<?php echo $row['country']; ?>","https://www.instagram.com","https://www.linkedin.com","https://www.pinterest.com/newenglandbuildingsupply","https://www.youtube.com/channel/UCyOfPzBxPEo86MkNHt-Ry2g"]},{"@type":"Person","@id":"<?php echo $row['url']; ?>/#/schema/person/3e745eb2eb7422930d2525a0b7071356","name":"briannabeetstra","url":"<?php echo $row['url']; ?>/author/briannabeetstra/"}]}</script>
	<!-- / Yoast SEO plugin. -->


<title>Type X vs. Type C Drywall → Quality Fire Rated Drywall from NEBS</title>
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" type="application/json" href="../wp-json/wp/v2/posts/2810.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.php?rsd" />
<link rel='shortlink' href='../index1fb0.php?p=2810' />
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed752d.json?url=<?php echo $row['url']; ?>%2Ftype-x-type-c-drywall%2F" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed8a1f?url=<?php echo $row['url']; ?>%2Ftype-x-type-c-drywall%2F&amp;format=xml" />
...
<body class="post-template-default single single-post postid-2810 single-format-standard wp-custom-logo wp-embed-responsive without-announcement">
...
<main class="wp-block-group alignfull animate-content single-post-content hentry is-layout-constrained wp-block-group-is-layout-constrained">
	...
	<h1 style="text-transform:uppercase;" class="wp-block-post-title has-h-2-font-size">Type X &#038; Type C Drywall: What You Need to Know About Fire-Rated Drywall</h1>
...
<p>Now that you know what type of fire rated drywall you need for your project, it’s time to start looking for options. At <?php echo $row['name']; ?> , we offer <a href="../builder/quality.php"> Type X and Type C drywall</a> in a variety of thicknesses to ensure your building is safe and well-built.</p>
<p>
To learn more about the types of drywall we offer, <a href="../contact-us/index.php">contact us today</a> or <a href="https://goo.gl/maps/x6wT35D1AFqYZEf4A" target="_blank" rel="noopener">stop by our downtown <?php echo $row['country']; ?> showroom</a> to speak with an experienced drywall professional. Happy drywalling!</p>
</div>
    ...
    <div class="is-content-justification-space-between is-layout-flex wp-block-group alignwide">
        <div class="is-layout-flex wp-block-columns wp-block-nav-post-img are-vertically-aligned-center justify-space-between">
            <div class="is-layout-flow wp-block-column column-feat-img wp-block-image is-vertically-aligned-center">
                <img width="1024" height="726" src="../wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1024x726.png" class="attachment-large size-large wp-post-image" alt="weatherproof outdoor cabinets" decoding="async" fetchpriority="high" srcset="<?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1024x726.png 1024w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-768x544.png 768w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets-1536x1088.png 1536w, <?php echo $row['url']; ?>/wp-content/uploads/2021/09/weatherproof-outdoor-cabinets.png 1640w" sizes="(max-width: 1024px) 100vw, 1024px" />            </div>
            <div class="is-layout-flow wp-block-column column-post-deets is-vertically-aligned-center has-link-arrow">
                <h2 class="has-h-5-font-size title-block">Next Post</h2>
                                    <p class="title-post has-large-font-size"><a href="../weatherproof-outdoor-cabinets-2/index.php">Weatherproof Outdoor Cabinets: What Material Should I Use?</a></p><p class="link-arrow has-small-font-size">Read story</p>                            </div>
        </div>
    </div>
...
<input type="hidden" id="frm_submit_entry_4" name="frm_submit_entry_4" value="1b393115d0" /><input type="hidden" name="_wp_http_referer" value="/type-x-type-c-drywall/" /><input type="hidden" name="item_meta[25]" id="field_a913j" value=""  data-invmsg="HubSpot is invalid"   />
...
<!-- Mirrored from <?php echo $row['url']; ?>/type-x-type-c-drywall/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Nov 2024 18:09:04 GMT -->
</html>
